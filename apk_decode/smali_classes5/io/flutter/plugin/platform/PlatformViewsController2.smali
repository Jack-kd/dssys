...
.method public applyTransactions()V
    ...
    .line 1
    invoke-static {}, Lio/flutter/plugin/platform/o;->a()Landroid/view/SurfaceControl$Transaction;
    ...
    .line 20
    invoke-static {v2}, Lio/flutter/plugin/platform/s;->a(Ljava/lang/Object;)Landroid/view/SurfaceControl$Transaction;
    ...
    .line 24
    invoke-static {v0, v2}, Lio/flutter/plugin/platform/m;->a(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl$Transaction;)Landroid/view/SurfaceControl$Transaction;
    ...
    .line 31
    :cond_0
    invoke-static {v0}, Lio/flutter/plugin/platform/r;->a(Landroid/view/SurfaceControl$Transaction;)V
...
.method public createOverlaySurface()Lio/flutter/embedding/engine/FlutterOverlaySurface;
    ...
    .line 5
    .line 6
    invoke-static {}, Lio/flutter/plugin/platform/p;->a()Landroid/view/SurfaceControl$Builder;
    ...
    .line 22
    invoke-static {v0, v2, v3}, Lio/flutter/plugin/platform/t;->a(Landroid/view/SurfaceControl$Builder;II)Landroid/view/SurfaceControl$Builder;
    ...
    .line 26
    invoke-static {v0, v2}, Lio/flutter/plugin/platform/u;->a(Landroid/view/SurfaceControl$Builder;I)Landroid/view/SurfaceControl$Builder;
    ...
    .line 30
    .line 31
    invoke-static {v0, v2}, Lio/flutter/plugin/platform/v;->a(Landroid/view/SurfaceControl$Builder;Ljava/lang/String;)Landroid/view/SurfaceControl$Builder;

    .line 32
    .line 33
    .line 34
    invoke-static {v0, v1}, Lio/flutter/plugin/platform/w;->a(Landroid/view/SurfaceControl$Builder;Z)Landroid/view/SurfaceControl$Builder;

    .line 35
    .line 36
    .line 37
    invoke-static {v0, v1}, Lio/flutter/plugin/platform/x;->a(Landroid/view/SurfaceControl$Builder;Z)Landroid/view/SurfaceControl$Builder;

    .line 38
    .line 39
    .line 40
    invoke-static {v0}, Lio/flutter/plugin/platform/y;->a(Landroid/view/SurfaceControl$Builder;)Landroid/view/SurfaceControl;
    ...
    .line 45
    .line 46
    invoke-static {v2}, Lio/flutter/plugin/platform/z;->a(Lio/flutter/embedding/android/FlutterView;)Landroid/view/AttachedSurfaceControl;
    ...
    .line 50
    invoke-static {v2, v0}, Lio/flutter/plugin/platform/k;->a(Landroid/view/AttachedSurfaceControl;Landroid/view/SurfaceControl;)Landroid/view/SurfaceControl$Transaction;
    ...
    .line 55
    .line 56
    invoke-static {v2, v0, v3}, Lio/flutter/plugin/platform/l;->a(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;I)Landroid/view/SurfaceControl$Transaction;

    .line 57
    .line 58
    .line 59
    invoke-static {v2}, Lio/flutter/plugin/platform/r;->a(Landroid/view/SurfaceControl$Transaction;)V

    .line 60
    .line 61
    .line 62
    invoke-static {v0}, Lio/flutter/plugin/platform/q;->a(Landroid/view/SurfaceControl;)Landroid/view/Surface;
...
.method public hideOverlaySurface()V
    ...
    .line 13
    invoke-static {v0, v1, v2}, Lio/flutter/plugin/platform/j;->a(Landroid/view/SurfaceControl$Transaction;Landroid/view/SurfaceControl;Z)Landroid/view/SurfaceControl$Transaction;
...
.method public initializePlatformViewIfNeeded(I)Z
    ...
    .line 55
    .line 56
    invoke-direct {v3, p0, p1}, Lio/flutter/plugin/platform/A;-><init>(Lio/flutter/plugin/platform/PlatformViewsController2;I)V
...
.method public onEndFrame()V
    ...
    .line 42
    .line 43
    invoke-static {v1}, Lio/flutter/plugin/platform/z;->a(Lio/flutter/embedding/android/FlutterView;)Landroid/view/AttachedSurfaceControl;
    ...
    .line 47
    invoke-static {v1, v0}, Lio/flutter/plugin/platform/n;->a(Landroid/view/AttachedSurfaceControl;Landroid/view/SurfaceControl$Transaction;)Z
