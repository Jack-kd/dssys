...
.method static constructor <clinit>()V
    ...
    const-string v1, "\u51fa\u4ef7\u8fc7\u4f4e"

    const-string v2, "LOSS_REASON_LOW_PRICE"

    const/4 v3, 0x0

    const/4 v4, 0x2

    invoke-direct {v0, v2, v3, v4, v1}, Lcom/sigmob/windad/WindAdBiddingLossReason;-><init>(Ljava/lang/String;IILjava/lang/String;)V
    ...
    new-instance v1, Lcom/sigmob/windad/WindAdBiddingLossReason;

    const/16 v2, 0x7d0

    const-string v3, "\u8fd4\u56de\u8d85\u65f6"

    const-string v5, "LOSS_REASON_RETURN_TIMEOUT"

    const/4 v6, 0x1

    invoke-direct {v1, v5, v6, v2, v3}, Lcom/sigmob/windad/WindAdBiddingLossReason;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v1, Lcom/sigmob/windad/WindAdBiddingLossReason;->LOSS_REASON_RETURN_TIMEOUT:Lcom/sigmob/windad/WindAdBiddingLossReason;

    new-instance v2, Lcom/sigmob/windad/WindAdBiddingLossReason;

    const/16 v3, 0x7d1

    const-string v5, "\u5e7f\u544a\u7d20\u6750\u683c\u5f0f\u9519\u8bef"

    const-string v6, "LOSS_REASON_RETURN_ERROR"

    invoke-direct {v2, v6, v4, v3, v5}, Lcom/sigmob/windad/WindAdBiddingLossReason;-><init>(Ljava/lang/String;IILjava/lang/String;)V

    sput-object v2, Lcom/sigmob/windad/WindAdBiddingLossReason;->LOSS_REASON_RETURN_ERROR:Lcom/sigmob/windad/WindAdBiddingLossReason;

    filled-new-array {v0, v1, v2}, [Lcom/sigmob/windad/WindAdBiddingLossReason;

    move-result-object v0

    sput-object v0, Lcom/sigmob/windad/WindAdBiddingLossReason;->b:[Lcom/sigmob/windad/WindAdBiddingLossReason;
