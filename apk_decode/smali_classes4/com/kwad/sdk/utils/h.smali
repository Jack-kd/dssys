...
# static fields
.field private static arT:Landroid/os/Handler;

.field private static arZ:Ljava/lang/ref/WeakReference;
...
.field private static boh:Landroid/os/Messenger;

.field private static volatile boi:Ljava/util/concurrent/ExecutorService;

.field private static volatile boj:Lcom/kwad/sdk/collector/AppStatusRules;

.field private static bok:Lcom/kwad/sdk/collector/h;
...
.method public static Uf()Lcom/kwad/sdk/collector/AppStatusRules;
    .locals 1

    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->boj:Lcom/kwad/sdk/collector/AppStatusRules;
...
.method private static Ug()Z
    .locals 2

    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->boh:Landroid/os/Messenger;
    ...
    .line 18
    .line 19
    sput-object v1, Lcom/kwad/sdk/utils/h;->boh:Landroid/os/Messenger;
    :try_end_0
...
.method private static Uh()V
    ...
    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->boi:Ljava/util/concurrent/ExecutorService;
    ...
    .line 8
    :try_start_0
    sget-object v1, Lcom/kwad/sdk/utils/h;->boi:Ljava/util/concurrent/ExecutorService;
    ...
    .line 11
    .line 12
    invoke-static {}, Lcom/kwad/sdk/core/threads/GlobalThreadPools;->Oh()Ljava/util/concurrent/ExecutorService;
    ...
    .line 16
    sput-object v1, Lcom/kwad/sdk/utils/h;->boi:Ljava/util/concurrent/ExecutorService;
...
.method private static Ui()Z
    ...
    .line 3
    .line 4
    sget v2, Lcom/kwad/sdk/api/proxy/app/ServiceProxyRemote;->b:I
...
.method public static synthetic Uj()Landroid/os/Messenger;
    .locals 1
...
.method public static synthetic Uk()Lcom/kwad/sdk/collector/AppStatusRules;
    .locals 1
...
.method public static synthetic Ul()V
    .locals 0

    .line 1
    invoke-static {}, Lcom/kwad/sdk/utils/h;->Uh()V
...
.method public static synthetic Um()Ljava/util/concurrent/ExecutorService;
    .locals 1
...
.method public static synthetic Un()Landroid/os/Handler;
    .locals 1

    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->arT:Landroid/os/Handler;
...
.method public static synthetic Uo()Lcom/kwad/sdk/collector/h;
    .locals 1

    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->bok:Lcom/kwad/sdk/collector/h;
...
.method public static synthetic Up()Ljava/lang/ref/WeakReference;
    .locals 1

    .line 1
    sget-object v0, Lcom/kwad/sdk/utils/h;->arZ:Ljava/lang/ref/WeakReference;
...
.method public static synthetic Uq()Landroid/content/ServiceConnection;
    .locals 1
...
.method private static a(Lcom/kwad/sdk/collector/AppStatusRules$Strategy;)Ljava/util/List;
    ...
    .line 19
    :cond_0
    invoke-static {}, Lcom/kwad/sdk/collector/b;->HX()Lcom/kwad/sdk/collector/a;
...
.method public static a(Landroid/content/Context;JLcom/kwad/sdk/collector/h;)V
    ...
    .line 2
    invoke-static {p1, p2}, Lcom/kwad/sdk/core/config/e;->ao(J)Z
    ...
    .line 4
    :cond_2
    sput-object p3, Lcom/kwad/sdk/utils/h;->bok:Lcom/kwad/sdk/collector/h;
    ...
    sput-object p1, Lcom/kwad/sdk/utils/h;->arZ:Ljava/lang/ref/WeakReference;

    .line 8
    sget-object p1, Lcom/kwad/sdk/utils/h;->arT:Landroid/os/Handler;
    ...
    sput-object p1, Lcom/kwad/sdk/utils/h;->arT:Landroid/os/Handler;
...
.method public static synthetic access$000()Z
    ...
    .line 1
    invoke-static {}, Lcom/kwad/sdk/utils/h;->Ug()Z
...
.method public static c(Landroid/content/Context;J)V
    ...
    sput-object v0, Lcom/kwad/sdk/utils/h;->arT:Landroid/os/Handler;
...
.method public static cO(Landroid/content/Context;)V
    ...
    .line 4
    .line 5
    invoke-static {p0}, Lcom/kwad/sdk/utils/h;->cP(Landroid/content/Context;)Lcom/kwad/sdk/collector/AppStatusRules;
    ...
    .line 9
    sput-object p0, Lcom/kwad/sdk/utils/h;->boj:Lcom/kwad/sdk/collector/AppStatusRules;
...
.method private static cP(Landroid/content/Context;)Lcom/kwad/sdk/collector/AppStatusRules;
    .locals 2
...
.method private static cQ(Landroid/content/Context;)V
    ...
    .line 4
    :cond_0
    invoke-static {}, Lcom/kwad/sdk/utils/h;->Ui()Z
...
.method private static cR(Landroid/content/Context;)Ljava/util/List;
    ...
    .line 21
    sput-object v0, Lcom/kwad/sdk/utils/h;->boj:Lcom/kwad/sdk/collector/AppStatusRules;

    .line 22
    .line 23
    :cond_1
    invoke-static {p0}, Lcom/kwad/sdk/utils/h;->cS(Landroid/content/Context;)Ljava/util/List;
...
.method private static cS(Landroid/content/Context;)Ljava/util/List;
    .locals 5
    ...
    .line 13
    .line 14
    invoke-static {v1, v2}, Lcom/kwad/sdk/core/config/e;->ao(J)Z
    ...
    .line 84
    .line 85
    invoke-static {v0}, Lcom/kwad/sdk/utils/h;->U(Ljava/util/List;)Ljava/util/List;
...
.method public static synthetic cT(Landroid/content/Context;)V
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/kwad/sdk/utils/h;->cQ(Landroid/content/Context;)V
...
.method public static synthetic cU(Landroid/content/Context;)Ljava/util/List;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/kwad/sdk/utils/h;->cR(Landroid/content/Context;)Ljava/util/List;
