...
# static fields
.field private static final TAG:Ljava/lang/String; = "LoadAdRequest"
...
.field private bidFloor:Ljava/lang/Integer;
...
.field private mAdxId:Ljava/lang/String;
...
.field private final mTBAdxInfo:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map<",
            "**>;"
...
.method public constructor <init>(Lcom/sigmob/windad/WindAdRequest;)V
    ...
    invoke-virtual {v0}, Lcom/sigmob/sdk/base/j;->a()I

    move-result v0

    iput v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->request_scene_type:I
    ...
    invoke-virtual {p1}, Lcom/sigmob/windad/WindAdRequest;->getAdxId()Ljava/lang/String;

    move-result-object v0

    iput-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->mAdxId:Ljava/lang/String;

    invoke-virtual {p1}, Lcom/sigmob/windad/WindAdRequest;->getTBAdxInfo()Ljava/util/Map;

    move-result-object v0

    iput-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->mTBAdxInfo:Ljava/util/Map;
    ...
    :cond_1
    instance-of v0, p1, Lcom/sigmob/windad/newInterstitial/WindNewInterstitialAdRequest;

    if-eqz v0, :cond_2

    move-object v0, p1

    check-cast v0, Lcom/sigmob/windad/newInterstitial/WindNewInterstitialAdRequest;

    invoke-virtual {v0}, Lcom/sigmob/windad/newInterstitial/WindNewInterstitialAdRequest;->isEnableKeepOn()Z

    move-result v1

    iput-boolean v1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->enable_keep_on:Z

    invoke-virtual {v0}, Lcom/sigmob/windad/newInterstitial/WindNewInterstitialAdRequest;->isEnableScreenLockDisPlayAd()Z
...
.method public getAdx_id()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->mAdxId:Ljava/lang/String;

    return-object v0
.end method

.method public getBidFloor()Ljava/lang/Integer;
    .locals 1

    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->bidFloor:Ljava/lang/Integer;
...
.method public getOriginPrice()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->originPrice:Ljava/lang/String;
...
.method public getOriginVid()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->originVid:Ljava/lang/String;
...
.method public getTBAdxInfo()Ljava/util/Map;
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->mTBAdxInfo:Ljava/util/Map;
...
.method public getTraceId()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->traceId:Ljava/lang/String;
...
.method public setAdx_id(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->mAdxId:Ljava/lang/String;

    new-instance v0, Ljava/lang/StringBuilder;

    invoke-direct {v0}, Ljava/lang/StringBuilder;-><init>()V

    const-string v1, "setAdxId: adxId = "
    ...
    const-string v1, "LoadAdRequest"

    invoke-static {v1, p1, v0}, Lcom/sigmob/sdk/base/utils/k;->b(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V

    return-void
.end method

.method public setBidFloor(Ljava/lang/Integer;)V
    .locals 0

    iput-object p1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->bidFloor:Ljava/lang/Integer;
...
.method public setOriginPrice(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->originPrice:Ljava/lang/String;
...
.method public setOriginVid(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->originVid:Ljava/lang/String;
...
.method public setTraceId(Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/sigmob/sdk/base/models/LoadAdRequest;->traceId:Ljava/lang/String;
