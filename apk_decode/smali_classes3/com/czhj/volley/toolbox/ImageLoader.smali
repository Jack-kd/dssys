...
.method public static synthetic a(Lcom/czhj/volley/toolbox/ImageLoader;Ljava/lang/Runnable;)Ljava/lang/Runnable;
    .locals 0
...
.method public static synthetic a(Lcom/czhj/volley/toolbox/ImageLoader;)Ljava/util/HashMap;
    .locals 0
...
.method public static synthetic b(Lcom/czhj/volley/toolbox/ImageLoader;)Ljava/util/HashMap;
    .locals 0
...
.method public get(Ljava/lang/String;Lcom/czhj/volley/toolbox/ImageLoader$ImageListener;IILandroid/widget/ImageView$ScaleType;)Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;
    ...
    invoke-static {p1, p3, p4, p5}, Lcom/czhj/volley/toolbox/ImageLoader;->a(Ljava/lang/String;IILandroid/widget/ImageView$ScaleType;)Ljava/lang/String;

    move-result-object v4

    iget-object v0, p0, Lcom/czhj/volley/toolbox/ImageLoader;->b:Lcom/czhj/volley/toolbox/ImageLoader$ImageCache;

    invoke-interface {v0, v4}, Lcom/czhj/volley/toolbox/ImageLoader$ImageCache;->getBitmap(Ljava/lang/String;)Landroid/graphics/Bitmap;

    move-result-object v2

    const/4 v8, 0x1

    new-instance v0, Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;
    ...
    invoke-interface {p2, v0, v8}, Lcom/czhj/volley/toolbox/ImageLoader$ImageListener;->onResponse(Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;Z)V
    ...
    invoke-interface {p2, v6, v8}, Lcom/czhj/volley/toolbox/ImageLoader$ImageListener;->onResponse(Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;Z)V
    ...
    invoke-virtual {v0, v6}, Lcom/czhj/volley/toolbox/ImageLoader$BatchedImageRequest;->addContainer(Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;)V
    ...
    iget-object v2, p0, Lcom/czhj/volley/toolbox/ImageLoader;->a:Lcom/czhj/volley/RequestQueue;

    if-eqz v2, :cond_2

    invoke-virtual {v2, v1}, Lcom/czhj/volley/RequestQueue;->add(Lcom/czhj/volley/Request;)Lcom/czhj/volley/Request;

    iget-object v2, p0, Lcom/czhj/volley/toolbox/ImageLoader;->c:Ljava/util/HashMap;

    new-instance v3, Lcom/czhj/volley/toolbox/ImageLoader$BatchedImageRequest;

    invoke-direct {v3, v1, v6}, Lcom/czhj/volley/toolbox/ImageLoader$BatchedImageRequest;-><init>(Lcom/czhj/volley/Request;Lcom/czhj/volley/toolbox/ImageLoader$ImageContainer;)V
...
.method public makeImageRequest(Ljava/lang/String;IILandroid/widget/ImageView$ScaleType;Ljava/lang/String;)Lcom/czhj/volley/Request;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v0, Lcom/czhj/volley/toolbox/ImageRequest;
...
.method public onGetImageError(Ljava/lang/String;Lcom/czhj/volley/VolleyError;)V
    .locals 1
