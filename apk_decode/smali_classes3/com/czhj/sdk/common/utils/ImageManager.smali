...
# static fields
.field private static volatile a:Lcom/czhj/sdk/common/utils/ImageManager;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->c:Ljava/util/concurrent/ExecutorService;
    ...
    iput-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->d:Landroid/util/LruCache;
    ...
    iput-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->e:Landroid/os/Handler;
...
.method private a()Ljava/io/File;
    ...
    .line 2
    iget-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->f:Ljava/io/File;
    ...
    :cond_2
    iput-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->f:Ljava/io/File;

    return-object v0
.end method

.method public static synthetic a(Lcom/czhj/sdk/common/utils/ImageManager;)Ljava/io/File;
    .locals 0
...
.method public static synthetic b(Lcom/czhj/sdk/common/utils/ImageManager;)Landroid/os/Handler;
    .locals 0

    iget-object p0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->e:Landroid/os/Handler;

    return-object p0
.end method

.method public static synthetic c(Lcom/czhj/sdk/common/utils/ImageManager;)Landroid/util/LruCache;
    .locals 0

    iget-object p0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->d:Landroid/util/LruCache;

    return-object p0
.end method

.method public static synthetic d(Lcom/czhj/sdk/common/utils/ImageManager;)Ljava/util/concurrent/ExecutorService;
    .locals 0

    iget-object p0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->c:Ljava/util/concurrent/ExecutorService;
...
.method public clearCache()V
    ...
    invoke-direct {v1, p0}, Lcom/czhj/sdk/common/utils/ImageManager$1;-><init>(Lcom/czhj/sdk/common/utils/ImageManager;)V
...
.method public customCachePath(Ljava/io/File;)Lcom/czhj/sdk/common/utils/ImageManager;
    ...
    iput-object p1, p0, Lcom/czhj/sdk/common/utils/ImageManager;->f:Ljava/io/File;
...
.method public getBitmap(Ljava/lang/String;Lcom/czhj/sdk/common/utils/ImageManager$BitmapLoadedListener;)V
    ...
    iget-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->d:Landroid/util/LruCache;
    ...
    iget-object v1, p0, Lcom/czhj/sdk/common/utils/ImageManager;->d:Landroid/util/LruCache;
    ...
    :goto_0
    invoke-static {p1}, Lcom/czhj/sdk/common/utils/Md5Util;->getMd5FilenameFromUrl(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_4
    iget-object v0, p0, Lcom/czhj/sdk/common/utils/ImageManager;->c:Ljava/util/concurrent/ExecutorService;

    new-instance v1, Lcom/czhj/sdk/common/utils/ImageManager$2;

    invoke-direct {v1, p0, p1, p2}, Lcom/czhj/sdk/common/utils/ImageManager$2;-><init>(Lcom/czhj/sdk/common/utils/ImageManager;Ljava/lang/String;Lcom/czhj/sdk/common/utils/ImageManager$BitmapLoadedListener;)V
