...
# direct methods
.method public constructor <init>(Lcom/czhj/sdk/common/Database/DBOperator;Landroid/database/sqlite/SQLiteDatabase;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Lcom/czhj/sdk/common/Database/DBOperator$DataSQLiteLisenter;)V
    .locals 0
...
.method public run()V
    ...
    :try_start_0
    iget-object v0, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->j:Landroid/database/sqlite/SQLiteDatabase;

    iget-object v1, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->b:Ljava/lang/String;

    iget-object v2, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->c:[Ljava/lang/String;

    iget-object v3, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->d:Ljava/lang/String;

    iget-object v4, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->e:[Ljava/lang/String;

    iget-object v5, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->f:Ljava/lang/String;

    iget-object v6, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->g:Ljava/lang/String;

    iget-object v7, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->h:Ljava/lang/String;

    iget-object v8, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->i:Ljava/lang/String;
    ...
    :try_start_1
    invoke-direct {p0, v1}, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->a(Landroid/database/Cursor;)Ljava/util/List;
    ...
    invoke-interface {v2, v0}, Lcom/czhj/sdk/common/Database/DBOperator$DataSQLiteLisenter;->onSuccess(Ljava/util/List;)V
    :try_end_1
    ...
    :goto_3
    iget-object v1, p0, Lcom/czhj/sdk/common/Database/DBOperator$SQLiteThread;->k:Lcom/czhj/sdk/common/Database/DBOperator$DataSQLiteLisenter;
    ...
    invoke-interface {v1, v2}, Lcom/czhj/sdk/common/Database/DBOperator$DataSQLiteLisenter;->onFailed(Ljava/lang/Error;)V
