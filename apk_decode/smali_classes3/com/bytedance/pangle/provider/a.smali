...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    invoke-static {p0, p3, p2}, Lk0/j;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;)I
    ...
    .line 54
    invoke-static {p0, p1, p2}, Lk0/j;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/os/Bundle;)I
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-static {p0, p5, p2, p3, p4}, Lk0/g;->a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
    ...
    .line 18
    invoke-static {p0, p1, p2, p3, p4}, Lk0/g;->a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Landroid/os/Bundle;Landroid/os/CancellationSignal;)Landroid/database/Cursor;
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Landroid/os/CancellationSignal;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    .line 9
    :try_start_0
    invoke-static {p1, v0}, Lcom/bytedance/pangle/provider/a;->a(Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 10
    :goto_1
    const-string p1, "ContentProviderManager#query(6 params) throw exception:"

    invoke-static {v1, p1, p0}, Lcom/bytedance/pangle/log/ZeusLogger;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :catch_2
    :try_start_1
    const-string v0, "not found plugin provider, but found host ContentResolver execute query(6 params) !!!"
    ...
    .line 13
    const-string p1, "not found host provider-ContentProviderManager#query(6 params) throw exception:"
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    ...
    :goto_1
    :try_start_2
    const-string p0, "not found plugin provider, but found host ContentResolver execute query(5 params) !!!"
...
.method public static a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;Ljava/lang/String;)Landroid/net/Uri;
    ...
    invoke-static {p0, p4, p2, p3}, Lk0/h;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)Landroid/net/Uri;
    ...
    .line 42
    invoke-static {p0, p1, p2, p3}, Lk0/h;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)Landroid/net/Uri;
...
.method private static a(Ljava/lang/String;Landroid/net/Uri;Ljava/lang/String;)Landroid/net/Uri;
    ...
    .line 3
    invoke-static {p2, p0, p1}, Lcom/byazt/yt/hp;->hp(Ljava/lang/String;Ljava/lang/String;Landroid/net/Uri;)Ljava/lang/String;

    move-result-object p0

    .line 4
    invoke-static {p0}, Lcom/byazt/lc/e;->hp(Ljava/lang/String;)Ljava/lang/String;
    ...
    check-cast p1, Lcom/bytedance/pangle/provider/ContentProviderManager$jx;

    .line 6
    iget-object p1, p1, Lcom/bytedance/pangle/provider/ContentProviderManager$l;->l:Ljava/lang/String;
...
.method public static a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;)Landroid/os/Bundle;
    ...
    check-cast v3, Lcom/bytedance/pangle/provider/ContentProviderManager$jx;

    .line 75
    iget-object v3, v3, Lcom/bytedance/pangle/provider/ContentProviderManager$l;->l:Ljava/lang/String;
    ...
    .line 79
    :try_start_0
    invoke-static {p0, v3, p2, p3, p4}, Lk0/f;->a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
    ...
    .line 82
    invoke-static {p0, p1, p2, p3, p4}, Lk0/f;->a(Landroid/content/ContentResolver;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Landroid/os/Bundle;)Landroid/os/Bundle;
...
.method public static b(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;Ljava/lang/String;)I
    ...
    .line 13
    invoke-static {p0, p4, p2, p3}, Lk0/i;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)I
    ...
    .line 29
    .line 30
    invoke-static {p0, p1, p2, p3}, Lk0/i;->a(Landroid/content/ContentResolver;Landroid/net/Uri;Landroid/content/ContentValues;Landroid/os/Bundle;)I
