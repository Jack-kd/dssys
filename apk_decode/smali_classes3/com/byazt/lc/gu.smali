.class public final Lcom/byazt/lc/gu;
...
# static fields
.field public static volatile hp:Ljava/util/ArrayList;
...
.method public static hp()Ljava/util/List;
    ...
    .line 3
    :goto_0
    invoke-static {v0}, Lcom/byazt/lc/gu;->hp(Landroid/content/res/AssetManager;)Ljava/util/List;
...
.method public static hp(Landroid/content/res/AssetManager;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static hp(Landroid/content/res/AssetManager;Ljava/lang/String;)Z
    .locals 7
...
.method private static hp(Landroid/content/pm/ApplicationInfo;)[Ljava/lang/String;
    .locals 4
    ...
    invoke-static {v1, v2}, Lcom/byazt/vw/hp;->hp(Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/reflect/Field;
...
.method public static l(Landroid/content/res/AssetManager;)Ljava/lang/String;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/byazt/lc/gu;->hp(Landroid/content/res/AssetManager;)Ljava/util/List;

    move-result-object p0

    invoke-static {p0}, Lcom/byazt/lc/gu;->hp(Ljava/util/List;)Ljava/lang/String;
...
.method public static declared-synchronized l()Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    const-class v0, Lcom/byazt/lc/gu;
    ...
    .line 3
    sget-object v1, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;

    if-nez v1, :cond_3

    .line 4
    const-class v1, Lcom/byazt/lc/gu;
    ...
    .line 5
    :try_start_1
    sget-object v2, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;
    ...
    sput-object v2, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;
    ...
    .line 10
    sget-object v5, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;
    ...
    .line 15
    invoke-static {}, Lcom/byazt/lc/q;->v()Z
    ...
    .line 16
    sget-object v3, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;
    ...
    invoke-static {v2}, Lcom/byazt/lc/gu;->hp(Landroid/content/pm/ApplicationInfo;)[Ljava/lang/String;
    ...
    sget-object v4, Lcom/byazt/lc/gu;->hp:Ljava/util/ArrayList;
