...
.method private hp(Ljava/nio/ByteBuffer;)I
    .locals 7
...
.method private static hp(Ljava/nio/MappedByteBuffer;ILjava/lang/String;)Lcom/byazt/lc/w;
    .locals 3
    ...
    invoke-direct {p0, p1, p2}, Lcom/byazt/lc/w;-><init>(Ljava/lang/Object;Ljava/lang/Object;)V
...
.method private hp(Ljava/io/File;Ljava/util/HashSet;Lcom/byazt/vn/s;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 38
    invoke-virtual {p0, p1}, Lcom/byazt/vn/jx;->hp(Ljava/io/File;)Ljava/nio/MappedByteBuffer;

    move-result-object p1

    .line 39
    invoke-direct {p0, p1}, Lcom/byazt/vn/jx;->hp(Ljava/nio/ByteBuffer;)I
    ...
    .line 52
    invoke-static {p1, v4, v6}, Lcom/byazt/vn/jx;->hp(Ljava/nio/MappedByteBuffer;ILjava/lang/String;)Lcom/byazt/lc/w;

    move-result-object v4

    .line 53
    :try_start_0
    iget-object v7, v4, Lcom/byazt/lc/w;->l:Ljava/lang/Object;

    check-cast v7, [B

    invoke-static {v6, v7, p3}, Lcom/byazt/vn/gu;->hp(Ljava/lang/String;[BLcom/byazt/vn/s;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    .line 54
    :goto_2
    iget-object v6, v4, Lcom/byazt/lc/w;->l:Ljava/lang/Object;
    ...
    .line 55
    iget-object v6, v4, Lcom/byazt/lc/w;->hp:Ljava/lang/Object;
...
# virtual methods
.method public hp(Ljava/io/File;ZLjava/lang/StringBuilder;)I
    .locals 19
    ...
    .line 4
    invoke-static {v10}, Lcom/byazt/lc/eb;->hp(Ljava/util/zip/ZipFile;)V
    ...
    .line 8
    invoke-static {v9}, Lcom/byazt/lc/s;->hp(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v9, v6}, Lcom/byazt/lc/s;->hp(Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    .line 28
    new-instance v12, Lcom/byazt/vn/jx$1;
    :try_end_4
    ...
    :try_start_5
    invoke-direct/range {v12 .. v17}, Lcom/byazt/vn/jx$1;-><init>(Lcom/byazt/vn/jx;Lorg/json/JSONObject;Lorg/json/JSONObject;[ILjava/util/HashSet;)V

    move-object/from16 v1, v17

    move-object/from16 v13, p0

    invoke-direct {v13, v0, v1, v12}, Lcom/byazt/vn/jx;->hp(Ljava/io/File;Ljava/util/HashSet;Lcom/byazt/vn/s;)V

    .line 29
    new-instance v1, Ljava/lang/StringBuilder;

    const-string v5, "modifyRes count = "
    ...
    invoke-static {v1, v5, v2}, Lcom/byazt/lc/s;->hp(Ljava/lang/String;Ljava/io/File;Ljava/lang/StringBuilder;)Z
    ...
    .line 37
    invoke-static {v9}, Lcom/byazt/lc/eb;->hp(Ljava/util/zip/ZipFile;)V
...
.method public hp(Ljava/io/File;)Ljava/nio/MappedByteBuffer;
    .locals 9
    .annotation system Ldalvik/annotation/Throws;
        value = {
