...
public final class C1422a implements FlutterPlugin, MethodChannel.MethodCallHandler, ActivityAware {
    ...
    public final void c(MethodChannel.Result result, boolean asAnotherTask) {
        ...
        Activity activity = this.activity;
        Uri uriFromParts = activity != null ? Uri.fromParts(AbsServerManager.PACKAGE_QUERY_BINDER, activity.getPackageName(), null) : null;
    ...
    public final void h(MethodChannel.Result result, boolean asAnotherTask) {
        ...
        if (activity != null) {
            ...
            j.d(intentPutExtra, "putExtra(...)");
            if (asAnotherTask) {
                intentPutExtra.addFlags(C.ENCODING_PCM_MU_LAW);
            }
    ...
    public void onMethodCall(MethodCall call, MethodChannel.Result result) {
        ...
        if (j.a(str, "openSettings")) {
            a(call, result);
        } else if (j.a(str, "openSettingsPanel")) {
            b(call, result);
        } else {
            result.notImplemented();
        }
