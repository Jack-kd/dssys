...
final class FlowKt__ErrorsKt$retry$1 extends SuspendLambda implements Function2<Throwable, kotlin.coroutines.e, Object> {
    int label;

    public FlowKt__ErrorsKt$retry$1(kotlin.coroutines.e eVar) {
        super(2, eVar);
    }
    ...
    public final Object invoke(Throwable th, kotlin.coroutines.e eVar) {
        return ((FlowKt__ErrorsKt$retry$1) create(th, eVar)).invokeSuspend(kotlin.j.f51397a);
    }
}
