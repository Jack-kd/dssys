...
public final class d implements a.c, x, x.a, x.b {
    ...
    public final void Bg() {
        synchronized (this.azo) {
            try {
                ...
                b((byte) 10);
                a.InterfaceC0580a interfaceC0580aBd = this.azt.Bd();
                com.kwad.framework.filedownloader.a aVarAP = interfaceC0580aBd.AP();
                if (com.kwad.framework.filedownloader.f.d.aDr) {
                ...
                try {
                    ...
                    h.Bn().b(interfaceC0580aBd);
                    h.Bn().a(interfaceC0580aBd, n(th));
                }
                if (com.kwad.framework.filedownloader.f.d.aDr) {
    ...
    public final boolean pause() {
        ...
        h.Bn().b(interfaceC0580aBd);
        h.Bn().a(interfaceC0580aBd, com.kwad.framework.filedownloader.message.f.e(aVarAP));
        r.BG().BK().e(interfaceC0580aBd);
        return true;
    }
        ...
        try {
            ...
            synchronized (this.azo) {
                try {
                    ...
                    if (h.Bn().a(interfaceC0580aBd)) {
                        vVarBK.e(interfaceC0580aBd);
                        h.Bn().b(interfaceC0580aBd);
                    }
                    h.Bn().a(interfaceC0580aBd, messageSnapshotN);
                } finally {
                }
            }
        } catch (Throwable th) {
