...
public class b {
    ...
    public static ThreadPoolExecutor a(int i2, LinkedBlockingQueue<Runnable> linkedBlockingQueue, String str) {
        ...
        com.kwad.sdk.core.threads.a.b bVar = new com.kwad.sdk.core.threads.a.b(i2, i2, 15L, TimeUnit.SECONDS, linkedBlockingQueue, new a(str));
    ...
    @Deprecated
    public static ThreadPoolExecutor w(int i2, String str) {
        return Dv() ? Dw() : a(i2, new LinkedBlockingQueue(), str);
    }
}
