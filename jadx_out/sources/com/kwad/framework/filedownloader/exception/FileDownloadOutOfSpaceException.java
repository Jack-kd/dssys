...
public class FileDownloadOutOfSpaceException extends IOException {
    ...
    public FileDownloadOutOfSpaceException(long j2, long j3, long j4, Throwable th) {
        super(f.c("The file is too large to store, breakpoint in bytes:  %d, required space in bytes: %d, but free space in bytes: %d", Long.valueOf(j4), Long.valueOf(j3), Long.valueOf(j2)), th);
        init(j2, j3, j4);
    }
    ...
    public FileDownloadOutOfSpaceException(long j2, long j3, long j4) {
        super(f.c("The file is too large to store, breakpoint in bytes:  %d, required space in bytes: %d, but free space in bytes: %d", Long.valueOf(j4), Long.valueOf(j3), Long.valueOf(j2)));
        init(j2, j3, j4);
    }
}
