...
public class KSCoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static abstract class Behavior<V extends View> {
        ...
        public boolean blocksInteractionBelow(KSCoordinatorLayout kSCoordinatorLayout, V v2) {
            return getScrimOpacity(kSCoordinatorLayout, v2) > 0.0f;
        }

        public boolean getInsetDodgeRect(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull Rect rect) {
            return false;
        }

        @ColorInt
        public int getScrimColor(KSCoordinatorLayout kSCoordinatorLayout, V v2) {
            return -16777216;
        }

        @FloatRange(from = 0.0d, to = 1.0d)
        public float getScrimOpacity(KSCoordinatorLayout kSCoordinatorLayout, V v2) {
            return 0.0f;
        }

        public boolean layoutDependsOn(KSCoordinatorLayout kSCoordinatorLayout, V v2, View view) {
            return false;
        }

        @NonNull
        public WindowInsetsCompat onApplyWindowInsets(KSCoordinatorLayout kSCoordinatorLayout, V v2, WindowInsetsCompat windowInsetsCompat) {
        ...
        public boolean onDependentViewChanged(KSCoordinatorLayout kSCoordinatorLayout, V v2, View view) {
            return false;
        }

        public void onDependentViewRemoved(KSCoordinatorLayout kSCoordinatorLayout, V v2, View view) {
        }

        public void onDetachedFromLayoutParams() {
        }

        public boolean onInterceptTouchEvent(KSCoordinatorLayout kSCoordinatorLayout, V v2, MotionEvent motionEvent) {
            return false;
        }
        ...
        public boolean onMeasureChild(KSCoordinatorLayout kSCoordinatorLayout, V v2, int i2, int i3, int i4, int i5) {
            return false;
        }

        public boolean onNestedFling(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, float f2, float f3, boolean z2) {
            return false;
        }

        public boolean onNestedPreFling(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, float f2, float f3) {
            return false;
        }

        @Deprecated
        public void onNestedPreScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i3, @NonNull int[] iArr) {
        }

        @Deprecated
        public void onNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i3, int i4, int i5) {
        }

        @Deprecated
        public void onNestedScrollAccepted(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2) {
        }

        public boolean onRequestChildRectangleOnScreen(KSCoordinatorLayout kSCoordinatorLayout, V v2, Rect rect, boolean z2) {
            return false;
        }

        public void onRestoreInstanceState(KSCoordinatorLayout kSCoordinatorLayout, V v2, Parcelable parcelable) {
        }

        public Parcelable onSaveInstanceState(KSCoordinatorLayout kSCoordinatorLayout, V v2) {
            return View.BaseSavedState.EMPTY_STATE;
        }

        @Deprecated
        public boolean onStartNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2) {
            return false;
        }

        @Deprecated
        public void onStopNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view) {
        }
        ...
        public void onNestedPreScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i3, @NonNull int[] iArr, int i4) {
            if (i4 == 0) {
                onNestedPreScroll(kSCoordinatorLayout, v2, view, i2, i3, iArr);
            }
        }

        public void onNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, int i2, int i3, int i4, int i5, int i6) {
            if (i6 == 0) {
                onNestedScroll(kSCoordinatorLayout, v2, view, i2, i3, i4, i5);
            }
        }

        public void onNestedScrollAccepted(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2, int i3) {
            if (i3 == 0) {
                onNestedScrollAccepted(kSCoordinatorLayout, v2, view, view2, i2);
            }
        }

        public boolean onStartNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, @NonNull View view2, int i2, int i3) {
            if (i3 == 0) {
                return onStartNestedScroll(kSCoordinatorLayout, v2, view, view2, i2);
            }
            return false;
        }

        public void onStopNestedScroll(@NonNull KSCoordinatorLayout kSCoordinatorLayout, @NonNull V v2, @NonNull View view, int i2) {
            if (i2 == 0) {
                onStopNestedScroll(kSCoordinatorLayout, v2, view);
            }
        }
    }
    ...
    static {
        Package r02 = KSCoordinatorLayout.class.getPackage();
    ...
    private int getKeyline(int i2) {
        ...
        if (iArr == null) {
            com.kwad.sdk.core.d.c.e(TAG, "No keylines defined for " + this + " - attempted index lookup " + i2);
            return 0;
        }
        if (i2 >= 0 && i2 < iArr.length) {
            return iArr[i2];
        }
        com.kwad.sdk.core.d.c.e(TAG, "Keyline index " + i2 + " out of range for " + this);
        return 0;
    }
    ...
    */
    public boolean drawChild(android.graphics.Canvas r17, android.view.View r18, long r19) {
        /*
            ...
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$LayoutParams r2 = (com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.LayoutParams) r2
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$Behavior r3 = r2.mBehavior
            if (r3 == 0) goto L8f
        ...
        L22:
            android.graphics.Paint r4 = r0.mScrimPaint
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$Behavior r2 = r2.mBehavior
            ...
            int r3 = androidx.core.math.MathUtils.clamp(r3, r4, r5)
            r2.setAlpha(r3)
            int r2 = r17.save()
        ...
        L91:
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.drawChild(android.graphics.Canvas, android.view.View, long):boolean");
    }
    ...
    public LayoutParams getResolvedLayoutParams(View view) {
        ...
        if (!layoutParams.mBehaviorResolved) {
            ...
            if (aVar != null) {
                try {
                    layoutParams.setBehavior(aVar.value().getDeclaredConstructor(null).newInstance(null));
                } catch (Exception e2) {
    ...
    */
    public final void onChildViewsChanged(int r18) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.onChildViewsChanged(int):void");
    }
    ...
    */
    public void onMeasure(int r27, int r28) {
        /*
            ...
            To view this dump add '--comments-level debug' option
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.onMeasure(int, int):void");
    }
    ...
    */
    public boolean onNestedFling(android.view.View r12, float r13, float r14, boolean r15) {
        ...
        L7:
            ...
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$LayoutParams r4 = (com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.LayoutParams) r4
            boolean r5 = r4.isNestedScrollAccepted(r1)
            if (r5 == 0) goto L32
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$Behavior r4 = r4.getBehavior()
            if (r4 == 0) goto L32
            r5 = r11
            r7 = r12
            r8 = r13
        ...
        L45:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.onNestedFling(android.view.View, float, float, boolean):boolean");
    }
    ...
    */
    public boolean onNestedPreFling(android.view.View r11, float r12, float r13) {
        ...
        L3a:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.onNestedPreFling(android.view.View, float, float):boolean");
    }
    ...
    */
    public boolean onTouchEvent(android.view.MotionEvent r18) {
        ...
        L18:
            ...
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$LayoutParams r6 = (com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.LayoutParams) r6
            com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout$Behavior r6 = r6.getBehavior()
            if (r6 == 0) goto L15
        ...
        L56:
            ...
            return r6
        */
        throw new UnsupportedOperationException("Method not decompiled: com.kwad.sdk.lib.ad.desigin.KSCoordinatorLayout.onTouchEvent(android.view.MotionEvent):boolean");
    }
        ...
        for (int i5 = 0; i5 < childCount; i5++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (layoutParams.isNestedScrollAccepted(i4) && (behavior = layoutParams.getBehavior()) != null) {
                    ...
                    iMax = i2 > 0 ? Math.max(iMax, this.mTempIntPair[0]) : Math.min(iMax, this.mTempIntPair[0]);
                    iMax2 = i3 > 0 ? Math.max(iMax2, this.mTempIntPair[1]) : Math.min(iMax2, this.mTempIntPair[1]);
                    z2 = true;
                }
            }
        }
    ...
    public KSCoordinatorLayout(Context context, AttributeSet attributeSet, int i2) {
        ...
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.ksad_KSCoordinatorLayout, i2, R.style.ksad_Widget_Design_KSADCoordinatorLayout);
    ...
    public static class d extends AbsSavedState {
        ...
        public d(Parcel parcel, ClassLoader classLoader) {
            ...
            this.bhR = new SparseArray<>(i2);
            for (int i3 = 0; i3 < i2; i3++) {
                this.bhR.append(iArr[i3], parcelableArray[i3]);
            }
        }
        ...
        public final void writeToParcel(Parcel parcel, int i2) {
            ...
            for (int i3 = 0; i3 < size; i3++) {
                iArr[i3] = this.bhR.keyAt(i3);
                parcelableArr[i3] = this.bhR.valueAt(i3);
            }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        public boolean isBlockingInteractionBelow(KSCoordinatorLayout kSCoordinatorLayout, View view) {
            ...
            Behavior behavior = this.mBehavior;
            boolean zBlocksInteractionBelow = (behavior != null ? behavior.blocksInteractionBelow(kSCoordinatorLayout, view) : false) | z2;
