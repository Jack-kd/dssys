...
final class KSDirectedAcyclicGraph<T> {
    ...
    public final void addEdge(@NonNull T t2, @NonNull T t3) {
    ...
    public final void addNode(@NonNull T t2) {
    ...
    public final boolean contains(@NonNull T t2) {
        return this.mGraph.containsKey(t2);
    }

    @Nullable
    public final List getIncomingEdges(@NonNull T t2) {
        return this.mGraph.get(t2);
    }

    @Nullable
    public final List<T> getOutgoingEdges(@NonNull T t2) {
        int size = this.mGraph.getSize();
    ...
    public final boolean hasOutgoingEdges(@NonNull T t2) {
        int size = this.mGraph.getSize();
        for (int i2 = 0; i2 < size; i2++) {
            ArrayList<T> arrayListValueAt = this.mGraph.valueAt(i2);
            if (arrayListValueAt != null && arrayListValueAt.contains(t2)) {
