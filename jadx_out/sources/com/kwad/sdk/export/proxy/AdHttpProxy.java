...
public interface AdHttpProxy {
    ...
    c doGetWithoutResponse(String str, Map<String, String> map, boolean z2);
    ...
    boolean downloadUrlToStream(String str, OutputStream outputStream, long j2, boolean z2, @Nullable AdHttpResponseListener adHttpResponseListener);
}
