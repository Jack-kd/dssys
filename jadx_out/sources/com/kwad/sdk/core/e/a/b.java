    ...
    private ServiceConnection serviceConnection = new ServiceConnection() { // from class: com.kwad.sdk.core.e.a.b.1
        ...
        public final void onServiceConnected(ComponentName componentName, IBinder iBinder) throws InterruptedException {
            try {
                ...
                com.kwad.sdk.core.d.c.d("HONORDeviceIDHelper", e2);
            }
        }
    ...
    */
    public final java.lang.String getOAID() {
        /*
            ...
            java.lang.String r2 = android.provider.Settings.Secure.getString(r3, r0)     // Catch: java.lang.Throwable -> L1f
            goto L21
        L1f:
            r0 = move-exception
            goto L37
        ...
        L3a:
            ...
            return r2
        L43:
            com.kwad.sdk.core.e.a.c$c r0 = r5.MP()
            if (r0 == 0) goto L4c
