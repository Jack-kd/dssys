...
public final class ap implements com.kwad.sdk.core.d<AdProductInfo> {
    ...
    private static JSONObject b(AdProductInfo adProductInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        long j2 = adProductInfo.itemId;
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "itemId", j2);
        }
