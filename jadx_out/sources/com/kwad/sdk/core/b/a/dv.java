...
public final class dv implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.DetailCommonInfo> {
    ...
    private static JSONObject b(AdStyleInfo.PlayDetailInfo.DetailCommonInfo detailCommonInfo, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "middleEndcardShowTime", i2);
        }
        int i3 = detailCommonInfo.rewardFullClickSwitch;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "rewardFullClickSwitch", i3);
        }
        int i4 = detailCommonInfo.rewardInteractionType;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "rewardInteractionType", i4);
        }
        return jSONObject;
    }
}
