...
public final class aa implements com.kwad.sdk.core.d<AdMatrixInfo.AdInteractionInfo> {
    ...
    private static JSONObject b(AdMatrixInfo.AdInteractionInfo adInteractionInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        int i2 = adInteractionInfo.interactiveStyle;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "interactiveStyle", i2);
        }
        ...
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isMediaDisable", z2);
        }
