...
public final class mm implements com.kwad.sdk.core.d<AdMatrixInfo.SplashSlideInfo> {
    ...
    private static void a(AdMatrixInfo.SplashSlideInfo splashSlideInfo, JSONObject jSONObject) {
        ...
        splashSlideInfo.title = jSONObject.optString(g.a.f3271h);
    ...
    private static JSONObject b(AdMatrixInfo.SplashSlideInfo splashSlideInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        String str = splashSlideInfo.title;
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, g.a.f3271h, splashSlideInfo.title);
        }
        ...
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "convertDistance", i3);
        }
