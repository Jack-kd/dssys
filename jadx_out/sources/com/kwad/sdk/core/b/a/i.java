...
public final class i implements com.kwad.sdk.core.d<AdInfo.AdBannerInfo> {
    ...
    private static JSONObject b(AdInfo.AdBannerInfo adBannerInfo, JSONObject jSONObject) {
        ...
        int i2 = adBannerInfo.videoSoundType;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoSoundType", i2);
        }
        int i3 = adBannerInfo.videoAutoPlayType;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoAutoPlayType", i3);
        }
        boolean z2 = adBannerInfo.isSupportCarousel;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isSupportCarousel", z2);
        }
        return jSONObject;
    }
}
