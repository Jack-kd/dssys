...
public final class dj implements com.kwad.sdk.core.d<SdkConfigData.CouponActiveConfig> {
    ...
    private static void a(SdkConfigData.CouponActiveConfig couponActiveConfig, JSONObject jSONObject) {
        ...
        couponActiveConfig.title = jSONObject.optString(g.a.f3271h);
    ...
    private static JSONObject b(SdkConfigData.CouponActiveConfig couponActiveConfig, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        int i2 = couponActiveConfig.popUpShowTimeSeconds;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "popUpShowTimeSeconds", i2);
        }
        String str = couponActiveConfig.title;
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, g.a.f3271h, couponActiveConfig.title);
        }
        ...
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoThreshold", i3);
        }
        int i4 = couponActiveConfig.videoSeconds;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoSeconds", i4);
        }
