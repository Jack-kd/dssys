...
public final class y implements com.kwad.sdk.core.d<AdInfo> {
    ...
    private static JSONObject b(AdInfo adInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
        ...
        long j4 = adInfo.mStartDownloadTime;
        if (j4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mStartDownloadTime", j4);
        }
        boolean z2 = adInfo.isAllowVideoAutoPlay;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "isAllowVideoAutoPlay", z2);
        }
        int i4 = adInfo.convertCount;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "convertCount", i4);
        }
        boolean z3 = adInfo.ksUaPattern;
        if (z3) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ksUaPattern", z3);
        }
        boolean z4 = adInfo.unionMark;
        if (z4) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "unionMark", z4);
        }
        ...
        int i5 = adInfo.ocpcActionType;
        if (i5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ocpcActionType", i5);
        }
