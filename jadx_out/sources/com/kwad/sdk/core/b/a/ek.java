...
public final class ek implements com.kwad.sdk.core.d<com.kwad.components.ad.draw.a.b> {
    ...
    private static void a(com.kwad.components.ad.draw.a.b bVar, JSONObject jSONObject) {
        ...
        if (obj.toString().equals(bVar.materialUrl)) {
            bVar.materialUrl = "";
        }
    ...
    private static JSONObject b(com.kwad.components.ad.draw.a.b bVar, JSONObject jSONObject) {
        ...
        int i5 = bVar.renderType;
        if (i5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "render_type", i5);
        }
        int i6 = bVar.cP;
        if (i6 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "expect_render_type", i6);
        }
        int i7 = bVar.adStyle;
        if (i7 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "ad_style", i7);
        }
        return jSONObject;
    }
}
