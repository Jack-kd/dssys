...
public final class bw implements com.kwad.sdk.core.d<BackTraceElement> {
    ...
    private static JSONObject b(BackTraceElement backTraceElement, JSONObject jSONObject) {
        ...
        long j2 = backTraceElement.mLineNumber;
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mLineNumber", j2);
        }
        int i2 = backTraceElement.mIndex;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIndex", i2);
        }
        boolean z2 = backTraceElement.mNeedClustering;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mNeedClustering", z2);
        }
        return jSONObject;
    }
}
