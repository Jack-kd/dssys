...
public final class nc implements com.kwad.sdk.core.d<com.kwad.sdk.core.request.model.f> {
    ...
    private static JSONObject b(com.kwad.sdk.core.request.model.f fVar, JSONObject jSONObject) {
        ...
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "taskType", i3);
        }
        int i4 = fVar.count;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "count", i4);
        }
        long j2 = fVar.aXx;
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "lastModifiedTime", j2);
        }
        return jSONObject;
    }
}
