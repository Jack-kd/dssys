...
public final class a implements com.kwad.sdk.core.d<ABParams> {
    ...
    private static JSONObject b(ABParams aBParams, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoBlackAreaClick", i2);
        }
        int i3 = aBParams.videoBlackAreaNewStyle;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoBlackAreaNewStyle", i3);
        }
        ...
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showVideoAtH5", i4);
        }
        int i5 = aBParams.playableStyle;
        if (i5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "playableStyle", i5);
        }
        return jSONObject;
    }
}
