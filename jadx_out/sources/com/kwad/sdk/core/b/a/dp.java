...
public final class dp implements com.kwad.sdk.core.d<AdInfo.CutRuleInfo> {
    ...
    private static JSONObject b(AdInfo.CutRuleInfo cutRuleInfo, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "picHeight", i2);
        }
        int i3 = cutRuleInfo.viewTopMargin;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "viewTopMargin", i3);
        }
        int i4 = cutRuleInfo.safeAreaHeight;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "safeAreaHeight", i4);
        }
        return jSONObject;
    }
}
