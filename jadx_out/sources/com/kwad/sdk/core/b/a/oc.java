...
public final class oc implements com.kwad.sdk.core.d<WebCardVideoPositionHandler.VideoPosition> {
    ...
    private static JSONObject b(WebCardVideoPositionHandler.VideoPosition videoPosition, JSONObject jSONObject) {
        ...
        if (d2 != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "leftMarginRation", d2);
        }
        double d3 = videoPosition.topMarginRation;
        if (d3 != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "topMarginRation", d3);
        }
        double d4 = videoPosition.widthRation;
        if (d4 != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "widthRation", d4);
        }
        double d5 = videoPosition.heightWidthRation;
        if (d5 != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "heightWidthRation", d5);
        }
        int i2 = videoPosition.leftMargin;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "leftMargin", i2);
        }
        int i3 = videoPosition.topMargin;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "topMargin", i3);
        }
        ...
        if (i6 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "borderRadius", i6);
        }
        return jSONObject;
    }
}
