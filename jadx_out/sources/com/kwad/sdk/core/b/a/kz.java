...
public final class kz implements com.kwad.sdk.core.d<AdInfo.RewardRetryTaskInfo> {
    ...
    private static JSONObject b(AdInfo.RewardRetryTaskInfo rewardRetryTaskInfo, JSONObject jSONObject) {
        ...
        int i2 = rewardRetryTaskInfo.retryMaxTime;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "retryMaxTime", i2);
        }
        int i3 = rewardRetryTaskInfo.rewardRetryTaskType;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "rewardRetryTaskType", i3);
        }
        return jSONObject;
    }
}
