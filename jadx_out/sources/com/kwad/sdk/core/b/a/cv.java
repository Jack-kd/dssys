...
public final class cv implements com.kwad.sdk.core.d<AdInfo.ComplianceInfo> {
    ...
    private static JSONObject b(AdInfo.ComplianceInfo complianceInfo, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "materialJumpType", i2);
        }
        int i3 = complianceInfo.actionBarType;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "actionBarType", i3);
        }
        int i4 = complianceInfo.describeBarType;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "describeBarType", i4);
        }
        int i5 = complianceInfo.titleBarTextSwitch;
        if (i5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "titleBarTextSwitch", i5);
        }
        return jSONObject;
    }
}
