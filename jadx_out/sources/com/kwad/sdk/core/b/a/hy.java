...
public final class hy implements com.kwad.sdk.core.d<LiveDetailReward> {
    ...
    private static void a(LiveDetailReward liveDetailReward, JSONObject jSONObject) {
        ...
        liveDetailReward.success = jSONObject.optBoolean(com.baidu.mobads.sdk.internal.cb.f11292o);
    ...
    private static JSONObject b(LiveDetailReward liveDetailReward, JSONObject jSONObject) {
        ...
        boolean z2 = liveDetailReward.success;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.baidu.mobads.sdk.internal.cb.f11292o, z2);
        }
        long j2 = liveDetailReward.countDownSecond;
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "countDownSecond", j2);
        }
        double d2 = liveDetailReward.hasRewardTime;
        if (d2 != 0.0d) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "hasRewardTime", d2);
        }
        String str = liveDetailReward.pageDataKey;
