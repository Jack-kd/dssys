...
public final class ef implements com.kwad.sdk.core.d<AdInfo.DownloadSafeInfo> {
    ...
    private static void a(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) {
        ...
        downloadSafeInfo.appName = jSONObject.optString(com.umeng.analytics.pro.cl.f49061p);
    ...
    private static JSONObject b(AdInfo.DownloadSafeInfo downloadSafeInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
        ...
        if (str2 != null && !str2.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, com.umeng.analytics.pro.cl.f49061p, downloadSafeInfo.appName);
        }
        ...
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "packageSize", j2);
        }
        ...
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "secWindowPopNoWifiSwitch", z2);
        }
        boolean z3 = downloadSafeInfo.secWindowPopSwitch;
        if (z3) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "secWindowPopSwitch", z3);
        }
