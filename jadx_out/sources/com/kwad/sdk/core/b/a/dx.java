...
public final class dx implements com.kwad.sdk.core.d<AdStyleInfo.PlayDetailInfo.DetailWebCardInfo> {
    ...
    private static JSONObject b(AdStyleInfo.PlayDetailInfo.DetailWebCardInfo detailWebCardInfo, JSONObject jSONObject) {
        ...
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "maxTimeOut", j2);
        }
        long j3 = detailWebCardInfo.typeLandscape;
        if (j3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typeLandscape", j3);
        }
        long j4 = detailWebCardInfo.typePortrait;
        if (j4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "typePortrait", j4);
        }
        ...
        if (j5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "cardShowTime", j5);
        }
