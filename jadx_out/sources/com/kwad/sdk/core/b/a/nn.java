...
public final class nn implements com.kwad.sdk.core.d<UaidInfo> {
    ...
    private static JSONObject b(UaidInfo uaidInfo, JSONObject jSONObject) {
        ...
        int i3 = uaidInfo.operatorType;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "operator_type", i3);
        }
        int i4 = uaidInfo.networkType;
        if (i4 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "network_type", i4);
        }
        boolean z2 = uaidInfo.dcontrollerEnableNetwork;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "dcontroller_enable_network", z2);
        }
        boolean z3 = uaidInfo.dcontrollerEnablePhoneState;
        if (z3) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "dcontroller_enable_phone_state", z3);
        }
        boolean z4 = uaidInfo.imsiNotEmpty;
        if (z4) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "imsi_not_empty", z4);
        }
        String str3 = uaidInfo.uaid;
        if (str3 != null && !str3.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "uaid", uaidInfo.uaid);
        }
        int i5 = uaidInfo.result;
        if (i5 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "result", i5);
        }
        String str4 = uaidInfo.token;
        if (str4 != null && !str4.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "token", uaidInfo.token);
        }
