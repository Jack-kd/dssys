...
public final class hj implements com.kwad.sdk.core.d<JavaBackTraceElement> {
    ...
    private static JSONObject b(JavaBackTraceElement javaBackTraceElement, JSONObject jSONObject) {
        ...
        boolean z2 = javaBackTraceElement.mIsTitle;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsTitle", z2);
        }
        boolean z3 = javaBackTraceElement.mIsCausedBy;
        if (z3) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsCausedBy", z3);
        }
        boolean z4 = javaBackTraceElement.mIsNative;
        if (z4) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "mIsNative", z4);
        }
        return jSONObject;
    }
}
