...
public final class cw implements com.kwad.sdk.core.d<AdMatrixInfo.ComponentParam> {
    ...
    private static JSONObject b(AdMatrixInfo.ComponentParam componentParam, JSONObject jSONObject) {
        ...
        long j2 = componentParam.pageId;
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "page_id", j2);
        }
        long j3 = componentParam.endPageId;
        if (j3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "endcard_page_id", j3);
        }
        return jSONObject;
    }
}
