...
public final class ar implements com.kwad.sdk.core.d<AdInfo.AdShowVideoH5Info> {
    ...
    private static JSONObject b(AdInfo.AdShowVideoH5Info adShowVideoH5Info, JSONObject jSONObject) {
        ...
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "showPageType", i2);
        }
        boolean z2 = adShowVideoH5Info.videoAutoLoopAtH5;
        if (z2) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoAutoLoopAtH5", z2);
        }
        boolean z3 = adShowVideoH5Info.videoMutedAtH5;
        if (z3) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoMutedAtH5", z3);
        }
        boolean z4 = adShowVideoH5Info.videoClickAtH5;
        if (z4) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "videoClickAtH5", z4);
        }
        return jSONObject;
    }
}
