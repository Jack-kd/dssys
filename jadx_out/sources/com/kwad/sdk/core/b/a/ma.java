...
public final class ma implements com.kwad.sdk.core.d<AdProductInfo.SpikeInfo> {
    ...
    private static JSONObject b(AdProductInfo.SpikeInfo spikeInfo, JSONObject jSONObject) {
        ...
        if (j2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "endTime", j2);
        }
        int i2 = spikeInfo.soldStock;
        if (i2 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "soldStock", i2);
        }
        int i3 = spikeInfo.originalStock;
        if (i3 != 0) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, "originalStock", i3);
        }
        return jSONObject;
    }
}
