...
public final class mb implements com.kwad.sdk.core.d<AdMatrixInfo.SplashActionBarInfo> {
    ...
    private static void a(AdMatrixInfo.SplashActionBarInfo splashActionBarInfo, JSONObject jSONObject) {
        ...
        splashActionBarInfo.title = jSONObject.optString(g.a.f3271h);
    ...
    private static JSONObject b(AdMatrixInfo.SplashActionBarInfo splashActionBarInfo, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
            jSONObject = new JSONObject();
        }
        String str = splashActionBarInfo.title;
        if (str != null && !str.equals("")) {
            com.kwad.sdk.utils.ac.putValue(jSONObject, g.a.f3271h, splashActionBarInfo.title);
        }
