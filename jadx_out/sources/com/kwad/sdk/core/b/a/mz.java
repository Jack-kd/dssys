...
public final class mz implements com.kwad.sdk.core.d<r.a> {
    ...
    private static void a(r.a aVar, JSONObject jSONObject) {
        ...
        aVar.Cg = fraudDataInfo;
        fraudDataInfo.parseJson(jSONObject.optJSONObject("verifyResult"));
    }

    private static JSONObject b(r.a aVar, JSONObject jSONObject) throws JSONException {
        if (jSONObject == null) {
