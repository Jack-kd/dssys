...
public class AdTrackLog extends com.kwad.sdk.core.response.a.a implements Serializable {
    ...
    private int toReportInt(boolean z2) {
        return z2 ? 1 : 2;
    }
    ...
    public void setKsUaPattern(boolean z2) {
        this.ksUaPattern = toReportInt(z2);
    }

    public void setUnionMark(boolean z2) {
        this.unionMark = toReportInt(z2);
    }
