...
public final class a implements AdHttpProxy {
    ...
    @Override // com.kwad.sdk.export.proxy.AdHttpProxy
    public final c doGetWithoutResponse(String str, Map<String, String> map, boolean z2) {
        return com.kwad.sdk.core.network.a.b.a(str, map, false, z2);
    }
    ...
    @Override // com.kwad.sdk.export.proxy.AdHttpProxy
    public final boolean downloadUrlToStream(String str, OutputStream outputStream, long j2, boolean z2, @Nullable AdHttpResponseListener adHttpResponseListener) {
        return com.kwad.sdk.core.network.a.b.downloadUrlToStream(str, outputStream, j2, z2, adHttpResponseListener);
    }
