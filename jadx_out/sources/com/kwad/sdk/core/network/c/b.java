...
public final class b implements AdHttpProxy {
    ...
    public final c doGetWithoutResponse(String str, Map<String, String> map, boolean z2) {
        return com.kwad.sdk.core.network.a.c.a(str, map, false, z2);
    }
    ...
    public final boolean downloadUrlToStream(String str, OutputStream outputStream, long j2, boolean z2, @Nullable AdHttpResponseListener adHttpResponseListener) {
        return com.kwad.sdk.core.network.a.c.downloadUrlToStream(str, outputStream, j2, z2, adHttpResponseListener);
    }
