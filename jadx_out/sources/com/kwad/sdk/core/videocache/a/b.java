...
public final class b implements com.kwad.sdk.core.videocache.a {
    ...
    public b(File file, a aVar) throws ProxyCacheException {
        ...
        try {
            ...
            this.file = file2;
            this.baD = new RandomAccessFile(this.file, zExists ? t.f31269k : "rw");
    ...
    public final synchronized int a(byte[] bArr, long j2, int i2) {
        try {
            ...
            throw new ProxyCacheException(String.format("Error reading %d bytes with offset %d from file[%d bytes] to buffer[%d bytes]", Integer.valueOf(i2), Long.valueOf(j2), Long.valueOf(OV()), Integer.valueOf(bArr.length)), e2);
        }
        return this.baD.read(bArr, 0, i2);
    }
    ...
    public final synchronized void complete() {
        ...
        this.file = file;
        try {
            this.baD = new RandomAccessFile(this.file, t.f31269k);
            this.aZM.s(this.file);
        } catch (IOException e2) {
    ...
    public final synchronized void d(byte[] bArr, int i2) {
        try {
            ...
            this.baD.seek(OV());
            this.baD.write(bArr, 0, i2);
        } catch (IOException e2) {
            throw new ProxyCacheException(String.format("Error writing %d bytes to %s from buffer with size %d", Integer.valueOf(i2), this.baD, 1024), e2);
        }
    }
