...
public class DefaultConfigurationFactory {
    ...
    public static DiskCache createDiskCache(Context context, FileNameGenerator fileNameGenerator, long j2, int i2, String str) {
        ...
        if (j2 > 0 || i2 > 0) {
            ...
            try {
                return new LruDiskCache(StorageUtils.getIndividualCacheDirectory(context, str), fileCreateReserveDiskCacheDir, fileNameGenerator2, j2, i2);
            } catch (IOException e3) {
                e = e3;
                L.e(e);
                return new UnlimitedDiskCache(new File(str), fileCreateReserveDiskCacheDir, fileNameGenerator2);
            }
        }
        fileNameGenerator2 = fileNameGenerator;
        return new UnlimitedDiskCache(new File(str), fileCreateReserveDiskCacheDir, fileNameGenerator2);
