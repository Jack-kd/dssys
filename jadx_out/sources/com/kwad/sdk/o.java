...
public final class o {
    ...
    public void GH() {
        try {
            ...
            com.kwad.sdk.core.config.c.aQC.getValue().getClass();
    ...
    private void GU() {
        try {
            com.kwad.library.solder.lib.i.a(new i.a() { // from class: com.kwad.sdk.o.2
    ...
    private void Gx() {
        ...
        com.kwad.sdk.core.d.c.i("KSAdSDK", "SDK_VERSION_NAME: 5.4.10.2 TK_VERSION_CODE: 6.2.3 BRIDGE_VERSION: 1.3");
        if (this.aGB == null) {
        ...
        long j2 = Gs().aGz;
        if (j2 > 0) {
            p.ar(SystemClock.elapsedRealtime() - j2);
        }
        f.a(ServiceProvider.getSDKConfig(), j2);
        this.aGo.set(true);
    }
    ...
    private void Gz() {
        try {
            com.kwad.sdk.commercial.c.a(new c.a() { // from class: com.kwad.sdk.o.6
    ...
    public void e(SdkConfigData sdkConfigData) {
        ...
        com.kwad.sdk.utils.h.a(getContext(), WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, new com.kwad.sdk.collector.h() { // from class: com.kwad.sdk.o.8
    ...
    private void g(final com.kwad.sdk.g.a aVar) {
        try {
            com.kwad.components.core.request.h.a(new h.b() { // from class: com.kwad.sdk.o.7
    ...
    public final boolean GV() {
        return !Gv() ? this.aGo.get() : this.aGo.get() && this.aGp.get();
    }
    ...
    public final boolean Gv() {
        ...
        IKsAdSDK.class.getDeclaredMethod("start", null);
        this.aGs.set(true);
        Objects.toString(this.aGs);
        return this.aGs.get();
    }

    public final void b(final Context context, final SdkConfig sdkConfig) {
        Objects.toString(this.aGo);
        this.aGq.set(true);
        if (this.aGo.get()) {
    ...
    public final void setLaunchTime(long j2) {
        this.aGy = j2;
        com.kwad.sdk.utils.q.setLaunchTime(j2);
    }
