...
public final class JavaBackTraceElement extends BackTraceElement {
    ...
    public JavaBackTraceElement(String str, int i2) {
        super(str, i2);
    ...
    public final void setIsCausedBy(boolean z2) {
        this.mIsCausedBy = z2;
    }

    public final void setIsNative(boolean z2) {
        this.mIsNative = z2;
    }

    public final void setIsTitle(boolean z2) {
        this.mIsTitle = z2;
    }
}
