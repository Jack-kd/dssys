...
public class JvmtiHelper {
    ...
    private static void doAllocAsyncReport(String str, long j2) {
    }
    ...
    private static native void setConfig(int i2, int i3, int i4, int i5, boolean z2, boolean z3, String str, boolean z4);

    private static boolean unlikely(boolean z2) {
        return z2;
    }
