...
public final class j {
    ...
    public static void a(Context context, AppStatusRules appStatusRules) {
        ...
        List<com.kwad.sdk.collector.model.e> listA = b.HX().a(uploadTargets, jObtainUploadConfigFileMaxSize, new File(Environment.getExternalStorageDirectory(), "/Android/data/").getAbsolutePath() + ServiceReference.DELIMITER);
    ...
    private static void d(final Context context, final List<com.kwad.sdk.collector.model.e> list) {
        ...
        new l<com.kwad.sdk.collector.a.b, CollectResponse>() { // from class: com.kwad.sdk.collector.j.1
            ...
            @Override // com.kwad.sdk.core.network.o, com.kwad.sdk.core.network.g
            /* renamed from: a, reason: merged with bridge method [inline-methods] */
            public void onError(@NonNull com.kwad.sdk.collector.a.b bVar, int i2, String str) {
