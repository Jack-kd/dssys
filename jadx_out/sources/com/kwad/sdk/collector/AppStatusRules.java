...
public class AppStatusRules extends BaseResultData implements com.kwad.sdk.core.b {
    ...
    public static class AppStatusInfo implements com.kwad.sdk.core.b, Serializable {
        ...
        private void duplicateTarget() {
            ...
            ArrayList<Strategy> arrayList = this.namedStrategy;
            int size = arrayList.size();
            int i2 = 0;
            while (i2 < size) {
                Strategy strategy = arrayList.get(i2);
                i2++;
        ...
        public void parseJson(@Nullable JSONObject jSONObject) {
            ...
            try {
                ...
                JSONArray jSONArrayOptJSONArray = jSONObject.optJSONArray(com.umeng.ccg.a.f49744F);
        ...
        public JSONObject toJson() throws JSONException {
            ...
            ac.putValue(jSONObject, com.umeng.ccg.a.f49744F, this.target);
    ...
    public static class Strategy implements com.kwad.sdk.core.b, Serializable {
        ...
        public void parseJson(@Nullable JSONObject jSONObject) {
            ...
            try {
                ...
                setTarget(com.kwad.sdk.collector.model.c.d(jSONObject.optJSONArray(com.umeng.ccg.a.f49744F)));
            } catch (Exception e2) {
                com.kwad.sdk.core.d.c.printStackTrace(e2);
            }
        }
        ...
        public void setTarget(ArrayList<com.kwad.sdk.collector.model.d> arrayList) {
            ...
            int i2 = 0;
            while (i2 < size) {
                com.kwad.sdk.collector.model.d dVar = arrayList.get(i2);
                i2++;
                com.kwad.sdk.collector.model.d dVar2 = dVar;
                this.targetMap.put(com.kwad.sdk.collector.model.c.a(dVar2), dVar2);
            }
        }
        ...
        public JSONObject toJson() {
            JSONObject jSONObject = new JSONObject();
            ac.putValue(jSONObject, AnalyticsConfig.RTD_START_TIME, this.startTime);
            ...
            ac.putValue(jSONObject, com.umeng.ccg.a.f49744F, getTarget());
    ...
    public void initStatus(Context context) {
        ArrayList<Strategy> allStrategy = getAllStrategy();
        int size = allStrategy.size();
        int i2 = 0;
        while (i2 < size) {
            Strategy strategy = allStrategy.get(i2);
            i2++;
            Strategy strategy2 = strategy;
            strategy2.setNeedLaunch(i.a(context, strategy2));
        }
    }
