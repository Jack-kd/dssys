...
public class KsSecSDKWrapper {
    ...
    public static void getEGidByCallback(Context context, boolean z2, final ResponseDfpCallbackProxy responseDfpCallbackProxy) {
        KWEGIDDFP.instance().getEGidByCallback(context, false, new ResponseDfpCallback() { // from class: com.kwad.sdk.liteapi.KsSecSDKWrapper.1
            ...
            public final void onFailed(int i2, String str) {
                ...
                if (responseDfpCallbackProxy2 != null) {
                    responseDfpCallbackProxy2.onFailed(i2, str);
                }
                Log.e(KsSecSDKWrapper.TAG, "initGId onFailed errorCode:" + i2 + "errorMessage :" + str);
            }
