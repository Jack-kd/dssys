...
public class LiteApiReporter {
    ...
    public static void reportDexError(Context context, String str, int i2) {
        LiteApiLogger.w(TAG, "reportDexError dexErrorCode: " + i2);
        try {
            LiteApiReportRequest liteApiReportRequestNewInstance = LiteApiReportRequest.newInstance(context, str, i2);
