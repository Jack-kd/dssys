...
public final class at {
    ...
    private static int VR() {
        ...
        try {
            ...
            com.kwad.sdk.core.d.c.w("PackageInstallHelper", Log.getStackTraceString(e2));
            return 0;
        }
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static void VS() throws Throwable {
        try {
            String strI = ai.i("ksadsdk_perf", "install_permission_times_per_day", "");
            if (TextUtils.isEmpty(strI)) {
    ...
    public static com.kwad.sdk.core.config.d hU(String str) {
        ...
        try {
            ...
            com.kwad.sdk.core.d.c.w("PackageInstallHelper", e2);
            return null;
        }
    }
                ...
                public final void run() throws Throwable {
                    try {
                        ...
                        if (!activity2.isFinishing() && !activity2.isDestroyed()) {
                            ...
                            aVar.a(new e.b() { // from class: com.kwad.sdk.utils.at.3.1
