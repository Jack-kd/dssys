...
public final class au {
    ...
    public static void aA(String str, String str2) throws Throwable {
        ...
        try {
            ai.g(context, str2, C1241a.getFileMD5(file));
        } catch (Exception e2) {
    ...
    public static int ay(@Nullable Context context, String str) {
        ...
        try {
            ...
            if (ContextCompat.checkSelfPermission(context, com.kuaishou.weapon.p0.g.f31167i) != 0) {
                return -1;
            }
    ...
    public static boolean az(@Nullable Context context, @Nullable String str) {
    ...
    public static int dI(Context context) {
        ...
        try {
            ...
            if (packageInfoNoCache != null && (applicationInfo = packageInfoNoCache.applicationInfo) != null && applicationInfo.enabled) {
