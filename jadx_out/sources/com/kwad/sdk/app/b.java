        ...
        com.kwad.sdk.core.c.b.a(new d() { // from class: com.kwad.sdk.app.b.4
            ...
            public final void onBackToForeground() {
                if (b.this.aIU.size() > 0) {
                    for (int i2 = 0; i2 < b.this.aIU.size(); i2++) {
                        b.F(b.this.mContext, (String) b.this.aIU.get(i2));
                    }
                    b.this.aIU.clear();
                }
                com.kwad.sdk.core.c.b.LW();
        ...
        com.kwad.sdk.core.c.b.a(new d() { // from class: com.kwad.sdk.app.b.5
            ...
            public final void onBackToForeground() {
                if (b.this.aIV.size() > 0) {
                    for (int i2 = 0; i2 < b.this.aIV.size(); i2++) {
                        b.dg((String) b.this.aIV.get(i2));
                    }
                    b.this.aIV.clear();
                }
                com.kwad.sdk.core.c.b.LW();
    ...
    private b() {
        ...
        this.aIX = new BroadcastReceiver() { // from class: com.kwad.sdk.app.b.3
            ...
            private boolean d(Intent intent) {
                boolean z2 = TextUtils.equals(this.aIZ.getAction(), intent.getAction()) && this.aIZ.getFlags() == intent.getFlags() && TextUtils.equals(this.aIZ.getDataString(), intent.getDataString());
                this.aIZ = intent;
                return z2;
            }
