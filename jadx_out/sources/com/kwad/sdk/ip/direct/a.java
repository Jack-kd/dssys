...
public final class a {
    ...
    private static boolean Rm() {
        ...
        while (true) {
            ...
            if (list2.get(i3) != null) {
                iNextInt -= list2.get(i3).getWeight();
            }
            if (iNextInt < 0) {
                i2 = i3;
                break;
    ...
    private static boolean Rq() {
        ...
        int i2 = bgT.get();
        com.kwad.sdk.core.d.c.d("IpDirect_Helper", "value:" + i2);
        return i2 <= 3;
    }
    ...
    private static void Ru() {
        ...
        Iterator<HttpDnsInfo.IpInfo> it2 = bgO.iterator();
        while (true) {
            if (!it2.hasNext()) {
                break;
            }
        ...
        Iterator<HttpDnsInfo.IpInfo> it3 = bgP.iterator();
        while (true) {
            if (!it3.hasNext()) {
                break;
            }
    ...
    public static void a(HttpDnsInfo httpDnsInfo) {
        ...
        if (zFQ) {
            ...
            if (list.isEmpty() && bgO.isEmpty() && bgP.isEmpty()) {
    ...
    private static boolean gN(String str) {
        boolean zEquals = TextUtils.equals("https://" + str, i.EI());
