...
public final class a {
    ...
    public static void d(AdTemplate adTemplate, String str, String str2) {
        try {
            a(adTemplate, true, b.It().dB(6).dA(str).setErrorCode(100007).setErrorMsg(str2));
        } catch (Throwable th) {
    ...
    private static void a(AdTemplate adTemplate, boolean z2, com.kwad.sdk.commercial.c.a aVar) {
        ...
        c.d(d.In().m57do(z2 ? ILoggerReporter.Category.ERROR_LOG : ILoggerReporter.Category.APM_LOG).g(z2 ? 1.0d : 0.01d).b(e.bA(adTemplate)).Q("ad_sdk_deeplink_performance", "status").A(aVar));
    }
}
