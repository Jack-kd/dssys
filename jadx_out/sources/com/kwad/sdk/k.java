...
public final class k {
    ...
    public static class a implements com.kwad.sdk.service.a.a {
        ...
        public final void k(Context context, AdTemplate adTemplate) {
            com.kwad.components.core.e.d.a.a(new a.C0529a(context).aJ(adTemplate).au(true));
        }
    ...
    public static class c implements com.kwad.sdk.service.a.h {
        ...
        public final boolean ao(long j2) {
            return com.kwad.sdk.core.config.e.ao(j2);
        }
    ...
    public static void Fo() {
        byte b3 = 0;
        ServiceProvider.put(com.kwad.sdk.service.a.f.class, new b(b3));
        ServiceProvider.put(com.kwad.sdk.service.a.h.class, new c(b3));
        ServiceProvider.put(com.kwad.sdk.service.a.e.class, new com.kwad.sdk.service.a.e() { // from class: com.kwad.sdk.k.1
            ...
            public final void a(final com.kwad.sdk.service.a.c cVar) {
                com.kwad.components.core.d.a.a(new a.b() { // from class: com.kwad.sdk.k.1.1
            ...
            public final void a(final com.kwad.sdk.service.a.g gVar) {
                com.kwad.components.core.d.a.a(new a.c() { // from class: com.kwad.sdk.k.1.2
                    @Override // com.kwad.components.core.d.a.c
                    public final void onCrashOccur(int i2, String str) {
        ...
        ServiceProvider.put(com.kwad.sdk.service.a.b.class, new com.kwad.sdk.service.a.b() { // from class: com.kwad.sdk.k.5
            ...
            public final void e(@NonNull JSONObject jSONObject, int i2) {
                com.kwad.components.core.p.a.vL().e(jSONObject, i2);
            }
        });
        ServiceProvider.put(s.class, new s() { // from class: com.kwad.sdk.k.6
            ...
            public final boolean an(long j2) {
                com.kwad.sdk.core.config.item.d dVar = com.kwad.sdk.core.config.c.aMY;
                return com.kwad.sdk.core.config.item.q.an(j2);
            }
        });
        ...
        ServiceProvider.put(com.kwad.sdk.service.a.a.class, new a(b3));
    }
}
