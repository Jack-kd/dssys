...
public class FrameSequenceDrawable extends Drawable implements Animatable, Runnable {
    ...
    private static Bitmap acquireAndValidateBitmap(a aVar, int i2, int i3) {
        Bitmap bitmapG = aVar.G(i2, i3);
        if (bitmapG.getWidth() < i2 || bitmapG.getHeight() < i3 || bitmapG.getConfig() != Bitmap.Config.ARGB_8888) {
                        ...
                        synchronized (FrameSequenceDrawable.this.mLock) {
                            try {
                                ...
                                if (FrameSequenceDrawable.this.mDestroyed) {
                                    ...
                                    frameSequenceDrawable.mNextSwap = z2 ? LocationRequestCompat.PASSIVE_INTERVAL : frame + frameSequenceDrawable.mLastSwap;
