...
public class KSAdInfoData implements Serializable {
    ...
    public KSAdInfoData setConvertType(int i2) {
        this.convertType = i2;
        return this;
    }

    public KSAdInfoData setCreativeId(long j2) {
        this.creativeId = j2;
        return this;
    }
    ...
    public KSAdInfoData setInteractionType(int i2) {
    ...
    public KSAdInfoData setMaterialType(int i2) {
