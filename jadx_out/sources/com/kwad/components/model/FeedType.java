...
public final class FeedType {
    ...
    private FeedType(String str, int i2, int i3, FeedDefaultType feedDefaultType) {
        this.type = i3;
    ...
    @NonNull
    public static FeedType fromInt(int i2, int i3) {
        if (isH5Type(i2)) {
            return FEED_TYPE_TEXT_NEW;
        }
        for (FeedType feedType : values()) {
            if ((feedType.type == i2 && !isNewVerticalType(i2)) || (feedType.type == i2 && isNewVerticalType(i2) && feedType.mFeedDefaultType.getDefaultType() == i3)) {
                return feedType;
            }
        }
    ...
    private static boolean isH5Type(int i2) {
        return i2 == 7 || i2 == 8 || i2 == 14 || i2 == 15 || i2 == 16 || i2 == 17 || i2 == 18 || i2 == 19 || i2 == 20 || i2 >= 2000;
    }

    public static boolean isNewVerticalType(int i2) {
        return i2 == 21;
    }
