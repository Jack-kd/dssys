...
public final class d extends AbstractKsNativeAd implements DialogInterface.OnDismissListener, DialogInterface.OnShowListener, com.kwad.components.core.internal.api.a {
    ...
    private KsNativeAd.VideoPlayListener pC = new KsNativeAd.VideoPlayListener() { // from class: com.kwad.components.ad.nativead.d.10
        ...
        public final void onVideoPlayError(int i2, int i3) {
            if (d.this.pv != null) {
                d.this.pv.onVideoPlayError(i2, i3);
            }
        }
    ...
    private static int[] ad(int i2) {
        ...
        return new int[]{i2 % 2 == 0 ? 2 : 1, i4, i3};
    }
    ...
    public final int getVideoHeight() {
        return com.kwad.sdk.core.response.helper.a.cY(this.mAdInfo) ? PlatformPlugin.DEFAULT_SYSTEM_UI : com.kwad.sdk.core.response.helper.a.bb(this.mAdInfo).videoHeight;
    }
    ...
    @Override // com.kwad.sdk.api.core.AbstractKsNativeAd
    public final View getVideoView2(Context context, boolean z2) {
        if (context == null || !o.Gs().Fx()) {
            return null;
        }
        return getVideoView2(context, new KsAdVideoPlayConfig.Builder().videoSoundEnable(z2).build());
    }
        ...
        if (com.kwad.sdk.core.response.helper.a.am(this.mAdInfo) || com.kwad.sdk.core.response.helper.b.dz(this.mAdTemplate)) {
            ...
            this.pm = new b.e() { // from class: com.kwad.components.ad.nativead.d.8
                ...
                public final boolean b(final double d2) {
                    ...
                    com.kwad.components.core.e.d.a.a(new a.C0529a(m.wrapContextIfNeed(view.getContext())).aJ(d.this.mAdTemplate).b(d.this.mApkDownloadHelper).az(false).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.8.1
                        @Override // com.kwad.components.core.e.d.a.b
                        public final void onAdClicked() {
                            com.kwad.sdk.core.adlog.c.a(d.this.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().ec(157).j(d2), (JSONObject) null);
                            d.this.pD.l(view);
                        }
                    }));
            ...
            b.ft().a(com.kwad.sdk.core.response.helper.b.dz(this.mAdTemplate) || com.kwad.sdk.core.response.helper.a.am(this.mAdInfo), f2, view, this.pm, com.kwad.sdk.core.response.helper.b.dK(this.mAdInfo));
        }
    }
    ...
    public void k(final View view) {
        ...
        this.pl = new b.c() { // from class: com.kwad.components.ad.nativead.d.9
            ...
            public final boolean u(final String str) {
                ...
                com.kwad.components.core.e.d.a.a(new a.C0529a(m.wrapContextIfNeed(view.getContext())).aJ(d.this.mAdTemplate).b(d.this.mApkDownloadHelper).az(false).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.9.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
    ...
    public static /* synthetic */ boolean b(d dVar, al.a aVar) {
        return c(aVar);
    }
    ...
    private void b(final ViewGroup viewGroup) {
        ...
        if (!com.kwad.sdk.core.config.e.Kg() && com.kwad.sdk.core.config.e.Kf() >= 0.0f) {
            ...
            aVar.setViewCallback(new a.InterfaceC0573a() { // from class: com.kwad.components.ad.nativead.d.6
                ...
                public final void b(View view) {
                    if (!d.this.mAdTemplate.mPvReported) {
                        ...
                        if (com.kwad.sdk.core.response.helper.a.cY(d.this.mAdInfo)) {
                            ...
                            c0601a.showLiveStyle = d.this.py;
                            c0601a.showLiveStatus = d.this.px;
                            bVar.b(c0601a);
                        }
                ...
                public final void onWindowFocusChanged(boolean z2) {
                    ...
                    if (!z2 || (viewGroup2 = viewGroup) == null) {
                        return;
                    }
                    viewGroup2.getWidth();
                }
        ...
        cVarD.setViewCallback(new c.a() { // from class: com.kwad.components.ad.nativead.d.7
    ...
    private void a(@Nullable Activity activity, @NonNull ViewGroup viewGroup, @NonNull Map<View, Integer> map) {
        ...
        for (View view : map.keySet()) {
            if (map.get(view) != null) {
                ...
                a(activity2, viewGroup2, map.get(view).intValue(), view, true);
            } else {
                activity2 = activity;
                viewGroup2 = viewGroup;
            }
    ...
    private void a(final Activity activity, @NonNull final ViewGroup viewGroup, int i2, final View view, final boolean z2) {
        final al.a aVar = new al.a();
        if (view == null) {
            return;
        }
        final int[] iArrAd = ad(i2);
        if (view instanceof f) {
                    ...
                    if (action == 0) {
                        ...
                        if (com.kwad.sdk.utils.b.g(aVar)) {
                            if (iArrAd[2] != 1 && d.this.b(aVar)) {
                                ...
                                d.this.a(activity, view2, aVar, iArrAd[0], z2, MediaPlayer.MEDIA_PLAYER_OPTION_GET_DROP_COUNT);
                            }
                            return true;
                        }
                        if (iArrAd[1] != 1 && com.kwad.sdk.core.config.e.Jm()) {
                            if (d.b(d.this, aVar)) {
                                d.this.a(activity, view2, aVar, iArrAd[0], z2, 0);
                            }
                            return true;
                        }
                    }
            ...
            view.setOnClickListener(new View.OnClickListener() { // from class: com.kwad.components.ad.nativead.d.4
                ...
                public final void onClick(View view2) {
                    ...
                    d.this.a(activity, view2, aVar, iArr[0], z2, 0);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(@Nullable Activity activity, final View view, final al.a aVar, int i2, boolean z2, final int i3) {
        long playDuration;
        com.kwad.components.ad.nativead.d.a aVar2;
        ...
        Context contextWrapContextIfNeed = m.wrapContextIfNeed(context);
        e eVar = this.pu;
        if (eVar != null && (iAdLivePlayModule = eVar.ir) != null) {
            playDuration = iAdLivePlayModule.getPlayDuration();
        } else {
            f fVar = this.pt;
            playDuration = (fVar == null || (aVar2 = fVar.pX) == null) ? 0L : aVar2.getPlayDuration();
        }
        com.kwad.components.core.e.d.a.a(new a.C0529a(contextWrapContextIfNeed).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aQ(i2).as(true).D(playDuration).az(z2).a(new a.b() { // from class: com.kwad.components.ad.nativead.d.5
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                com.kwad.sdk.core.adlog.c.a(d.this.mAdTemplate, new com.kwad.sdk.core.adlog.c.b().f(aVar).ec(i3), (JSONObject) null);
                d.this.pD.l(view);
            }
        }));
    }
