...
public class FeedErrorInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public FeedErrorInfo setErrorType(int i2) {
        this.errorType = i2;
        return this;
    }

    public FeedErrorInfo setFeedType(int i2) {
        this.feedType = i2;
        return this;
    }

    public FeedErrorInfo setMaterialType(long j2) {
        this.materialType = j2;
        return this;
    }

    public FeedErrorInfo setWidth(long j2) {
        this.width = j2;
        return this;
    }
}
