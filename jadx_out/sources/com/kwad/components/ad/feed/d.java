...
public final class d {
    ...
    public static class c {
        private InterfaceC0465d hD;
        private Context mContext;

        public c(InterfaceC0465d interfaceC0465d, Context context) {
            this.hD = interfaceC0465d;
            this.mContext = context;
        }
    }
    ...
    public static void a(boolean z2, float f2, Context context, InterfaceC0465d interfaceC0465d, boolean z3) {
        if (hu == null) {
            a(z2, f2, context, z3);
        }
        hx.add(new c(interfaceC0465d, context));
    }
    ...
    public static void a(InterfaceC0465d interfaceC0465d) {
        for (c cVar : hx) {
            if (cVar != null && cVar.hD == interfaceC0465d) {
                hx.remove(cVar);
            }
        }
    ...
    private static void a(boolean z2, float f2, Context context, boolean z3) {
        hu = new com.kwad.sdk.core.g.d(z2, f2);
        ...
        hu.a(new com.kwad.sdk.core.g.b() { // from class: com.kwad.components.ad.feed.d.1
            ...
            public final void a(double d2) {
                if (d.hx != null) {
                    Iterator it = d.hx.iterator();
                    while (true) {
                        if (!it.hasNext()) {
                            break;
                        }
                        c cVar = (c) it.next();
                        if (cVar != null && cVar.hD != null && cVar.hD.b(d2)) {
