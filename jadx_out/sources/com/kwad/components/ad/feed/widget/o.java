...
public final class o extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    public final void onClick(View view) {
        d(view, view == this.hW ? 25 : view == this.iQ ? 100 : view == this.ie ? 1 : 35);
    }
    ...
    private void d(View view, final int i2) {
        if (view == this.hY) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aL(5).aM(i2).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aN(view == this.ie ? 1 : 2).as(view == this.ie).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.o.1
