...
public final class i extends c {
    ...
    public i(@NonNull Context context) {
        super(context);
        this.iq = new a.InterfaceC0559a() { // from class: com.kwad.components.ad.feed.widget.i.1
            ...
            public final void a(int i2, al.a aVar) {
                ...
                i.this.cp();
                com.kwad.components.core.e.d.a.a(new a.C0529a(i.this.getContext()).aJ(i.this.mAdTemplate).b(i.this.mApkDownloadHelper).aN(i4).as(z2).au(true).aL(5).aM(i3).d(aVar).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.i.1.1
