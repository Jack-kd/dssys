...
public final class q extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    public q(@NonNull Context context) {
        ...
        this.jr = new b.a() { // from class: com.kwad.components.ad.feed.widget.q.14
        ...
        this.iq = new a.InterfaceC0559a() { // from class: com.kwad.components.ad.feed.widget.q.11
            ...
            public final void a(int i2, al.a aVar) {
                ...
                q.this.cM();
                com.kwad.components.core.e.d.a.a(new a.C0529a(q.this.getContext()).aJ(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).aN(i4).as(z2).au(true).aM(i3).d(aVar).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.11.1
    ...
    private void bj() {
        ...
        this.jp.a(new b.a().bi(this.mAdTemplate).bu(com.kwad.sdk.core.response.helper.b.ds(this.mAdTemplate)).f(this.mAdWebView).m(this.iT).f(this.mApkDownloadHelper).a(this.jq));
        this.mAdWebView.loadUrl(com.kwad.sdk.core.response.helper.b.ds(this.mAdTemplate));
        R r2 = this.mAdTemplate;
        com.kwad.components.ad.feed.monitor.b.a(r2, com.kwad.sdk.core.response.helper.b.ds(r2));
        cK();
    }
    ...
    public void cL() {
        ...
        this.hD = new d.InterfaceC0465d() { // from class: com.kwad.components.ad.feed.widget.q.18
            @Override // com.kwad.components.ad.feed.d.InterfaceC0465d
            public final boolean b(final double d2) {
                if (!cb.r(q.this.iT, (int) (com.kwad.sdk.core.config.e.Kd() * 100.0f)) || !q.this.fx()) {
                    return false;
                }
                com.kwad.components.core.e.d.a.a(new a.C0529a(q.this.getContext()).aJ(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).aN(2).as(false).au(false).aM(157).aL(5).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.18.1
                    @Override // com.kwad.components.core.e.d.a.b
                    public final void onAdClicked() {
    ...
    public a.b getCurrentVoiceItem() {
        if (this.fU == null) {
            this.fU = new a.b(new a.c() { // from class: com.kwad.components.ad.feed.widget.q.2
    ...
    public aq.a getOpenNewPageListener() {
        return new aq.a() { // from class: com.kwad.components.ad.feed.widget.q.19
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(q.this.mContext, new AdWebViewActivityProxy.a.C0548a().aY(bVar.title).aZ(bVar.url).aQ(true).aY(q.this.mAdTemplate).ua());
            }
        };
    }
    ...
    private a.b getVideoPlayCallback() {
        return new a.b() { // from class: com.kwad.components.ad.feed.widget.q.8
            ...
            public final void onVideoPlayError(int i2, int i3) {
                com.kwad.components.ad.feed.monitor.b.a(q.this.mAdTemplate, 2, 1, com.kwad.sdk.core.response.helper.a.M(q.this.mAdInfo), i2 + " " + i3, SystemClock.elapsedRealtime() - q.this.hP);
            }
                ...
                if (q.this.jl == null && com.kwad.sdk.core.response.helper.b.dw(q.this.mAdTemplate) && q.this.jn) {
                    ...
                    q.this.jl.setOnViewEventListener(new com.kwad.sdk.widget.d() { // from class: com.kwad.components.ad.feed.widget.q.8.1
                        ...
                        public final void a(View view, float f2, float f3, float f4, float f5) {
                            ...
                            q.this.P(MediaPlayer.MEDIA_PLAYER_OPTION_GET_DROP_COUNT);
                        }
                    });
    ...
    @Override // com.kwad.components.core.widget.b
    public final void cw() throws NumberFormatException {
        super.cw();
    ...
    public final boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (com.kwad.sdk.core.response.helper.b.cR(this.mAdTemplate) == null) {
            return super.onInterceptTouchEvent(motionEvent);
        }
        b(motionEvent);
    ...
    public final void setVideoPlayConfig(KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        if (ksAdVideoPlayConfig instanceof KSAdVideoPlayConfigImpl) {
            ...
            if (kSAdVideoPlayConfigImpl.getVideoSoundValue() != 0) {
                ...
                R r2 = this.mAdTemplate;
                if (r2 != 0) {
                    r2.mIsAudioEnable = zIsVideoSoundEnable;
                }
                IAdLiveOfflineView iAdLiveOfflineView = this.fH;
                if (iAdLiveOfflineView == null || iAdLiveOfflineView.getView() == null || (iAdLivePlayModule = this.ir) == null) {
                    com.kwad.sdk.core.video.videoview.a aVar = this.cB;
    ...
    public void P(final int i2) {
        cM();
        com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aN(1).as(true).aM(i2).aL(5).au(false).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.9
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                q.this.bY(i2);
            }
    ...
    private void v(AdTemplate adTemplate) {
        ...
        if (jb.get(Long.valueOf(this.mAdTemplate.posId)) != null) {
    ...
    public final void aa() {
        az azVar;
        b.a aVar;
        if (!this.mAdTemplate.mPvReported && (aVar = this.avs) != null && this.isNative) {
            aVar.onAdShow();
    ...
    public final void af() {
        ...
        d.InterfaceC0465d interfaceC0465d = this.hD;
        if (interfaceC0465d != null) {
            com.kwad.components.ad.feed.d.a(interfaceC0465d);
        }
        IAdLivePlayModule iAdLivePlayModule = this.ir;
        if (iAdLivePlayModule != null) {
    ...
    public static /* synthetic */ boolean d(q qVar, boolean z2) {
        qVar.jn = true;
        return true;
    }
    ...
    public final void b(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        this.cB.a(new b.a(this.mAdTemplate).dQ(strM).dR(com.kwad.sdk.core.response.helper.h.b(com.kwad.sdk.core.response.helper.e.eP(this.mAdTemplate))).a(this.mAdTemplate.mVideoPlayerStatus).b(new com.kwad.sdk.contentalliance.a.a.a(this.mAdTemplate, System.currentTimeMillis())).IG(), null);
    ...
    public class AnonymousClass12 extends com.kwad.components.core.webview.c {
                ...
                public final void a(WebCardVideoPositionHandler.VideoPosition videoPosition) {
                    if (q.this.mAdInfo != null) {
                        if (com.kwad.sdk.core.response.helper.a.bi(q.this.mAdInfo) || q.this.is) {
                            q qVar = q.this;
                            qVar.jj = (ViewGroup.MarginLayoutParams) qVar.ij.getLayoutParams();
                            int iCeil = (int) Math.ceil(q.this.iU);
                            int i2 = q.this.mWidth;
                            if (videoPosition.widthRation == 0.0d) {
                                videoPosition.widthRation = 0.9200000166893005d;
                                videoPosition.leftMarginRation = 0.03999999910593033d;
                            }
                            q.this.jj.topMargin = (int) (videoPosition.topMarginRation * iCeil);
                            double d2 = i2;
                            q.this.jj.leftMargin = (int) (videoPosition.leftMarginRation * d2);
                            q.this.jj.width = (int) (d2 * videoPosition.widthRation);
                            q.this.jj.height = (int) (q.this.jj.width * videoPosition.heightWidthRation);
                            ...
                            if (!(q.this.ce instanceof KSAdVideoPlayConfigImpl) || ((KSAdVideoPlayConfigImpl) q.this.ce).getVideoSoundValue() == 0) {
                                q qVar2 = q.this;
                                qVar2.mIsAudioEnable = com.kwad.sdk.core.response.helper.a.ch(qVar2.mAdInfo);
                            } else {
                                q qVar3 = q.this;
                                qVar3.mIsAudioEnable = qVar3.ce.isVideoSoundEnable();
                            }
                            q.this.mAdTemplate.mIsAudioEnable = q.this.mIsAudioEnable;
                            q qVar4 = q.this;
                            qVar4.cv = com.kwad.sdk.core.response.helper.a.bv(qVar4.mAdInfo);
                            if (!q.this.is) {
                                q qVar5 = q.this;
                                qVar5.b(qVar5.ce);
        ...
        @Override // com.kwad.components.core.webview.c
        public final void onReceivedHttpError(int i2, String str, String str2) throws NumberFormatException {
            q.this.a("1", 2, 5);
        }
        ...
        public final void a(al.a aVar) {
            ...
            if (q.this.iU == 0.0d) {
                ...
                q.jb.put(Long.valueOf(q.this.mAdTemplate.posId), Double.valueOf(aVar.height / q.this.mWidth));
            }
        }
        ...
        public final void a(com.kwad.sdk.core.webview.d.b.a aVar) {
            ...
            boolean zBi = com.kwad.sdk.core.response.helper.a.bi(q.this.mAdInfo);
            com.kwad.sdk.core.webview.d.b.d dVar = aVar.arb;
            if (dVar != null && !TextUtils.isEmpty(dVar.QY)) {
                str = aVar.arb.QY;
            } else {
                str = "";
            }
            com.kwad.components.core.e.d.a.a(new a.C0529a(q.this.getContext()).aJ(q.this.mAdTemplate).b(q.this.mApkDownloadHelper).as(q.a(q.this, aVar)).aN(i2).aM(aVar.nm).aq(str).aL(5).ay(aVar.QK).aw(zBi).D(q.this.ir == null ? 0L : q.this.ir.getPlayDuration()).au(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.12.5
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    if (q.this.avs != null) {
                        q.this.avs.onAdClicked();
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void a(String str, int i2, int i3) throws NumberFormatException {
        int i4;
        ...
        if (this.mAdWebView != null) {
            R r2 = this.mAdTemplate;
            com.kwad.components.ad.feed.monitor.b.a(r2, com.kwad.sdk.core.response.helper.b.ds(r2), System.currentTimeMillis() - this.mAdWebView.getLoadTime(), i2);
        }
        com.kwad.components.core.p.a aVarVL = com.kwad.components.core.p.a.vL();
        AdTemplate adTemplate = this.mAdTemplate;
        aVarVL.b(adTemplate, com.kwad.sdk.core.response.helper.b.ds(adTemplate), str);
        try {
        ...
        com.kwad.components.ad.feed.monitor.b.a(i4, com.kwad.sdk.core.response.helper.a.bk(this.mAdInfo), this.mAdTemplate, i3);
        a aVar = this.ji;
        if (aVar != null) {
            aVar.e(1, str);
        }
        ...
        if (this.jg == null) {
            this.isNative = true;
            com.kwad.components.core.widget.b.e(this);
            ...
            com.kwad.components.core.widget.b bVarA = com.kwad.components.ad.feed.b.a(context, FeedType.fromInt(r3.type, r3.defaultType), iBk);
            this.jg = bVarA;
            if (bVarA != null) {
                ...
                this.jg.d((com.kwad.components.core.widget.b) this.mAdResultData);
                com.kwad.components.core.widget.b bVar = this.jg;
    ...
    private void a(com.kwad.sdk.core.video.videoview.a aVar, final int i2) {
        if (aVar != null) {
            ...
            R r2 = this.mAdTemplate;
            FeedType.fromInt(r2.type, r2.defaultType);
            cM();
            com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aN(2).aw(com.kwad.sdk.core.response.helper.a.bi(this.mAdInfo)).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.q.10
                @Override // com.kwad.components.core.e.d.a.b
                public final void onAdClicked() {
                    q.this.bY(i2);
                }
