...
public final class r extends com.kwad.components.core.widget.b<AdResultData, AdTemplate> implements com.kwad.sdk.widget.d {
    ...
    public void cL() {
        ...
        if (this.hD == null) {
            this.hD = new d.InterfaceC0465d() { // from class: com.kwad.components.ad.feed.widget.r.11
                ...
                public final boolean b(final double d2) {
                    ...
                    com.kwad.components.core.e.d.a.a(new a.C0529a(r.this.getContext()).aJ(r.this.mAdTemplate).b(r.this.mApkDownloadHelper).aN(2).as(false).au(false).aM(157).aL(5).aw(true).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.r.11.1
    ...
    public void cX() {
        if (this.jg == null) {
            ...
            com.kwad.components.core.widget.b bVarA = com.kwad.components.ad.feed.b.a(context, FeedType.fromInt(r2.type, r2.defaultType), iBk);
            this.jg = bVarA;
            if (bVarA != null) {
    ...
    public void cY() {
        ...
        if (this.hC == null) {
            this.hC = new d.b() { // from class: com.kwad.components.ad.feed.widget.r.12
    ...
    public void cZ() {
        float fDy = com.kwad.sdk.core.response.helper.b.dy(this.mAdTemplate);
        if (this.hD == null) {
            this.hD = new d.InterfaceC0465d() { // from class: com.kwad.components.ad.feed.widget.r.2
                @Override // com.kwad.components.ad.feed.d.InterfaceC0465d
                public final boolean b(double d2) {
                    if (!cb.r(r.this.jB, (int) (com.kwad.sdk.core.config.e.Kd() * 100.0f)) || !r.this.fx() || !com.kwad.components.ad.feed.d.ce()) {
                        return false;
                    }
                    r.this.go.a("setSensorParams", new com.kwad.components.core.webview.tachikoma.c.i(2, Double.toString(d2)).toJson().toString(), (com.kwad.sdk.components.m) null);
                    return true;
                }
            };
        }
    ...
    public a.b getCurrentVoiceItem() {
        if (this.fU == null) {
            this.fU = new a.b(new a.c() { // from class: com.kwad.components.ad.feed.widget.r.10
    ...
    */
    public boolean getMuteStatus() {
        /*
            r3 = this;
            boolean r0 = com.kwad.sdk.core.config.e.hO()
            r1 = 1
            if (r0 != 0) goto L14
            android.content.Context r0 = r3.mContext
            com.kwad.components.core.t.a r0 = com.kwad.components.core.t.a.aO(r0)
            boolean r0 = r0.wD()
            if (r0 == 0) goto L14
            goto L44
        L14:
            com.kwad.components.core.l.a$b r0 = r3.fU
            if (r0 == 0) goto L24
            ...
            goto L44
        L24:
            com.kwad.sdk.api.KsAdVideoPlayConfig r0 = r3.ce
        ...
        L3a:
            ...
            boolean r0 = com.kwad.sdk.core.response.helper.a.ch(r0)
            if (r0 != 0) goto L43
            goto L44
        L43:
            r1 = 0
    ...
    public final void d(@NonNull AdResultData adResultData) {
        ...
        if (com.kwad.sdk.core.response.helper.b.dB(this.mAdTemplate) > 0.0d) {
            this.mHeight = (int) (this.mWidth * com.kwad.sdk.core.response.helper.b.dB(this.mAdTemplate));
        } else {
        ...
        this.go.a(com.kwad.sdk.wrapper.m.getActivityFromContext(this.mContext), adResultData, new com.kwad.components.core.webview.tachikoma.j() { // from class: com.kwad.components.ad.feed.widget.r.5
            ...
            public final void a(com.kwad.components.core.webview.tachikoma.b.o oVar) {
                r.this.dp = oVar;
                r.this.dp.a(new o.a() { // from class: com.kwad.components.ad.feed.widget.r.5.5
    ...
    private r(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        super(context, attributeSet, 0);
        this.mWidth = getContext().getResources().getDisplayMetrics().widthPixels;
        this.mIsNative = false;
        this.jr = new b.a() { // from class: com.kwad.components.ad.feed.widget.r.9
    ...
    public boolean b(boolean z2, boolean z3) {
        ...
        if (!com.kwad.sdk.core.response.helper.a.cj(adInfoEO)) {
            if (!com.kwad.sdk.core.response.helper.a.ck(adInfoEO)) {
                ...
                if (com.kwad.sdk.core.config.e.JW()) {
                }
            }
            return z3;
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean a(boolean z2, boolean z3, KSAdVideoPlayConfigImpl kSAdVideoPlayConfigImpl, int i2) {
        if (i2 != 1) {
            if (i2 != 2) {
                if (i2 == 3) {
                    return false;
    ...
    public void b(final com.kwad.components.core.webview.tachikoma.f.d dVar) {
        AdMatrixInfo.RotateInfo rotateInfoDM = com.kwad.sdk.core.response.helper.b.dM(this.mAdTemplate);
        if (this.hC == null) {
            this.hC = new d.b() { // from class: com.kwad.components.ad.feed.widget.r.4
                @Override // com.kwad.components.ad.feed.d.b
                public final boolean u(String str) {
                    if (!cb.r(r.this.jB, (int) (com.kwad.sdk.core.config.e.Kd() * 100.0f)) || !r.this.fx() || !com.kwad.components.ad.feed.d.ce()) {
                        return false;
    ...
    public void a(final com.kwad.components.core.webview.tachikoma.f.d dVar) {
        float fDy = com.kwad.sdk.core.response.helper.b.dy(this.mAdTemplate);
        if (this.hD == null) {
            this.hD = new d.InterfaceC0465d() { // from class: com.kwad.components.ad.feed.widget.r.3
                @Override // com.kwad.components.ad.feed.d.InterfaceC0465d
                public final boolean b(double d2) {
                    if (!cb.r(r.this.jB, (int) (com.kwad.sdk.core.config.e.Kd() * 100.0f)) || !r.this.fx() || !com.kwad.components.ad.feed.d.ce()) {
                        return false;
