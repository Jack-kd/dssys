...
public final class p extends a implements View.OnClickListener, com.kwad.sdk.widget.d {
    ...
    private void d(View view, final int i2) {
        if (view == this.hY) {
            ...
            com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aJ(this.mAdTemplate).aL(5).aM(i2).b(this.mApkDownloadHelper).aN(view == this.ie ? 1 : 2).as(view == this.ie).a(new a.b() { // from class: com.kwad.components.ad.feed.widget.p.1
