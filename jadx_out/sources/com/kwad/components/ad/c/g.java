...
public final class g {
    ...
    public static void loadBannerAd(KsScene ksScene, @NonNull final KsLoadManager.BannerAdListener bannerAdListener) {
        ...
        KsAdLoadManager.O().a(new a.C0558a().e(new ImpInfo(sceneImplCovert)).aZ(zB).a(new j() { // from class: com.kwad.components.ad.c.g.3
                ...
                if (com.kwad.sdk.core.response.helper.a.bj(com.kwad.sdk.core.response.helper.e.eO(adTemplate3))) {
                    ...
                    com.kwad.components.ad.c.a.a.a(adTemplate3, adVideoPreCacheConfigObtainVideoPreCacheConfig, new com.kwad.components.ad.c.a.b() { // from class: com.kwad.components.ad.c.g.2.2
                        ...
                        public final void ai() {
                            ...
                            g.a(adTemplate4, bannerAdListener, hVar, jElapsedRealtime);
                        }
            ...
            public final void onError(final int i2, final String str) {
                int i3 = com.kwad.sdk.core.network.e.aTe.errorCode;
                by.runOnUiThread(new bi() { // from class: com.kwad.components.ad.c.g.2.1
                    @Override // com.kwad.sdk.utils.bi
                    public final void doTask() {
                        bannerAdListener.onError(i2, str);
                        com.kwad.components.ad.c.c.c.a(sceneImplCovert, i2, str, SystemClock.elapsedRealtime() - jElapsedRealtime, 0);
                        com.kwad.components.ad.c.c.c.d(i2, str);
                    }
                });
            }
        }).wd());
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void a(final AdTemplate adTemplate, final KsLoadManager.BannerAdListener bannerAdListener, final KsBannerAd ksBannerAd, final long j2) {
        by.postOnUiThread(new bi() { // from class: com.kwad.components.ad.c.g.4
            @Override // com.kwad.sdk.utils.bi
            public final void doTask() {
                l.at("bannerAd_", "onBannerAdCacheSuccess");
                try {
                    com.kwad.sdk.commercial.convert.d.a(com.kwad.sdk.core.response.helper.e.eI(adTemplate), SystemClock.elapsedRealtime() - j2, 2);
