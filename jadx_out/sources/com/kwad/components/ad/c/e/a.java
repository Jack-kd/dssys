...
public final class a extends c {
    ...
    public final void aE() {
        ...
        try {
            if (bVar.bU > 0) {
                d.b(e.eI(bVar.mAdTemplate), 2, SystemClock.elapsedRealtime() - this.cS.bU);
            }
    ...
    private void b(ViewGroup viewGroup) {
        ...
        aVar.setViewCallback(new a.InterfaceC0573a() { // from class: com.kwad.components.ad.c.e.a.1
            ...
            public final void onWindowFocusChanged(boolean z2) {
                if (a.this.f2do != null) {
                    if (!z2) {
                        a aVar2 = a.this;
                        aVar2.f(aVar2.cS.mAdTemplate.mIsAudioEnable);
                        a.this.f2do.yC();
                        return;
                    }
                    a.this.f2do.yB();
                    ...
                    if (a.this.dn) {
                        a aVar3 = a.this;
                        nVar.aut = !aVar3.f(aVar3.cS.mAdTemplate.mIsAudioEnable);
                    } else {
                        nVar.aut = false;
                    }
                    a.this.dp.c(nVar);
    ...
    public final void a(o oVar) {
        ...
        oVar.a(new o.a() { // from class: com.kwad.components.ad.c.e.a.3
            ...
            public final boolean isMuted() {
                boolean z2;
                try {
                    if (com.kwad.sdk.core.config.e.Kh() || !com.kwad.components.core.t.a.aO(a.this.cS.mContext).wD()) {
                        z2 = (!(a.this.cS.bS instanceof KSAdVideoPlayConfigImpl) || ((KSAdVideoPlayConfigImpl) a.this.cS.bS).getVideoSoundValue() == 0) ? !com.kwad.sdk.core.response.helper.a.ce(e.eO(a.this.cS.mAdTemplate)) : !a.this.cS.bS.isVideoSoundEnable();
                    }
                    if (a.this.cS.mAdTemplate != null) {
                        a.this.cS.mAdTemplate.mIsAudioEnable = !z2;
                    }
                    a.this.dn = z2;
                    return z2;
