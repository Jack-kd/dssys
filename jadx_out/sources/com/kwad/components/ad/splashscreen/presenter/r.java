        ...
        if (ksSplashSlidePathView != null) {
            ksSplashSlidePathView.setOnSlideTouchListener(new KsSplashSlidePathView.a() { // from class: com.kwad.components.ad.splashscreen.presenter.r.1
                ...
                public final void a(float f2, float f3, float f4, float f5) {
                    ...
                    final float fPx2dip = com.kwad.sdk.c.a.a.px2dip(r.this.getContext(), (float) Math.sqrt(Math.pow(f4 - f2, 2.0d) + Math.pow(f5 - f3, 2.0d)));
                    if (!SlideConvertHelper.a(r.this.HC.mAdTemplate, f2, f3, f4, f5) || (hVar = (rVar = r.this).HC) == null) {
                        return;
                    }
                    hVar.a(1, rVar.getContext(), MediaPlayer.MEDIA_PLAYER_OPTION_GET_DROP_COUNT, 1, new h.a() { // from class: com.kwad.components.ad.splashscreen.presenter.r.1.1
                ...
                public final void c(MotionEvent motionEvent) {
                    r rVar;
                    com.kwad.components.ad.splashscreen.h hVar;
                    if (!com.kwad.components.ad.splashscreen.h.o(r.this.mAdInfo) || (hVar = (rVar = r.this).HC) == null) {
                        return;
                    }
                    hVar.c(1, rVar.getContext(), 53, 3);
                }
            });
        }
    }
