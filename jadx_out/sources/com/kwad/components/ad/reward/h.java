...
public final class h extends com.kwad.components.core.proxy.j {
    ...
    public static c a(g gVar, @Nullable String str) {
        ...
        if (zN || com.kwad.sdk.core.response.helper.e.S(adTemplate)) {
            ...
            if (playDuration < (iAg * 1000) - 800 && (i2 = (int) (iAg - ((playDuration / 1000.0f) + 0.5f))) >= 0) {
                i4 = i2;
            }
        }
        return (!zN || aVar == null) ? (!com.kwad.sdk.core.response.helper.e.S(adTemplate) || aVar2 == null) ? com.kwad.components.ad.reward.a.b.j(adInfoEO) ? c.i(adInfoEO) : (com.kwad.sdk.core.response.helper.a.cq(adInfoEO) == 1 && com.kwad.components.ad.reward.a.b.hV() == 1) ? c.a(adInfoEO, i3) : adTemplate.isNativeRewardPreview ? c.h(str, i3) : com.kwad.sdk.core.response.helper.a.cY(adInfoEO) ? c.c(adTemplate, i3) : com.kwad.sdk.core.response.helper.a.cN(adTemplate) ? c.d(adTemplate, i3) : com.kwad.components.ad.reward.a.b.hP() == 1 ? c.q(i3) : c.F(str) : c.a(aVar2, adTemplate, String.valueOf(i4)) : c.a(aVar, adTemplate, String.valueOf(i4));
    }
    ...
    public static class c extends com.kwad.sdk.core.response.a.a {
        ...
        public static c c(AdTemplate adTemplate, long j2) {
            AdInfo adInfoEO = com.kwad.sdk.core.response.helper.e.eO(adTemplate);
            c cVar = new c();
            cVar.style = 8;
        ...
        public static c d(AdTemplate adTemplate, long j2) {
    ...
    private static View a(com.kwad.components.ad.reward.l.a aVar, final DialogFragment dialogFragment, LayoutInflater layoutInflater, ViewGroup viewGroup, c cVar, AdTemplate adTemplate, final a aVar2) throws Resources.NotFoundException {
        ...
        if (iIndexOf < 0) {
            ...
            if (zEquals) {
                ...
                i2 = str2.length() > 1 ? iIndexOf + 3 : iIndexOf + 2;
            }
