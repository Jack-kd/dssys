...
public class ActionBarAppLandscape extends LinearLayout implements d {
        ...
        if (this.en == null) {
            this.en = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.1
                ...
                public final void onPaused(int i2) {
                    ActionBarAppLandscape.this.FM.e(com.kwad.sdk.core.response.helper.a.eG(i2), i2);
                    ActionBarAppLandscape.this.FN.setVisibility(8);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i2) {
                    ActionBarAppLandscape.this.FM.e(com.kwad.sdk.core.response.helper.a.eF(i2), i2);
                    ActionBarAppLandscape.this.FN.setVisibility(8);
                }
            };
        }
    ...
    private void d(View view, final boolean z2) {
        com.kwad.components.core.e.d.a.a(new a.C0529a(view.getContext()).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).as(view == this.FM).aN(view == this.FN ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.reward.widget.actionbar.ActionBarAppLandscape.2
            @Override // com.kwad.components.core.e.d.a.b
            public final void onAdClicked() {
                if (ActionBarAppLandscape.this.FO != null) {
                    ActionBarAppLandscape.this.FO.P(z2);
                }
            }
        }));
    }
