...
public final class c {
    ...
    public c(long j2, KsLoadManager.RewardVideoAdListener rewardVideoAdListener) {
        this.jP = j2;
        this.vK = rewardVideoAdListener;
    }

    public final void b(AdTemplate adTemplate, @Nullable List<KsRewardVideoAd> list) {
    ...
    public final void b(AdTemplate adTemplate, @Nullable List<KsRewardVideoAd> list, long j2) {
        ...
        if (adTemplate != null) {
            try {
                com.kwad.sdk.commercial.convert.d.a(e.eI(adTemplate), SystemClock.elapsedRealtime() - j2, 2);
            } catch (Throwable th) {
