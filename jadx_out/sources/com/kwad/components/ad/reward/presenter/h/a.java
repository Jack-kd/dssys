...
public final class a extends g implements j {
    ...
    private boolean yc;
    private boolean yd;
    private g.b ye = new g.b() { // from class: com.kwad.components.ad.reward.presenter.h.a.1
    ...
    private final m kf = new m() { // from class: com.kwad.components.ad.reward.presenter.h.a.3
        ...
        public final void onMediaPlayProgress(long j2, long j3) {
            ...
            long jAS = com.kwad.sdk.core.response.helper.a.aS(a.this.mAdInfo) * 1000;
            if (j3 <= a.this.Bw || jH - j3 <= jAS || a.this.yc) {
                return;
            }
    ...
    private void iT() {
        ...
        com.kwad.components.ad.reward.e.b bVar = this.uj.sy;
        if (bVar != null) {
            bVar.onRewardVerify();
        }
        this.uj.sz.pause();
    ...
    public final void ay() {
        ...
        if (as.VM()) {
            ...
            this.Bw = com.kwad.sdk.core.response.helper.a.aR(r0) * 1000;
            e eVar = this.uj.sz;
            if (eVar != null) {
                eVar.a(this.kf);
            }
