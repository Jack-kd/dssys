...
public final class o extends b implements View.OnClickListener, com.kwad.components.ad.reward.presenter.platdetail.actionbar.a {
    ...
    private synchronized void iU() {
        ...
        com.kwad.sdk.core.adlog.c.d(this.uj.mAdTemplate, (JSONObject) null, new com.kwad.sdk.core.adlog.c.b().ee(MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT).aC(this.uj.sz.getPlayDuration()));
        this.wZ = true;
    }

    /* JADX INFO: Access modifiers changed from: private */
    public Animator iV() throws Resources.NotFoundException {
    ...
    public final void J(boolean z2) throws Resources.NotFoundException {
        ViewGroup viewGroup = this.wT;
    ...
    public final void onClick(View view) {
        ...
        com.kwad.sdk.core.adlog.c.e(this.uj.mAdTemplate, null, new com.kwad.sdk.core.adlog.c.b().ee(MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT).aC(this.uj.sz.getPlayDuration()));
    }
