...
public final class h extends g implements j, com.kwad.components.ad.reward.presenter.platdetail.actionbar.a {
    ...
    private g.a Bd = new g.a() { // from class: com.kwad.components.ad.reward.presenter.f.h.2
    ...
    private e.b kx() {
        return new e.b() { // from class: com.kwad.components.ad.reward.presenter.f.h.3
            ...
            public final int ky() {
                if (h.this.uj.tg != null) {
                    return com.kwad.sdk.c.a.a.px2dip(h.this.getContext(), r0.dx());
                }
                if (h.this.Bb == null) {
                    return 0;
                }
                return h.this.Bb.getLayoutParams() instanceof ViewGroup.MarginLayoutParams ? com.kwad.sdk.c.a.a.px2dip(h.this.getContext(), h.this.Bb.getHeight() + ((ViewGroup.MarginLayoutParams) r0).bottomMargin) : com.kwad.sdk.c.a.a.px2dip(h.this.getContext(), h.this.Bb.getHeight());
            }
        };
    }
