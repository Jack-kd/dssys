...
public final class t extends b implements View.OnClickListener, com.kwad.components.ad.reward.e.o, com.kwad.sdk.core.g.b {
    ...
    private void dy() throws Resources.NotFoundException {
        ...
        boolean z2 = com.kwad.sdk.core.response.helper.a.bl(com.kwad.sdk.core.response.helper.e.eO(this.uj.mAdTemplate)) == 8;
        final int dimensionPixelSize = resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_marginLeft);
        final int dimensionPixelSize2 = this.uj.mScreenOrientation == 1 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_marginBottom) + com.kwad.sdk.c.a.a.a(getContext(), 50.0f) : z2 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_live_shop_marginBottom) : resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_icon_marginBottom);
        int dimensionPixelSize3 = this.uj.mScreenOrientation == 1 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_title_marginBottom) + com.kwad.sdk.c.a.a.a(getContext(), 50.0f) : z2 ? resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_title_live_shop_marginBottom) : resources.getDimensionPixelSize(R.dimen.ksad_reward_shake_tips_title_marginBottom);
        ...
        com.kwad.sdk.core.adlog.c.b(this.uj.mAdTemplate, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SOLOPLAY, (JSONObject) null);
        this.kN.post(new bi() { // from class: com.kwad.components.ad.reward.presenter.t.6
            ...
            public final void doTask() {
                ...
                t tVar = t.this;
                tVar.kV = tVar.a(dimensionPixelSize, height - dimensionPixelSize2);
                if (t.this.kV != null) {
                    t.this.kV.start();
                }
            }
