...
public final class a extends g implements com.kwad.components.ad.reward.k.a {
    ...
    private void U(final boolean z2) {
        c.d("TKPreFormPresenter", "switchPreForm: " + z2);
        this.Ba.post(new bi() { // from class: com.kwad.components.ad.reward.presenter.e.a.2
            @Override // com.kwad.sdk.utils.bi
            public final void doTask() {
                a.this.Ba.setVisibility(z2 ? 0 : 4);
                a.this.Ba.setClickable(z2);
                if (a.this.Av != null) {
                    if (z2) {
                        a.this.Av.yx();
                        a.this.Av.yy();
    ...
    public final BackPressHandleResult hJ() {
        ...
        return (this.AI == null || (kSFrameLayout = this.Ba) == null) ? BackPressHandleResult.NOT_HANDLED : kSFrameLayout.getVisibility() == 0 ? this.AI.hJ() : BackPressHandleResult.NOT_HANDLED;
    }
