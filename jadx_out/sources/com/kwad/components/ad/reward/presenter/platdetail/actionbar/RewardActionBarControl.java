...
public final class RewardActionBarControl {
    ...
    private ShowActionBarResult R(boolean z2) {
        c cVar;
        ...
        return this.za.f(this.zc) ? ShowActionBarResult.SHOW_H5_SUCCESS : ShowActionBarResult.SHOW_H5_FAILURE;
    }
    ...
    public void S(boolean z2) {
        if (this.yW != null) {
            ...
            this.zf = true;
            this.yW.a(z2, this.zc);
        }
    }

    public final void Q(boolean z2) {
        ShowActionBarResult showActionBarResultR = R(z2);
