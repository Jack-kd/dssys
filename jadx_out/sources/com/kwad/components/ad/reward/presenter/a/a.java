...
public final class a extends g implements j {
    ...
    private boolean yc;
    private boolean yd;
    private g.b ye = new g.b() { // from class: com.kwad.components.ad.reward.presenter.a.a.1
    ...
    private final m kf = new m() { // from class: com.kwad.components.ad.reward.presenter.a.a.2
        ...
        public final void onMediaPlayProgress(long j2, long j3) {
            ...
            if (j3 <= a.this.ya || jH - j3 <= a.this.yb || a.this.yc) {
                return;
            }
            a.a(a.this, true);
    ...
    @Override // com.kwad.components.ad.reward.presenter.f.d, com.kwad.components.core.webview.tachikoma.j
    public final void aE() throws Throwable {
    ...
    public final void ay() {
        ...
        this.mAdInfo = e.eO(this.uj.mAdTemplate);
        this.ya = com.kwad.sdk.core.response.helper.a.aP(r0) * 1000;
        this.yb = com.kwad.sdk.core.response.helper.a.aQ(this.mAdInfo) * 1000;
    ...
    public final void a(WebCloseStatus webCloseStatus) {
        com.kwad.components.ad.reward.g gVar = this.uj;
        boolean z2 = webCloseStatus != null && webCloseStatus.interactSuccess;
        gVar.sR = z2;
        if (z2) {
            gVar.sz.lp();
        }
