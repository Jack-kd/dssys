...
public final class f {
    ...
    public static void a(final com.kwad.components.ad.reward.g gVar, boolean z2) {
        ...
        q(gVar);
        boolean z3 = !gVar.hi() && Z(gVar.mAdTemplate);
    ...
    public static void p(final com.kwad.components.ad.reward.g gVar) {
        by.runOnUiThread(new bi() { // from class: com.kwad.components.ad.reward.presenter.f.3
            ...
            public final void doTask() {
                ...
                gVar2.sy.onVideoSkipToEnd(gVar2.tn);
                gVar.release();
                gVar.iM();
            }
        });
    ...
    private static void q(com.kwad.components.ad.reward.g gVar) {
        ...
        long j3 = gVar.tn;
        com.kwad.sdk.core.adlog.c.e(gVar.mAdTemplate, gVar.mReportExtData, new com.kwad.sdk.core.adlog.c.b().ee(69).eh(i2).ei(j3 != 0 ? (int) (j3 / 1000) : 0));
    }
    ...
    public static void u(com.kwad.components.ad.reward.g gVar) {
        ...
        com.kwad.sdk.core.adlog.c.b bVarEo = new com.kwad.sdk.core.adlog.c.b().ec(MediaPlayer.MEDIA_PLAYER_OPTION_SET_DEFAULT_CODEC_ID).eo(8);
        boolean z2 = com.kwad.sdk.core.download.a.b.I(context, com.kwad.sdk.core.response.helper.a.da(adInfoEO)) == 1;
        com.kwad.sdk.core.d.c.i("openAppMarket", "handleDeepLink dpSuccess: " + z2);
        if (z2) {
    ...
    private static void w(final com.kwad.components.ad.reward.g gVar) {
        ...
        com.kwad.components.ad.reward.g.a(gVar, com.kwad.components.ad.reward.h.a(gVar, (String) null), new h.b() { // from class: com.kwad.components.ad.reward.presenter.f.6
            ...
            public final void H(boolean z2) {
                gVar.F(false);
                if (!z2) {
                    com.kwad.sdk.core.adlog.c.t(adTemplate, MediaPlayer.MEDIA_PLAYER_OPTION_GET_CONTAINER_FPS);
                }
                f.x(gVar);
                gVar.iM();
            }
    ...
    private static void a(final com.kwad.components.ad.reward.g gVar, @NonNull final h.b bVar) {
        ...
        if (jAg > 0 && com.kwad.sdk.core.response.helper.a.N(adInfoEO) > jAg) {
            str = "观看视频" + jAg + "s即可获取奖励";
        } else {
            str = "观看完整视频即可获取奖励";
        }
        ...
        com.kwad.components.ad.reward.g.a(gVar, cVarA, new h.b() { // from class: com.kwad.components.ad.reward.presenter.f.7
            ...
            public final void h(int i2, int i3) {
                super.h(i2, i3);
                com.kwad.components.ad.reward.g gVar2 = gVar;
                gVar2.a(1, gVar2.mContext, i2, i3);
            }
