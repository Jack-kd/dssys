...
public class KSRewardVideoActivityProxy extends com.kwad.components.core.n.b<g> implements g.b, n.a, c.b, OnAdLiveResumeInterceptor {
    ...
    private com.kwad.components.ad.reward.e.i mAdOpenInteractionListener = new com.kwad.components.ad.reward.e.i() { // from class: com.kwad.components.ad.reward.KSRewardVideoActivityProxy.3
        ...
        public final void i(boolean z2) {
            if (KSRewardVideoActivityProxy.this.notifyPageDismiss(z2)) {
    ...
    private void handleNotifyVerify(boolean z2) {
        ...
        if (z2 || ((g) this.mCallerContext).sY == 0) {
        ...
        if (com.kwad.sdk.core.response.helper.a.df(this.mModel.da())) {
            T t2 = this.mCallerContext;
            if (((g) t2).mAdTemplate.converted || ((g) t2).sP || ((g) t2).hg()) {
                return;
            }
    ...
    private boolean isLaunchTaskCompleted() {
        T t2 = this.mCallerContext;
        return ((g) t2).ti != null && ((g) t2).ti.isCompleted();
    }
    ...
    public static void launch(Activity activity, AdResultData adResultData, @NonNull KsVideoPlayConfig ksVideoPlayConfig, KsRewardVideoAd.RewardAdInteractionListener rewardAdInteractionListener, com.kwad.components.core.j.d dVar, int i2) {
        Intent intent;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public boolean notifyPageDismiss(boolean z2) {
    ...
    private void notifyRewardStep(final int i2, final int i3) {
        com.kwad.components.ad.reward.model.c cVar = this.mModel;
        if (cVar == null || com.kwad.sdk.core.response.helper.e.eZ(cVar.getAdTemplate()) || ((g) this.mCallerContext).sV.contains(Integer.valueOf(i3))) {
            return;
        }
        ((g) this.mCallerContext).sV.add(Integer.valueOf(i3));
        o.a(i2, i3, (g) this.mCallerContext, this.mModel);
        by.runOnUiThread(new bi() { // from class: com.kwad.components.ad.reward.KSRewardVideoActivityProxy.7
            @Override // com.kwad.sdk.utils.bi
            public final void doTask() {
                try {
                    if (KSRewardVideoActivityProxy.this.mAdOpenInteractionListener.i(i2, i3)) {
                        com.kwad.components.ad.reward.monitor.d.a(KSRewardVideoActivityProxy.this.mModel.getAdTemplate(), i2, i3, false);
                    }
                } catch (Throwable th) {
    ...
    public void notifyRewardVerify() {
        com.kwad.components.ad.reward.model.c cVar = this.mModel;
        if (cVar == null || !((g) this.mCallerContext).mCheckExposureResult || com.kwad.sdk.core.response.helper.e.eZ(cVar.getAdTemplate()) || ((g) this.mCallerContext).hi()) {
            return;
        }
        if (this.mModel.iF()) {
            T t2 = this.mCallerContext;
            if (((g) t2).ti == null || !((g) t2).ti.isCompleted()) {
                return;
            }
        ...
        if (((g) t3).tj == null || !((g) t3).tj.isCompleted()) {
            return;
        }
        handleNotifyVerify(true);
    }
    ...
    public void notifyRewardVerifyStepByStep() {
        ...
        T t2 = this.mCallerContext;
        boolean z2 = ((g) t2).tj != null && ((g) t2).tj.isCompleted();
    ...
    public int getLayoutId() {
        com.kwad.components.ad.reward.model.c cVar = this.mModel;
        return (cVar == null || !cVar.jM) ? R.layout.ksad_activity_reward_video_legacy : R.layout.ksad_activity_reward_neo;
    }
        ...
        try {
            ...
            if (cVar != null) {
                ...
                if (!TextUtils.isEmpty(strM)) {
                    com.kwad.sdk.core.videocache.c.a.cm(this.mContext.getApplicationContext()).fA(strM);
                }
    ...
    public g onCreateCallerContext() {
        ...
        if (com.kwad.sdk.core.response.helper.b.dk(adTemplate)) {
            j jVar = new j(gVar, this.mModel.iK(), null);
            gVar.sC = jVar;
            jVar.a(new com.kwad.components.ad.reward.c.d() { // from class: com.kwad.components.ad.reward.KSRewardVideoActivityProxy.6
        ...
        if (this.mModel.da() != null) {
            gVar.tm = com.kwad.sdk.core.response.helper.a.bQ(this.mModel.da()) ? com.kwad.sdk.core.response.helper.a.ax(this.mModel.da()) : com.kwad.sdk.core.response.helper.a.aq(this.mModel.da());
        }
