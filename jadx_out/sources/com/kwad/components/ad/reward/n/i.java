...
public final class i extends d implements View.OnClickListener {
    ...
    public static class a {
        ...
        public static a ag(AdTemplate adTemplate) {
    ...
    public static /* synthetic */ Animator a(i iVar, View view, float f2) {
        return a(view, f2);
    }
    ...
    public final void onClick(View view) {
        if (view.equals(this.wT)) {
            this.uj.a(1, view.getContext(), TTVideoEngine.PLAYER_BUFFERING_DATA_OF_MILLISECONDS, 2);
    ...
    private void a(AdTemplate adTemplate, a aVar) throws Resources.NotFoundException {
        ...
        int i2 = TextUtils.isEmpty(aVar.lC()) ? 8 : 0;
        View view = this.DE;
        if (view != null) {
