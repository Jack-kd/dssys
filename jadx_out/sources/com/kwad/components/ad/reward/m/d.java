...
public final class d extends com.kwad.components.ad.k.b implements g.a {
    ...
    private void by() {
        ...
        this.Nx.a(new b.a(this.mAdTemplate).dQ(this.CC).dR(h.b(com.kwad.sdk.core.response.helper.e.eP(this.mAdTemplate))).a(this.mVideoPlayerStatus).b(com.kwad.sdk.contentalliance.a.a.a.cm(this.mAdTemplate)).IG(), this.mDetailVideoView);
    ...
    public final void hs() {
        ...
        this.CE = false;
        if (!this.CD.get() || (bVar = this.Nx) == null) {
            return;
        }
        bVar.d(this.qQ);
        this.Nx.release();
    ...
    public final void lo() {
        ...
        m mVar = new m() { // from class: com.kwad.components.ad.reward.m.d.2
            ...
            public final void onMediaPlayError(int i2, int i3) {
                ...
                com.kwad.components.core.p.a.vL().m(d.this.mAdTemplate, i2, i3);
            }
        };
        this.qQ = mVar;
        this.Nx.c(mVar);
        this.Nx.a(new c.e() { // from class: com.kwad.components.ad.reward.m.d.3
