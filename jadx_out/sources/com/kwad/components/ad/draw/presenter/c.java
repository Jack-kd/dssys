...
public final class c extends com.kwad.components.ad.draw.b.a implements View.OnClickListener {
    ...
    private l mVideoPlayStateListener = new m() { // from class: com.kwad.components.ad.draw.presenter.c.1
        ...
        public final void onMediaPlayProgress(long j2, long j3) {
            if (j3 >= c.this.em * 1000) {
                c.this.dQ.dV.ba();
            } else if (j3 >= c.this.el * 1000) {
                c.this.aX();
            } else if (j3 >= c.this.ek * 1000) {
                c.this.aV();
            }
        }
    ...
    private KsAppDownloadListener en = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.presenter.c.2
        ...
        public final void onPaused(int i2) {
            ...
            c.this.ei.e(com.kwad.sdk.core.response.helper.a.Nx(), i2);
        }

        @Override // com.kwad.sdk.api.KsAppDownloadListener
        public final void onProgressUpdate(int i2) {
            c.this.eh.setText(i2 + "%");
            c.this.ei.e(i2 + "%", i2);
        }
    };
    ...
    private void a(boolean z2, int i2) {
        com.kwad.components.core.e.d.a.a(new a.C0529a(this.ee.getContext()).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).aN(i2).as(z2).a(new a.b() { // from class: com.kwad.components.ad.draw.presenter.c.3
