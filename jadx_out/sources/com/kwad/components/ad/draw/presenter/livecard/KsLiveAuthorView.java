...
public class KsLiveAuthorView extends FrameLayout implements cc.a {
    ...
    public KsLiveAuthorView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
    ...
    @RequiresApi(api = 21)
    public KsLiveAuthorView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2, int i3) {
        super(context, attributeSet, i2, i3);
        this.ca = new cc(this);
        A(context);
    }

    public static Animator a(View view, boolean z2) {
        float width = view.getWidth();
        if (width <= 0.0f) {
            return null;
        }
        float f2 = 0.9f * width;
        c.d("KsLiveAuthorView", "getIconScaleAnimator size: " + width + ", endSize: " + f2);
