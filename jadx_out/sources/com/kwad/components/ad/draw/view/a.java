...
public final class a extends KSFrameLayout implements View.OnClickListener {
    ...
    public a.b getCurrentVoiceItem() {
        if (this.fU == null) {
            this.fU = new a.b(new a.c() { // from class: com.kwad.components.ad.draw.view.a.6
    ...
    public boolean isVideoSoundEnable() {
        return this.fV == 1 ? !this.fA : !com.kwad.sdk.core.response.helper.a.ci(e.eO(this.mAdTemplate));
    }
