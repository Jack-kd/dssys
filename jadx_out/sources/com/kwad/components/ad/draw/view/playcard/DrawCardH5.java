...
public class DrawCardH5 extends FrameLayout implements View.OnClickListener {
    ...
    public void onClick(View view) {
        if (view != this.gJ) {
            com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aJ(this.mAdTemplate).aN(view == this.gL ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardH5.1
