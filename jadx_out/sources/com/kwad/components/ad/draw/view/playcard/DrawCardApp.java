...
public class DrawCardApp extends FrameLayout implements View.OnClickListener {
        ...
        if (this.en == null) {
            this.en = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.1
                ...
                public final void onPaused(int i2) {
                    super.onPaused(i2);
                    DrawCardApp.this.gF.e(com.kwad.sdk.core.response.helper.a.Nx(), i2);
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i2) {
                    DrawCardApp.this.gF.e(i2 + "%", i2);
                }
            };
        }
        return this.en;
    ...
    public void onClick(View view) {
        if (view != this.gx) {
            com.kwad.components.core.e.d.a.a(new a.C0529a(getContext()).aJ(this.mAdTemplate).b(this.mApkDownloadHelper).as(view == this.gF).aN(view == this.gF ? 1 : 2).a(new a.b() { // from class: com.kwad.components.ad.draw.view.playcard.DrawCardApp.2
    ...
    private void d(int i2, int i3) {
        br();
        ValueAnimator valueAnimatorB = x.b(this, i2, i3);
