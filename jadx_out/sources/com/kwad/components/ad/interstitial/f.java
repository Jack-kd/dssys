...
public final class f {
    public static void loadInterstitialAd(@NonNull KsScene ksScene, @NonNull final KsLoadManager.InterstitialAdListener interstitialAdListener) {
        ...
        KsAdLoadManager.O().a(new a.C0558a().e(new ImpInfo(sceneImplCovert)).aZ(zB).a(new com.kwad.components.core.request.d() { // from class: com.kwad.components.ad.interstitial.f.2
            ...
            public final void a(@NonNull AdResultData adResultData, boolean z2) {
                ...
                com.kwad.components.ad.interstitial.report.c.eZ().a(adTemplateList.get(0), z2);
                ...
                if (arrayList.size() != 0) {
                    com.kwad.components.ad.interstitial.report.c.eZ().b(adTemplateList.get(0), z2);
            ...
            public final void onError(final int i2, final String str) {
                com.kwad.components.ad.interstitial.report.c.eZ().a(i2, str, sceneImplCovert.getPosId());
