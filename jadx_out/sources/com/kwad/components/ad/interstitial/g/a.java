        ...
        if (dVar != null && (ownerActivity = dVar.getOwnerActivity()) != null && !ownerActivity.isFinishing()) {
            ...
            if (iDV > com.kwad.sdk.core.response.helper.a.cD(adInfoEO) && iDW < com.kwad.sdk.core.response.helper.a.cE(adInfoEO)) {
                ...
                if (com.kwad.sdk.core.response.helper.a.cF(adInfoEO) == 1) {
                    new com.kwad.components.core.page.widget.a(ownerActivity, com.kwad.sdk.core.response.helper.a.cG(adInfoEO), new a.InterfaceC0552a() { // from class: com.kwad.components.ad.interstitial.g.a.1
                        ...
                        public final void b(DialogInterface dialogInterface) {
                            ...
                            dialogInterface.dismiss();
                            com.kwad.sdk.core.adlog.c.e(cVar.mAdTemplate, null, new com.kwad.sdk.core.adlog.c.b().ee(MediaPlayer.MEDIA_PLAYER_OPTION_GET_CONTAINER_FPS).ej(8));
                            cVar.lx.dismiss();
                        }
                    ...
                    com.kwad.sdk.core.adlog.c.d(cVar.mAdTemplate, new JSONObject(), new com.kwad.sdk.core.adlog.c.b().ee(149).ej(8));
                    return true;
                }
            }
        }
