...
public final class b extends com.kwad.components.ad.interstitial.h.a {
        ...
        this.lI.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.kwad.components.ad.interstitial.aggregate.b.6
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                if (i2 < b.this.lL - 1) {
                    ...
                    b.this.lF.scrollTo((i2 * width) + iIntValue, 0);
                    b.this.lF.onPageScrolled(i2 + 1, iIntValue / width, 0);
                }
            }
        });
    ...
    private b(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        this.lN = new ViewPager.SimpleOnPageChangeListener() { // from class: com.kwad.components.ad.interstitial.aggregate.b.9
            ...
            public final void onPageSelected(int i2) {
                com.kwad.components.ad.interstitial.h.c cVarU = b.this.lF.U(i2);
                if (cVarU != null) {
                    cVarU.fh();
                }
                if (this.lQ != i2) {
    ...
    @Override // com.kwad.components.ad.interstitial.h.a
    public final void a(@NonNull AdResultData adResultData, com.kwad.components.ad.interstitial.d dVar, @NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig, KsInterstitialAd.AdInteractionListener adInteractionListener, int i2) throws Resources.NotFoundException {
        ...
        this.lG.a(new a.InterfaceC0474a() { // from class: com.kwad.components.ad.interstitial.aggregate.b.2
            @Override // com.kwad.components.ad.interstitial.aggregate.a.InterfaceC0474a
        ...
        if (marginLayoutParams != null) {
            boolean zVM = as.VM();
            this.lM = zVM;
            marginLayoutParams.bottomMargin = com.kwad.sdk.c.a.a.a(this.mContext, zVM ? 12.0f : 6.0f);
    ...
    @Override // com.kwad.components.ad.interstitial.h.a
    public final void a(@NonNull AdResultData adResultData, com.kwad.components.ad.interstitial.d dVar, @NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig, KsInterstitialAd.AdInteractionListener adInteractionListener, int i2, boolean z2) throws Resources.NotFoundException {
        this.mAdResultData = adResultData;
        this.lK = g(adResultData);
        this.mAdTemplateList.clear();
        this.mAdTemplateList.addAll(this.mAdResultData.getAdTemplateList());
        this.lL = this.mAdTemplateList.size();
        this.ls = adInteractionListener;
        a aVar = new a(this.mAdResultData, dVar, ksAdVideoPlayConfig, adInteractionListener, z2);
        this.lG = aVar;
        ...
        this.lG.a(new a.InterfaceC0474a() { // from class: com.kwad.components.ad.interstitial.aggregate.b.4
            @Override // com.kwad.components.ad.interstitial.aggregate.a.InterfaceC0474a
            public final void dG() {
                if (b.this.lI != null) {
                    b.this.lI.cancel();
