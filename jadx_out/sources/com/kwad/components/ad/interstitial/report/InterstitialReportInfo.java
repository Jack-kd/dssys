...
public class InterstitialReportInfo extends com.kwad.sdk.commercial.c.a implements Serializable {
    ...
    public InterstitialReportInfo setActionType(long j2) {
        this.actionType = j2;
        return this;
    }

    public InterstitialReportInfo setCallbackType(long j2) {
        this.callbackType = j2;
        return this;
    }

    public InterstitialReportInfo setClickSceneType(long j2) {
        this.clickSceneType = j2;
        return this;
    }

    public InterstitialReportInfo setCreativeId(long j2) {
        this.creativeId = j2;
        return this;
    }

    public InterstitialReportInfo setDownloadDuration(long j2) {
        this.downloadDuration = j2;
        return this;
    }

    public InterstitialReportInfo setDownloadSize(long j2) {
        this.downloadSize = j2;
        return this;
    }

    public InterstitialReportInfo setDownloadType(int i2) {
    ...
    public InterstitialReportInfo setItemClickType(long j2) {
        this.itemClickType = j2;
        return this;
    }

    public InterstitialReportInfo setLoadDataTime(long j2) {
        this.loadDataTime = j2;
        return this;
    }

    public InterstitialReportInfo setMaterialType(int i2) {
        this.materialType = i2;
        return this;
    }

    public InterstitialReportInfo setPlayStartedDuration(long j2) {
        this.playStartedDuration = j2;
        return this;
    }

    public InterstitialReportInfo setRenderDuration(long j2) {
        this.renderDuration = j2;
        return this;
    }

    public InterstitialReportInfo setRenderType(int i2) {
        this.renderType = i2;
        return this;
    }

    public InterstitialReportInfo setStatus(int i2) {
        this.status = i2;
        return this;
    }

    public InterstitialReportInfo setType(int i2) {
        this.type = i2;
        return this;
    }

    public InterstitialReportInfo setVideoDuration(long j2) {
    ...
    public InterstitialReportInfo setVisiblePercent(double d2) {
