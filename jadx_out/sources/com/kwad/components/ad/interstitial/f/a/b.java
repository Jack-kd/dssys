...
public final class b extends a {
    ...
    private final c.b nx = new c.b() { // from class: com.kwad.components.ad.interstitial.f.a.b.1
        ...
        public final void c(long j2, long j3) {
            com.kwad.components.ad.interstitial.report.a.eV().b(b.this.mN.mAdTemplate, j2, j3);
            if (b.this.oh != null) {
    ...
    public void eC() {
        ...
        com.kwad.components.ad.interstitial.d dVar = cVar.lx;
        if (dVar != null && a(dVar)) {
            this.mN.lx.dismiss();
        }
        try {
            ...
            public final void a(String str, @NonNull final com.kwad.sdk.core.webview.c.c cVar) {
                ...
                by.runOnUiThreadDelay(new bi() { // from class: com.kwad.components.ad.interstitial.f.a.b.4.1
                    ...
                    public final void doTask() {
                        ...
                        dVar.auk = aq.isWifiConnected(b.this.getContext()) || b.this.mN.ce.isDataFlowAutoStart() || b.y(b.this.mN.mAdTemplate);
                        cVar.b(dVar);
                    }
                }, 0L);
            }
                ...
                if (b.this.mN.lx != null) {
                    b.this.mN.gp.post(new bi() { // from class: com.kwad.components.ad.interstitial.f.a.b.5.1
                        ...
                        public final void doTask() throws Throwable {
                            ...
                            c cVar = b.this.mN;
                            ak.a aVar2 = aVar;
                            cVar.a(aVar2.type == 3, aVar2.aqL, null);
                            b.this.eC();
                        }
                    });
                }
    ...
    private aq.a getOpenNewPageListener() {
        return new aq.a() { // from class: com.kwad.components.ad.interstitial.f.a.b.8
            ...
            public final void a(com.kwad.components.core.webview.a.b bVar) {
                AdWebViewActivityProxy.launch(b.this.getContext(), new AdWebViewActivityProxy.a.C0548a().aY(bVar.title).aZ(bVar.url).aQ(true).q(b.this.mN.mAdResultData).ua());
            }
        };
    }
    ...
    public final void onUnbind() {
        ...
        com.kwad.components.ad.interstitial.g.b bVar = this.mN.lq;
        if (bVar != null) {
            bVar.b(this.fF);
        }
        this.mN.b(this.nx);
    ...
    public void d(double d2) {
        this.mN.a(new c.C0478c(getContext()).m(true).c(d2).W(2).a(this.mN.gp.getTouchCoords()).X(157));
    ...
    public final void a(t tVar, com.kwad.sdk.core.webview.b bVar) {
        ...
        this.od = bVarM;
        if (bVarM != null) {
            bVarM.a(new b.InterfaceC0472b() { // from class: com.kwad.components.ad.interstitial.f.a.b.10
                @Override // com.kwad.components.ad.h.a.a.b.InterfaceC0472b
                public final void ab(int i2) {
                    if (i2 == com.kwad.components.ad.h.a.a.b.rg) {
        ...
        tVar.c(eQ());
        tVar.c(new com.kwad.components.core.webview.jshandler.aq(getOpenNewPageListener()));
        ...
        tVar.c(new q() { // from class: com.kwad.components.ad.interstitial.f.a.b.12
            ...
            public final void a(String str, @NonNull com.kwad.sdk.core.webview.c.c cVar) {
                super.a(str, cVar);
                com.kwad.components.core.t.n.i(b.this.getContext(), b.this.mN.mAdTemplate);
            }
        });
        this.oh = eL();
        this.mN.a(this.nx);
        ...
        tVar.c(new com.kwad.components.core.webview.tachikoma.b(new b.a() { // from class: com.kwad.components.ad.interstitial.f.a.b.13
            ...
            public final void eU() throws Throwable {
