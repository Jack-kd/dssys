...
public final class d extends KSFrameLayout implements com.kwad.sdk.widget.d {
    ...
    public d(@NonNull Context context, a aVar) {
        ...
        this.oW = false;
        this.oV = aVar;
        m.inflate(context, aVar.fs() ? R.layout.ksad_interstitial_native_above : R.layout.ksad_interstitial_native, this);
        t(aVar.oY);
    }

    private void e(View view, int i2) {
        com.kwad.sdk.c.a.a.c(view, 0, com.kwad.sdk.c.a.a.a(getContext(), i2), 0, 0);
    }

    private void fl() {
        a(this.oO, 40, 40);
        a(this.oS, MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE, 30);
    ...
    public final void b(boolean z2, int i2) {
        ...
        if (i2 >= 0) {
            this.oT.setText(String.format(this.oE, String.valueOf(i2)));
        }
    }
