...
public final class b extends j implements View.OnClickListener {
    ...
    public final void onActivityCreated(Bundle bundle) {
        ...
        if (cVar != null) {
            com.kwad.sdk.core.adlog.c.d(cVar.mAdTemplate, new JSONObject(), new com.kwad.sdk.core.adlog.c.b().ee(149).ej(9));
        }
    }
    ...
    public final void onClick(View view) {
        if (this.mN != null) {
            if (view.equals(this.ov)) {
                ...
                this.mN.lx.dismiss();
                com.kwad.sdk.core.adlog.c.e(this.mN.mAdTemplate, null, new com.kwad.sdk.core.adlog.c.b().ee(MediaPlayer.MEDIA_PLAYER_OPTION_GET_CONTAINER_FPS).ej(9));
            }
        }
        dismiss();
        oz = false;
