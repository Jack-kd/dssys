...
public final class a {
    ...
    private static n a(long j2, AdTemplate adTemplate, String str) {
        return new n(j2, adTemplate, str);
    }

    private static n b(long j2, AdTemplate adTemplate) {
        return new n(j2, adTemplate);
    }
    ...
    public final void bd(@NonNull AdTemplate adTemplate) {
        g.a(b(10007L, adTemplate));
    }

    public final void be(@NonNull AdTemplate adTemplate) {
        g.a(b(10208L, adTemplate));
    }

    public final void bf(@NonNull AdTemplate adTemplate) {
    ...
    public final void e(@NonNull JSONObject jSONObject, int i2) {
        n nVarS = S(10201L);
        ac.putValue(jSONObject, "appChangeType", i2);
        nVarS.aVP = jSONObject;
        g.a(nVarS);
    }

    public final void g(AdTemplate adTemplate, int i2, String str) {
    ...
    public final void h(@NonNull AdTemplate adTemplate, long j2) {
        n nVarB = b(10202L, adTemplate);
        nVarB.aVU = j2;
        g.a(nVarB);
    }

    public final void i(AdTemplate adTemplate, int i2) {
        n nVarB = b(10108L, adTemplate);
        nVarB.aVN = i2;
        g.a(nVarB);
    }

    public final void j(AdTemplate adTemplate, long j2) {
        n nVarB = b(10207L, adTemplate);
        nVarB.aWl = j2;
        g.a(nVarB);
    }

    public final void l(@NonNull AdTemplate adTemplate, int i2, int i3) {
    ...
    public final void m(@NonNull AdTemplate adTemplate, int i2, int i3) {
    ...
    public final void h(@NonNull AdTemplate adTemplate, int i2, String str) {
    ...
    public final void i(AdTemplate adTemplate, long j2) {
        n nVarB = b(10206L, adTemplate);
        nVarB.aWk = j2;
        g.a(nVarB);
    }

    public final void j(@NonNull AdTemplate adTemplate, int i2) {
        if (e.Kq()) {
