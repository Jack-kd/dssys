...
public final class a {
    ...
    public static void d(AdTemplate adTemplate, boolean z2) {
        try {
            InnerEcEvent innerEcEventCreateAdClickEvent = InnerEcEvent.createAdClickEvent(adTemplate);
            innerEcEventCreateAdClickEvent.clickUserNowCancel = z2;
    ...
    public static void f(AdTemplate adTemplate, int i2, String str) {
        try {
            InnerEcError innerEcErrorCreateCommonError = InnerEcError.createCommonError(adTemplate, 2);
            innerEcErrorCreateCommonError.errorCode = i2;
