...
import com.kwad.auth.login.KwadRouteHandlerActivity;
...
public class e {
    ...
    private void init() {
        ...
        if (!atomicBoolean2.get()) {
            if (bz.aE(((com.kwad.sdk.service.a.f) ServiceProvider.get(com.kwad.sdk.service.a.f.class)).getApiVersion(), "4.10.30")) {
                try {
                    int i2 = KwadRouteHandlerActivity.f31464b;
                    com.kwad.sdk.service.c.putComponentProxy(KwadRouteHandlerActivity.class, RouteHandlerActivityProxy.class);
    ...
    public final void b(InnerEcUserLoginBindInfo innerEcUserLoginBindInfo) throws Throwable {
