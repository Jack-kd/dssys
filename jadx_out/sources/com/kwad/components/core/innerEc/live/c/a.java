...
public final class a {
    ...
    private void j(Throwable th) {
        ...
        int i2 = serverExceptionL.errorCode;
        c.i("LiveExceptionService", "handleServerException errorCode: " + i2 + ", subCode" + serverExceptionL.subCode);
        ...
        if (i2 < 600 || i2 == 608 || TextUtils.isEmpty(serverExceptionL.errorMessage)) {
            return;
        }
        c.i("LiveExceptionService", "LIVE_START_PLAY_OVER_LOAD" + serverExceptionL.errorMessage);
    }
