...
public final class a extends h {
    ...
    private void initView() {
        ...
        this.afx = aVar;
        aVar.a(new a.InterfaceC0551a() { // from class: com.kwad.components.core.page.splitLandingPage.a.3
            @Override // com.kwad.components.core.page.splitLandingPage.view.a.InterfaceC0551a
        ...
        this.afv.setSplitScrollWebViewListener(new SplitScrollWebView.a() { // from class: com.kwad.components.core.page.splitLandingPage.a.5
            ...
            public final void g(float f2) {
                a.this.afv.setTranslationY(a.this.afv.getTranslationY() - f2);
            }
