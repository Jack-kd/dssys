...
public final class a {
    ...
    public final Animator aV(boolean z2) {
        AnimatorSet animatorSet = new AnimatorSet();
        animatorSet.playTogether(x.h(this.Dy, z2), x.h(this.ik, z2));
        return animatorSet;
    }
    ...
    public final boolean uS() {
        ...
        if (iT > iS) {
            ...
            rect.right = i2;
            rect.left = i2 - com.kwad.sdk.c.a.a.a(this.mContext, 86.0f);
            ...
            rect.right = i3;
            rect.left = i3 - com.kwad.sdk.c.a.a.a(this.mContext, 154.0f);
        ...
        rect.right = iA3;
        WindowManager.LayoutParams layoutParams = this.afH;
        ...
        layoutParams.width = (iA3 - i4) + com.kwad.sdk.c.a.a.a(this.mContext, 12.0f);
        ...
        this.Dy.setPivotX(f2);
        this.Dy.setPivotY(f3);
    ...
    private void c(@NonNull KsAdVideoPlayConfig ksAdVideoPlayConfig) {
        ...
        this.afG.setVideoPlayCallback(new a.c() { // from class: com.kwad.components.core.page.splitLandingPage.view.a.4
