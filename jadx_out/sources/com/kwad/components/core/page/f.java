...
public final class f extends com.kwad.components.core.n.d<com.kwad.components.core.page.d.a.b> implements YodaWebPageListener {
    ...
    private void b(com.kwad.components.core.b.b bVar) {
        T t2 = this.abm;
        if (t2 == 0 || ((com.kwad.components.core.page.d.a.b) t2).aeg == null) {
            return;
        }
        ((com.kwad.components.core.page.d.a.b) t2).aeg.a(bVar);
    }
    ...
    public final boolean onKey(View view, int i2, KeyEvent keyEvent) {
        com.kwad.sdk.core.d.c.w("MerchantLandingPageView", "onKey " + i2 + " " + keyEvent.getAction());
        return false;
    }
    ...
    public final void onVisibleChange(boolean z2) {
        com.kwad.sdk.core.d.c.w("MerchantLandingPageView", "onVisibleChange " + z2);
    }
