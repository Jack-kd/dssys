...
public class AdWebViewVideoActivityProxy extends i {
    ...
    private com.kwad.components.core.page.widget.a buildDialog() {
        return new com.kwad.components.core.page.widget.a(getActivity(), new a.InterfaceC0552a() { // from class: com.kwad.components.core.page.AdWebViewVideoActivityProxy.4
    ...
    public a.C0529a getAdClickConfig(boolean z2) {
        return new a.C0529a(getActivity()).as(z2).ax(true).at(false).aJ(this.mAdTemplate).av(false);
    }
    ...
    private void initView() throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        ...
        if (com.kwad.sdk.core.response.helper.a.aL(adInfoEO)) {
            ...
            this.mApkDownloadHelper = new com.kwad.components.core.e.d.d(this.mAdTemplate, new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.core.page.AdWebViewVideoActivityProxy.1
                ...
                public final void onPaused(int i2) {
                    ...
                    AdWebViewVideoActivityProxy.this.mProgressbar.setText(com.kwad.sdk.core.response.helper.a.eG(i2));
                }

                @Override // com.kwad.sdk.api.KsAppDownloadListener
                public final void onProgressUpdate(int i2) {
                    AdWebViewVideoActivityProxy.this.mProgressbar.setProgress(i2);
                    AdWebViewVideoActivityProxy.this.mProgressbar.setText(com.kwad.sdk.core.response.helper.a.eF(i2));
                }
            });
        ...
        String strCs = (list == null || list.size() <= 0 || this.mAdTemplate.adInfoList.get(0) == null) ? "详情页面" : com.kwad.sdk.core.response.helper.a.cs(com.kwad.sdk.core.response.helper.e.eO(this.mAdTemplate));
        ...
        aVar.a(new a.InterfaceC0518a() { // from class: com.kwad.components.core.page.AdWebViewVideoActivityProxy.3
        ...
        if (com.kwad.sdk.core.config.e.Jk() != 0) {
            ...
            getSupportFragmentManager().beginTransaction().replace(i2, this.mSplitLandingPage).commitAllowingStateLoss();
            return;
        }
