...
import com.kwad.components.core.page.widget.a.c;
...
public final class a extends b {
    ...
    public void by(int i2) {
        ...
        if (getView() == null || i2 < 0 || (viewFindViewById = getView().findViewById(R.id.ksad_half_bottom_container)) == null) {
            return;
        }
        viewFindViewById.setPadding(0, 0, 0, i2);
    }
    ...
    public void h(float f2) {
        if (getView() != null) {
            ...
            if (frameLayout instanceof RoundCornerNewLayout) {
                ((RoundCornerNewLayout) frameLayout).setTopRadius(f2 < 1.0f ? com.kwad.sdk.c.a.a.a(getView().getContext(), this.agm.ahA) : 0);
            }
        }
    }
                ...
                if (frameLayout != null) {
                    ...
                    this.agl.a(new c.a() { // from class: com.kwad.components.core.page.widget.a.a.3
                        ...
                        public final void bA(int i2) {
                            ...
                            a aVar = a.this;
                            if (aVar.agD instanceof h) {
                                aVar.vb();
                            }
                            if (a.this.agr != null && i2 != 1) {
                                h unused = a.this.agr;
                            }
                            if (i2 != 1) {
                                a.this.ago = i2;
    ...
    public final void onCreate(@Nullable Bundle bundle) {
        ...
        j(this.agm.ahz);
        Map<String, String> map = this.agm.ahH;
        if (map != null) {
            this.ags = map.get("merchantLaunchToken");
        }
    }
