...
public class a extends com.kwad.sdk.core.video.videoview.b implements View.OnClickListener {
    ...
    public a(Context context, @NonNull AdTemplate adTemplate, @NonNull com.kwad.sdk.core.video.videoview.c cVar) {
        ...
        this.amu = new com.kwad.sdk.core.download.a.a() { // from class: com.kwad.components.core.video.a.1
            ...
            public final void onDownloadFailed() {
                a aVar = a.this;
                aVar.amp.setText(com.kwad.sdk.core.response.helper.a.aK(aVar.mAdInfo));
            }

            @Override // com.kwad.sdk.api.KsAppDownloadListener
            public final void onDownloadFinished() {
                a aVar = a.this;
                aVar.amp.setText(com.kwad.sdk.core.response.helper.a.cK(aVar.mAdTemplate));
            }
            ...
            public final void onInstalled() {
                a aVar = a.this;
                aVar.amp.setText(com.kwad.sdk.core.response.helper.a.af(aVar.mAdInfo));
            }
            ...
            public final void onProgressUpdate(int i2) {
                a.this.amp.setText(com.kwad.sdk.core.response.helper.a.eF(i2));
            }
        };
    ...
    private void bY(int i2) {
        try {
            InterfaceC0559a interfaceC0559a = this.amr;
            if (interfaceC0559a != null) {
                interfaceC0559a.a(i2, this.amh.getTouchCoords());
            }
        } catch (Throwable th) {
    ...
    public void setAdClickListener(InterfaceC0559a interfaceC0559a) {
        this.amr = interfaceC0559a;
    }
