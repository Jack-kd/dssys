...
public final class l implements IOfflineHostApi {
    ...
    @Override // com.kwad.components.offline.api.core.IOfflineHostApi
    public final void adLiveErrorReport(int i2, String str, String str2, Long l2, int i3, String str3) {
        if (l2 == null) {
            l2 = -1L;
        }
        com.kwad.sdk.commercial.c.d(com.kwad.sdk.commercial.d.In().m57do(ILoggerReporter.Category.ERROR_LOG).g(1.0d).Q("ad_sdk_live_video_error_monitor", "status").b(BusinessType.OTHER).A(new AdLivePlayMonitorInfo().setScene(i2).setAppId(str).setAuthorId(str2).setUserId(l2).setErrorCode(i3).setErrorMsg(str3)).a(com.kwai.adclient.kscommerciallogger.model.b.buV));
    }
    ...
    public final IBundleService bundleService() {
        return new IBundleService() { // from class: com.kwad.components.core.offline.b.a.l.4
            ...
            public final void loadBundle(Context context, String str, final IBundleLoadListener iBundleLoadListener) {
                com.kwad.components.core.webview.tachikoma.g.yH().b(context, str, new g.b() { // from class: com.kwad.components.core.offline.b.a.l.4.1
            ...
            public final void loadBundleWithString(Context context, String str, final IBundleLoadListener iBundleLoadListener) {
                com.kwad.components.core.webview.tachikoma.g.yH().a(context, str, new g.b() { // from class: com.kwad.components.core.offline.b.a.l.4.2
                    @Override // com.kwad.components.core.webview.tachikoma.g.b
                    public final void onFailed(String str2) {
                        IBundleLoadListener iBundleLoadListener2 = iBundleLoadListener;
                        if (iBundleLoadListener2 != null) {
                    ...
                    com.kwad.sdk.service.d.a(new com.kwad.sdk.service.a.g() { // from class: com.kwad.components.core.offline.b.a.l.1.2
                        ...
                        public final void p(int i2, String str) {
                            ...
                            if (iCrashOccurListener2 != null) {
                                iCrashOccurListener2.onCrashOccur(i2, str);
                            }
                        }
                    });
                }
    ...
    public final PackageInfo getPackageInfo(Context context, String str, int i2) {
        return aa.getPackageInfo(context, str, i2);
    }

    @Override // com.kwad.components.offline.api.core.IOfflineHostApi
    public final long getSystemTimeInMs(Context context, boolean z2) {
        return bv.C(context, z2);
    }
    ...
    @Override // com.kwad.components.offline.api.core.IOfflineHostApi
    public final void saveTKTemplateCache(String str, int i2, String str2) {
        com.kwad.components.core.webview.tachikoma.h.yK().b(str, i2, str2);
    }
