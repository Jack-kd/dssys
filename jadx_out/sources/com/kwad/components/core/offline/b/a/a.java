...
public final class a implements IAdInnerEcHostProvider {
    private static void a(Activity activity, String str) {
        ...
        if (str.contains("kwaishop-c-pay-result")) {
            PayResultActivityProxy.launch(activity, new AdWebViewActivityProxy.a.C0548a().aZ(str).bv(2).ua());
        } else {
            WebPageActivityProxy.launch(activity, new AdWebViewActivityProxy.a.C0548a().aZ(str).bv(2).ua());
        }
    }
    ...
    public static boolean h(Context context, String str) {
        ...
        if (!str.startsWith("kwaimerchant://openhalfweb")) {
            if (str.startsWith(com.anythink.core.basead.a.e.f1620e)) {
    ...
    @Override // com.kwad.components.offline.api.core.adInnerEc.IAdInnerEcHostProvider
    public final Intent createIntentWithAnyUri(Context context, Uri uri, boolean z2, boolean z3) {
        return null;
    }
    ...
    @Override // com.kwad.components.offline.api.core.adInnerEc.IAdInnerEcHostProvider
    public final boolean getBooleanConfig(String str, boolean z2) {
        return com.kwad.sdk.core.config.e.f(str, z2);
    }
    ...
    public final String getMerchantVersion() {
        return com.kwad.sdk.core.config.e.KT() ? "1.1.0" : "1.0.0";
    }
    ...
    @Override // com.kwad.components.offline.api.core.adInnerEc.IAdInnerEcHostProvider
    public final void startMerchantPay(Activity activity, boolean z2, String str, String str2, final IHostPayResultListener iHostPayResultListener) {
        ...
        com.kwad.components.core.innerEc.f.a(activity, str, str2, new ResultReceiver(new Handler(Looper.getMainLooper())) { // from class: com.kwad.components.core.offline.b.a.a.1
            ...
            public final void onReceiveResult(int i2, Bundle bundle) {
                com.kwad.sdk.core.d.c.d("AdInnerEcHostProviderImpl", "startMerchantPay onReceiveResult resultCode: " + i2);
                q qVarA = q.a(bundle);
                ...
                if (iHostPayResultListener5 != null) {
                    iHostPayResultListener5.onPayFailure(String.valueOf(i2));
                }
                com.kwad.components.core.innerEc.logger.a.a(com.kwad.components.core.e.d.a.QJ, qVarA);
            }
        });
