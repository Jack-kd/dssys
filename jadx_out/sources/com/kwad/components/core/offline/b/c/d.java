...
public final class d {
    public static com.kwad.sdk.contentalliance.a.a.b a(PlayVideoInfo playVideoInfo) {
        ...
        return new b.a(playVideoInfo.videoUrl).dR(playVideoInfo.manifest).b(a(playVideoInfo.ksplayerLogParams)).a(playVideoInfo.videoPlayerStatus).bD(playVideoInfo.isNoCache).IG();
    }
    ...
    public static l a(final OfflineVideoPlayStateListener offlineVideoPlayStateListener) {
        ...
        return new l() { // from class: com.kwad.components.core.offline.b.c.d.11
            ...
            public final void onMediaPlayError(int i2, int i3) {
                offlineVideoPlayStateListener.onMediaPlayError(i2, i3);
            }
            ...
            public final void onMediaPlayProgress(long j2, long j3) {
                offlineVideoPlayStateListener.onMediaPlayProgress(j2, j3);
            }
    ...
    public static i a(final OfflineMediaPlayStateListener offlineMediaPlayStateListener) {
        ...
        return new i() { // from class: com.kwad.components.core.offline.b.c.d.2
            ...
            @Override // com.kwad.components.core.video.i
            public final void onMediaPlayError(int i2, int i3) {
                offlineMediaPlayStateListener.onMediaPlayError(i2, i3);
            }
            ...
            @Override // com.kwad.components.core.video.i
            public final void onMediaPlayProgress(long j2, long j3) {
                offlineMediaPlayStateListener.onMediaPlayProgress(j2, j3);
            }
