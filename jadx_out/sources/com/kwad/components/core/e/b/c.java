...
public final class c {
    ...
    private static long c(int i2, int[] iArr, long j2) {
        ...
        return ((i2 + 1) ^ (j3 ^ j4)) | ((j2 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 16) | (f(i2, iArr, j4) << 48) | (j5 << 32);
    }
    ...
    private static long d(int i2, int[] iArr, long j2) {
        ...
        return (((i2 + 1) ^ (f(i2, iArr, j4) ^ j5)) << 32) | (f(i2, iArr, j4) << 48) | (j6 << 16) | j3;
    }
    ...
    private static long e(int i2, int[] iArr, long j2) {
        ...
        return ((i10 ^ iArr2[(i4 ^ iArr2[i10 ^ i7]) ^ i8]) << 8) | (iArr2[i9 ^ r7] ^ r6);
    }
    ...
    private static long f(int i2, int[] iArr, long j2) {
        ...
        int[] iArr2 = b.Qt;
        int i10 = iArr2[i6 ^ i4] ^ i3;
        return ((iArr2[i9 ^ r7] ^ r6) << 8) | (i10 ^ iArr2[(i4 ^ iArr2[i10 ^ i7]) ^ i8]);
    }

    public final String C(long j2) {
        return com.kwad.sdk.core.a.c.LO().encodeToString(ByteBuffer.allocate(8).putLong(a(j2, this.Qu)).array());
    }
    ...
    private static long b(int i2, int[] iArr, long j2) {
        long j3 = j2 >>> 48;
        long j4 = (j2 >> 32) & WebSocketProtocol.PAYLOAD_SHORT_MAX;
        return (((i2 + 1) ^ (j3 ^ j4)) << 16) | ((j2 & WebSocketProtocol.PAYLOAD_SHORT_MAX) << 48) | (e(i2, iArr, j3) << 32) | ((j2 >> 16) & WebSocketProtocol.PAYLOAD_SHORT_MAX);
    }

    private static long a(int i2, int[] iArr, long j2) {
        long j3 = j2 >>> 48;
        long j4 = (j2 >> 32) & WebSocketProtocol.PAYLOAD_SHORT_MAX;
        return (e(i2, iArr, j3) << 32) | ((((j2 & WebSocketProtocol.PAYLOAD_SHORT_MAX) ^ e(i2, iArr, j3)) ^ (i2 + 1)) << 48) | (j4 << 16) | ((j2 >> 16) & WebSocketProtocol.PAYLOAD_SHORT_MAX);
    }
}
