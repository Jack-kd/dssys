...
public class a extends com.kwad.sdk.core.network.d {
    ...
    private static void a(com.kwad.sdk.core.request.model.g gVar, AdLabelImpl adLabelImpl) {
        int i2 = adLabelImpl.thirdAge;
        if (i2 != 0) {
            gVar.thirdAge = i2;
        }
        int i3 = adLabelImpl.thirdGender;
        if (i3 != 0) {
            gVar.thirdGender = i3;
        }
    ...
    public a(ImpInfo impInfo, @Nullable List<String> list, boolean z2, com.kwad.components.core.request.model.c cVar) throws JSONException {
