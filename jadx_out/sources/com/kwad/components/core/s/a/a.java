...
public class a extends com.kwad.components.core.n.b<b> {
    ...
    private static void bX(int i2) {
        Map<String, Object> map = akU.get(Integer.valueOf(i2));
        if (map != null) {
            map.clear();
        }
    }
    ...
    private static Object s(int i2, String str) {
        Map<String, Object> map = akU.get(Integer.valueOf(i2));
        if (map != null) {
            return map.get(str);
        }
    ...
    public void initData() {
        ...
        this.akO = getIntent().getStringExtra(g.a.f3271h);
    ...
    public void initView() {
        ...
        aVar.a(new a.InterfaceC0518a() { // from class: com.kwad.components.core.s.a.a.1
