...
public final class a extends e implements h {
    ...
    private void ao(Context context) {
        ...
        com.kwad.sdk.core.f.c.a(context, new com.kwad.sdk.core.f.a() { // from class: com.kwad.components.core.f.a.1
            ...
            public final void aw(String str) throws Throwable {
    ...
    public void au(String str) throws Throwable {
    ...
    public final void F(long j2) throws Throwable {
        if (this.mContext == null || j2 <= 0 || j2 == qT()) {
            return;
        }
        this.RV = j2;
        ai.d(this.mContext, j2);
    }
