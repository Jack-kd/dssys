...
public final class TkLoggerReporter {
    ...
    public final void reportTKDownload(String str, JSONObject jSONObject) {
        OfflineHostProvider.getApi().loggerReporter().reportEvent(d.In().m57do(str).g(0.1d).Q("ad_tk_download_performance", "download_state").i(jSONObject));
    }

    public final void reportTKPerform(String str, JSONObject jSONObject) {
        OfflineHostProvider.getApi().loggerReporter().reportEvent(d.In().m57do(str).g(0.1d).i(0.001d).Q("ad_tk_render_performance", "render_state").i(jSONObject));
    }

    public final void reportTKSODownload(String str, JSONObject jSONObject) {
        OfflineHostProvider.getApi().loggerReporter().reportEvent(d.In().m57do(str).g(0.1d).Q("ad_tk_so_download_event", "download_state").i(jSONObject));
    }

    public final void reportTKSOLoad(String str, JSONObject jSONObject) {
        OfflineHostProvider.getApi().loggerReporter().reportEvent(d.In().m57do(str).g(0.1d).Q("ad_tk_so_load_performence", "download_state").i(jSONObject));
    }
