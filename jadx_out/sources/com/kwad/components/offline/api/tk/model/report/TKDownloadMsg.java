...
public class TKDownloadMsg extends BaseOfflineCompoJsonParse<TKDownloadMsg> implements Serializable {
    ...
    public TKDownloadMsg setInitSdkTimeConsuming(long j2) {
    ...
    public TKDownloadMsg setThreadPoolCoreSize(int i2) {
    ...
    public void parseJson(TKDownloadMsg tKDownloadMsg, JSONObject jSONObject) {
        ...
        tKDownloadMsg.retryCount = jSONObject.optInt(n.b.f3359h);
    ...
    public JSONObject toJson(TKDownloadMsg tKDownloadMsg, JSONObject jSONObject) throws JSONException {
        ...
        if (i3 != 0) {
            JsonHelper.putValue(jSONObject, n.b.f3359h, i3);
        }
