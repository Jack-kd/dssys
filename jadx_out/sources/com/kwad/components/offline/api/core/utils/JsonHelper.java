...
public class JsonHelper {
    ...
    public static void putValue(JSONObject jSONObject, String str, double d2) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, int i2) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, float f2) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, byte b3) throws JSONException {
        try {
            jSONObject.put(str, (int) b3);
        } catch (JSONException unused) {
        }
    }
    ...
    public static void putValue(JSONObject jSONObject, String str, long j2) throws JSONException {
        try {
    ...
    public static void putValue(JSONObject jSONObject, String str, boolean z2) throws JSONException {
