...
public interface IOfflineHostApi {
    void adLiveErrorReport(int i2, String str, String str2, Long l2, int i3, String str3);
    ...
    PackageInfo getPackageInfo(Context context, String str, int i2);

    long getSystemTimeInMs(Context context, boolean z2);
    ...
    void saveTKTemplateCache(String str, int i2, String str2);
