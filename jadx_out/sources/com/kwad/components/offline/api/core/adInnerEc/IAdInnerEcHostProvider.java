...
public interface IAdInnerEcHostProvider {
    ...
    Intent createIntentWithAnyUri(Context context, Uri uri, boolean z2, boolean z3);
    ...
    void startMerchantPay(Activity activity, boolean z2, String str, String str2, IHostPayResultListener iHostPayResultListener);
