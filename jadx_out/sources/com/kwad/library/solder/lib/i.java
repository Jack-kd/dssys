...
public final class i {
    ...
    private static ExecutorService df(int i2) {
    ...
    private synchronized void init(Context context) {
        try {
            ...
            c.a aVarCI = new c.a().cI("sodler");
            a aVar = aEA;
            c.a aVarBz = aVarCI.di(aVar != null ? aVar.getMaxRetryCount() : 1).bz(false);
            a aVar2 = aEA;
            c.a aVarBA = aVarBz.bA(aVar2 != null && aVar2.DT());
            a aVar3 = aEA;
            c.a aVarA = aVarBA.a(df(aVar3 != null ? aVar3.getCorePoolSize() : 0));
            a aVar4 = aEA;
    ...
    public final <P extends com.kwad.library.solder.lib.a.a, R extends com.kwad.library.solder.lib.a.e<P>> void a(Context context, @NonNull R r2, com.kwad.library.solder.lib.ext.b<P, R> bVar) {
        init(context);
        r2.dh(this.aEy.DK().getRetryCount());
        r2.a(new b<P, R>(bVar, new b.C0592b()) { // from class: com.kwad.library.solder.lib.i.3
