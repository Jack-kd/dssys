...
public class YogaNative {
    static {
        eb.hp("tt_ugen_layout");
    }

    public static native void jni_YGConfigFreeJNI(long j2);

    public static native int jni_YGConfigGetErrataJNI(long j2);

    public static native long jni_YGConfigNewJNI();

    public static native void jni_YGConfigSetErrataJNI(long j2, int i2);

    public static native void jni_YGConfigSetExperimentalFeatureEnabledJNI(long j2, int i2, boolean z2);
    ...
    public static native void jni_YGConfigSetUseWebDefaultsJNI(long j2, boolean z2);
    ...
    public static native void jni_YGNodeFinalizeJNI(long j2);
    ...
    public static native void jni_YGNodeRemoveAllChildrenJNI(long j2);

    public static native void jni_YGNodeRemoveChildJNI(long j2, long j3);

    public static native void jni_YGNodeResetJNI(long j2);

    public static native void jni_YGNodeSetAlwaysFormsContainingBlockJNI(long j2, boolean z2);

    public static native void jni_YGNodeSetHasBaselineFuncJNI(long j2, boolean z2);

    public static native void jni_YGNodeSetHasMeasureFuncJNI(long j2, boolean z2);

    public static native void jni_YGNodeSetIsReferenceBaselineJNI(long j2, boolean z2);

    public static native void jni_YGNodeSetStyleInputsJNI(long j2, float[] fArr, int i2);
    ...
    public static native int jni_YGNodeStyleGetBoxSizingJNI(long j2);
    ...
    public static native float jni_YGNodeStyleGetGapJNI(long j2, int i2);
    ...
    public static native void jni_YGNodeStyleSetBoxSizingJNI(long j2, int i2);
    ...
    public static native void jni_YGNodeStyleSetGapJNI(long j2, int i2, float f2);

    public static native void jni_YGNodeStyleSetGapPercentJNI(long j2, int i2, float f2);
    ...
    public static native void jni_YGNodeStyleSetPositionAutoJNI(long j2, int i2);
