...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
        ...
        if (!cls.isInterface()) {
            ...
            while (rawType != Object.class) {
                ...
                while (i2 < length) {
                    ...
                    boolean zExcludeField2 = reflectiveTypeAdapterFactory2.excludeField(field, z2);
                    if (zExcludeField || zExcludeField2) {
                        ...
                        for (?? r13 = z2; r13 < size; r13++) {
                            ...
                            boolean z3 = zExcludeField;
                            BoundField boundField3 = (BoundField) linkedHashMap.put(str, reflectiveTypeAdapterFactory3.createBoundField(gson, field, str, TypeToken.get(typeResolve), z3, zExcludeField2));
                            if (boundField2 != null) {
    ...
    public static boolean excludeField(Field field, boolean z2, Excluder excluder) {
