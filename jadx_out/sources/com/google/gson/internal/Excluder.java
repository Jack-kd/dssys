...
public final class Excluder implements TypeAdapterFactory, Cloneable {
    ...
    public Excluder disableInnerClassSerialization() {
        Excluder excluderM50clone = m50clone();
        excluderM50clone.serializeInnerClasses = false;
        return excluderM50clone;
    }
    ...
    public Excluder excludeFieldsWithoutExposeAnnotation() {
        Excluder excluderM50clone = m50clone();
        excluderM50clone.requireExpose = true;
        return excluderM50clone;
    }
    ...
    public Excluder withExclusionStrategy(ExclusionStrategy exclusionStrategy, boolean z2, boolean z3) {
        ...
        if (z2) {
            ...
            excluderM50clone.serializationStrategies = arrayList;
            arrayList.add(exclusionStrategy);
        }
        if (z3) {
            ArrayList arrayList2 = new ArrayList(this.deserializationStrategies);
            excluderM50clone.deserializationStrategies = arrayList2;
    ...
    public Excluder withModifiers(int... iArr) {
        Excluder excluderM50clone = m50clone();
        excluderM50clone.modifiers = 0;
        for (int i2 : iArr) {
            excluderM50clone.modifiers = i2 | excluderM50clone.modifiers;
        }
        return excluderM50clone;
    }
