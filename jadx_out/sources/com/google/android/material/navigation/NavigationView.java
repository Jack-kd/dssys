...
public class NavigationView extends ScrimInsetsFrameLayout {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (mode == Integer.MIN_VALUE) {
            i2 = View.MeasureSpec.makeMeasureSpec(Math.min(View.MeasureSpec.getSize(i2), this.maxWidth), C.ENCODING_PCM_32BIT);
        } else if (mode == 0) {
            i2 = View.MeasureSpec.makeMeasureSpec(this.maxWidth, C.ENCODING_PCM_32BIT);
        }
