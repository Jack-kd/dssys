...
public class MaterialRadioButton extends AppCompatRadioButton {
    ...
    public MaterialRadioButton(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        super(ThemeEnforcement.createThemedContext(context, attributeSet, i2, i3), attributeSet, i2);
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(getContext(), attributeSet, R.styleable.MaterialRadioButton, i2, i3, new int[0]);
