...
class MaterialButtonHelper {
    ...
    private MaterialShapeDrawable getMaterialShapeDrawable(boolean z2) {
        ...
        return IS_LOLLIPOP ? (MaterialShapeDrawable) ((LayerDrawable) ((InsetDrawable) this.rippleDrawable.getDrawable(0)).getDrawable()).getDrawable(!z2 ? 1 : 0) : (MaterialShapeDrawable) this.rippleDrawable.getDrawable(!z2 ? 1 : 0);
    }
