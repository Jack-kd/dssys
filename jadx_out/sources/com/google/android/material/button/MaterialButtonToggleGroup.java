...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public class CheckedStateTracker implements MaterialButton.OnCheckedChangeListener {
        ...
        public void onCheckedChanged(@NonNull MaterialButton materialButton, boolean z2) {
            ...
            MaterialButtonToggleGroup.this.dispatchOnButtonChecked(materialButton.getId(), z2);
            MaterialButtonToggleGroup.this.updateCheckedStates(materialButton.getId(), z2);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void updateCheckedStates(int i2, boolean z2) {
        for (int i3 = 0; i3 < getChildCount(); i3++) {
            MaterialButton childButton = getChildButton(i3);
            if (childButton.isChecked() && this.singleSelection && z2 && childButton.getId() != i2) {
    ...
    public MaterialButtonToggleGroup(@NonNull Context context, @Nullable AttributeSet attributeSet, int i2) {
        ...
        this.skipCheckedStateTracker = false;
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, R.styleable.MaterialButtonToggleGroup, i2, R.style.Widget_MaterialComponents_MaterialButtonToggleGroup, new int[0]);
