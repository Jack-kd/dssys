...
public class CollapsingToolbarLayout extends FrameLayout {
    ...
    public void onLayout(boolean z2, int i2, int i3, int i4, int i5) {
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            ...
            if (z3) {
                ...
                this.collapsingTextHelper.setCollapsedBounds(this.tmpRect.left + (z4 ? this.toolbar.getTitleMarginEnd() : this.toolbar.getTitleMarginStart()), this.tmpRect.top + maxOffsetForPinChild + this.toolbar.getTitleMarginTop(), this.tmpRect.right + (z4 ? this.toolbar.getTitleMarginStart() : this.toolbar.getTitleMarginEnd()), (this.tmpRect.bottom + maxOffsetForPinChild) - this.toolbar.getTitleMarginBottom());
    ...
    public void onMeasure(int i2, int i3) {
        ...
        super.onMeasure(i2, View.MeasureSpec.makeMeasureSpec(getMeasuredHeight() + systemWindowInsetTop, C.ENCODING_PCM_32BIT));
    }
