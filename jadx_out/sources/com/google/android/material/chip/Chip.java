...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable {
    ...
    private void initMinTouchTarget(Context context, @Nullable AttributeSet attributeSet, int i2) {
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, com.google.android.material.R.styleable.Chip, i2, com.google.android.material.R.style.Widget_MaterialComponents_Chip_Action, new int[0]);
    ...
    */
    ...
    public Chip(Context context, AttributeSet attributeSet, int i2) {
        ...
        initMinTouchTarget(context, attributeSet, i2);
