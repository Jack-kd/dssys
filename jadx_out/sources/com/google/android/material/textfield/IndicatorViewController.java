...
final class IndicatorViewController {
    ...
    private void updateCaptionViewsVisibility(final int i2, final int i3, boolean z2) {
        ...
        if (z2) {
            ...
            indicatorViewController.createCaptionAnimators(arrayList, this.helperTextEnabled, this.helperTextView, 2, i2, i3);
            indicatorViewController.createCaptionAnimators(arrayList, indicatorViewController.errorEnabled, indicatorViewController.errorView, 1, i2, i3);
        ...
        indicatorViewController.textInputView.updateLabelState(z2);
