...
public class ShapePath {
    ...
    public static class LineShadowOperation extends ShadowCompatOperation {
        ...
        @Override // com.google.android.material.shape.ShapePath.ShadowCompatOperation
        public void draw(Matrix matrix, @NonNull ShadowRenderer shadowRenderer, int i2, @NonNull Canvas canvas) {
            RectF rectF = new RectF(0.0f, 0.0f, (float) Math.hypot(this.operation.f30753y - this.startY, this.operation.f30752x - this.startX), 0.0f);
        ...
        public float getAngle() {
            return (float) Math.toDegrees(Math.atan((this.operation.f30753y - this.startY) / (this.operation.f30752x - this.startX)));
        }
    }
    ...
    public static class PathLineOperation extends PathOperation {
        ...
        private float f30752x;

        /* renamed from: y, reason: collision with root package name */
        private float f30753y;
        ...
        public void applyToPath(@NonNull Matrix matrix, @NonNull Path path) {
            ...
            matrix.invert(matrix2);
            path.transform(matrix2);
            path.lineTo(this.f30752x, this.f30753y);
            path.transform(matrix);
        }
    }
    ...
    public ShadowCompatOperation createShadowCompatOperation(final Matrix matrix) {
        ...
        return new ShadowCompatOperation() { // from class: com.google.android.material.shape.ShapePath.1
            ...
            public void draw(Matrix matrix2, ShadowRenderer shadowRenderer, int i2, Canvas canvas) {
                ...
                while (it.hasNext()) {
                    ((ShadowCompatOperation) it.next()).draw(matrix, shadowRenderer, i2, canvas);
                }
            }
        };
    }
    ...
    public void lineTo(float f2, float f3) {
        ...
        pathLineOperation.f30752x = f2;
        pathLineOperation.f30753y = f3;
