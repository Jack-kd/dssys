...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
    ...
    public void onMeasure(int i2, int i3) {
        ...
        int childCount = getChildCount();
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.itemHeight, C.ENCODING_PCM_32BIT);
        if (isShifting(this.labelVisibilityMode, size2) && this.itemHorizontalTranslationEnabled) {
            ...
            int i5 = size - iMin;
            int iMin2 = Math.min(i5 / (i4 != 0 ? i4 : 1), this.inactiveItemMaxWidth);
            int i6 = i5 - (i4 * iMin2);
            int i7 = 0;
            while (i7 < childCount) {
                if (getChildAt(i7).getVisibility() != 8) {
                    int[] iArr = this.tempChildWidths;
                    int i8 = i7 == this.selectedItemPosition ? iMin : iMin2;
                    iArr[i7] = i8;
                    if (i6 > 0) {
                        iArr[i7] = i8 + 1;
                        i6--;
        ...
        for (int i11 = 0; i11 < childCount; i11++) {
            ...
            if (childAt2.getVisibility() != 8) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec(this.tempChildWidths[i11], C.ENCODING_PCM_32BIT), iMakeMeasureSpec);
                childAt2.getLayoutParams().width = childAt2.getMeasuredWidth();
                measuredWidth += childAt2.getMeasuredWidth();
            }
        }
        setMeasuredDimension(View.resolveSizeAndState(measuredWidth, View.MeasureSpec.makeMeasureSpec(measuredWidth, C.ENCODING_PCM_32BIT), 0), View.resolveSizeAndState(this.itemHeight, iMakeMeasureSpec, 0));
    }
