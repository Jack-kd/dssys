...
public class MsaClient {
    ...
    public String getAAID() {
        return (String) Utils.rL(new Object[]{this, Integer.valueOf(TTVideoEngine.PLAYER_BUFFERING_DATA_OF_MILLISECONDS), 1606976968590L});
    }
    ...
    public String getVAID() {
        return (String) Utils.rL(new Object[]{this, Integer.valueOf(UMErrorCode.E_UM_BE_EMPTY_URL_PATH), 1606976968593L});
    }

    public boolean isSupported() {
        return ((Boolean) Utils.rL(new Object[]{this, Integer.valueOf(UMErrorCode.E_UM_BE_ERROR_WORK_MODE), 1606976968594L})).booleanValue();
    }
