...
public class ZteProvider extends BaseProvider {
    ...
    public static /* synthetic */ boolean access$002(ZteProvider zteProvider, boolean z2) {
    ...
    public static /* synthetic */ MsaClient access$100(ZteProvider zteProvider) {
        ...
        objArr[1] = zteProvider;
        objArr[2] = Integer.valueOf(WebSocketProtocol.PAYLOAD_SHORT);
    ...
    public void doStart() {
        Utils.rL(new Object[]{this, Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE), 1606976968602L});
    }
    ...
    public void shutDown() {
        Utils.rL(new Object[]{this, Integer.valueOf(MediaPlayer.MEDIA_PLAYER_OPTION_MEDIA_CODEC_SIDE_DATA), 1606976968604L});
    }
}
