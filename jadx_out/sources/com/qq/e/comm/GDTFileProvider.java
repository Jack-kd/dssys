...
public class GDTFileProvider extends ContentProvider {
    ...
    private static final String[] f35298b = {"_display_name", "_size"};

    /* renamed from: c, reason: collision with root package name */
    private static final File f35299c = new File(File.separator);

    /* renamed from: d, reason: collision with root package name */
    private static HashMap<String, a> f35300d = new HashMap<>();
    ...
    public static class b implements a {
        ...
        /* renamed from: b, reason: collision with root package name */
        private final HashMap<String, File> f35303b = new HashMap<>();
        ...
        public void a(String str, File file) throws IOException {
            ...
            try {
                this.f35303b.put(str, file.getCanonicalFile());
        ...
        public File a(Uri uri) throws IOException {
            ...
            File file = this.f35303b.get(strDecode);
            if (file == null) {
        ...
        public Uri a(File file) throws IOException {
            try {
                ...
                for (Map.Entry<String, File> entry2 : this.f35303b.entrySet()) {
                ...
                return new Uri.Builder().scheme("content").authority(this.f35302a).encodedPath(Uri.encode(entry.getKey()) + '/' + Uri.encode(canonicalPath.substring(length), ServiceReference.DELIMITER)).build();
            } catch (IOException unused) {
    ...
    private static a b(Context context, String str) {
        a aVarC;
        synchronized (f35300d) {
            try {
                aVarC = f35300d.get(str);
                if (aVarC == null) {
                    try {
                        aVarC = c(context, str);
                        f35300d.put(str, aVarC);
                    } catch (IOException e2) {
    ...
    public void attachInfo(Context context, ProviderInfo providerInfo) {
        ...
        this.f35301a = b(context, providerInfo.authority);
    }

    @Override // android.content.ContentProvider
    public int delete(Uri uri, String str, String[] strArr) {
        return this.f35301a.a(uri).delete() ? 1 : 0;
    }

    @Override // android.content.ContentProvider
    public String getType(Uri uri) {
        File fileA = this.f35301a.a(uri);
    ...
    public ParcelFileDescriptor openFile(Uri uri, String str) throws FileNotFoundException {
        return ParcelFileDescriptor.open(this.f35301a.a(uri), a(str));
    }
