...
public class ADActivity extends Activity {
    ...
    protected ACTD f35120a;

    /* renamed from: b, reason: collision with root package name */
    private FrameLayout f35121b;
    ...
    private void a() {
        ...
        this.f35121b = new FrameLayout(this);
        this.f35121b.setLayoutParams(new LinearLayout.LayoutParams(-1, -1));
        linearLayout.addView(this.f35121b);
    }
    ...
    public void setContentView(int i2) {
        a();
        LayoutInflater.from(this).inflate(i2, (ViewGroup) this.f35121b, true);
    }

    @Override // android.app.Activity
    public void setContentView(View view) {
        a();
        this.f35121b.addView(view);
    }

    @Override // android.app.Activity
    public void setContentView(View view, ViewGroup.LayoutParams layoutParams) {
        a();
        this.f35121b.addView(view, layoutParams);
    }
}
