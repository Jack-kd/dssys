...
class KwaiIpNeigh {
    ...
    private static native int getARPTableFromJni(int i2);

    private static native int getARPTableFromJni2(int i2);
    ...
    public static String j(String str, boolean z2) {
        ...
        if ((z2 ? getARPTableFromJni2(iDetachFd) : getARPTableFromJni(iDetachFd)) != 0) {
