...
public class LiveInfoSource {
    ...
    public boolean adjustOriginBitRate(String str, String str2, long j2) {
        LiveStreamInfo liveStreamInfo = this.mStreamInfo;
        if (liveStreamInfo == null) {
            return false;
        }
        return liveStreamInfo.adjustOriginBitRate(str, str2, j2);
    }
    ...
    public String getLabelfromBitrate(long j2, String str) {
        ...
        return liveStreamInfo.getLabelfromBitrate(j2, str);
    }
    ...
    public boolean isSupportSR(int i2, int i3, float f2) {
        ...
        return liveStreamInfo.isSupportSR(i2, i3, f2);
    }
    ...
    public boolean isSupportSharpen(int i2, int i3) {
        ...
        return liveStreamInfo.isSupportSharpen(i2, i3);
    }
    ...
    public void setEnableOriginResolution(boolean z2) {
        ...
        liveStreamInfo.setEnableOriginResolution(z2);
    }

    public void setEnableSR(int i2) {
        this.mEnableSR = i2;
    }
    ...
    public void setRtcFallback(int i2) {
        LiveStreamInfo liveStreamInfo = this.mStreamInfo;
        if (liveStreamInfo != null) {
            liveStreamInfo.setRtcFallback(i2);
        }
    }
    ...
    public boolean setStreamInfoFlag(int i2) {
        LiveStreamInfo liveStreamInfo = this.mStreamInfo;
        if (liveStreamInfo == null) {
            return false;
        }
        return liveStreamInfo.setFlag(i2);
    }
