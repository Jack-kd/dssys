...
public final class RetryProcessor {
    ...
    public interface RetryListener {
        ...
        void onRetryResetPlayer(boolean z2);
    }
    ...
    public void handleRetryForError(int i2, LiveError liveError) {
        if (i2 == -1) {
    ...
    private void upLoadErrorLog(LiveError liveError) throws JSONException {
        int i2 = this.mLogErrorCount - 1;
        this.mLogErrorCount = i2;
        if (i2 >= 0) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void uploadRetryLog(int i2) throws JSONException {
        boolean z2 = this.mIsHasUploadLog;
        if (!z2 || (z2 && System.currentTimeMillis() - this.mLastUploadLogTime >= 1000)) {
            this.mLogService.onRetry(i2);
            this.mLogService.onFirstFrameFail(i2);
    ...
    */
    public void onError(com.bykv.vk.component.ttvideo.log.LiveError r7, boolean r8) {
        ...
        L2c:
            ...
            java.lang.Object r1 = r0.get(r1)     // Catch: java.lang.NumberFormatException -> L42
            java.lang.Integer r1 = (java.lang.Integer) r1     // Catch: java.lang.NumberFormatException -> L42
            int r1 = r1.intValue()     // Catch: java.lang.NumberFormatException -> L42
            r7.code = r1     // Catch: java.lang.NumberFormatException -> L43
            goto L4a
        L42:
            r1 = 0
        L43:
    ...
    public void onStall(boolean z2, boolean z3) {
        if (!z2) {
            reset();
            return;
        }
    ...
    public void setStallRetryTimeInterval(long j2) {
        this.mStallRetryTimeInterval = j2;
    }
