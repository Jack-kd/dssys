...
public class AVMDLDataLoader implements Handler.Callback {
    ...
    private String createFilePathBaseDir(String str, String str2) {
        ...
        if (str.charAt(str.length() - 1) == '/') {
            ...
            str3 = str + ServiceReference.DELIMITER + str2;
        }
            ...
            synchronized (AVMDLDataLoader.class) {
                if (mInstance == null) {
                    try {
                        ...
                        u.l("ttmdl", "create native exception".concat(String.valueOf(e2)));
                        mInstance = null;
                    }
                }
            }
    ...
    public static synchronized int init(boolean z2) {
        try {
            if (mIsLibraryLoaded) {
                return 0;
            }
            ...
            if (!z2) {
                try {
                    ...
                    u.l("ttmn", "Can't load avmdl library: ".concat(String.valueOf(e2)));
                } catch (Throwable th) {
                    u.l("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th)));
                }
    ...
    private void initLogThread(final Handler.Callback callback) {
        if (this.mMsgThread == null) {
            jx jxVar = new jx() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.1
            ...
            this.mMsgThread = jxVar;
            jxVar.setName("mdl_log_handler");
    ...
    public static String makeTsFileKey(String str, String str2) {
        try {
            ...
            AVMDLLog.e(TAG, "makeTsFileKey failed, other reason:  " + e2.getMessage());
            return null;
        } catch (UnsatisfiedLinkError e3) {
            AVMDLLog.e(TAG, "makeTsFileKey failed, native not support: " + e3.getMessage());
            return null;
        }
    }
    ...
    private void setConfigureInternal(AVMDLDataLoaderConfigure aVMDLDataLoaderConfigure) {
        ...
        if (i3 > 0) {
            _setIntValue(this.mHandle, KeyIsSocketSendBufferKB, i3);
        }
        int i4 = aVMDLDataLoaderConfigure.mRingBufferSizeKB;
        if (i4 > 0) {
            _setIntValue(this.mHandle, KeyIsRingBufferSizeKB, i4);
        }
        ...
        int i5 = aVMDLDataLoaderConfigure.mEnableEventInfo;
        if (i5 > 0) {
            _setIntValue(this.mHandle, KeyIsEnableEventInfo, i5);
        }
        int i6 = aVMDLDataLoaderConfigure.mEnableStorageModule;
        if (i6 > 0) {
            _setIntValue(this.mHandle, 10000, i6);
            int i7 = aVMDLDataLoaderConfigure.mStoPlayDldWinSizeKBNM;
            if (i7 > 0) {
                _setIntValue(this.mHandle, 10001, i7);
            }
            int i8 = aVMDLDataLoaderConfigure.mStoPlayDldWinSizeKBLS;
            if (i8 > 0) {
                _setIntValue(this.mHandle, 10002, i8);
            }
            int i9 = aVMDLDataLoaderConfigure.mStoRingBufferSizeKB;
            if (i9 > 0) {
                _setIntValue(this.mHandle, 10003, i9);
            }
            int i10 = aVMDLDataLoaderConfigure.mStoIoWriteLimitKBTh1;
            if (i10 > 0) {
                _setIntValue(this.mHandle, KeyIsStoIoWriteLimitKBTh1, i10);
            }
            int i11 = aVMDLDataLoaderConfigure.mStoIoWriteLimitKBTh2;
            if (i11 > 0) {
                _setIntValue(this.mHandle, KeyIsStoIoWriteLimitKBTh2, i11);
            }
            int i12 = aVMDLDataLoaderConfigure.mStoMaxIdleTimeSec;
            if (i12 > 0) {
                _setIntValue(this.mHandle, KeyIsStoMaxIdleTimeSec, i12);
            }
        }
    ...
    private double testFileIO(String str, int i2, RandomAccessFile randomAccessFile) throws Exception {
        if (TextUtils.isEmpty(str)) {
            return -1.0d;
        }
    ...
    public long getAllCacheSize() {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                j_getLongValue = _getLongValue(j2, 100);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public String getAuth(String str) {
        ...
        this.mReadLock.lock();
        try {
            return _getAuth(this.mHandle, str);
        } catch (UnsatisfiedLinkError unused) {
    ...
    public String getCDNLog(String str) {
        ...
        this.mReadLock.lock();
        try {
            return _getCDNLog(this.mHandle, str);
        } catch (UnsatisfiedLinkError unused) {
            return null;
        } finally {
            this.mReadLock.unlock();
    ...
    public AVMDLFileInfo getCacheInfo(String str) {
        ...
        try {
            try {
                long j2 = this.mHandle;
                if (j2 != 0) {
                    String[] strArrSplit = _getStringValueByStr(j2, str, 101).split(",");
    ...
    public long getCacheSize(String str, String str2) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                j_getLongValueByStrStr = _getLongValueByStrStr(j2, str, str2, 103);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public String getLocalAddr() {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                str_getStringValue = _getStringValue(j2, 4);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
        ...
        try {
            switch (i2) {
                ...
                default:
                    ...
                    if (j3 != 0) {
                        j_getLongValue = _getLongValue(j3, i2);
                        break;
                    }
                    break;
            }
    ...
    public long getLongValueByStr(String str, int i2) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                j_getLongValueByStr = _getLongValueByStr(j2, str, i2);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mWriteLock.unlock();
    ...
    public String getStringCacheInfo(String str) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                str_getStringValueByStr = _getStringValueByStr(j2, str, 101);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public String getStringValue(int i2) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                str_getStringValue = _getStringValue(j2, i2);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public String getStringValueByStr(String str, int i2) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                str_getStringValueByStr = _getStringValueByStr(j2, str, i2);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public boolean handleMessage(Message message) {
        int i2 = message.what;
        return (i2 == 12 || i2 == 9) ? postMessage(this.mLiveListener, message) : (i2 == 71 || i2 == 72 || i2 == 73 || i2 == 74) ? postMessage(this.mEventListener, message) : postMessage(this.mVodListener, message);
    }
    ...
    public void onLogInfo(int i2, int i3, int i4, String str) {
        if (this.mState == 1 && this.mLogHandler != null && isNotifyInfo(i2)) {
            ...
            aVMDLDataLoaderNotifyInfo.parameter = i4;
    ...
    public void preloadGroupResource(String str, String str2, int i2, int i3) {
        if (this.mState != 1 || TextUtils.isEmpty(str2) || i3 == 0) {
            return;
        }
        this.mWriteLock.lock();
        try {
    ...
    public int start() {
        ...
        initNativeHandle();
        new jx(new Runnable() { // from class: com.bykv.vk.component.ttvideo.mediakit.medialoader.AVMDLDataLoader.2
    ...
    public String getStringCacheInfo(String str, String str2) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                str_getStringValueByStrStr = _getStringValueByStrStr(j2, str, str2, 101);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public void preloadResource(String str, int i2, int i3) {
        if (this.mState != 1 || TextUtils.isEmpty(str) || i3 == 0) {
            return;
        }
        this.mWriteLock.lock();
        try {
    ...
    public long getCacheSize(String str) {
        ...
        try {
            long j2 = this.mHandle;
            if (j2 != 0) {
                j_getLongValueByStr = _getLongValueByStr(j2, str, 103);
            }
        } catch (UnsatisfiedLinkError unused) {
        } catch (Throwable th) {
            this.mReadLock.unlock();
    ...
    public static synchronized int init(boolean z2, boolean z3) {
        try {
            if (mIsLibraryLoaded) {
                return 0;
            }
            ...
            if (!z2) {
                ...
                if (z3) {
                    u.l("ttmn", "try to load pcdn lib");
                    try {
                        eb.hp("avmdlp2p");
                    } catch (UnsatisfiedLinkError e3) {
                        u.l("ttmn", "Can't load avmdlp2p library: ".concat(String.valueOf(e3)));
                    } catch (Throwable th2) {
                        u.l("ttmn", "other exception when loading avmdl library: ".concat(String.valueOf(th2)));
                    }
                }
                tryLoadTTNetLoaderPlugin();
            }
    ...
    */
    public void onLogInfo(int r6, int r7, java.lang.String r8) throws org.json.JSONException {
        /*
    ...
    */
    public static synchronized int init(boolean r4, boolean r5, boolean r6) {
        ...
        La:
            ...
            com.byazt.dnb.eb.hp(r6)     // Catch: java.lang.Throwable -> L19 java.lang.UnsatisfiedLinkError -> L1c
        ...
        L1c:
            ...
            com.byazt.ymw.u.l(r1, r6)     // Catch: java.lang.Throwable -> L19
        L2c:
            ...
            com.byazt.dnb.eb.hp(r6)     // Catch: java.lang.Throwable -> L38 java.lang.UnsatisfiedLinkError -> L3a
        ...
        L3c:
            ...
            com.byazt.ymw.u.l(r6, r4)     // Catch: java.lang.Throwable -> L19
            goto L5b
        L4c:
            java.lang.String r6 = "ttmn"
        ...
        L5b:
            ...
            com.byazt.ymw.u.l(r4, r5)     // Catch: java.lang.Throwable -> L19
            java.lang.String r4 = "avmdlp2p"
            com.byazt.dnb.eb.hp(r4)     // Catch: java.lang.Throwable -> L6a java.lang.UnsatisfiedLinkError -> L6c
            goto L8d
        L6a:
            r4 = move-exception
            goto L6e
        ...
        L6e:
            ...
            com.byazt.ymw.u.l(r5, r4)     // Catch: java.lang.Throwable -> L19
            goto L8d
        L7e:
            java.lang.String r5 = "ttmn"
