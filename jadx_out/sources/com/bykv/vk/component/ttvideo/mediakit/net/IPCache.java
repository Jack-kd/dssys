    ...
    public void put(String str, AVMDLDNSInfo aVMDLDNSInfo) {
        ...
        try {
            ...
            if (concurrentHashMap != null) {
                ...
                if (AVMDLDNSParser.mGlobalEnableParallel > 0 && aVMDLDNSInfo2 != null && (i2 = aVMDLDNSInfo.mType) == 0 && aVMDLDNSInfo2.mType > i2 && aVMDLDNSInfo2.mExpiredTime > System.currentTimeMillis()) {
                    ...
                    this.mDNSRecord.put(str2, aVMDLDNSInfo);
                }
            } else {
                str2 = str;
            }
            this.lock.unlock();
            AVMDLDataLoader.getInstance().updateDNSInfo(str2, aVMDLDNSInfo.mIpList, aVMDLDNSInfo.mExpiredTime, null, aVMDLDNSInfo.mType);
        } catch (Throwable th) {
            this.lock.unlock();
            throw th;
        }
