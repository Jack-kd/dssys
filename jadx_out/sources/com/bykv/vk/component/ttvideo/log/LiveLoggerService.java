...
import com.byazt.otv.hp;
import com.byazt.otv.j;
...
public class LiveLoggerService implements Handler.Callback {
    ...
    public String mEnterMethod = com.baidu.mobads.sdk.internal.a.f10877a;
    public String mEnterAction = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mCommonFlag = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mProjectKey = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mCdnPlayURL = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mCurrentPlayURL = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mCdnIp = com.baidu.mobads.sdk.internal.a.f10877a;
    private boolean mIpIsFromPlayerCore = false;
    private String mPlayerVersion = com.baidu.mobads.sdk.internal.a.f10877a;
    private boolean mIsPreview = false;
    private long mLogIndex = 0;
    private String mSdkParams = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientSDKVersion = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientPlatform = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientOSVersion = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientModel = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientStartTime = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    private String mPushClientPushProtocal = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mPushClientQId = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mLinkInfo = "";
    private boolean mOpenNodeOptimizer = false;
    private String mEvaluatorSymbol = com.baidu.mobads.sdk.internal.a.f10877a;
    private boolean mHitNodeOptimizer = false;
    private boolean mIsRemoteSorted = false;
    private boolean mIsHitCache = false;
    public String mCodecType = com.baidu.mobads.sdk.internal.a.f10877a;
    public boolean mHardDecodeEnable = false;
    public String mCodecName = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mSpeedSwitchInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mRuleIds = com.baidu.mobads.sdk.internal.a.f10877a;
    public String mSessionId = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mUrlAbility = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mStreamData = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    private String mSuggestFormat = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mProtocol = LiveConfigKey.TCP;
    private String mSuggestProtocol = com.baidu.mobads.sdk.internal.a.f10877a;
    private int mQuicFlag = -1;
    private String mOriginUrl = com.baidu.mobads.sdk.internal.a.f10877a;
    private String mChipBoard = Build.BOARD;
    private String mChipHardware = Build.HARDWARE;
    public String mSettingsInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    public String mTTNetNQEInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mLastResolution = com.baidu.mobads.sdk.internal.a.f10877a;
    public long mResBitrate = -1;
    public int mDefaultResBitrate = -1;
    public int mAbrSwitchCount = 0;
    public String mAbrSwitchCountInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mAbrSwitchInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mDnsIp = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mRtcSessionId = com.baidu.mobads.sdk.internal.a.f10877a;
    public String mRtcPlayStopStatInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mRequestUrl = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    private String mSessionErrorMsg = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public String mLiveIOErrorMsg = com.baidu.mobads.sdk.internal.a.f10877a;
    public long mFirstFrameView = 0;
    public String mLiveIOVersion = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    private void checkSeiIndex(int i2) throws JSONException {
        ...
        if (i3 >= 0) {
            if (i2 <= i3) {
                ...
                if (i2 - i3 > 1) {
                    ...
                    this.mExpectedSeiCount = i4 + ((i2 - i5) - 1);
                    this.mExpectedUniqueSeiCount += (i2 - i5) - 1;
                }
            }
        }
    ...
    private void checkVideoFrame(int i2, int i3, long j2) throws JSONException {
        ...
        if (jLongValue > 0 && jLongValue <= this.mLastCheckDTS) {
            ...
            while (this.mVideoDTSQueue.size() > 0) {
                ...
                long j3 = this.mLastCheckDTS;
                if (jLongValue2 == j3) {
                    z2 = true;
                }
                if (z2 && jLongValue2 > j3 && jLongValue2 <= j2) {
                    i5++;
                    if (jLongValue2 == j2) {
                        break;
                    }
                }
                this.mVideoDTSQueue.poll().getClass();
            }
        ...
        if (i2 - i6 != 1) {
            onStreamAbnormalSEI(i2 <= i6 ? 1 : 0, i2, i6);
        }
        this.mLastIndex = i2;
        this.mLastSentFrames = i3;
        this.mLastCheckDTS = j2;
    ...
    private JSONObject createPlayingLog(LogBundle logBundle, long j2, long j3, long j4, long j5, boolean z2) throws JSONException {
        long j6;
        JSONObject jSONObjectCreateCommonLog = createCommonLog();
        if (jSONObjectCreateCommonLog == null) {
            return null;
        ...
        jSONObjectCreateCommonLog.put("event_key", "playing").put("download_size_delta", j6).put(s.a.f3403e, j12).put("video_play_size", logBundle.playedSize).put("render_fps", logBundle.fps).put("video_rate", j10).put("download_speed", this.mLogBundle.downloadSpeed).put("play_time", j7).put(n.b.f3359h, this.mRetryCount).put("stall_count", i2).put("stall_time", iCurrentTimeMillis).put("audio_render_stall_count", this.mPlayingAudioRenderStallCount).put("audio_render_stall_time", this.mPlayingAudioRenderStallTime).put("video_render_stall_count", this.mPlayingVideoRenderStallCount).put("video_render_stall_time", this.mPlayingVideoRenderStallTime).put("silence_detected_count", this.mSilenceDetectedCount).put("is_last", z2 ? 1 : 0).put(com.umeng.ccg.a.f49746H, this.mLogIndex).put("speed_switch_count", this.mSpeedSwitchCount).put("speed_switch_info", this.mSpeedSwitchInfo).put("video_buffer_time", this.mLogBundle.videoBufferTime).put("audio_buffer_time", this.mLogBundle.audioBufferTime).put("enable_sei_check", this.mEnableSeiCheck ? 1 : 0).put("ntp_sync", this.mHasNTP ? 1 : 0).put("rtc_stat_info", this.mLogBundle.rtcStatInfo).put("suggest_format", this.mSuggestFormat).put("suggest_protocol", this.mSuggestProtocol);
        int i3 = this.mNoSyncPlayingCount;
        if (i3 > 0) {
            jSONObjectCreateCommonLog.put("av_out_sync_count", i3).put("av_out_sync_duration", this.mNoSyncPlayingTimeDuration).put("av_out_sync_info", this.mNoSyncPlayingInfoStr);
        }
        ...
        this.mSpeedSwitchInfo = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public void ntp() {
        ...
        try {
            ...
            if (inetAddress != null) {
                jVarHp = this.mNTPClient.hp(inetAddress);
            }
        ...
        long jL = jVarHp.l().jl().l();
        this.mTimeDiff = ((jVarHp.l().zy().l() - jL) + (jVarHp.l().gu().l() - System.currentTimeMillis())) / 2;
    }

    private void onLink(boolean z2) throws JSONException {
        if (this.mEnableOpenMDL == 1) {
            MediaLoaderWrapper.getDataLoader().setInt64ValueByStrKey(z2 ? 8013 : 8014, this.mSessionId, -1);
        }
        JSONObject jSONObjectCreateCommonLog = createCommonLog();
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "link").put("info", z2 ? "start" : "end");
    ...
    private void onStreamAbnormalFrame(int i2, int i3, int i4) throws JSONException {
        JSONObject jSONObjectCreateCommonLog;
        if (this.mLiveEngine == null || (jSONObjectCreateCommonLog = createCommonLog()) == null) {
            return;
        }
        try {
            jSONObjectCreateCommonLog.put("event_key", "stream_abnormal").put("stream_type", "video").put("type", i2).put("sent_frames", i3).put("received_frames", i4);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j2 = this.mLogTotalCount;
            if (j2 > 0) {
                this.mLogTotalCount = j2 + 1;
    ...
    private void onStreamAbnormalSEI(int i2, int i3, int i4) throws JSONException {
        JSONObject jSONObjectCreateCommonLog;
        if (this.mLiveEngine == null || (jSONObjectCreateCommonLog = createCommonLog()) == null) {
            return;
        }
        try {
            jSONObjectCreateCommonLog.put("event_key", "stream_abnormal").put("stream_type", "video").put("type", i2).put("cur_index", i3).put("last_index", i4);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j2 = this.mLogTotalCount;
            if (j2 > 0) {
                this.mLogTotalCount = j2 + 1;
    ...
    private void report(boolean z2) {
        LogBundle logBundle;
        ...
        try {
            ...
            liveLoggerService = this;
            try {
                liveLoggerService.mLogUploader.onMonitorLog(liveLoggerService.createPlayingLog(this.mLogBundle, j2, j3, j4, j5, z2), MONITOR_LOG_TYPE);
                long j6 = liveLoggerService.mLogTotalCount;
                if (j6 > 0) {
                    liveLoggerService.mLogTotalCount = j6 + 1;
                }
            } catch (JSONException unused) {
            }
        ...
        long j7 = liveLoggerService.mInterval;
        if (isRtcPlayAvailable()) {
            j7 = liveLoggerService.mRtcPlayingLogInterval;
        }
        if (liveLoggerService.mStarted) {
            liveLoggerService.mHandler.sendEmptyMessageDelayed(101, j7);
        }
    }
    ...
    private void resetSessionInfo() {
        ...
        this.mSessionErrorMsg = com.baidu.mobads.sdk.internal.a.f10877a;
        logBundle.reset();
    }
    ...
    public void calculateRenderFailType() {
        ...
        long j2 = logBundle.audioRenderTimestamp;
        if (j2 > 0 && logBundle.videoRenderTimestamp > 0) {
            this.mRenderFailType = 0;
            return;
        }
        if (j2 > 0 && logBundle.videoRenderTimestamp <= 0) {
            this.mRenderFailType = 1;
        } else if (j2 > 0 || logBundle.videoRenderTimestamp <= 0) {
    ...
    public void calculateSessionRenderFailType() {
        long j2 = this.mSessionAudioRenderStartTime;
        if (j2 > 0 && this.mSessionVideoRenderStartTime > 0) {
            this.mSessionRenderFailType = 0;
            return;
        }
        if (j2 > 0 && this.mSessionVideoRenderStartTime <= 0) {
            this.mSessionRenderFailType = 1;
        } else if (j2 > 0 || this.mSessionVideoRenderStartTime <= 0) {
    ...
    public JSONObject createCommonLog() throws JSONException {
        ...
        try {
            ...
            if (str7 == null) {
                str7 = com.baidu.mobads.sdk.internal.a.f10877a;
            }
            ...
            if (str8 == null) {
                str8 = com.baidu.mobads.sdk.internal.a.f10877a;
            }
            ...
            if (str9 == null) {
                str9 = com.baidu.mobads.sdk.internal.a.f10877a;
            }
            ...
            if (this.mRtcSessionId.equals(com.baidu.mobads.sdk.internal.a.f10877a)) {
            ...
            int i2 = this.mTslTimeShift;
            if (i2 > 0) {
                jSONObjectPut11.put("tsl_timeshift", i2);
            }
            ...
            int i3 = this.mFCDNTranscodeMethod;
            if (i3 != -1) {
                jSONObjectPut11.put("fcdn_res_type", i3);
            }
    ...
    public void enableHardDecode(boolean z2) {
        this.mHardDecodeEnable = z2;
    }
    ...
    public long getInt64Value(int i2, long j2) {
        ...
        if (i2 != 0) {
            return i2 != 100 ? j2 : this.mLogBundle.delay;
        }
        int i3 = this.mPushClientMaxBitrate;
        return (i3 != -1 || (videoLiveManager = this.mLiveEngine) == null) ? i3 : videoLiveManager.getIntOption(i2, j2);
    }
    ...
    public JSONObject getLiveInfoItems() {
        ...
        if (arrayList != null && !arrayList.isEmpty()) {
            ArrayList<Long> arrayList2 = this.mDownloadSpeedTimeSeries;
            int size = arrayList2.size();
            int i2 = 0;
            while (i2 < size) {
                Long l2 = arrayList2.get(i2);
                i2++;
                lValueOf = Long.valueOf(lValueOf.longValue() + l2.longValue());
            }
        ...
        try {
            ...
            if (str2 == null) {
                str2 = com.baidu.mobads.sdk.internal.a.f10877a;
            }
    ...
    public void onAbrSwitch(long j2, String str, boolean z2) {
        if (this.mLiveEngine == null || this.mLogUploader == null) {
            return;
        }
        try {
            JSONObject jSONObjectCreateCommonLog = createCommonLog();
            jSONObjectCreateCommonLog.put("event_key", "abr_switch").put("auto_switch", z2 ? 1 : 0).put("target_resoultion", str).put("predict_bitrate", j2).put("abr_switch_info", this.mAbrSwitchInfo).put("cur_download_speed", this.mCurDownloadSpeed).put("cur_audio_buffer_time", this.mCurAudioBufferTime).put("cur_video_buffer_time", this.mCurVideoBufferTime).put("stall_count", this.mStallTotalCount).put("switch_cost", this.mAbrSwitchCost).put("use_expect_bitrate", this.mUseExpectBitrate);
    ...
    public void onAudioDTSRollback(long j2, long j3) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "timestamp_rollback").put("packet_type", MediaFormat.KEY_AUDIO).put("timestamp_type", "dts").put("latest_ts", j3).put("previous_ts", j2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
    ...
    public void onDecoderStall(long j2, int i2, boolean z2) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "decode_stall").put("type", z2 ? "video" : MediaFormat.KEY_AUDIO).put("decode_stall_time", j2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    public void onDemuxerStall(long j2, int i2, boolean z2) {
        if (j2 > System.currentTimeMillis() - this.mLogBundle.startPlayTime || j2 <= i2) {
            return;
        }
        if (z2) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "demux_stall").put("type", z2 ? "video" : MediaFormat.KEY_AUDIO).put("demux_stall_time", j2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    public void onError(int i2, String str) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "play_error").put("code", i2).put("info", str);
    ...
    public void onFirstFrame(long j2, long j3) {
        ...
        if (this.mLiveEngine != null && this.mLogUploader != null && (logBundle = this.mLogBundle) != null) {
            try {
                ...
                try {
                    JSONObject jSONObjectCreateFirstFrameLog = createFirstFrameLog(this.mLogBundle, j2, this.mIsHitCache, j3);
    ...
    public void onFirstFrameFail(int i2) throws JSONException {
        VideoLiveManager videoLiveManager;
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "first_frame_failed").put("start_time", System.currentTimeMillis()).put(MediationConstant.KEY_REASON, i2);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
    ...
    public void onLoaderError(int i2, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "p2p_error").put("error_msg", str).put("code", i2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
                    this.mLogTotalCount = j2 + 1;
    ...
    public void onLoaderSwitch(int i2, String str) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                jSONObjectCreateCommonLog.put("event_key", "p2p_switch").put("switch_info", str).put("p2p_vendor", com.baidu.mobads.sdk.internal.a.f10877a).put(MediationConstant.KEY_REASON, i2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
                    this.mLogTotalCount = j2 + 1;
    ...
    */
    public void onPrepare(int r12) {
        ...
        L27:
            if (r0 == 0) goto Lc2
            long r4 = r11.mFirstAudioPacketDTS     // Catch: org.json.JSONException -> Lc2
            r6 = 0
            int r1 = (r4 > r6 ? 1 : (r4 == r6 ? 0 : -1))
            r8 = 0
            if (r1 <= 0) goto L3e
            long r9 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> Lc2
        ...
        L3f:
            ...
            org.json.JSONObject r4 = r0.put(r4, r5)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r5 = "error_msg"
            if (r12 == 0) goto L52
            com.bykv.vk.component.ttvideo.VideoLiveManager r9 = r11.mLiveEngine     // Catch: org.json.JSONException -> Lc2
            java.lang.String r9 = r9.getPlayerErrorInfo()     // Catch: org.json.JSONException -> Lc2
            goto L53
        L52:
            r9 = r2
        L53:
            org.json.JSONObject r4 = r4.put(r5, r9)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r5 = "result"
            org.json.JSONObject r12 = r4.put(r5, r12)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r4 = "sdk_params"
            java.lang.String r5 = r11.mSdkParams     // Catch: org.json.JSONException -> Lc2
            if (r5 != 0) goto L64
            goto L65
        L64:
            r2 = r5
        L65:
            org.json.JSONObject r12 = r12.put(r4, r2)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r2 = "first_audio_packet_dts_rollback"
            org.json.JSONObject r12 = r12.put(r2, r1)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "first_audio_packet_dts"
            long r4 = r11.mFirstAudioPacketDTS     // Catch: org.json.JSONException -> Lc2
            org.json.JSONObject r12 = r12.put(r1, r4)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "previous_audio_packet_dts"
            long r4 = r11.mPreviousAudioPacketDTS     // Catch: org.json.JSONException -> Lc2
            org.json.JSONObject r12 = r12.put(r1, r4)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "stream_type"
            com.bykv.vk.component.ttvideo.log.LogBundle r2 = r11.mLogBundle     // Catch: org.json.JSONException -> Lc2
            int r2 = r2.mStreamType     // Catch: org.json.JSONException -> Lc2
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "suggest_format"
            java.lang.String r2 = r11.mSuggestFormat     // Catch: org.json.JSONException -> Lc2
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "suggest_protocol"
            java.lang.String r2 = r11.mSuggestProtocol     // Catch: org.json.JSONException -> Lc2
            org.json.JSONObject r12 = r12.put(r1, r2)     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "nnsr_enabled"
            com.bykv.vk.component.ttvideo.VideoLiveManager r2 = r11.mLiveEngine     // Catch: org.json.JSONException -> Lc2
            boolean r2 = r2.getSRState()     // Catch: org.json.JSONException -> Lc2
            if (r2 != 0) goto Lad
            com.bykv.vk.component.ttvideo.VideoLiveManager r2 = r11.mLiveEngine     // Catch: org.json.JSONException -> Lc2
            boolean r2 = r2.getSharpenState()     // Catch: org.json.JSONException -> Lc2
            if (r2 == 0) goto Lac
            goto Lad
        Lac:
            r3 = r8
        Lad:
            r12.put(r1, r3)     // Catch: org.json.JSONException -> Lc2
            com.bykv.vk.component.ttvideo.ILiveListener r12 = r11.mLogUploader     // Catch: org.json.JSONException -> Lc2
            java.lang.String r1 = "live_client_monitor_log"
            r12.onMonitorLog(r0, r1)     // Catch: org.json.JSONException -> Lc2
            long r0 = r11.mLogTotalCount     // Catch: org.json.JSONException -> Lc2
            int r12 = (r0 > r6 ? 1 : (r0 == r6 ? 0 : -1))
            if (r12 <= 0) goto Lc2
            r2 = 1
            long r0 = r0 + r2
            r11.mLogTotalCount = r0     // Catch: org.json.JSONException -> Lc2
        Lc2:
            return
        */
    ...
    public void onPtsBack(long j2, boolean z2) {
        JSONObject jSONObjectCreateCommonLog = createCommonLog();
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "pts_back").put("type", z2 ? "video" : MediaFormat.KEY_AUDIO).put("pts_back_diff", j2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            } catch (JSONException unused) {
            }
        }
    ...
    public void onRenderStall(long j2, int i2, boolean z2, boolean z3) {
        if (j2 > System.currentTimeMillis() - this.mLogBundle.startPlayTime || j2 <= i2) {
            return;
        }
        if (z2) {
            ...
            this.mVideoRenderStallTotalCount++;
            this.mPlayingVideoRenderStallTime = (int) (this.mPlayingVideoRenderStallTime + j2);
            ...
            this.mPlayingAudioRenderStallTime = (int) (this.mPlayingAudioRenderStallTime + j2);
        ...
        if (z3) {
            ...
            if (jSONObjectCreateCommonLog != null) {
                try {
                    jSONObjectCreateCommonLog.put("event_key", "render_stall").put("type", z2 ? "video" : MediaFormat.KEY_AUDIO).put("render_stall_time", j2).put("video_buffer_time", this.mLogBundle.videoBufferTime).put("audio_buffer_time", this.mLogBundle.audioBufferTime);
                    this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                    long j3 = this.mLogTotalCount;
                    if (j3 > 0) {
                        this.mLogTotalCount = j3 + 1;
    ...
    public void onRetry(int i2) {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "retry").put(MediationConstant.KEY_REASON, this.mErrorCode).put("code", i2).put("render_fail_type", this.mRenderFailType);
                reportQuicOpenResult(jSONObjectCreateCommonLog);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j2 = this.mLogTotalCount;
                if (j2 > 0) {
    ...
    public void onRtcDecoderStall(long j2, boolean z2) {
        JSONObject jSONObjectCreateCommonLog;
        if (j2 <= System.currentTimeMillis() - this.mLogBundle.startPlayTime && (jSONObjectCreateCommonLog = createCommonLog()) != null) {
            try {
                jSONObjectCreateCommonLog.put("event_key", "rtc_decode_stall").put("type", z2 ? "video" : MediaFormat.KEY_AUDIO).put("decode_stall_time", j2);
                this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
                long j3 = this.mLogTotalCount;
                if (j3 > 0) {
                    this.mLogTotalCount = j3 + 1;
    ...
    public void onSessionStop() {
        ...
        if (j5 > 0) {
            j2 = j5 - this.mSessionVideoRenderStartTime;
            j3 = this.mSessionFirstStallEndTime - j5;
        } else {
            j2 = 0;
            j3 = 0;
        }
    ...
    public void onStallStart(int i2, boolean z2) {
    ...
    public void onStop(String str) throws JSONException {
        ...
        if (jSONObjectCreateCommonLog != null) {
            try {
                ...
                long j6 = this.mFirstStallStartTime;
                if (j6 > 0) {
                    j3 = j6 - this.mLogBundle.videoRenderTimestamp;
                    j2 = 0;
                    j5 = this.mFirstStallEndTime - j6;
                } else {
                    j2 = 0;
                    j3 = 0;
                }
                ...
                if (i3 > 0) {
                    jSONObject.put("av_out_sync_count", i3).put("av_out_sync_duration", this.mNoSyncTimeDuration).put("av_out_sync_info", this.mNoSyncInfoStr);
                }
                ...
                if (isRtcPlayAvailable()) {
                    ...
                    if (this.mCdnPlayURL == null) {
                        jSONObject.put("tcp_connect_end", this.mLogBundle.tcpConnectTimestamp);
                    } else {
                        jSONObject.put("tcp_connect_end", this.mProtocol.equals(LiveConfigKey.KCP) ? this.mLogBundle.playerDNSTimestamp : this.mLogBundle.tcpConnectTimestamp);
                    }
                }
                ...
                if (i4 != 0) {
                    jSONObject.put("bitrate_amnormal", i4);
                }
                int i5 = this.mCodecNotSame;
                if (i5 != 0) {
                    jSONObject.put("abr_codec_not_same", i5);
                }
                ...
                boolean z2 = this.mIsCdnAbrSwitch;
                if (z2) {
                    jSONObject.put("cdn_abr_switch_performed", z2 ? 1 : 0).put("cdn_abr_switch_code", this.mCdnAbrSwitchCode);
                }
                long j9 = this.mLogTotalCount + j4;
                this.mLogTotalCount = j9;
                jSONObject.put("log_total_count_when_playing", j9);
                this.mLogUploader.onMonitorLog(jSONObject, MONITOR_LOG_TYPE);
                this.mLogTotalCount = j2;
            } catch (JSONException unused) {
            }
        }
    }
    ...
    public void onSwitch(String str, String str2, String str3, int i2) {
        ...
        try {
            ...
            jSONObjectPut2.put("next_cdn_play_url", str2).put("res_bitrate", this.mResBitrate).put("last_res", this.mLastResolution).put("code", i2).put(MediationConstant.KEY_REASON, str3);
            this.mLogUploader.onMonitorLog(jSONObjectCreateCommonLog, MONITOR_LOG_TYPE);
            long j2 = this.mLogTotalCount;
            if (j2 > 0) {
                this.mLogTotalCount = j2 + 1;
    ...
    public void onUpdateMetaData(String str) {
        ...
        try {
            ...
            if (jSONObject.has(bv.f48924y)) {
                this.mPushClientOSVersion = jSONObject.getString(bv.f48924y);
            }
    ...
    public void onUpdateSeiInfo(String str) throws JSONException {
        ...
        try {
            ...
            if (jSONObject.has("ts")) {
                ...
                this.mLogBundle.delay = (System.currentTimeMillis() - j2) + j3;
                LogBundle logBundle = this.mSessionLogBundle;
                if (logBundle != null) {
                    logBundle.delay = (System.currentTimeMillis() - j2) + j3;
                }
            }
            String str2 = this.mLogBundle.seiSource;
            if (jSONObject.has(com.sigmob.sdk.base.n.f36449l)) {
                this.mLogBundle.seiSource = jSONObject.getString(com.sigmob.sdk.base.n.f36449l);
            ...
            if (!str2.equals(com.baidu.mobads.sdk.internal.a.f10877a) && !this.mLogBundle.seiSource.equals(str2)) {
            ...
            if (jSONObject.has("app_data")) {
                ...
                this.mLogBundle.channelId = com.baidu.mobads.sdk.internal.a.f10877a;
            }
            ...
            if (jSONObject.has("trans_info") || jSONObject.has("tans_info")) {
                ...
                if (jSONObject4 != null) {
                    checkVideoFrame(jSONObject4.getInt(com.umeng.ccg.a.f49746H), jSONObject4.getInt("sent_frames"), jSONObject4.getInt("checked_dts"));
                }
            }
    ...
    public void openNodeOptimizer(boolean z2) {
        this.mOpenNodeOptimizer = z2;
    }

    public void reset() {
        this.mCdnPlayURL = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mCurrentPlayURL = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mCdnIp = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mIpIsFromPlayerCore = false;
        this.mLogIndex = 0L;
        this.mPushClientSDKVersion = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mPushClientPlatform = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mPushClientOSVersion = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mPushClientModel = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mPushClientStartTime = com.baidu.mobads.sdk.internal.a.f10877a;
        ...
        this.mPushClientPushProtocal = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mPushClientQId = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mEvaluatorSymbol = com.baidu.mobads.sdk.internal.a.f10877a;
        ...
        this.mCodecName = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mCodecType = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mIsInMainLooper = 1;
        this.mRuleIds = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mSessionId = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mSettingsInfo = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mTTNetNQEInfo = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mEnableP2P = 0;
        ...
        this.mLastResolution = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mDefaultResBitrate = -1;
        this.mResBitrate = -1L;
        this.mAbrSwitchCount = 0;
        this.mAbrSwitchCountInfo = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mAbrSwitchInfo = com.baidu.mobads.sdk.internal.a.f10877a;
        ...
        this.mRtcSessionId = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mRtcPlayStopStatInfo = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mDisableVideoRender = 0;
        this.mRequestUrl = com.baidu.mobads.sdk.internal.a.f10877a;
        ...
        this.mLiveIOPlay = 0;
        this.mLiveIOP2P = 0;
        this.mLiveIOErrorMsg = com.baidu.mobads.sdk.internal.a.f10877a;
        this.mFirstFrameView = 0L;
        this.mLiveIOVersion = com.baidu.mobads.sdk.internal.a.f10877a;
    ...
    public void setCdnIp(String str, boolean z2) {
        this.mCdnIp = str;
        this.mIpIsFromPlayerCore = z2;
    }
    ...
    public void setRemoteSorted(boolean z2) {
        this.mIsRemoteSorted = z2;
    }
