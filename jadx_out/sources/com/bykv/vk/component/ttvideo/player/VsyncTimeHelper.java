...
public final class VsyncTimeHelper {
    ...
    public static final class UIVSyncSampler implements Handler.Callback, Choreographer.FrameCallback {
        ...
        private void addObserverInternal() {
            ...
            if (i2 != 1 || (choreographer = this.choreographer) == null) {
                return;
            }
        ...
        private void recordUIFps(long j2) {
            ...
            long j3 = this.sampledVsyncTimeNs - this.lastSampledVsyncTimeNs;
            if (j3 <= 0) {
                this.lastSampledVsyncTimeNs = -9223372036854775807L;
                return;
            }
            long j4 = this.uiVsyncDurationNs;
            this.skipedFrameCount += j3 - j4 > 0 ? Math.round((j3 - j4) / j4) : 0;
            int iMin = (int) (1000000000 / j3);
        ...
        private void removeObserverInternal() {
            ...
            int i2 = this.observerCount - 1;
            this.observerCount = i2;
            if (i2 != 0 || (choreographer = this.choreographer) == null) {
                return;
            }
        ...
        private void updateUIVsyncDurationNs(long j2) {
            this.uiVsyncDurationNs = j2;
        }
        ...
        public void updateVsyncDuration(long j2) {
            this.bundle.putLong(BUNDLE_VSYNC_DURATION, j2);
