...
public interface MediaPlayer {
    ...
    public interface OnExternInfoListener {
        void onExternInfo(MediaPlayer mediaPlayer, int i2, String str);
    }
    ...
    public interface onSARChangedListener {
        void onSARChanged(MediaPlayer mediaPlayer, int i2, int i3);
    }
    ...
    void setDataSource(FileDescriptor fileDescriptor, long j2, long j3) throws IllegalStateException, IOException, IllegalArgumentException;
    ...
    void switchStream(int i2, int i3);
    ...
    public static class TrackInfo {
        ...
        public TrackInfo(int i2, MediaFormat mediaFormat) {
