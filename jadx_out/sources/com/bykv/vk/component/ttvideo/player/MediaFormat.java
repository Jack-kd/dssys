...
public final class MediaFormat {
    ...
    public static final MediaFormat createAudioFormat(int i2, int i3, int i4) {
        ...
        mediaFormat.setInteger(KEY_TRACK_ID, i2);
        mediaFormat.setInteger(KEY_SAMPLE_RATE, i3);
        mediaFormat.setInteger(KEY_CHANNEL_COUNT, i4);
        return mediaFormat;
    }
    ...
    public static final MediaFormat createVideoFormat(int i2, int i3, int i4, int i5) {
        ...
        mediaFormat.setInteger(KEY_BIT_RATE, i5);
        return mediaFormat;
    }
