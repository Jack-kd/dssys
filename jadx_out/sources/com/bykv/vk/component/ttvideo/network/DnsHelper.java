...
public final class DnsHelper {
    ...
    public interface OnParseCompletionListener {
        void onParseComplete(String str, String str2, LiveError liveError, boolean z2);
    }
    ...
    public static final class URLHostIndex {
        ...
        public URLHostIndex(int i2, int i3, int i4) {
            this.hostStart = i2;
            this.hostEnd = i3;
            this.authEnd = i4;
        }
    ...
    private static URLHostIndex getURLHostIndex(String str) {
        ...
        return new URLHostIndex(i2, i3, iIndexOf);
    }
    ...
    public static String hostToIPUrl(String str, String str2) {
        ...
        int i2 = uRLHostIndex.hostEnd;
        if (uRLHostIndex.authEnd != -1) {
            str3 = str3 + str.substring(uRLHostIndex.hostEnd, uRLHostIndex.authEnd);
            i2 = uRLHostIndex.authEnd;
        }
        if (!zStartsWith) {
            str3 = str3 + ServiceReference.DELIMITER + getUrlHost(str);
        }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void notifyParseComplete(boolean z2, String str, String str2, LiveError liveError, boolean z3) {
        OnParseCompletionListener onParseCompletionListener;
        if (this.mIsForceHttp != z2 || (onParseCompletionListener = this.mCompletionListener) == null) {
            return;
        }
        if (z3 && str2 != null) {
        ...
        onParseCompletionListener.onParseComplete(str, str2, liveError, z3);
    }
    ...
    public void configure(boolean z2, String str) {
        this.mIsForceHttp = (!z2 || this.mNetworkClient == null || TextUtils.isEmpty(str) || str.equals("null")) ? false : true;
    ...
    public void parseDns(final String str, OnParseCompletionListener onParseCompletionListener) {
        ...
        final boolean z2 = this.mIsForceHttp;
        cancel();
