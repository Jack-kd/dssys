    ...
    public static void c(File file) throws IOException {
        if (file.exists()) {
            ...
            if (file.lastModified() < jCurrentTimeMillis) {
                com.octopus.ad.internal.c.f.d(com.octopus.ad.internal.c.f.f34582r, "Last modified date {} is not set for file {}" + new Date(file.lastModified()) + file.getAbsolutePath());
            }
        }
    }
