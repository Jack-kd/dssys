...
public final class NativeAd implements AdLifeControl, IBidding {
    ...
    private final com.octopus.ad.internal.b.c f33213a;

    @RequiresPermission(g.f31159a)
    public NativeAd(Context context, String str, NativeAdListener nativeAdListener) {
        this(context, str, nativeAdListener, "");
    }

    @Override // com.octopus.ad.AdLifeControl
    public void cancel() {
        com.octopus.ad.internal.b.c cVar = this.f33213a;
        if (cVar != null) {
            cVar.m();
            this.f33213a.f34252b.a();
        }
    }
    ...
    public boolean isLoaded() {
        return this.f33213a.g();
    }

    public boolean isValid() {
        return isLoaded() && this.f33213a.h();
    }

    @RequiresPermission(g.f31159a)
    public void loadAd() {
        this.f33213a.a(new AdRequest.Builder().build().a());
    }
    ...
    @RequiresPermission(g.f31159a)
    public NativeAd(Context context, String str, NativeAdListener nativeAdListener, String str2) {
        com.octopus.ad.internal.b.c cVar = new com.octopus.ad.internal.b.c(context == null ? q.a().l() : context, str, p.NATIVE, str2);
        this.f33213a = cVar;
