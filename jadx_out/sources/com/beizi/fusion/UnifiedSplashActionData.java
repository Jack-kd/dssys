...
public class UnifiedSplashActionData {
    private int downX;
    private int downY;
    ...
    public void setMaxAccX(double d2) {
        this.maxAccX = d2;
    }
    ...
    public String toString() {
        return "UnifiedSplashActionData{type=" + this.type + ", downX=" + this.downX + ", downY=" + this.downY + ", upX=" + this.upX + ", upY=" + this.upY + '}';
    }
}
