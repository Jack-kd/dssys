...
public class i4 extends e2 implements b2 {

    /* renamed from: U, reason: collision with root package name */
    private Context f14402U;

    /* renamed from: V, reason: collision with root package name */
    private String f14403V;

    /* renamed from: W, reason: collision with root package name */
    private long f14404W;

    /* renamed from: X, reason: collision with root package name */
    private long f14405X;

    /* renamed from: Y, reason: collision with root package name */
    private cj f14406Y;

    /* renamed from: a0, reason: collision with root package name */
    private AdSpacesBean.UniteControlBean f14408a0;

    /* renamed from: b0, reason: collision with root package name */
    private int f14409b0;

    /* renamed from: e0, reason: collision with root package name */
    private boolean f14412e0;

    /* renamed from: f0, reason: collision with root package name */
    private long f14413f0;

    /* renamed from: g0, reason: collision with root package name */
    private String f14414g0;

    /* renamed from: h0, reason: collision with root package name */
    private String f14415h0;

    /* renamed from: Z, reason: collision with root package name */
    protected String f14407Z = null;

    /* renamed from: c0, reason: collision with root package name */
    private boolean f14410c0 = false;

    /* renamed from: d0, reason: collision with root package name */
    private boolean f14411d0 = false;

    public i4(Context context, String str, long j2, long j3, AdSpacesBean.BuyerBean buyerBean, AdSpacesBean.ForwardBean forwardBean, String str2, String str3, n3 n3Var) {
    ...
    private boolean N0() {
        try {
            AdSpacesBean.UniteControlBean uniteControlBean = this.f14408a0;
            if (uniteControlBean == null) {
                return true;
            }
            int random = uniteControlBean.getRandom();
            long duration = this.f14408a0.getDuration();
            long jLongValue = ((Long) go.a(this.f14402U, "uniteTime", (Object) 0L)).longValue();
            if (jLongValue > 0 && duration > 0 && System.currentTimeMillis() - jLongValue < duration) {
                if (random < this.f14409b0 && random != 100) {
                    return false;
                }
            }
            return true;
    ...
    private void P0() {
        ...
        AdSpacesBean.BuyerBean.OrderDataEulerAngleViewBean orderDataEulerAngleViewBeanA = a(eulerAngleRule.getOrderData(), this.f14406Y.c());
    ...
    private void Q0() {
        ...
        AdSpacesBean.BuyerBean.OrderDataFullScreenClickBean orderDataFullScreenClickBeanB = b(fullScreenClick.getOrderData(), this.f14406Y.c());
    ...
    private void S0() {
        ...
        AdSpacesBean.BuyerBean.OrderDataRegionalClickViewBean orderDataRegionalClickViewBeanC = c(regionalClickView.getOrderData(), this.f14406Y.c());
    ...
    private void T0() {
        ...
        AdSpacesBean.BuyerBean.OrderDataScrollViewOrderBean orderDataScrollViewOrderBeanD = d(scrollClick.getOrderData(), this.f14406Y.c());
    ...
    private void U0() {
        ...
        AdSpacesBean.BuyerBean.OrderDataShakeViewBean orderDataShakeViewBeanE = e(shakeView.getOrderData(), this.f14406Y.c());
    ...
    public void A0() {
        h0();
        L0();
        cj cjVar = new cj(this.f14402U);
        this.f14406Y = cjVar;
        cjVar.a(this.f13619i);
        this.f14406Y.a(this.f13615e);
        this.f14406Y.a(this.f13619i);
        this.f14406Y.a(new a());
        this.f14406Y.b(true);
        try {
            this.f14406Y.a(this.f13612b.m44clone());
        } catch (Exception e2) {
            e2.printStackTrace();
        }
        this.f14406Y.a((int) this.f14404W);
        this.f14406Y.a(this.f13615e);
        if ("S2S".equals(l())) {
            this.f14406Y.c(l());
            n3 n3Var = this.f13614d;
        ...
        if (n3Var2 != null) {
            Map mapY = n3Var2.y();
            if (!TextUtils.isEmpty(this.f14414g0) || !TextUtils.isEmpty(this.f14415h0)) {
                if (mapY == null) {
                    mapY = new HashMap();
                }
                mapY.put("bz_user_id", this.f14414g0);
                if (!TextUtils.isEmpty(this.f14415h0)) {
                    mapY.put("bz_user_custom_data", h3.b(this.f14415h0));
                }
            }
            this.f14406Y.c(mapY);
            this.f14406Y.d(this.f13614d.v());
        }
        this.f14406Y.w();
    }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:22:0x0083, code lost:
        ...
        r6.f14411d0 = com.beizi.fusion.rl.a(java.lang.Integer.parseInt(r3.getRate()));
     */
    @Override // com.beizi.fusion.e2
    /*
    ...
    */
    public void B0() {
        ...
        L59:
            ...
            if (r2 <= 0) goto L9a
            r6.f14410c0 = r0     // Catch: java.lang.Exception -> L92
            r2 = 0
        L6b:
            ...
            r6.f14411d0 = r1     // Catch: java.lang.Exception -> L92
            goto L9a
        L92:
            r1 = move-exception
            goto L97
        ...
        L9a:
            ...
            r6.D()
            r6.v0()
            android.content.Context r1 = r6.f14402U
        ...
        Le3:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.beizi.fusion.i4.B0():void");
    }
    ...
    public class a implements ej {
        ...
        @Override // com.beizi.fusion.ej
        public void a() {
            if (i4.this.f13614d != null) {
                i4.this.f13614d.N();
            }
        }
        ...
        public void onAdClicked() {
            if (i4.this.f14410c0 && i4.this.f13615e != null) {
                i4.this.f13612b.setCallBackStrategyUuid(i4.this.f13615e.getCallBackStrategyUuid());
                i4.this.I0();
            }
            i4.this.a0();
            if (!i4.this.f14410c0 || i4.this.f14411d0) {
                if (i4.this.f13614d != null && i4.this.f13614d.z() != 2) {
                    i4.this.f13614d.b(i4.this.x());
                }
                i4.this.Z();
                i4.this.J0();
            }
        ...
        public void onAdFailedToLoad(int i2) {
            i4.this.a(String.valueOf(i2), i2);
        }

        @Override // com.beizi.fusion.ej
        public void onAdLoaded() {
            i4.this.f13620j = c2.ADLOAD;
            if (i4.this.f14406Y.q() != null) {
                try {
                    i4 i4Var = i4.this;
                    i4Var.a(Double.parseDouble(i4Var.f14406Y.q()));
                } catch (Exception e2) {
                    e2.printStackTrace();
                }
            }
            i4 i4Var2 = i4.this;
            i4Var2.f14412e0 = i4Var2.f14406Y.u();
            boolean unused = i4.this.f14412e0;
            if (i4.this.f14412e0) {
                i4 i4Var3 = i4.this;
                i4Var3.f14413f0 = i4Var3.f14406Y.f();
                i4.this.f13612b.setIsCacheAd("1");
                if (i4.this.f14413f0 > 0) {
                    i4.this.f13612b.setCacheTime(String.valueOf(System.currentTimeMillis() - i4.this.f14413f0));
                }
                i4.this.I0();
            }
            i4.this.g0();
        ...
        public void a(String str) {
            try {
                go.b(i4.this.f14402U, i4.this.f14407Z, Long.valueOf(System.currentTimeMillis()));
                i4.this.f13612b.setComplain(str);
                i4.this.I0();
                i4.this.d0();
            } catch (Exception e2) {
                e2.printStackTrace();
    ...
    public void z() {
        cj cjVar;
        if (L() && (cjVar = this.f14406Y) != null && cjVar.t()) {
            G0();
        }
    }
