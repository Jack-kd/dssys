...
public final class b extends d {
    ...
    public final /* synthetic */ c f41615e;

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public b(c cVar, Map map, String str, String str2) {
        super(str, map);
        this.f41615e = cVar;
        this.f41614d = str2;
    }
    ...
    public final void a() {
        ...
        com.smartdigimkt.p1.a aVar = this.f41615e.f41618c;
        if (aVar != null) {
            aVar.onAdClosed();
        }
        e eVar = com.smartdigimkt.p1.b.f42548a;
        eVar.f42554a.remove(this.f41614d);
    }
