...
import com.smartdigimkt.v1.g2;
import com.smartdigimkt.z3.c;

/* loaded from: classes5.dex */
public class CloseFrameLayout extends FrameLayout implements b3 {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        int action;
        Rect rect;
        if (this.f43355a >= 1.0f || (!((action = motionEvent.getAction()) == 0 || action == 5) || (rect = this.f43356b) == null || rect.contains(getLeft() + ((int) motionEvent.getX()), getTop() + ((int) motionEvent.getY())))) {
    ...
    public void setClickViewAlpha(double d2) {
        if (this.f43357c < 1.0f && d2 >= 0.0d && d2 <= 1.0d) {
            float f2 = (float) d2;
            try {
                this.f43357c = f2;
                setAlpha(f2);
