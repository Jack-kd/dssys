...
public class WebImage extends WebViewClient {
    ...
    public WebImage(WebView webView, String str, Object obj, boolean z2, boolean z3, int i2) {
        this.wv = webView;
        this.url = str;
        this.progress = obj;
        this.zoom = z2;
    ...
    public void setup() {
        String strReplace = getSource(this.wv.getContext()).replace("@src", this.url).replace("@color", Integer.toHexString(this.color));
        this.wv.setWebViewClient(this);
        this.wv.loadDataWithBaseURL(null, strReplace, "text/html", "utf-8", null);
        this.wv.setBackgroundColor(this.color);
    }
