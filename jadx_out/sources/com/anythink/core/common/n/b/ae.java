...
public abstract class ae {
    ...
    private static ae a(final x xVar, final byte[] bArr, final int i2) {
        if (bArr != null) {
            com.anythink.core.common.n.b.a.c.a(bArr.length, i2);
            return new ae() { // from class: com.anythink.core.common.n.b.ae.2

                /* renamed from: d, reason: collision with root package name */
                final /* synthetic */ int f6692d = 0;
    ...
    private static ae a(final x xVar, final File file) {
        if (file != null) {
            return new ae() { // from class: com.anythink.core.common.n.b.ae.3
                ...
                @Override // com.anythink.core.common.n.b.ae
                public final void a(com.anythink.core.common.n.c.d dVar) {
                    com.anythink.core.common.n.c.w wVarA = com.anythink.core.common.n.c.n.a(file);
                    try {
                        dVar.a(wVarA);
                        if (wVarA != null) {
                            wVarA.close();
