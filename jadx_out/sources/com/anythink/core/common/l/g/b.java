...
public final class b implements ATBiddingListenerExt {
    ...
    private final ATBiddingListener f5470a;

    /* renamed from: b, reason: collision with root package name */
    private final com.anythink.core.common.l.d.b f5471b;

    public b(ATBiddingListener aTBiddingListener, com.anythink.core.common.l.d.b bVar) {
        this.f5470a = aTBiddingListener;
        this.f5471b = bVar;
    }

    @Override // com.anythink.core.api.ATBiddingListener
    public final void onC2SBidResult(ATBiddingResult aTBiddingResult) {
        ATBiddingListener aTBiddingListener = this.f5470a;
    ...
    public final void onC2SBiddingResultWithCache(final ATBiddingResult aTBiddingResult, final BaseAd baseAd) {
        ...
        if (!aTBiddingResult.isSuccessWithUseType() || (bVar = this.f5471b) == null || !bVar.l()) {
            ATBiddingListener aTBiddingListener = this.f5470a;
            if (aTBiddingListener != null) {
        ...
        if (baseAd == null) {
            ATBiddingListener aTBiddingListener2 = this.f5470a;
        ...
        boolean zEquals = String.valueOf(this.f5471b.e()).equals("2") ? ((String) this.f5471b.a("size", "")).equals(y.f4503c) : true;
        this.f5471b.a(baseAd.getNetworkInfoMap());
        if (TextUtils.isEmpty(baseAd.getMainImageUrl()) && baseAd.getAdMediaView(new Object[0]) == null && zEquals) {
            ATBiddingListener aTBiddingListener3 = this.f5470a;
        ...
        if (!TextUtils.isEmpty(baseAd.getMainImageUrl())) {
            com.anythink.core.common.res.b.a(s.b().g()).a(new e(2, baseAd.getMainImageUrl()), 0, 0, new b.a() { // from class: com.anythink.core.common.l.g.b.1
                @Override // com.anythink.core.common.res.b.a
                public final void onFail(String str, String str2) {
                    if (b.this.f5470a != null) {
                        b.this.f5470a.onC2SBiddingResultWithCache(ATBiddingResult.fail("load image failed: ".concat(String.valueOf(str2))), null);
                    }
                }

                @Override // com.anythink.core.common.res.b.a
                public final void onSuccess(String str, Bitmap bitmap) {
                    if (!TextUtils.equals(str, baseAd.getMainImageUrl()) || b.this.f5470a == null) {
                        return;
                    }
                    b.this.f5470a.onC2SBiddingResultWithCache(aTBiddingResult, new d(baseAd, b.this.f5471b.a()));
                }
            });
            return;
        }
        ATBiddingListener aTBiddingListener4 = this.f5470a;
        if (aTBiddingListener4 != null) {
            aTBiddingListener4.onC2SBiddingResultWithCache(aTBiddingResult, new d(baseAd, this.f5471b.a()));
        }
    }
