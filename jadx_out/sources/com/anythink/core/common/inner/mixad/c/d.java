...
public final class d implements IATThirdPartyMaterial {
    ...
    public final View getShakeView(int i2, int i3, ATShakeViewListener aTShakeViewListener) {
        g gVar = this.f4749b;
        if (gVar != null) {
            return gVar.a(i2, i3, aTShakeViewListener);
        }
        return null;
    }
    ...
    public final Double getStarRating() {
        BaseAd baseAd = this.f4748a;
        return (baseAd == null || baseAd.getStarRating() == null) ? Double.valueOf(0.0d) : this.f4748a.getStarRating();
    }
