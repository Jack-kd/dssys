...
public class y {
    ...
    private static final String f8317b = "MraidJSController";
    ...
    private static volatile y f8319d;

    /* renamed from: e, reason: collision with root package name */
    private volatile String f8321e;

    /* renamed from: f, reason: collision with root package name */
    private File f8322f;

    /* renamed from: g, reason: collision with root package name */
    private final Object f8323g = new Object();

    /* renamed from: h, reason: collision with root package name */
    private final String f8324h = "mraid_js";

    /* renamed from: i, reason: collision with root package name */
    private final String f8325i = "anythink_mraid/";

    /* renamed from: a, reason: collision with root package name */
    boolean f8320a = false;

    /* renamed from: com.anythink.core.common.v.y$3, reason: invalid class name */
    public class AnonymousClass3 implements Runnable {
        ...
        public final void run() {
            synchronized (y.this.f8323g) {
                try {
                    if (!y.this.f8322f.exists()) {
                        y.this.f8322f.mkdirs();
                    }
                    File file = new File(y.this.f8322f, "mraid_js.txt");
                    if (file.exists()) {
                        file.delete();
                    }
                    v.a(this.f8330a.getBytes(), file);
    ...
    private y() {
        try {
            this.f8322f = new File(com.anythink.core.common.d.s.b().g().getFilesDir().getAbsoluteFile().getAbsolutePath() + "/anythink_mraid/");
        } catch (Throwable unused) {
        }
        com.anythink.core.common.v.b.c.a().d(new com.anythink.core.common.v.b.d(com.anythink.core.common.v.b.e.bE, new Runnable() { // from class: com.anythink.core.common.v.y.1
            @Override // java.lang.Runnable
            public final void run() {
                y yVar = y.this;
                yVar.f8321e = yVar.c();
    ...
    private String d() {
        return !TextUtils.isEmpty(this.f8321e) ? this.f8321e : f8318c;
    }
    ...
    public String c() {
        ...
        synchronized (this.f8323g) {
            strA = "";
            try {
                File file = new File(this.f8322f, "mraid_js.txt");
    ...
    public static /* synthetic */ void b(y yVar, String str) {
        com.anythink.core.common.v.b.c.a().d(new com.anythink.core.common.v.b.d(com.anythink.core.common.v.b.e.bF, yVar.new AnonymousClass3(str)));
    }
    ...
    private synchronized void a(final Context context, final String str) {
        ...
        String strC = ad.c(context, t.b.f3058a, "mraid_js", "");
        if (TextUtils.isEmpty(strC) || !strC.equals(str)) {
            this.f8320a = true;
            try {
                new com.anythink.core.common.m.i(str).a(1, new com.anythink.core.common.m.s() { // from class: com.anythink.core.common.v.y.2
                    ...
                    public final void onLoadFinish(int i2, Object obj) {
                        ...
                        if (!TextUtils.isEmpty(string)) {
                            y.this.f8321e = string;
                            y.b(y.this, string);
                            ad.b(context, t.b.f3058a, "mraid_js", str);
                        }
                        y.this.f8320a = false;
                    }
    ...
    private void a(String str) {
        com.anythink.core.common.v.b.c.a().d(new com.anythink.core.common.v.b.d(com.anythink.core.common.v.b.e.bF, new AnonymousClass3(str)));
    }
}
