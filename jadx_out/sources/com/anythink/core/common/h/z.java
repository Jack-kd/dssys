...
public class z {
    ...
    public com.anythink.core.common.f commonAdManager;
    ...
    public z(boolean z2, double d2, String str, String str2, String str3, String str4, String str5, ATAdConst.CURRENCY currency) {
        this.useType = 1;
        this.isSuccess = z2;
        this.originPrice = d2;
        this.price = d2;
    ...
    public com.anythink.core.common.f getCommonAdManager() {
        return this.commonAdManager;
    }
    ...
    public void setCommonAdManager(com.anythink.core.common.f fVar) {
        this.commonAdManager = fVar;
    }
    ...
    public z(boolean z2, double d2, String str, ATBiddingNotice aTBiddingNotice, String str2, ATAdConst.CURRENCY currency) {
        this.useType = 1;
        this.isSuccess = z2;
        this.originPrice = d2;
        this.price = d2;
    ...
    public z(boolean z2, double d2, double d3, String str, ATBiddingNotice aTBiddingNotice, String str2, ATAdConst.CURRENCY currency) {
        this(z2, d3, str, aTBiddingNotice, str2, currency);
        this.sortPrice = d2;
    }
}
