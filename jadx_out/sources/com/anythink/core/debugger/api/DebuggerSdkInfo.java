...
public class DebuggerSdkInfo {
    ...
    public void setHaveLoadAd(boolean z2) {
        this.isHaveLoadAd = z2;
    }

    public void setHavePreInitNetwork(boolean z2) {
        this.isHavePreInitNetwork = z2;
    }

    public void setInitSdk(boolean z2) {
        this.isInitSdk = z2;
    }
