...
public class ATBiddingResult extends z {
    private ATBiddingResult(boolean z2, double d2, double d3, String str, ATBiddingNotice aTBiddingNotice, String str2, ATAdConst.CURRENCY currency) {
        super(z2, d2, d3, str, aTBiddingNotice, str2, currency);
    }
