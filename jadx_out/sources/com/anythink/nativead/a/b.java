...
public final class b implements ATNativeMaterial {
    ...
    CustomNativeAd f9190a;

    /* renamed from: b, reason: collision with root package name */
    boolean f9191b;

    public b(CustomNativeAd customNativeAd, boolean z2) {
        this.f9190a = customNativeAd;
        this.f9191b = z2;
    }

    @Override // com.anythink.core.api.IATThirdPartyMaterial
    public final ATAdAppInfo getAdAppInfo() {
        CustomNativeAd customNativeAd = this.f9190a;
    ...
    public final View getAdMediaView(Object... objArr) {
        ...
        if (this.f9191b || this.f9190a.isNativeExpress() || (customNativeAd = this.f9190a) == null) {
            return null;
        }
    ...
    public final View getSlideView(int i2, int i3, int i4, ATShakeViewListener aTShakeViewListener) {
        CustomNativeAd customNativeAd = this.f9190a;
        if (customNativeAd != null) {
            return customNativeAd.getSlideView(i2, i3, i4, aTShakeViewListener);
        }
        return null;
    }
    ...
    public final Double getStarRating() {
        ...
        if (customNativeAd != null && customNativeAd.getStarRating() != null) {
            dDoubleValue = this.f9190a.getStarRating().doubleValue();
        }
    ...
    public final double getVideoProgress() {
        return this.f9190a.getVideoProgress();
    }
