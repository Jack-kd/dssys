...
public class TTATNativePatchAd extends TTATNativeAd {
    public TTATNativePatchAd(Context context, String str, TTNativeAd tTNativeAd, boolean z2, Bitmap bitmap, int i2, boolean z3) {
        super(context, str, tTNativeAd, z2, bitmap, i2, z3);
    }
