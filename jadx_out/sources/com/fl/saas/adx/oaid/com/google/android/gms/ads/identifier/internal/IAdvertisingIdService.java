package com.fl.saas.adx.oaid.com.google.android.gms.ads.identifier.internal;
...
public interface IAdvertisingIdService extends IInterface {
    ...
    public static class Default implements IAdvertisingIdService {
        ...
        @Override // com.fl.saas.adx.oaid.com.google.android.gms.ads.identifier.internal.IAdvertisingIdService
        public String getId() {
            return null;
        }
    ...
    boolean isLimitAdTrackingEnabled(boolean z2);
}
