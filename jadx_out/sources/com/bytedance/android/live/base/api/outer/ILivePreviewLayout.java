...
public interface ILivePreviewLayout {
    ...
    public static class Builder {
        ...
        public Builder setAutoEnterEnable(boolean z2) {
            this.autoEnterEnable = z2;
            return this;
        }

        public Builder setCanShowDislike(boolean z2) {
            this.canShowDislike = z2;
            return this;
        }
        ...
        public Builder setEnablePullToRefresh(boolean z2) {
        ...
        public Builder setShowTopList(boolean z2) {
            this.showTopList = z2;
            return this;
        }

        public Builder setShowTopListAtOnce(boolean z2) {
            this.showTopListAtOnce = z2;
            return this;
        }

        public Builder setSmoothEnterEnable(boolean z2) {
            this.smoothEnterEnable = z2;
            return this;
        }
