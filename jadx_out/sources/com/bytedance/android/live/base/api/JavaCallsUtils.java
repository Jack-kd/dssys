...
public class JavaCallsUtils {
    ...
    public static <T> T callMethod(Object obj, String str, Object... objArr) {
        try {
            ...
            a.j(LOG_TAG, "Meet exception when call Method '" + str + "' in " + obj, e2);
            return null;
        }
    }
    ...
    public static <T> T callStaticMethod(String str, String str2, Object... objArr) {
        try {
            ...
            a.j(LOG_TAG, "Meet exception when call Method '" + str2 + "' in " + str, e2);
            return null;
        }
    }
    ...
    private static Class<?>[] getParameterTypes(Object... objArr) {
        ...
        for (int i2 = 0; i2 < objArr.length; i2++) {
            ...
            clsArr[i2] = (obj == null || !(obj instanceof JavaParam)) ? obj == null ? null : obj.getClass() : ((JavaParam) obj).clazz;
        }
        return clsArr;
    }
    ...
    public static <T> T newEmptyInstance(Class<?> cls) {
        try {
            ...
            a.j(LOG_TAG, "Meet exception when make instance as a " + cls.getSimpleName(), e2);
            return null;
        }
    }
    ...
    public static Object newInstance(String str, Object... objArr) {
        try {
            ...
            a.j(LOG_TAG, "Meet exception when make instance as a ".concat(String.valueOf(str)), e2);
            return null;
        }
    }
