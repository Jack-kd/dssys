...
public class LivePluginHelper {
    ...
    public static final ScheduledExecutorService sExecutor = l.jx(new DefaultThreadFactory());
    ...
    public static class DefaultThreadFactory implements ThreadFactory {
        ...
        public Thread newThread(Runnable runnable) {
            jx jxVar = new jx(this.group, runnable, this.namePrefix + this.threadNumber.getAndIncrement(), 0L);
            if (jxVar.isDaemon()) {
                jxVar.setDaemon(false);
            }
            if (jxVar.getPriority() != 10) {
    ...
    public static class LiveInitCallback implements ILiveInitCallback {
        ...
        @Override // com.bytedance.android.live.base.api.ILiveInitCallback
        public void onLiveInitFailed(String str) {
            ArrayList arrayList = LivePluginHelper.mLiveInitListeners;
            int size = arrayList.size();
            int i2 = 0;
            while (i2 < size) {
                Object obj = arrayList.get(i2);
                i2++;
                ILiveInitCallback iLiveInitCallback = (ILiveInitCallback) obj;
    ...
    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback) throws Throwable {
        init(application, str, builder, iLiveInitCallback, true);
    }

    public static void initLive(final Application application, final String str, final ILiveHostContextParam.Builder builder, final ILiveInitCallback iLiveInitCallback, final boolean z2) {
        runInLiveProcess = z2;
            ...
            public void run() {
                ...
                if (LivePluginHelper.prepare(new Runnable() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.2.1
                    ...
                    public void run() {
                        ...
                        LivePluginHelper.realInitLivePlugin(application, str, builder, iLiveInitCallback, z2);
                    }
                })) {
    ...
    public static void logVersionInfo() {
        ...
        try {
            ...
            a.jx("live init", "version_info: lib_version_name=2.1.1.4-tob-tob-61440787; sdkApiVersionName=2.1.1.4-tob-tob-61440787; pluginVersionCode=" + ((Long) pair.first).longValue() + "; pluginVersionName=" + ((String) pair.second));
        } catch (Throwable th) {
            a.hp(th);
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static void realInitLivePlugin(final Application application, final String str, final ILiveHostContextParam.Builder builder, final ILiveInitCallback iLiveInitCallback, final boolean z2) {
        sExecutor.execute(new Runnable() { // from class: com.bytedance.android.openliveplugin.LivePluginHelper.1
            ...
            public void run() {
                ...
                LiveReflectFacade.initLiveInPlugin(application, str, builder, z2, LiveInitCallback.INSTANCE);
            }
        });
    }

    public static void setApmEnable(boolean z2) {
        ZeusPlatformUtils.setApmEnable(z2);
    }
    ...
    public static void setStopAppLogOnEnterBackground(boolean z2) {
        stopAppLogOnEnterBackground = z2;
    }
    ...
    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z2) throws Throwable {
        init(application, str, builder, iLiveInitCallback, z2, false);
    }

    public static void init(Application application, String str, ILiveHostContextParam.Builder builder, ILiveInitCallback iLiveInitCallback, boolean z2, boolean z3) throws Throwable {
        if (!ZeusPlatformUtils.hasInitZeus) {
            ZeusPlatformUtils.initZeus(application, z2, "com.byted.live.lite");
        } else if (z2) {
            ZeusPlatformUtils.fetchPlugin("com.byted.live.lite");
        }
        initLive(application, str, builder, iLiveInitCallback, z3);
    }
}
