...
public class ZeusPlatformUtils {
    ...
    public static final ScheduledExecutorService sExecutor = l.jx(new s("ZeusPlatformUtils"));
    ...
    public static void initZeus(Application application) throws Throwable {
    ...
    public static void setHostVersionCodeTag(long j2) {
        addCustomTag("internal_host_version_code", String.valueOf(j2));
    }
    ...
    public static void initZeus(Application application, boolean z2, String str) throws Throwable {
        if (application == null || hasInitZeus) {
            return;
        }
        hasInitZeus = true;
