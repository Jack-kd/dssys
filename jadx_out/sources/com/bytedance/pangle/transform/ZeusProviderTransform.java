...
public class ZeusProviderTransform {
    ...
    public static int update(Object obj, Uri uri, ContentValues contentValues, String str, String[] strArr, String str2) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, n.f36454q, new Object[]{uri, contentValues, str, strArr}, new Class[]{Uri.class, ContentValues.class, String.class, String[].class})).intValue();
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public static int update(Object obj, Uri uri, ContentValues contentValues, Bundle bundle, String str) {
        ...
        try {
            return ((Integer) MethodUtils.invokeMethod(obj, n.f36454q, new Object[]{uri, contentValues, bundle}, new Class[]{Uri.class, ContentValues.class, Bundle.class})).intValue();
        } catch (Exception e2) {
            throw new RuntimeException(e2);
        }
    }
    ...
    public static void notifyChange(Object obj, Collection<Uri> collection, ContentObserver contentObserver, int i2, String str) {
        if (obj instanceof ContentResolver) {
            ...
            ((ContentResolver) obj).notifyChange((Collection<Uri>) arrayList, contentObserver, i2);
            return;
        }
        try {
