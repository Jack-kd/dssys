...
import com.byazt.ye.FileProvider;
...
public class ZeusTransformUtils {
    ...
    public static void canThrowException(boolean z2) {
        sCanThrowException = z2;
    }
    ...
    private static Context convertProxy2PluginActivity(Context context) {
        try {
            return context instanceof GenerateProxyActivity ? (Activity) FieldUtils.readField(context, "mTargetActivity") : context;
        } catch (Throwable th) {
    ...
    private static Context getContextIfNeedWrap(Context context, Context context2, String str) {
        ...
        try {
            ...
            if (TextUtils.isEmpty(str2)) {
                if (!getAssetPaths(pluginResources.getAssets()).contains(ServiceReference.DELIMITER + str + "/version")) {
                    return context;
                }
    ...
    /* JADX WARN: Code restructure failed: missing block: B:14:0x0047, code lost:
        ...
        if (android.text.TextUtils.equals(r0, r4) != false) goto L15;
     */
    /*
    ...
    */
    public static android.content.res.Resources getResources(java.lang.Object r3, java.lang.String r4) {
        ...
        L55:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.bytedance.pangle.transform.ZeusTransformUtils.getResources(java.lang.Object, java.lang.String):android.content.res.Resources");
    }
    ...
    public static int mapRes(int i2, String str, String str2) {
        ...
        if (identifier == 0) {
            identifier = Zeus.getAppApplication().getResources().getIdentifier(str2.replace("_", i.f2495E), str, Zeus.getAppApplication().getPackageName());
        }
        if (identifier == 0) {
    ...
    public static void requestPermissions(Object obj, String[] strArr, int i2, String str) throws NoSuchFieldException, SecurityException {
        Object field;
    ...
    public static void supportFragmentWrapper(boolean z2) {
        sSupportFragmentWrapper = z2;
    }
    ...
    public static TypedArray obtainStyledAttributes(Object obj, int i2, int[] iArr, String str) throws Resources.NotFoundException {
        if (obj instanceof Context) {
            int[] iArrHandleAttrBefore = handleAttrBefore(iArr);
