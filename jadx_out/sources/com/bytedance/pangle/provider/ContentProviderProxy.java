...
public class ContentProviderProxy extends ContentProvider {
    ...
    public <T> ParcelFileDescriptor openPipeHelper(@NonNull Uri uri, @NonNull String str, @Nullable Bundle bundle, @Nullable T t2, @NonNull ContentProvider.PipeDataWriter<T> pipeDataWriter) throws FileNotFoundException {
        ...
        try {
            PluginContentProvider pluginContentProviderObtainPluginProvider = obtainPluginProvider(uri, uri.getAuthority());
            if (pluginContentProviderObtainPluginProvider != null) {
                return pluginContentProviderObtainPluginProvider.openPipeHelper(pluginContentProviderObtainPluginProvider.pluginUri, str, bundle, t2, pipeDataWriter);
            }
        } catch (Throwable th) {
    ...
    private PluginContentProvider obtainPluginProvider(Uri uri, String str, String str2) throws JSONException {
        ...
        if (!TextUtils.isEmpty(queryParameter)) {
            queryParameter = e.l(queryParameter);
        }
        ...
        PluginContentProvider pluginProvider = this.mPluginProviderManager.getPluginProvider(new ContentProviderManager.l(strOptString2, strOptString, str2));
