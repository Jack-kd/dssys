...
public abstract class GeneratePluginAppCompatActivity extends AppCompatActivity implements IPluginActivity {
    ...
    public void attachBaseContext(Context context) {
        ...
        hp.hp(this, this.mProxyActivity);
    }
    ...
    public void setContentView(int i2) {
        ...
        ZeusTransformUtils.clearConstructorCache();
        jx.hp(this, findViewById(R.id.content));
    }
    ...
    @Override // com.bytedance.pangle.activity.IPluginActivity
    public void setPluginProxyActivity(com.byazt.fo.l lVar, Plugin plugin) {
        this.mProxyActivity = (GenerateProxyAppCompatActivity) lVar;
        this.mPlugin = plugin;
    }
    ...
    public void startActivityForResult(String str, Intent intent, int i2, Bundle bundle) {
        this.mProxyActivity.startActivityForResult(str, intent, i2, bundle);
    }
