...
public abstract class GenerateProxyAppCompatActivity extends AppCompatActivity implements l {
    ...
    @Override // android.app.Activity, com.byazt.fo.l
    public void finish() {
        GeneratePluginAppCompatActivity generatePluginAppCompatActivity = this.mTargetActivity;
        if (generatePluginAppCompatActivity != null) {
    ...
    @Override // androidx.view.ComponentActivity, androidx.core.app.ComponentActivity, androidx.view.LifecycleOwner
    ...
    public void zeusSuperOnApplyThemeResource(Resources.Theme theme, int i2, boolean z2) {
        super.onApplyThemeResource(theme, i2, z2);
    }
    ...
    public void zeusSuperSetVrModeEnabled(boolean z2, ComponentName componentName) throws PackageManager.NameNotFoundException {
        super.setVrModeEnabled(z2, componentName);
    }
