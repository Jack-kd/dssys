...
@hp(hp = {0, 124, 125, WebSocketProtocol.PAYLOAD_SHORT, 1181})
...
public class TTAdConstant {
    ...
    public static final int IMAGE_MODE_CREATIVE_EFFECT = 2001;
    ...
    public static final int IMAGE_MODE_VERTICAL_CREATIVE_EFFECT = 2002;
    ...
    public enum RitScenes {
        ...
        GAME_MORE_KLLKRTUNITIES(TTAdConstant.l("game_more_kllkrtunities")),
