...
public class h extends a {
    ...
    public void c(Bundle bundle) {
        int i2 = this.f48189E - this.f48243y;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, this.f48244z);
        this.f48214d = layoutParams;
        layoutParams.addRule(11);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(i2, -2);
        this.f48212c = layoutParams2;
        layoutParams2.addRule(9);
        this.f48212c.setMargins(0, 0, r.c(6.0f), 0);
        RelativeLayout.LayoutParams layoutParams3 = new RelativeLayout.LayoutParams(i2, -2);
        this.f48224i = layoutParams3;
        ...
        RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(-1, this.f48244z);
        this.f48222h = layoutParams4;
        addView(this.f48228k, layoutParams4);
        if (i()) {
