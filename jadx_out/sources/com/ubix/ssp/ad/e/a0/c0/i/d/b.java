...
public interface b extends IInterface {
    ...
    public static abstract class a extends Binder implements b {
        ...
        /* renamed from: com.ubix.ssp.ad.e.a0.c0.i.d.b$a$a, reason: collision with other inner class name */
        public static class C0802a implements b {

            /* renamed from: a, reason: collision with root package name */
            public static b f46212a;

            /* renamed from: b, reason: collision with root package name */
            private IBinder f46213b;

            public C0802a(IBinder iBinder) {
                this.f46213b = iBinder;
            }
            ...
            public String a() {
                ...
                try {
                    ...
                    if (this.f46213b.transact(1, parcelObtain, parcelObtain2, 0) || a.m() == null) {
            ...
            public boolean f() {
                ...
                try {
                    parcelObtain.writeInterfaceToken("com.zui.deviceidservice.IDeviceidInterface");
                    if (!this.f46213b.transact(3, parcelObtain, parcelObtain2, 0) && a.m() != null) {
                        return a.m().f();
                    }
                    parcelObtain2.readException();
        ...
        public static b a(IBinder iBinder) {
            ...
            return (iInterfaceQueryLocalInterface == null || !(iInterfaceQueryLocalInterface instanceof b)) ? new C0802a(iBinder) : (b) iInterfaceQueryLocalInterface;
        }

        public static b m() {
            return C0802a.f46212a;
        }
