...
public enum WindAdError {
    ...
    ERROR_NO_AD(MsAdPatternType.MIX_RENDER, "无广告填充");
    ...
    WindAdError(int i2, String str) {
        this.f39156a = i2;
        this.message = str;
    }

    public static WindAdError getWindAdError(int i2) {
        for (WindAdError windAdError : values()) {
            if (windAdError.getErrorCode() == i2) {
                return windAdError;
            }
        }
        return null;
    ...
    public String toString() {
        return String.format(Locale.getDefault(), "{ \"error_code\":%d, \"message\": %s }", Integer.valueOf(this.f39156a), this.message);
    }
}
