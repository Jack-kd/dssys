...
public final class RvAdSetting extends AndroidMessage<RvAdSetting, Builder> {
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 21:
                        ...
                        break;
                    case 22:
                        builder.video_error_reward(ProtoAdapter.BOOL.decode(protoReader));
                        break;
                    default:
    ...
    public RvAdSetting(Integer num, Float f2, Integer num2, Integer num3, Integer num4, Integer num5, Integer num6, Boolean bool, Boolean bool2, ClickAreaSetting clickAreaSetting, Boolean bool3, Integer num7, Integer num8, Integer num9, Boolean bool4, Integer num10, Integer num11, Integer num12, Integer num13, Integer num14, Integer num15, Boolean bool5) {
        this(num, f2, num2, num3, num4, num5, num6, bool, bool2, clickAreaSetting, bool3, num7, num8, num9, bool4, num10, num11, num12, num13, num14, num15, bool5, ByteString.EMPTY);
    }
