...
public final class BidResponse extends AndroidMessage<BidResponse, Builder> {
    ...
    public static final class Builder extends Message.Builder<BidResponse, Builder> {
        ...
        public Builder error_code(Long l2) {
            this.error_code = l2;
            return this;
        }
        ...
        public Builder process_time_ms_dsp(Long l2) {
            this.process_time_ms_dsp = l2;
            return this;
        }

        public Builder process_time_ms_ssp(Long l2) {
            this.process_time_ms_ssp = l2;
            return this;
        }
        ...
        public Builder saas_options(Map<String, String> map) {
            Internal.checkElementsNotNull(map);
            this.saas_options = map;
            return this;
        }
    ...
    public static final class ProtoAdapter_BidResponse extends ProtoAdapter<BidResponse> {
        ...
        public ProtoAdapter_BidResponse() {
            ...
            this.saas_options = ProtoAdapter.newMapAdapter(protoAdapter, protoAdapter);
        }
            ...
            while (true) {
                ...
                switch (iNextTag) {
                    ...
                    case 17:
                        ...
                        break;
                    case 18:
                        builder.saas_options.putAll(this.saas_options.decode(protoReader));
                        break;
                    default:
        ...
        public void encode(ProtoWriter protoWriter, BidResponse bidResponse) throws IOException {
            ...
            ProtoAdapter.BOOL.encodeWithTag(protoWriter, 17, bidResponse.noncompliance_mark);
            this.saas_options.encodeWithTag(protoWriter, 18, bidResponse.saas_options);
        ...
        public int encodedSize(BidResponse bidResponse) {
            ProtoAdapter<String> protoAdapter = ProtoAdapter.STRING;
            int iEncodedSizeWithTag = protoAdapter.encodedSizeWithTag(1, bidResponse.request_id) + Ad.ADAPTER.asRepeated().encodedSizeWithTag(2, bidResponse.ads);
            ProtoAdapter<Long> protoAdapter2 = ProtoAdapter.UINT64;
            int iEncodedSizeWithTag2 = iEncodedSizeWithTag + protoAdapter2.encodedSizeWithTag(3, bidResponse.error_code) + protoAdapter2.encodedSizeWithTag(4, bidResponse.process_time_ms_dsp) + protoAdapter2.encodedSizeWithTag(5, bidResponse.process_time_ms_ssp);
            ProtoAdapter<Integer> protoAdapter3 = ProtoAdapter.UINT32;
            return iEncodedSizeWithTag2 + protoAdapter3.encodedSizeWithTag(6, bidResponse.pctr_valid_check) + protoAdapter.encodedSizeWithTag(7, bidResponse.pctr_version) + protoAdapter.encodedSizeWithTag(8, bidResponse.uid) + protoAdapter3.encodedSizeWithTag(9, bidResponse.expiration_time) + protoAdapter.encodedSizeWithTag(10, bidResponse.ad_ua) + SlotAdSetting.ADAPTER.encodedSizeWithTag(11, bidResponse.slot_ad_setting) + protoAdapter.encodedSizeWithTag(12, bidResponse.error_message) + Template.ADAPTER.encodedSizeWithTag(13, bidResponse.scene) + BiddingResponse.ADAPTER.encodedSizeWithTag(14, bidResponse.bidding_response) + protoAdapter.encodedSizeWithTag(15, bidResponse.rv_callback_url) + protoAdapter.encodedSizeWithTag(16, bidResponse.adx_id) + ProtoAdapter.BOOL.encodedSizeWithTag(17, bidResponse.noncompliance_mark) + this.saas_options.encodedSizeWithTag(18, bidResponse.saas_options) + bidResponse.unknownFields().size();
        }
        ...
        public BidResponse redact(BidResponse bidResponse) {
            ...
            SlotAdSetting slotAdSetting = builderNewBuilder.slot_ad_setting;
            if (slotAdSetting != null) {
                builderNewBuilder.slot_ad_setting = SlotAdSetting.ADAPTER.redact(slotAdSetting);
            }
            Template template = builderNewBuilder.scene;
            if (template != null) {
                builderNewBuilder.scene = Template.ADAPTER.redact(template);
            }
            BiddingResponse biddingResponse = builderNewBuilder.bidding_response;
            if (biddingResponse != null) {
                builderNewBuilder.bidding_response = BiddingResponse.ADAPTER.redact(biddingResponse);
            }
    ...
    static {
        ...
        DEFAULT_NONCOMPLIANCE_MARK = Boolean.FALSE;
    }

    public BidResponse(String str, List<Ad> list, Long l2, Long l3, Long l4, Integer num, String str2, String str3, Integer num2, String str4, SlotAdSetting slotAdSetting, String str5, Template template, BiddingResponse biddingResponse, String str6, String str7, Boolean bool, Map<String, String> map) {
        this(str, list, l2, l3, l4, num, str2, str3, num2, str4, slotAdSetting, str5, template, biddingResponse, str6, str7, bool, map, ByteString.EMPTY);
    }
    ...
    public String toString() {
        ...
        if (!this.saas_options.isEmpty()) {
            sb.append(", saas_options=");
            sb.append(this.saas_options);
        }
    ...
    public BidResponse(String str, List<Ad> list, Long l2, Long l3, Long l4, Integer num, String str2, String str3, Integer num2, String str4, SlotAdSetting slotAdSetting, String str5, Template template, BiddingResponse biddingResponse, String str6, String str7, Boolean bool, Map<String, String> map, ByteString byteString) {
        super(ADAPTER, byteString);
        this.request_id = str;
        this.ads = Internal.immutableCopyOf(a.f36070a, list);
        this.error_code = l2;
        this.process_time_ms_dsp = l3;
        this.process_time_ms_ssp = l4;
        this.pctr_valid_check = num;
        ...
        this.adx_id = str7;
        this.noncompliance_mark = bool;
        this.saas_options = Internal.immutableCopyOf(WindAds.SAAS_OPTIONS, map);
    }
    ...
    public Builder newBuilder() {
        ...
        builder.ads = Internal.copyOf(a.f36070a, this.ads);
