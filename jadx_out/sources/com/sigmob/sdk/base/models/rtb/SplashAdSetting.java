...
public final class SplashAdSetting extends AndroidMessage<SplashAdSetting, Builder> {
    ...
    public static final class ProtoAdapter_SplashAdSetting extends ProtoAdapter<SplashAdSetting> {
        ...
        public int encodedSize(SplashAdSetting splashAdSetting) {
            int iEncodedSizeWithTag = ProtoAdapter.INT32.encodedSizeWithTag(1, splashAdSetting.show_duration);
            ProtoAdapter<Boolean> protoAdapter = ProtoAdapter.BOOL;
            return iEncodedSizeWithTag + protoAdapter.encodedSizeWithTag(2, splashAdSetting.enable_close_on_click) + protoAdapter.encodedSizeWithTag(5, splashAdSetting.enable_full_click) + protoAdapter.encodedSizeWithTag(6, splashAdSetting.invisible_ad_label) + protoAdapter.encodedSizeWithTag(7, splashAdSetting.use_floating_btn) + splashAdSetting.unknownFields().size();
        }
