...
public final class Ad extends AndroidMessage<Ad, Builder> {
    ...
    public static final class Builder extends Message.Builder<Ad, Builder> {
        ...
        public Builder enable_small_window(Boolean bool) {
            this.enable_small_window = bool;
            return this;
        }
        ...
        public Builder frequency_control(List<FrequencyControl> list) {
            Internal.checkElementsNotNull(list);
            this.frequency_control = list;
            return this;
        }
    ...
    public static final class ProtoAdapter_Ad extends ProtoAdapter<Ad> {
            ...
            while (true) {
                ...
                if (iNextTag == 24) {
                    ...
                    if (iNextTag == 31) {
                        ...
                        parcelable = (FrequencyControl) FrequencyControl.ADAPTER.decode(protoReader);
                    } else if (iNextTag != 32) {
                        switch (iNextTag) {
                            case 1:
                        ...
                        builder.enable_small_window(ProtoAdapter.BOOL.decode(protoReader));
                    }
                    list.add(parcelable);
                } else {
        ...
        public void encode(ProtoWriter protoWriter, Ad ad) throws IOException {
            ...
            protoAdapter3.encodeWithTag(protoWriter, 17, ad.forbiden_parse_landingpage);
            ...
            FrequencyControl.ADAPTER.asRepeated().encodeWithTag(protoWriter, 31, ad.frequency_control);
            protoAdapter3.encodeWithTag(protoWriter, 32, ad.enable_small_window);
        ...
        public int encodedSize(Ad ad) {
            ProtoAdapter<String> protoAdapter = ProtoAdapter.STRING;
            int iEncodedSizeWithTag = protoAdapter.encodedSizeWithTag(1, ad.adslot_id) + protoAdapter.encodedSizeWithTag(2, ad.vid) + protoAdapter.encodedSizeWithTag(3, ad.cust_id) + protoAdapter.encodedSizeWithTag(4, ad.camp_id) + protoAdapter.encodedSizeWithTag(5, ad.crid) + MaterialMeta.ADAPTER.asRepeated().encodedSizeWithTag(6, ad.materials) + Tracking.ADAPTER.asRepeated().encodedSizeWithTag(7, ad.ad_tracking);
            ProtoAdapter<Integer> protoAdapter2 = ProtoAdapter.UINT32;
            int iEncodedSizeWithTag2 = iEncodedSizeWithTag + protoAdapter2.encodedSizeWithTag(8, ad.bid_price) + protoAdapter.encodedSizeWithTag(9, ad.product_id) + protoAdapter.encodedSizeWithTag(10, ad.settlement_price_enc) + protoAdapter2.encodedSizeWithTag(11, ad.is_override) + protoAdapter.encodedSizeWithTag(12, ad.ad_source_logo) + protoAdapter.encodedSizeWithTag(13, ad.ad_source_channel) + protoAdapter2.encodedSizeWithTag(14, ad.ad_type) + this.options.encodedSizeWithTag(15, ad.options) + protoAdapter2.encodedSizeWithTag(16, ad.expired_time);
            ProtoAdapter<Boolean> protoAdapter3 = ProtoAdapter.BOOL;
            return iEncodedSizeWithTag2 + protoAdapter3.encodedSizeWithTag(17, ad.forbiden_parse_landingpage) + protoAdapter2.encodedSizeWithTag(18, ad.display_orientation) + AdSetting.ADAPTER.encodedSizeWithTag(19, ad.ad_setting) + protoAdapter2.encodedSizeWithTag(20, ad.bid_type) + protoAdapter.encodedSizeWithTag(21, ad.attribution_id) + this.ad_track_macro.encodedSizeWithTag(24, ad.ad_track_macro) + WXProgramRes.ADAPTER.encodedSizeWithTag(27, ad.wx_program_res) + BiddingResponse.ADAPTER.encodedSizeWithTag(29, ad.bidding_response) + FrequencyControl.ADAPTER.asRepeated().encodedSizeWithTag(31, ad.frequency_control) + protoAdapter3.encodedSizeWithTag(32, ad.enable_small_window) + ad.unknownFields().size();
        }
        ...
        public Ad redact(Ad ad) {
            ...
            AdSetting adSetting = builderNewBuilder.ad_setting;
            if (adSetting != null) {
                builderNewBuilder.ad_setting = AdSetting.ADAPTER.redact(adSetting);
            }
            WXProgramRes wXProgramRes = builderNewBuilder.wx_program_res;
            if (wXProgramRes != null) {
                builderNewBuilder.wx_program_res = WXProgramRes.ADAPTER.redact(wXProgramRes);
            }
    ...
    public String toString() {
        ...
        if (!this.frequency_control.isEmpty()) {
            sb.append(", frequency_control=");
            sb.append(this.frequency_control);
        }
        if (this.enable_small_window != null) {
            sb.append(", enable_small_window=");
            sb.append(this.enable_small_window);
        }
    ...
    public Ad(String str, String str2, String str3, String str4, String str5, List<MaterialMeta> list, List<Tracking> list2, Integer num, String str6, String str7, Integer num2, String str8, String str9, Integer num3, Map<String, String> map, Integer num4, Boolean bool, Integer num5, AdSetting adSetting, Integer num6, String str10, Map<String, String> map2, WXProgramRes wXProgramRes, BiddingResponse biddingResponse, List<FrequencyControl> list3, Boolean bool2, ByteString byteString) {
        ...
        this.wx_program_res = wXProgramRes;
        this.bidding_response = biddingResponse;
        this.frequency_control = Internal.immutableCopyOf("frequency_control", list3);
        this.enable_small_window = bool2;
    }
