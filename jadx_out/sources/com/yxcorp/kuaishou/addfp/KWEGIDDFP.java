        ...
        try {
            ...
            if (TextUtils.isEmpty(this.mEgid)) {
                try {
                    ...
                    String strA2 = (TextUtils.isEmpty(strA) && !d.a(this.mParamContext).b() && f.a(this.mParamContext, new String[]{g.f31167i, "android.permission.WRITE_EXTERNAL_STORAGE"})) ? d.a(this.mParamContext).a("Lm91a2R0ZnQ=") : "";
