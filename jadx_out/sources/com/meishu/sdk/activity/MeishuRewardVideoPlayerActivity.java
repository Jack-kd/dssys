...
public class MeishuRewardVideoPlayerActivity extends SafeAppCompatActivity {
    ...
    private int totalTime = ca.f49002b;
    private Runnable updateTime = new l() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.14
        ...
        public void safeRun() {
            try {
                ...
                MeishuRewardVideoPlayerActivity.this.notifyVideoProgress(r0.totalTime, MeishuRewardVideoPlayerActivity.this.mImageCurrentTime);
                ...
                double d2 = (MeishuRewardVideoPlayerActivity.this.mImageCurrentTime * 1.0f) / MeishuRewardVideoPlayerActivity.this.totalTime;
                if (d2 < 0.25d || d2 >= 0.5d) {
                    if (d2 < 0.5d || d2 >= 0.75d) {
                        if (d2 >= 0.75d && d2 < 1.0d && !MeishuRewardVideoPlayerActivity.this.threeQuarterPerformed) {
    ...
    private final com.meishu.sdk.core.webview.listener.b jsEventListener = new com.meishu.sdk.core.webview.listener.b() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.22
        ...
        public String getActivityState() {
            return MeishuRewardVideoPlayerActivity.this.isActivityPause ? C1244a.f35682j : "resume";
        }
        ...
        public String getDeviceInfo() {
            int iB;
            try {
                iB = (int) m.b(MeishuRewardVideoPlayerActivity.this, y0.m(r0));
            } catch (Exception unused) {
                iB = 0;
            }
            MeishuRewardVideoPlayerActivity.this.initClkType();
            return v.f32031a.toJson(GetDeviceInfoResBean.make(iB, h.d(MeishuRewardVideoPlayerActivity.this.clk_type), h.e(MeishuRewardVideoPlayerActivity.this.clk_type), null));
        }
        ...
        public boolean isSoundsOpen() {
            if (MeishuRewardVideoPlayerActivity.this.image_src == null && MeishuRewardVideoPlayerActivity.this.mediaView != null) {
                return !MeishuRewardVideoPlayerActivity.this.mediaView.f32361w;
            }
            return false;
        }
    ...
    private final com.meishu.sdk.core.service.a appStateListener = new com.meishu.sdk.core.service.a() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.23
        ...
        public boolean onAppStateUpdate(boolean z2) {
            ...
            WebView webView = MeishuRewardVideoPlayerActivity.this.rewardTmpWrapper != null ? MeishuRewardVideoPlayerActivity.this.rewardTmpWrapper.f32154a : null;
            if (webView == null) {
                return true;
            }
            if (z2) {
    ...
    public static /* synthetic */ int access$5412(MeishuRewardVideoPlayerActivity meishuRewardVideoPlayerActivity, int i2) {
        int i3 = meishuRewardVideoPlayerActivity.mImageCurrentTime + i2;
        meishuRewardVideoPlayerActivity.mImageCurrentTime = i3;
        return i3;
    }

    private void applyCloseBtnVisibility() {
        int i2 = this.close_btn;
        if (i2 == 0) {
    ...
    private void clearRewardTmp() {
        try {
            ...
            if (sVar != null) {
                q.a(sVar.f32154a);
                try {
                    this.rewardTmpWrapper.f32155b.f32115g = null;
                } catch (Exception unused) {
                }
                try {
                    g gVar = this.rewardTmpWrapper.f32156c;
                    gVar.getClass();
                    try {
                        gVar.f32116a.clear();
                    } catch (Exception e2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public int getVideoRewardTotalTime(long j2) {
        if (j2 > 0) {
            try {
                if (j2 < this.mediaView.getDuration()) {
                    return (int) j2;
                }
            } catch (Exception e2) {
                e2.printStackTrace();
        ...
        return this.mediaView.getDuration() > 0 ? this.mediaView.getDuration() : ca.f49002b;
    }
    ...
    private void initShakeAndTurn(boolean z2) {
        try {
            ...
            if (i2 == adType.value()) {
                ...
                if (h.c(iA)) {
                    ...
                    ShakeUtil.getInstance().a(this.power_index2, this.power_index, iB, this.power_delay, this.power_count, this.shakeId, 0, new ShakeUtil.c() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.11
                        ...
                        public void onShake(int i3, boolean z3, int i4, ShakeResult shakeResult) {
                            try {
                                MeishuRewardVideoPlayerActivity.this.clkActType = i3;
                                MeishuRewardVideoPlayerActivity.this.clkPower = i4;
                                if (shakeResult != null) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void initWebView(long j2) {
        MeishuRewardVideoPlayerActivity meishuRewardVideoPlayerActivity;
        s sVarA;
        boolean z2 = this.canDisplayRewardTemp;
        if (!z2 && !this.canDisplayNewRewardTemp) {
            this.rewardTmpLoadRes = Boolean.FALSE;
            return;
        }
        if (z2 && this.rewardTmpType == 2 && this.rewardTmpTime * 1000 > j2) {
            this.rewardTmpLoadRes = Boolean.FALSE;
            return;
        }
        ...
        }, this.canDisplayNewRewardTemp ? 2000L : 3000L);
        q qVar = new q();
        qVar.f32150g = new j() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.8
            ...
            @Override // com.meishu.sdk.core.webview.j
            public void onWebReady(boolean z3) {
                if (MeishuRewardVideoPlayerActivity.this.rewardTmpLoadRes != null) {
                    return;
                }
                final WebView webView = MeishuRewardVideoPlayerActivity.this.rewardTmpWrapper != null ? MeishuRewardVideoPlayerActivity.this.rewardTmpWrapper.f32154a : null;
                if (webView == null) {
                    MeishuRewardVideoPlayerActivity.this.rewardTmpLoadRes = Boolean.FALSE;
                    MeishuRewardVideoPlayerActivity.this.onLoadRewardTmpRes(false);
                    return;
                ...
                MeishuRewardVideoPlayerActivity.this.rewardTmpLoadRes = Boolean.valueOf(z3);
                if (z3) {
                    ...
                    MeishuRewardVideoPlayerActivity meishuRewardVideoPlayerActivity2 = MeishuRewardVideoPlayerActivity.this;
                    meishuRewardVideoPlayerActivity2.onLoadRewardTmpRes(meishuRewardVideoPlayerActivity2.rewardTmpLoadRes.booleanValue());
                }
            }
        };
        ...
        com.meishu.sdk.core.webview.listener.g gVar = new com.meishu.sdk.core.webview.listener.g() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.9
            ...
            public boolean onPageFinished(String str, boolean z3, boolean z4, int i2) {
                return false;
            }
        ...
        com.meishu.sdk.core.webview.listener.b bVar = this.jsEventListener;
        s sVar = null;
        try {
            n nVar = new n();
            nVar.f32136a = 0;
            p pVar = new p(qVar, bVar, cVar, this);
            if (o.a(tempUrl)) {
                meishuRewardVideoPlayerActivity = this;
                try {
                    sVarA = o.a(meishuRewardVideoPlayerActivity, tempUrl, cVar, nVar, gVar, pVar);
                } catch (Throwable th) {
                    th = th;
                    th.printStackTrace();
                    gVar.onPageFinished(tempUrl, true, false, -1);
                    meishuRewardVideoPlayerActivity.rewardTmpWrapper = sVar;
                }
            } else {
                meishuRewardVideoPlayerActivity = this;
                sVarA = null;
    ...
    public boolean isLoadingRes() {
        return this.image_src != null ? this.isImgSuccess == null : this.videoLoaded == null;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void jumpEndCover(String str) throws IllegalStateException {
        NormalMediaView normalMediaView = this.mediaView;
        if (normalMediaView != null) {
            normalMediaView.f32329O = true;
            normalMediaView.l();
            normalMediaView.f();
        }
    ...
    public void loadImageError() {
        ...
        for (int i2 = 0; i2 < baseFullScreenVideoAdList.size(); i2++) {
            try {
                com.meishu.sdk.platform.ms.a aVar = (com.meishu.sdk.platform.ms.a) baseFullScreenVideoAdList.get(i2);
                if (aVar != null) {
    ...
    private void loadRewardImage() {
        try {
            ...
            com.meishu.sdk.core.cache.a.a(this.image_src, new y() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.13
                ...
                public void onResponse(HttpResponse<byte[]> httpResponse) throws IOException {
                    ...
                    try {
                        ...
                        if (gifWidth <= 0 || gifHeight <= 0) {
                            ...
                            layoutParams.height = Math.min((i2 * gifHeight) / gifWidth, displayMetrics.heightPixels - 100);
                        }
                        MeishuRewardVideoPlayerActivity.this.rewardImageview.setLayoutParams(layoutParams);
                        long j2 = MeishuRewardVideoPlayerActivity.this.video_keep_time * 1000;
                        if (j2 > 0) {
                            MeishuRewardVideoPlayerActivity.this.totalTime = (int) j2;
                        } else {
                            MeishuRewardVideoPlayerActivity.this.totalTime = ca.f49002b;
                        }
                        if (MeishuRewardVideoPlayerActivity.this.rewardTmpType == 2 && MeishuRewardVideoPlayerActivity.this.canDisplayRewardTemp) {
                            MeishuRewardVideoPlayerActivity.this.initWebView(r7.totalTime);
                        }
    ...
    private void loadRewardVideo() {
        try {
            ...
            final long j2 = this.video_keep_time * 1000;
            ...
            rewardMediaView.a(this.keepTimeFinishListener, j2);
            ...
            f fVar = new f();
            fVar.new a();
            fVar.f32398j = this.video_start;
            fVar.f32399k = this.video_one_quarter;
            fVar.f32400l = this.video_one_half;
            fVar.f32401m = this.video_three_quarter;
            fVar.f32402n = this.video_complete;
            fVar.f32403o = this.video_pause;
            fVar.f32404p = this.video_resume;
            fVar.f32405q = this.video_skip;
            fVar.f32409u = this.video_close;
            fVar.f32406r = this.video_mute;
            fVar.f32407s = this.video_unmute;
            fVar.f32408t = this.video_replay;
            try {
                c cVar = ad;
            ...
            rewardMediaView.setNativeAdMediaListener(new com.meishu.sdk.platform.ms.recycler.b(fVar, new RecyclerAdMediaListener() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.17
                ...
                public void onVideoStart() {
                    ...
                    int videoRewardTotalTime = MeishuRewardVideoPlayerActivity.this.getVideoRewardTotalTime(j2);
    ...
    public void notifyH5ActionShakeOrTurn() {
        try {
            s sVar = this.rewardTmpWrapper;
            WebView webView = sVar != null ? sVar.f32154a : null;
            if (webView == null) {
                return;
            }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void notifyVideoProgress(long j2, long j3) {
        try {
            if (isShowedRewardTemp()) {
                ...
                com.meishu.sdk.core.webview.jsbridge.util.a.a(webView, "notifyH5VideoProgress", j2 + "," + j3);
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public void onClick() {
        ...
        NormalMediaView normalMediaView = this.mediaView;
        if (normalMediaView == null || !normalMediaView.f32340b.f32693g) {
            return;
        }
        new SoftReference(this);
        sendBroadcast("broadcast_onclick", true);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void onLoadRewardTmpRes(boolean z2) {
        if (z2) {
    ...
    public void pauseVideo() {
        StringBuilder sbA = a.a("showRewardWeb, pauseVideo,video_keep_time=");
        sbA.append(this.video_keep_time);
    ...
    public void resumeUI() {
        ...
        relativeLayout.post(new l() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.10
            ...
            @Override // com.meishu.sdk.core.safe.l
            public void safeRun() throws IllegalStateException {
    ...
    public void rewardBroadcast() {
        ...
        if (!isNewRewardTempDisplay()) {
            rewardTimeEndReport(i2, tempId);
        }
        sendBroadcast("broadcast_onreward", false);
        rewardEdReport(i2, tempId);
    }

    private void rewardEdReport(int i2, int i3) {
        try {
            if (this.adType != AdType.REWARD.value()) {
                return;
            }
            p1.a(this.eventUrl, 31, 0, b1.a(this.image_src != null ? 1 : 2, i2, i3, ""));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void rewardEventUrlReport(int i2) {
        try {
            if (this.adType != AdType.REWARD.value()) {
                return;
            }
            p1.a(this.eventUrl, i2, 0, b1.a(this.image_src != null ? 1 : 2, ""));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }

    private void rewardTimeEndReport(int i2, int i3) {
        try {
            if (this.adType != AdType.REWARD.value()) {
                return;
            }
            p1.a(this.eventUrl, 17, 0, b1.a(this.image_src != null ? 1 : 2, i2, i3, ""));
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    }
    ...
    public static void setVideoMute(boolean z2) {
        isMute = z2;
    }
    ...
    public void showProgressBar() {
        if (this.rewardTmpType == 1) {
            long j2 = this.video_keep_time;
            int i2 = j2 > 0 ? (int) (j2 * 1000) : 25000;
            LogUtil.e(TAG, "showRewardWeb, pauseVideo,time=" + i2);
            CircleProcessBar circleProcessBar = this.processBar;
            if (circleProcessBar != null) {
                circleProcessBar.setVisibility(0);
                this.processBar.setmTotalTime(i2);
    ...
    public void safeOnCreate(Bundle bundle) {
        ...
        com.meishu.sdk.core.safe.o oVar = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.1
                ...
                try {
                    if (!MeishuRewardVideoPlayerActivity.this.onReward && MeishuRewardVideoPlayerActivity.this.adType == AdType.REWARD.value()) {
                        ...
                        noNavigationDialog.setButton(-2, "放弃奖励", new com.meishu.sdk.core.safe.b() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.1.2
                            @Override // com.meishu.sdk.core.safe.b
                            public void safeOnClick(DialogInterface dialogInterface, int i2) throws IllegalStateException {
                                dialogInterface.dismiss();
        ...
        com.meishu.sdk.core.safe.o oVar2 = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.2
            @Override // com.meishu.sdk.core.safe.o
        ...
        com.meishu.sdk.core.safe.o oVar3 = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.3
            @Override // com.meishu.sdk.core.safe.o
        ...
        if (intExtra2 == 1) {
            ...
            com.meishu.sdk.core.safe.o oVar4 = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.4
                @Override // com.meishu.sdk.core.safe.o
            ...
            com.meishu.sdk.core.safe.o oVar5 = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.5
                @Override // com.meishu.sdk.core.safe.o
            ...
            com.meishu.sdk.core.safe.o oVar6 = new com.meishu.sdk.core.safe.o() { // from class: com.meishu.sdk.activity.MeishuRewardVideoPlayerActivity.6
                @Override // com.meishu.sdk.core.safe.o
    ...
    public void safeOnPause() {
        ...
        removeCountDown();
        notifyH5ActivityState(C1244a.f35682j);
        if (this.isShake) {
            ShakeUtil.getInstance().e();
            ...
            try {
                ...
                fArr[1] = 0.0f;
                fArr[2] = 0.0f;
                shakeUtil.f33101e = 0.0f;
                shakeUtil.f33120x.clear();
                shakeUtil.f33121y.clear();
                shakeUtil.f33122z.clear();
                float[] fArr2 = shakeUtil.f33118v;
                fArr2[0] = 0.0f;
                fArr2[1] = 0.0f;
                fArr2[2] = 0.0f;
            } catch (Exception e2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void resumeCountDown(boolean z2) {
        Handler handler;
        if ((!z2 && this.canDisplayRewardTemp && isShowedRewardTemp()) || (handler = this.mHandler) == null) {
            return;
        }
        if (this.image_src != null) {
            handler.removeCallbacks(this.updateTime);
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void startShakeAndTurn(boolean z2) {
        if (!this.isShakeInit) {
