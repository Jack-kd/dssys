...
public class MeishuDetailActivity extends SafeAppCompatActivity {
    ...
    private void loadAppDetail(String str, String str2, String str3, float f2, int i2, int i3) {
        if (TextUtils.isEmpty(str)) {
            ...
            View view = this.bQuery.b(R.id.ms_text_title).f31521d;
            ...
            if (TextUtils.isEmpty(str2)) {
                ...
                View view2 = this.bQuery.b(R.id.ms_text_content).f31521d;
            ...
            if (f2 > 0.0f) {
                this.bQuery.b(R.id.ms_text_rank).a(String.format(Locale.CHINA, "评分: %.1f", Float.valueOf(f2)));
            } else {
                this.bQuery.b(R.id.ms_text_rank).d(8);
            }
            if (i2 > 0) {
                this.bQuery.b(R.id.ms_text_download_count).a(String.format(Locale.CHINA, "下载量: %s", new DecimalFormat("#,###").format(i2)));
            } else {
                this.bQuery.b(R.id.ms_text_download_count).d(8);
            }
            if (i3 > 0) {
                this.bQuery.b(R.id.ms_text_comments).a(String.format(Locale.CHINA, "评论数: %d", Integer.valueOf(i2)));
            } else {
    ...
    private void tryJumpDeepLink() {
        ...
        try {
            ...
            if (uri.resolveActivity(getPackageManager()) != null) {
                ...
                f.a(applicationContext, adSlotA, cVar2, z2, this.strongAction, null);
            }
        } catch (Throwable th) {
            th.printStackTrace();
        }
    ...
    public void safeOnCreate(Bundle bundle) {
        MeishuDetailActivity meishuDetailActivity;
        ...
        try {
            MediaPlayer mediaPlayer = meishuVideoView.f32688b;
            if (mediaPlayer != null && meishuVideoView.f32693g) {
        ...
        if (i2 == 0) {
            ...
            meishuDetailActivity = this;
            meishuDetailActivity.loadAppDetail(stringExtra, stringExtra2, stringExtra3, floatExtra, intExtra2, intExtra3);
        }
        ...
        textureView.setLayoutParams(new RelativeLayout.LayoutParams(i3, (int) (i3 / 1.7777778f)));
        ...
        textureView.setSurfaceTextureListener(new com.meishu.sdk.core.safe.m() { // from class: com.meishu.sdk.activity.MeishuDetailActivity.2
            ...
            public void safeOnSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i4, int i5) {
                MeishuDetailActivity.this.textureWidth = i4;
                MeishuDetailActivity.this.textureHeight = i5;
                if (MeishuDetailActivity.this.thisNormalMediaView != null) {
                    ...
                    try {
                        MediaPlayer mediaPlayer2 = meishuVideoView2.f32688b;
                        if (mediaPlayer2 != null) {
                            meishuVideoView2.f32698l = surface;
                            mediaPlayer2.setSurface(surface);
                        }
                    } catch (Throwable th2) {
                        th2.printStackTrace();
                    }
                    textureView.setTransform(MeishuDetailActivity.this.thisNormalMediaView.getMeishuVideoView().a(i4, i5));
            ...
            @Override // com.meishu.sdk.core.safe.m
            public void safeOnSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i4, int i5) {
            }
        ...
        meishuDetailActivity.thisNormalMediaView.getMeishuVideoView().setOnVideoSizeChangedListener(new k() { // from class: com.meishu.sdk.activity.MeishuDetailActivity.3
            @Override // com.meishu.sdk.core.safe.k
            public void safeOnVideoSizeChanged(MediaPlayer mediaPlayer2, int i4, int i5) {
                if (MeishuDetailActivity.this.thisNormalMediaView != null) {
    ...
    public void safeOnDestroy() {
        ...
        try {
            ...
            NormalMediaView normalMediaView2 = this.thisNormalMediaView;
            if (normalMediaView2 != null) {
                normalMediaView2.f32353o = false;
                normalMediaView2.setOnInfoListener(null);
                if (!normalMediaView2.f32352n) {
                    normalMediaView2.d();
                }
                ...
                try {
                    MediaPlayer mediaPlayer = meishuVideoView.f32688b;
                    if (mediaPlayer != null) {
                        meishuVideoView.f32698l = null;
                        mediaPlayer.setSurface(meishuVideoView.f32694h);
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
