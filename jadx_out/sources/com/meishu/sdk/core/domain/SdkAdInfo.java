...
public class SdkAdInfo {
    ...
    private int dealWithCod(int i2, Integer num) {
        if (i2 > 0 && num != null) {
            try {
                if (num.intValue() <= 100 && num.intValue() >= 0) {
                    return Math.max((int) (((100.0d - num.intValue()) * i2) / 100.0d), 0);
                }
            } catch (Exception e2) {
                e2.printStackTrace();
            }
    ...
    public static SdkAdInfo fromJson(String str) throws JSONException {
        Object objOpt;
        ...
        try {
            ...
            if (jSONObject.has("sdk")) {
                sdkAdInfo.setSdk(jSONObject.optString("sdk"));
            }
            ...
            if (jSONObject.has(be.f48800c)) {
                sdkAdInfo.setImp(jSONObject.optString(be.f48800c));
            }
            ...
            if (jSONObject.has("price")) {
                sdkAdInfo.setPrice(jSONObject.optInt("price"), iOptInt);
            }
            ...
            if (jSONObject.has("otype")) {
                sdkAdInfo.setOtype(jSONObject.optString("otype", "order"));
            }
            ...
            if (jSONObject.has(PointParamKey.EXPIRE_TIMESTAMP)) {
                sdkAdInfo.setExpire_timestamp(jSONObject.optInt(PointParamKey.EXPIRE_TIMESTAMP));
            }
            ...
            if (jSONObject.has("_price")) {
                sdkAdInfo.set_price(jSONObject.optString("_price", "__PRICE__"));
            }
            if (jSONObject.has(ATAdConst.NETWORK_REQUEST_PARAMS_KEY.APP_KEY)) {
                sdkAdInfo.setApp_key(jSONObject.optString(ATAdConst.NETWORK_REQUEST_PARAMS_KEY.APP_KEY));
            }
            if (jSONObject.has("cls")) {
                sdkAdInfo.setCls(jSONObject.optString("cls"));
            }
            if (jSONObject.has(k.aJ)) {
                sdkAdInfo.setCustom_ext(jSONObject.optString(k.aJ));
            }
            ...
            e2.printStackTrace();
            LogUtil.e("MeishuSdk_", e2.getMessage());
            return sdkAdInfo;
        }
    }
    ...
    public void replace() {
        ...
        if (strReplace.contains("__PRICE__")) {
            StringBuilder sbA = a.a("ssp");
            sbA.append(Base64.encodeToString(strValueOf.getBytes(), 2));
            set_price(sbA.toString());
            strReplace = strReplace.replace("__PRICE__", "ssp" + Base64.encodeToString(strValueOf.getBytes(), 2));
        }
        StringBuilder sbA2 = a.a("ssp");
        sbA2.append(Base64.encodeToString(strValueOf.getBytes(), 2));
        String strReplace3 = strReplace2.replace("__PRICE__", sbA2.toString());
        StringBuilder sbA3 = a.a("ssp");
        sbA3.append(Base64.encodeToString(strValueOf.getBytes(), 2));
        String strReplace4 = finalRsp.replace("__PRICE__", sbA3.toString());
        setRsp(strReplace);
    ...
    public void replaceErrorPst(AdPlatformError adPlatformError) {
        ...
        a0.a(strReplace, adPlatformError.getCode(), adPlatformError.getMessage());
        setErr(strReplace);
    ...
    public void setAlreadyLoaded(boolean z2) {
    ...
    public void setCsjGM(boolean z2) {
        this.isCsjGM = z2;
    }

    public void setCsjGMBidding(boolean z2) {
        this.isCsjGMBidding = z2;
    }
    ...
    public void setEcpm(String str) {
        try {
            ...
            this.originEcpm = i2;
            this.ecpm = dealWithCod(i2, Integer.valueOf(this.cod));
            int i4 = this.originEcpm;
            if (i4 <= 0) {
                i4 = this.price;
            }
            String strValueOf = String.valueOf(i4 * 10);
            ...
            String strReplace4 = strReplace3.replace("__PRE__", "ssp" + Base64.encodeToString(String.valueOf(i5 * 10).getBytes(), 2));
            String strReplace5 = this.cache_rsp.replace("__PRICE__", "ssp" + Base64.encodeToString(strValueOf.getBytes(), 2)).replace("__S__", str);
            String strReplace6 = this.cache_imp.replace("__PRICE__", "ssp" + Base64.encodeToString(strValueOf.getBytes(), 2)).replace("__S__", str);
            setRsp(strReplace);
    ...
    public void setPrice(int i2, int i3) {
        ...
        this.price = iMax;
        this.codPrice = dealWithCod(iMax, Integer.valueOf(i3));
    }
