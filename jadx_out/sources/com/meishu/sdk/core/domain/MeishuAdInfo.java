...
public class MeishuAdInfo {
    ...
    public static class PermissionBean implements Serializable {
        ...
        public static PermissionBean fromJson(String str) {
            ...
            try {
                JSONObject jSONObject = new JSONObject(str);
                permissionBean.setTitle(jSONObject.optString(g.a.f3271h));
        ...
        public JSONObject toJson() throws JSONException {
            ...
            try {
                jSONObject.put(g.a.f3271h, this.title);
    ...
    public static MeishuAdInfo fromJson(String str, AdType adType) {
        ...
        try {
            ...
            if (jSONObject.has("cid")) {
                meishuAdInfo.setCid(jSONObject.optString("cid"));
            }
            if (jSONObject.has(Constants.KEYS.EXPOSED_CLICK_URL_KEY)) {
                meishuAdInfo.setClickUrl(jsonArrayToStringArray(jSONObject.optJSONArray(Constants.KEYS.EXPOSED_CLICK_URL_KEY)));
            }
            ...
            if (jSONObject.has(g.a.f3271h)) {
                meishuAdInfo.setTitle(jSONObject.optString(g.a.f3271h));
            }
            ...
            if (jSONObject.has("icon")) {
                meishuAdInfo.setIcon(jSONObject.optString("icon"));
            }
            ...
            if (jSONObject.has(PointParamKey.EXPIRE_TIMESTAMP)) {
                meishuAdInfo.setExpire_timestamp(jSONObject.optInt(PointParamKey.EXPIRE_TIMESTAMP));
            }
            ...
            if (jSONObject.has(NativeModel.JSON_KEY_SCHEME) && jSONObject.opt(NativeModel.JSON_KEY_SCHEME) != null) {
                meishuAdInfo.setScheme(jSONObject.optString(NativeModel.JSON_KEY_SCHEME));
            }
            if (jSONObject.has("sdk")) {
                JSONArray jSONArray = jSONObject.getJSONArray("sdk");
                SdkAdInfo[] sdkAdInfoArr = new SdkAdInfo[jSONArray.length()];
                for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                    sdkAdInfoArr[i2] = SdkAdInfo.fromJson(jSONArray.getJSONObject(i2).toString());
                }
            ...
            if ((adType == AdType.FEED_MIX || adType == AdType.FEED_PRE_RENDER) && jSONObject.has("layout")) {
                meishuAdInfo.setLayout(LayoutBean.fromJson(jSONObject.getJSONObject("layout").toString()));
            }
            if (jSONObject.has("app_permission")) {
                JSONArray jSONArray2 = jSONObject.getJSONArray("app_permission");
                ArrayList arrayList = new ArrayList();
                for (int i3 = 0; i3 < jSONArray2.length(); i3++) {
                    arrayList.add(PermissionBean.fromJson(jSONArray2.getJSONObject(i3).toString()));
                }
            ...
            if (jSONObject.has("h5_url")) {
                meishuAdInfo.setH5_url(jSONObject.optString("h5_url"));
            }
    ...
    public void setAdg(int i2) {
        this.adg = i2;
    }

    public void setAdp(int i2) {
        this.adp = i2;
    }

    public void setAll_timeout(long j2) {
        this.all_timeout = j2;
    }
    ...
    public void setClickable_range(int i2) {
        this.clickable_range = i2;
    }
    ...
    public void setClk_type(int i2) {
        this.clk_type = i2;
    }
    ...
    public void setClose_btn(int i2) {
        this.close_btn = i2;
    }
    ...
    public void setDirect_market(int i2) {
        this.direct_market = i2;
    }
    ...
    public void setExpire_timestamp(int i2) {
        this.expire_timestamp = i2;
    }

    public void setExtend_down(int i2) {
        this.extend_down = i2;
    }

    public void setExtend_interval(int i2) {
        this.extend_interval = i2;
    }

    public void setExtend_left(int i2) {
        this.extend_left = i2;
    }

    public void setExtend_max_count(int i2) {
        this.extend_max_count = i2;
    }

    public void setExtend_right(int i2) {
        this.extend_right = i2;
    }

    public void setExtend_up(int i2) {
        this.extend_up = i2;
    }
    ...
    public void setHasMeishuAd(boolean z2) {
        this.hasMeishuAd = z2;
    }
    ...
    public void setInsert_style(int i2) {
        this.insert_style = i2;
    }

    public void setIs_eyes(int i2) {
        this.is_eyes = i2;
    }
    ...
    public void setMaterialTimeout(int i2) {
        this.material_timeout = i2;
    }
    ...
    public void setNative_s_e(int i2) {
        this.native_s_e = i2;
    }

    public void setNop(int i2) {
        this.nop = i2;
    }

    public void setOnce_timeout(long j2) {
        this.once_timeout = j2;
    }
    ...
    public void setPower_count(int i2) {
        this.power_count = i2;
    }

    public void setPower_delay(int i2) {
        this.power_delay = i2;
    }

    public void setPower_index(int i2) {
        this.power_index = i2;
    }

    public void setPower_index2(int i2) {
        this.power_index2 = i2;
    }
    ...
    public void setRewardTmpId(int i2) {
        this.reward_tmp_id = i2;
    }

    public void setReward_tmp_time(int i2) {
        this.reward_tmp_time = i2;
    }

    public void setReward_tmp_type(int i2) {
        this.reward_tmp_type = i2;
    }
    ...
    public void setSkipBtnLocation(int i2) {
        this.skip_btn_location = i2;
    }
    ...
    public void setVideo_keep_time(long j2) {
        this.video_keep_time = j2;
    }
    ...
    public void setWebTempId(int i2) {
        this.web_temp_id = i2;
    }
