...
public class GetH5AdInfoResBean implements Serializable {
    ...
    public static GetH5AdInfoResBean make(AdSlot adSlot, String str, boolean z2) {
        ...
        if (adSlot instanceof BaseAdSlot) {
            ...
            if (adSlot instanceof f) {
                getH5AdInfoResBean.video_keep_time = ((f) adSlot).f32397i;
            }
            ...
            if (TextUtils.isEmpty(fromLogo)) {
                StringBuilder sbA = com.meishu.sdk.activity.a.a("data:image/png;base64,");
                sbA.append(q.a(AdSdk.getContext(), R.drawable.ms_ad));
                getH5AdInfoResBean.from_logo = sbA.toString();
            } else {
    ...
    private static AppInfoBean makeAppInfoBean(@NotNull BaseAdSlot baseAdSlot) {
