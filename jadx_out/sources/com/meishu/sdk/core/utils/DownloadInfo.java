...
public class DownloadInfo implements Serializable {
    ...
    public DownloadInfo(String str, File file, String str2, com.meishu.sdk.platform.ms.c cVar) {
        ...
        if (dn_succ != null) {
            ...
            while (true) {
                ...
                strArr2[i4] = f.a(strArr2[i4], cVar);
                i4++;
            }
        }
        ...
        if (dn_inst_start != null) {
            ...
            while (true) {
                ...
                strArr3[i5] = f.a(strArr3[i5], cVar);
                i5++;
            }
        }
        ...
        if (dn_inst_succ != null) {
            while (true) {
                ...
                strArr4[i2] = f.a(strArr4[i2], cVar);
                i2++;
            }
        }
    ...
    private static final String makeFileName(String str) {
        try {
            return m1.a(MessageDigest.getInstance("MD5").digest(str.getBytes())).toLowerCase() + ".apk";
