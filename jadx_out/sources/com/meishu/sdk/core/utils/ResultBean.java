...
public class ResultBean {
    ...
    public static class AdInfo {
        ...
        public String toString() {
            StringBuilder sbA = com.meishu.sdk.activity.a.a("AdInfo{creative_type=");
            sbA.append(this.creative_type);
            sbA.append(", title='");
            sbA.append(this.title);
            sbA.append('\'');
            sbA.append(", desc='");
            sbA.append(this.desc);
            sbA.append('\'');
            sbA.append(", imgUrls=");
            sbA.append(Arrays.toString(this.imgUrls));
            sbA.append(", videoUrls=");
            sbA.append(Arrays.toString(this.videoUrls));
            sbA.append(", iconUrl='");
            sbA.append(this.iconUrl);
            sbA.append('\'');
            sbA.append(", cid='");
            sbA.append(this.cid);
            sbA.append('\'');
            sbA.append(", act_ext='");
            sbA.append(this.act_ext);
            sbA.append('\'');
            sbA.append('}');
            return sbA.toString();
        }
