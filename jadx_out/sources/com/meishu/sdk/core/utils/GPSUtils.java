...
public class GPSUtils {
    ...
    public Location getLocation() {
        try {
            if (ContextCompat.checkSelfPermission(this.mContext, com.kuaishou.weapon.p0.g.f31165g) != 0 && ContextCompat.checkSelfPermission(this.mContext, com.kuaishou.weapon.p0.g.f31166h) != 0) {
                return null;
            }
