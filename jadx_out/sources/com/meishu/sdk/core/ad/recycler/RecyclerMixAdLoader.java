...
public class RecyclerMixAdLoader extends com.meishu.sdk.core.loader.c<a> {
    ...
    public com.meishu.sdk.core.loader.d createMeishuAdDelegate(Context context, MeishuAdInfo meishuAdInfo) {
        ...
        f.this.f32413y = meishuAdInfo.getVideo_duration();
        ...
        f.this.f32412x = meishuAdInfo.getStyle_id();
        ...
        f.this.f32389a = meishuAdInfo.getWidth();
        f.this.f32390b = meishuAdInfo.getHeight();
        f.a drawing = interactionType.setDrawing(meishuAdInfo.getDrawing());
        f.this.f32414z = meishuAdInfo.isVideoAutoPlay();
        f.this.f32385A = meishuAdInfo.isVideoMute();
        f.this.getClass();
        ...
        f.this.f32398j = meishuAdInfo.getVideo_start();
        f.this.f32399k = meishuAdInfo.getVideo_one_quarter();
        f.this.f32400l = meishuAdInfo.getVideo_one_half();
        f.this.f32401m = meishuAdInfo.getVideo_three_quarter();
        f.this.f32402n = meishuAdInfo.getVideo_complete();
        f.this.f32403o = meishuAdInfo.getVideo_pause();
        f.this.f32404p = meishuAdInfo.getVideo_resume();
        f.this.f32405q = meishuAdInfo.getVideo_skip();
        f.this.f32409u = meishuAdInfo.getVideo_close();
        f.this.f32406r = meishuAdInfo.getVideo_mute();
        f.this.f32407s = meishuAdInfo.getVideo_unmute();
        f.this.f32408t = meishuAdInfo.getVideo_replay();
        ...
        f.this.f32391c = meishuAdInfo.getContent();
        f.this.f32392d = meishuAdInfo.getAction_text();
        f.this.iconUrl = meishuAdInfo.getIcon();
        f.this.f32393e = meishuAdInfo.getIcon_title();
        f.a fromLogo = packageName.setFromLogo(meishuAdInfo.getFrom_logo());
        f.this.f32394f = meishuAdInfo.getFrom();
        f fVar = f.this;
        ...
        if (creative_type == 2) {
            if (meishuAdInfo.getSrcUrls() != null && meishuAdInfo.getSrcUrls().length > 0) {
                fVar.f32395g = meishuAdInfo.getSrcUrls()[0];
            }
            return new com.meishu.sdk.platform.ms.recycler.c(this, fVar);
        }
