...
public abstract class b<T extends IAdLoadListener> extends c<T> {
    ...
    public d createMeishuAdDelegate(Context context, MeishuAdInfo meishuAdInfo) {
        ...
        f.this.f32396h = meishuAdInfo.getVideo_endcover();
        f.this.f32397i = meishuAdInfo.getVideo_keep_time();
        ...
        f.this.f32410v = meishuAdInfo.getClickable_range();
        f.this.f32411w = meishuAdInfo.getClose_btn();
    ...
    public void setVideoIsMute(boolean z2) {
        this.isMute = z2;
    }
}
