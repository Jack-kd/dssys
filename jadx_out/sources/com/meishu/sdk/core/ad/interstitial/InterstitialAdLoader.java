...
public class InterstitialAdLoader extends com.meishu.sdk.core.loader.c<b> {
    ...
    public void loadAd(float f2, float f3) {
        ...
        map.put("KEY_WIDTH", Float.valueOf(f2));
        map.put("KEY_HEIGHT", Float.valueOf(f3));
        loadAd(map);
    }
