        ...
        if (dVar != null && dVar.getSdkAdInfo() != null) {
            ...
            switch (sdk.hashCode()) {
                case 2319:
                    ...
                    break;
                case 2362:
                    if (sdk.equals(ADBidEvent.JINGDONG)) {
                        c2 = 1;
                        break;
                    }
                    break;
            ...
            if (expire_timestamp > 0) {
                j2 = expire_timestamp * 1000;
            }
            if (SystemClock.uptimeMillis() - this.adWrapper.getSdkAdInfo().getLoadedTime() >= j2) {
                return false;
            }
        }
        return true;
