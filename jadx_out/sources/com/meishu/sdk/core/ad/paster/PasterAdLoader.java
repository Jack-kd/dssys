...
public class PasterAdLoader extends com.meishu.sdk.core.loader.c<b> {
    ...
    public com.meishu.sdk.core.loader.d createMeishuAdDelegate(Context context, MeishuAdInfo meishuAdInfo) {
        ...
        if (creative_type == 2 && meishuAdInfo.getSrcUrls() != null && meishuAdInfo.getSrcUrls().length > 0) {
            fVar.f32395g = meishuAdInfo.getSrcUrls()[0];
        }
        if (creative_type == 1) {
            fVar.setImageUrls(meishuAdInfo.getSrcUrls());
        } else if (creative_type == 2 && meishuAdInfo.getSrcUrls() != null && meishuAdInfo.getSrcUrls().length > 0) {
            fVar.f32395g = meishuAdInfo.getSrcUrls()[0];
        }
