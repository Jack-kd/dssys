...
public class BaseAdSlot implements AdSlot {
    ...
    public static class AppendInfo implements Serializable {
        ...
        private final C1243b hasClicked = new C1243b();
        private final C1243b resLoadSuccess = new C1243b();
        ...
        public C1243b getHasClicked() {
            return this.hasClicked;
        }

        public C1243b getResLoadSuccess() {
        ...
        public void setHasClicked(boolean z2) {
            this.hasClicked.a(z2);
        }

        public void setHasClickedSkip(boolean z2) {
            this.hasClickedSkip = z2;
        }
        ...
        public void setHasTimeOver(boolean z2) {
            this.hasTimeOver = z2;
        }

        public void setHasVideoStart(boolean z2) {
            this.hasVideoStart = z2;
        }
    }
    ...
    public abstract class Builder<T extends Builder, K extends BaseAdSlot> {
        ...
        public T setActType(int i2) {
            BaseAdSlot.this.act_type = i2;
            return (T) returnThis();
        }
        ...
        public T setAdType(int i2) {
            BaseAdSlot.this.ad_type = i2;
            return (T) returnThis();
        }
        ...
        public T setAdg(int i2) {
            BaseAdSlot.this.adg = i2;
            return (T) returnThis();
        }

        public T setAdp(int i2) {
            BaseAdSlot.this.adp = i2;
            return (T) returnThis();
        }
        ...
        public T setCBC(int i2) {
            BaseAdSlot.this.cbc = i2;
            return (T) returnThis();
        }
        ...
        public T setClickType(int i2) {
            BaseAdSlot.this.clk_type = i2;
            return (T) returnThis();
        }
        ...
        public T setComments(int i2) {
            BaseAdSlot.this.comments = i2;
            return (T) returnThis();
        }
        ...
        public T setDirectMarket(int i2) {
            BaseAdSlot.this.direct_market = i2;
            return (T) returnThis();
        }
        ...
        public T setDownNum(int i2) {
            BaseAdSlot.this.downNum = i2;
            return (T) returnThis();
        }
        ...
        public T setDrawing(int i2) {
            BaseAdSlot.this.drawing = i2;
            return (T) returnThis();
        }
        ...
        public T setEcpm(int i2) {
            BaseAdSlot.this.ecpm = i2;
            return (T) returnThis();
        }
        ...
        public T setExpireTimestamp(int i2) {
            BaseAdSlot.this.expire_timestamp = i2;
            return (T) returnThis();
        }

        public T setExtend_down(int i2) {
            BaseAdSlot.this.extend_down = i2;
            return (T) returnThis();
        }

        public T setExtend_interval(int i2) {
            BaseAdSlot.this.extend_interval = i2;
            return (T) returnThis();
        }

        public T setExtend_left(int i2) {
            BaseAdSlot.this.extend_left = i2;
            return (T) returnThis();
        }

        public T setExtend_max_count(int i2) {
            BaseAdSlot.this.extend_max_count = i2;
            return (T) returnThis();
        }

        public T setExtend_right(int i2) {
            BaseAdSlot.this.extend_right = i2;
            return (T) returnThis();
        }

        public T setExtend_up(int i2) {
            BaseAdSlot.this.extend_up = i2;
            return (T) returnThis();
        }
        ...
        public T setLoadedTime(long j2) {
            BaseAdSlot.this.loadedTime = j2;
            return (T) returnThis();
        }
        ...
        public T setMaterialTimeout(int i2) {
            BaseAdSlot.this.material_timeout = i2;
            return (T) returnThis();
        }
        ...
        public T setNOP(int i2) {
            BaseAdSlot.this.nop = i2;
            return (T) returnThis();
        }

        public T setNativeSE(int i2) {
            BaseAdSlot.this.nativeSE = i2;
            return (T) returnThis();
        }
        ...
        public T setPowerCount(int i2) {
            BaseAdSlot.this.power_count = i2;
            return (T) returnThis();
        }

        public T setPowerDelay(int i2) {
            BaseAdSlot.this.power_delay = i2;
            return (T) returnThis();
        }

        public T setPowerIndex(int i2) {
            BaseAdSlot.this.power_index = i2;
            return (T) returnThis();
        }

        public T setPowerIndex2(int i2) {
            BaseAdSlot.this.power_index2 = i2;
            return (T) returnThis();
        }
        ...
        public T setRewardTmpId(int i2) {
            BaseAdSlot.this.reward_tmp_id = i2;
            return (T) returnThis();
        }

        public T setRewardTmpTime(int i2) {
            BaseAdSlot.this.reward_tmp_time = i2;
            return (T) returnThis();
        }

        public T setRewardTmpType(int i2) {
            BaseAdSlot.this.reward_tmp_type = i2;
            return (T) returnThis();
        }
        ...
        public T setScaleType(int i2) {
            BaseAdSlot.this.scale_type = i2;
            return (T) returnThis();
        }
        ...
        public T setSkipBtnLocation(int i2) {
            BaseAdSlot.this.skipBtnLocation = i2;
            return (T) returnThis();
        }
        ...
        public T setWebTempId(int i2) {
            BaseAdSlot.this.webTempId = i2;
            return (T) returnThis();
        }
    ...
    public static class ClickExtInfo implements Serializable {
        ...
        public ClickExtInfo setRewardTempId(int i2) {
            this.rewardTempId = i2;
            return this;
        }

        public ClickExtInfo setWebTempId(int i2, boolean z2) {
            this.webTempId = i2;
            if (z2) {
                if (this.lockClickExtInfo == null) {
                    this.lockClickExtInfo = new ClickExtInfo();
                }
                this.lockClickExtInfo.webTempId = i2;
                return this;
            }
            ClickExtInfo clickExtInfo = this.lockClickExtInfo;
            if (clickExtInfo != null) {
    ...
    public int getMaterialTimeout(int i2) {
        int i3 = this.material_timeout;
        return i3 > 0 ? i3 : i2;
    }
    ...
    public int getPower_index2() {
        int i2 = this.power_index2;
        return i2 == 0 ? this.power_index : i2;
    }
    ...
    public void setAdClosed(boolean z2) {
        this.isAdClosed = z2;
    }
    ...
    public void setClkActType(int i2) {
        this.clkActType = i2;
        clearClickExtInfo();
    }

    public void setClkPower(int i2) {
        this.clkPower = i2;
    }
    ...
    public void setDynamic(boolean z2) {
        this.isClkDynamic = z2;
    }

    public void setHasExposed(boolean z2) {
        this.appendInfo.setHasExposed(z2);
    }

    public void setHasVideoStart(boolean z2) {
        this.appendInfo.setHasVideoStart(z2);
    }
    ...
    public void setRewardBrowserOpenLandingPage(boolean z2) {
        this.isRewardBrowserOpenLandingPage = z2;
    }
