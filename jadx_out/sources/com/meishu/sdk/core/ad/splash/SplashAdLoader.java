...
import com.meishu.sdk.meishu_ad.splash.d;
...
public class SplashAdLoader extends com.meishu.sdk.core.loader.c<d> {
    ...
    public SplashAdLoader(Context context, MsAdSlot msAdSlot, SplashAdEventListener splashAdEventListener, int i2) {
        this.isMute = true;
        if (msAdSlot == null) {
    ...
    public com.meishu.sdk.core.loader.d createMeishuAdDelegate(Context context, MeishuAdInfo meishuAdInfo) {
        ...
        if (meishuAdInfo.getCreative_type() == 2 && meishuAdInfo.getSrcUrls() != null && meishuAdInfo.getSrcUrls().length > 0) {
            dVar.f32395g = meishuAdInfo.getSrcUrls()[0];
        }
    ...
    public SplashAdLoader(Context context, ViewGroup viewGroup, MsAdSlot msAdSlot, SplashAdEventListener splashAdEventListener, int i2) {
        this.isMute = true;
        if (msAdSlot == null) {
            LogUtil.e(TAG, "MsAdSlot is null");
            return;
