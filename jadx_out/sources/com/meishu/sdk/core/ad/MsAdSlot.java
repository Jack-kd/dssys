...
public class MsAdSlot {
    ...
    public static class Builder {
        ...
        public Builder setFetchCount(int i2) {
            this.fetchCount = i2;
            return this;
        }
        ...
        public Builder setIsClickToClose(boolean z2) {
            this.isClickToClose = z2;
            return this;
        }

        public Builder setIsHideSkipBtn(boolean z2) {
            this.hideSkipButton = z2;
            return this;
        }

        public Builder setIsVideoAutoPlay(boolean z2) {
            this.isVideoAutoPlay = z2;
            return this;
        }

        public Builder setIsshowDetail(boolean z2) {
            this.showDetail = z2;
            return this;
        }

        public Builder setNativeFeedUseShake(boolean z2) {
            this.nativeFeedUseShake = z2;
            return this;
        }
        ...
        public Builder setSplashIsFullScreen(boolean z2) {
            this.isSplashFullScreen = z2;
            return this;
        }

        public Builder setVideoMute(boolean z2) {
            this.isMute = z2;
            return this;
        }
