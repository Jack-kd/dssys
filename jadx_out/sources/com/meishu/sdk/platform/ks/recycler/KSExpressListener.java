...
public class KSExpressListener implements KsFeedAd.AdInteractionListener {
    ...
    public void onAdClicked() {
        try {
            if (this.adWrapper.getSdkAdInfo() != null && !TextUtils.isEmpty(this.adWrapper.getSdkAdInfo().getClk())) {
                ...
                a0.a(this.adWrapper.getContext(), f.a(this.adWrapper.getSdkAdInfo().getClk(), this.ksExpressFeedAd), new i());
    ...
    public void onAdShow() {
        try {
            i0.a(this.adWrapper.getSdkAdInfo(), this.ksExpressFeedAd.getAdView());
