...
public class OPPORecyclerAd extends a implements RecyclerAdData {
    ...
    public void bindAdToView(Context context, ViewGroup viewGroup, List<View> list, final RecylcerAdInteractionListener recylcerAdInteractionListener) {
        ...
        d.b(viewGroup);
        View nativeAdvanceContainer = new NativeAdvanceContainer(viewGroup.getContext());
    ...
    public boolean isNativeExpress() {
        ...
        return adPatternType == 200000 ? 2 == this.oppoRecyclerAdLoader.getSdkAdInfo().getDrawing() : adPatternType == 100000;
    }
    ...
    public void bindMediaView(ViewGroup viewGroup, final RecyclerAdMediaListener recyclerAdMediaListener) {
        ...
        MediaView mediaViewFindViewById = viewInflate.findViewById(R.id.ms_oppo_media_view);
        viewGroup.removeAllViews();
        viewGroup.addView(viewInflate);
        this.nativeAdvanceData.bindMediaView(viewGroup.getContext(), mediaViewFindViewById, new INativeAdvanceMediaListener() { // from class: com.meishu.sdk.platform.oppo.recycler.OPPORecyclerAd.2
