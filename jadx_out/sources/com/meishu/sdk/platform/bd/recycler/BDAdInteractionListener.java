...
public class BDAdInteractionListener implements NativeResponse.AdInteractionListener {
    ...
    public void onADExposed() {
        try {
            i0.a(this.bdRecyclerLoader.getSdkAdInfo(), this.adData.getAdView());
    ...
    public void onAdClick() {
        try {
            if (this.bdRecyclerLoader.getSdkAdInfo() != null && !TextUtils.isEmpty(this.bdRecyclerLoader.getSdkAdInfo().getClk())) {
                ...
                a0.a(this.bdRecyclerLoader.getContext().getApplicationContext(), f.a(this.bdRecyclerLoader.getSdkAdInfo().getClk(), this.adData), new i());
