...
public class BDSplashAd extends c {
    ...
    public BDSplashAd(boolean z2, ViewGroup viewGroup, BDSplashAdLoader bDSplashAdLoader) {
    ...
    public void showAd(ViewGroup viewGroup) {
        try {
            ...
            this.showed = true;
            p1.a(viewGroup, this.bdSplashAdLoader.getAdLoader().getPosId(), this.bdSplashAdLoader.getSdkAdInfo().getMsLoadedTime());
