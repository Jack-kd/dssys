...
public class BDSplashListener implements SplashInteractionListener {
    ...
    public void onAdClick() {
        try {
            if (this.loader.getSdkAdInfo() != null && !TextUtils.isEmpty(this.loader.getSdkAdInfo().getClk())) {
                ...
                a0.a(this.loader.getContext(), f.a(this.loader.getSdkAdInfo().getClk(), this.splashAd), new i());
    ...
    public void onAdExposed() {
        try {
            i0.a(this.loader.getSdkAdInfo(), this.loader.getAdLoader().getAdContainer());
            if (this.isExposed) {
                return;
            }
            d dVar = this.meishuListener;
