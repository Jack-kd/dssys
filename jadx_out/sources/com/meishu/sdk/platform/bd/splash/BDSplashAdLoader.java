...
public class BDSplashAdLoader extends BasePlatformLoader<SplashAdLoader, d> {
    ...
    /* JADX WARN: Type inference failed for: r0v5, types: [com.baidu.mobads.sdk.api.NativeResponse$MaterialType, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r13v2, types: [android.view.View, android.widget.TextView] */
    /* JADX WARN: Type inference failed for: r14v2, types: [android.view.View, android.widget.ImageView] */
    /* JADX WARN: Type inference failed for: r1v3 */
    /* JADX WARN: Type inference failed for: r1v4, types: [boolean, int] */
    /* JADX WARN: Type inference failed for: r1v5 */
    /* JADX WARN: Type inference failed for: r1v9, types: [com.baidu.mobads.sdk.api.NativeResponse$MaterialType, java.lang.Object] */
    /* JADX WARN: Type inference failed for: r20v0, types: [com.baidu.mobads.sdk.api.NativeResponse] */
    /* JADX WARN: Type inference failed for: r3v4, types: [com.meishu.sdk.core.bquery.e, com.meishu.sdk.core.bquery.i] */
    public void showNativeLayout(NativeResponse nativeResponse, final BDNativeSplashAd bDNativeSplashAd, boolean z2, boolean z3, Bitmap bitmap, Bitmap bitmap2, int i2, int i3) {
        ...
        ImageView imageView = (ImageView) meishuSplashRootView2.findViewById(R.id.ms_layout_native_splash_bg);
        ...
        TextView textView2 = (TextView) meishuSplashRootView2.findViewById(R.id.ms_layout_native_splash_cid);
        ...
        ?? iVar = new i(meishuSplashRootView2);
        ...
        if (z3) {
            ...
            if (TextUtils.isEmpty(nativeResponse.getIconUrl())) {
                ...
                iVar.f31521d = r14;
                iVar.a(nativeResponse.getIconUrl(), r12);
            }
        }
        try {
            ?? materialType = nativeResponse.getMaterialType();
            ?? r15 = NativeResponse.MaterialType.VIDEO;
            try {
                if (materialType.equals(r15)) {
                    bDSplashAdLoader = this;
                    XNativeView xNativeView = new XNativeView(bDSplashAdLoader.context);
                    ...
                    if (bitmap != null) {
                        ...
                        iVar.f31521d = gifImageView;
                        iVar.a(imageUrl, false);
                    }
                    if (bitmap2 != null) {
                        bDSplashAdLoader.context.getApplicationContext();
                        imageView.setImageBitmap(f0.a(bitmap2, 20));
                    }
                }
            } catch (Exception e2) {
                e = e2;
                bDSplashAdLoader = r15;
                e.printStackTrace();
                ...
                nativeResponse.registerViewForInteraction(linearLayout, arrayList, null, new NativeResponse.AdInteractionListener() { // from class: com.meishu.sdk.platform.bd.splash.BDSplashAdLoader.3
                    ...
                    public void adActReward(int i6) {
                    }
                    ...
                    public void onAdClick() {
                        try {
                            ...
                            if (BDSplashAdLoader.this.getSdkAdInfo() != null && bDNativeSplashAd != null) {
                                a0.a(BDSplashAdLoader.this.context.getApplicationContext(), f.a(BDSplashAdLoader.this.getSdkAdInfo().getClk(), bDNativeSplashAd), new com.meishu.sdk.core.utils.i());
    ...
    public void showNativeSplash(final NativeResponse nativeResponse, final BDNativeSplashAd bDNativeSplashAd) {
        if (nativeResponse.getMaterialType() != NativeResponse.MaterialType.VIDEO && nativeResponse.getMaterialType() == NativeResponse.MaterialType.NORMAL) {
            a.a(!TextUtils.isEmpty(nativeResponse.getImageUrl()) ? nativeResponse.getImageUrl() : (nativeResponse.getMultiPicUrls() == null || nativeResponse.getMultiPicUrls().size() <= 0) ? "" : nativeResponse.getMultiPicUrls().get(0), new y() { // from class: com.meishu.sdk.platform.bd.splash.BDSplashAdLoader.2
                ...
                public void onResponse(HttpResponse<byte[]> httpResponse) throws IOException {
                    ...
                    try {
                        ...
                        BDSplashAdLoader.this.showNativeLayout(nativeResponse, bDNativeSplashAd, true, z2, bitmapDecodeByteArray, BitmapFactory.decodeByteArray(responseBody, 0, responseBody.length), i2, i3);
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
                }
    ...
    private void showSkipView(MeishuSplashRootView meishuSplashRootView, final BDNativeSplashAd bDNativeSplashAd) {
        ...
        splashSkipView.setOnSkipListener(new SplashSkipView.b() { // from class: com.meishu.sdk.platform.bd.splash.BDSplashAdLoader.7
            ...
            public void onTick(long j2) {
                try {
                    if (BDSplashAdLoader.this.loadListener != null) {
                        ((d) BDSplashAdLoader.this.loadListener).onAdTick(j2);
                    }
                } catch (Throwable th) {
                    th.printStackTrace();
                }
    ...
    public void loadAd() {
        try {
            ...
            a0.a(((SplashAdLoader) this.adLoader).getContext(), i0.a(getSdkAdInfo().getReq()), new com.meishu.sdk.core.utils.i());
    ...
    public void sendGdtWinResult(boolean z2, int i2) {
        ...
        try {
            if (!z2) {
                SplashAd.class.getDeclaredMethod("biddingFail", String.class).invoke(this.splashAd, "203");
                return;
            }
            Method declaredMethod = SplashAd.class.getDeclaredMethod("biddingSuccess", String.class);
            SplashAd splashAd = this.splashAd;
            declaredMethod.invoke(splashAd, String.valueOf(u0.a(Integer.parseInt(splashAd.getECPMLevel()), i2, this.sdkAdInfo.getAt_rate(), this.sdkAdInfo.getPrice())));
        } catch (Throwable unused) {
            int i3 = 1;
            try {
                if (z2) {
                    LinkedHashMap<String, Object> linkedHashMap = new LinkedHashMap<>();
                    linkedHashMap.put("ecpm", Integer.valueOf(u0.a(Integer.parseInt(this.splashAd.getECPMLevel()), i2, this.sdkAdInfo.getAt_rate(), this.sdkAdInfo.getPrice())));
