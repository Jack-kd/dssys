...
public class HWNativeAdData extends a implements RecyclerAdData {
    ...
    public void bindAdToView(Context context, ViewGroup viewGroup, List<View> list, RecylcerAdInteractionListener recylcerAdInteractionListener) {
        ...
        View[] viewArrA = d.a(viewGroup, getClass(), NativeView.class);
        View nativeView = (NativeView) viewArrA[1];
        if (nativeView == null) {
            View view = viewArrA[0];
            nativeView = new NativeView(view.getContext());
            ...
            if (viewGroup2 != null) {
                ...
                TouchAdContainer touchAdContainer = new TouchAdContainer(view.getContext());
                touchAdContainer.setTouchPositionListener(new TouchPositionListener(this));
                touchAdContainer.addView(view, layoutParams2);
                nativeView.setId(view.getId());
                nativeView.addView(touchAdContainer, layoutParams2);
                viewGroup2.addView(nativeView, iIndexOfChild, layoutParams);
            }
        }
            ...
            try {
                if (viewGroup2.getParent() instanceof NativeView) {
                    ...
                    if (layoutParams == null) {
                        ...
                        viewGroup.addView((View) mediaView, layoutParams);
                    }
                    viewGroup2.getParent().setNativeAd(this.nativeAd);
                    if (getAdPatternType() == 2) {
                        viewGroup2.getParent().setMediaView(mediaView);
