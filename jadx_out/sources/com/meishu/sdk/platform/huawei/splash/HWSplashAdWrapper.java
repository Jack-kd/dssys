...
public class HWSplashAdWrapper extends BasePlatformLoader<SplashAdLoader, d> {
    ...
    /* renamed from: com.meishu.sdk.platform.huawei.splash.HWSplashAdWrapper$2, reason: invalid class name */
    public class AnonymousClass2 implements SplashLoadListener {
        public AnonymousClass2() {
        }

        public void onAdFailed(int i2) {
            new HWPlatformError("加载出错,code=" + i2, i2, HWSplashAdWrapper.this.getSdkAdInfo()).post(HWSplashAdWrapper.this.loadListener);
        }
    ...
    public class AnonymousClass3 extends SplashView.SplashAdLoadListener {
        ...
        public void onAdFailedToLoad(int i2) {
            LogUtil.e(HWSplashAdWrapper.TAG, "onAdFailedToLoad: " + i2);
            new HWPlatformError("加载出错", i2, HWSplashAdWrapper.this.getSdkAdInfo()).post(HWSplashAdWrapper.this.loadListener);
        }
    ...
    public void loadAd() {
        a.a(((SplashAdLoader) this.adLoader).getContext(), i0.a(getSdkAdInfo().getReq()));
        loadBiddingAd();
    }
