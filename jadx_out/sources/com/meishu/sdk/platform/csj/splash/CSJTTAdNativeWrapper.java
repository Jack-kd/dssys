...
public class CSJTTAdNativeWrapper extends BasePlatformLoader<SplashAdLoader, d> {
    ...
    private void loadNativeAd() {
        CSJAdConfig.getTtAdManager().createAdNative(((SplashAdLoader) this.adLoader).getContext().getApplicationContext()).loadFeedAd(new AdSlot.Builder().setCodeId(getSdkAdInfo().getPid()).setSupportDeepLink(true).setIsAutoPlay(true).setAdCount(1).build(), new TTAdNative.FeedAdListener() { // from class: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.2
            @Override // com.bytedance.sdk.openadsdk.TTAdNative.FeedAdListener
            public void onError(int i2, String str) {
                try {
                    new CSJPlatformError(str, Integer.valueOf(i2), CSJTTAdNativeWrapper.this.getSdkAdInfo()).post(CSJTTAdNativeWrapper.this.getLoaderListener());
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
    ...
    private void loadNewAd(AdSlot adSlot) {
        this.ttAdNative.loadSplashAd(adSlot, new TTAdNative.CSJSplashAdListener() { // from class: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.8
                ...
                try {
                    ...
                    cSJSplashAd.setSplashAdListener(new CSJSplashAd.SplashAdListener() { // from class: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.8.1
                        ...
                        public void onSplashAdClick(CSJSplashAd cSJSplashAd2) {
                            try {
                                if (CSJTTAdNativeWrapper.this.getSdkAdInfo() != null && !TextUtils.isEmpty(CSJTTAdNativeWrapper.this.getSdkAdInfo().getClk())) {
                                    ...
                                    a0.a(CSJTTAdNativeWrapper.this.getContext(), f.a(CSJTTAdNativeWrapper.this.getSdkAdInfo().getClk(), csjNewSplashAd), new i());
                        ...
                        public void onSplashAdShow(CSJSplashAd cSJSplashAd2) {
                            ...
                            try {
                                i0.a(CSJTTAdNativeWrapper.this.getSdkAdInfo(), cSJSplashAd2.getSplashView());
                                if (CSJTTAdNativeWrapper.this.getLoaderListener() != null) {
            ...
            public void onSplashLoadSuccess(CSJSplashAd cSJSplashAd) {
                StringBuilder sbA = a.a("load csj succ,thread=");
                sbA.append(Thread.currentThread().getName());
                LogUtil.d(CSJTTAdNativeWrapper.TAG, sbA.toString());
            }
        }, 3000);
    }
    ...
    public void showNativeAd(final TTFeedAd tTFeedAd, final CSJNativeSplashAd cSJNativeSplashAd) throws Resources.NotFoundException {
            ...
            public void onAdClicked(View view2, TTNativeAd tTNativeAd) {
                try {
                    if (CSJTTAdNativeWrapper.this.getSdkAdInfo() != null && cSJNativeSplashAd != null) {
                        LogUtil.d(CSJTTAdNativeWrapper.TAG, "send onADClicked");
                        a0.a(CSJTTAdNativeWrapper.this.context.getApplicationContext(), f.a(CSJTTAdNativeWrapper.this.getSdkAdInfo().getClk(), cSJNativeSplashAd), new i());
                        CSJTTAdNativeWrapper.this.getSdkAdInfo().getMsLoadedTime();
                        CSJTTAdNativeWrapper.this.getAdLoader().getPosId();
                    }
        ...
        if (tTFeedAd.getImageMode() == 3 || tTFeedAd.getImageMode() == 2 || tTFeedAd.getImageMode() == 4 || tTFeedAd.getImageMode() == 16) {
            ...
            com.meishu.sdk.core.cache.a.a(str2, new y() { // from class: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.4
        ...
        } else if (tTFeedAd.getImageMode() == 15 || tTFeedAd.getImageMode() == 5) {
            RelativeLayout.LayoutParams layoutParams3 = (RelativeLayout.LayoutParams) linearLayout.getLayoutParams();
            layoutParams3.width = (int) (displayMetrics.widthPixels * 0.86d);
            layoutParams3.height = -2;
            int i7 = (int) (displayMetrics.heightPixels * 0.07d);
        ...
        try {
            ...
            splashSkipView.setOnSkipListener(new SplashSkipView.b() { // from class: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.9
                ...
                public void onTick(long j2) {
                    try {
                        if (CSJTTAdNativeWrapper.this.loadListener != null) {
                            ((d) CSJTTAdNativeWrapper.this.loadListener).onAdTick(j2);
                        }
                    } catch (Throwable th) {
                        th.printStackTrace();
                    }
    ...
    */
    public void loadAd() {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.meishu.sdk.platform.csj.splash.CSJTTAdNativeWrapper.loadAd():void");
    }
}
