                ...
                tTNativeExpressAd.setExpressInteractionListener(new TTNativeExpressAd.ExpressAdInteractionListener() { // from class: com.meishu.sdk.platform.csj.banner.CSJBannerListenerImpl.1
                    ...
                    public void onAdClicked(View view, int i2) {
                        try {
                            if (CSJBannerListenerImpl.this.adNativeWrapper != null && !TextUtils.isEmpty(CSJBannerListenerImpl.this.adNativeWrapper.getSdkAdInfo().getClk())) {
                                ...
                                a0.a(CSJBannerListenerImpl.this.adNativeWrapper.getContext(), f.a(CSJBannerListenerImpl.this.adNativeWrapper.getSdkAdInfo().getClk(), cSJBannerAd), new i());
                            }
                    ...
                    public void onAdShow(View view, int i2) {
                        ...
                        try {
                            ...
                            i0.a(CSJBannerListenerImpl.this.adNativeWrapper.getSdkAdInfo(), cSJBannerAd.getAdView());
                    ...
                    public void onRenderFail(View view, String str, int i2) {
                        try {
                            a0.a(CSJBannerListenerImpl.this.adNativeWrapper.getSdkAdInfo().getErr(), Integer.valueOf(i2), str);
                            if (CSJBannerListenerImpl.this.adNativeWrapper.getLoaderListener() != null) {
                                CSJBannerListenerImpl.this.adNativeWrapper.getLoaderListener().onAdError();
                                CSJBannerListenerImpl.this.adNativeWrapper.getLoaderListener().onAdRenderFail(str, i2);
                            }
                        } catch (Throwable th) {
                            th.printStackTrace();
                        }
