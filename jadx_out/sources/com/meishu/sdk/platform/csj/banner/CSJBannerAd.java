...
public class CSJBannerAd extends a {
    ...
    public void showAd(ViewGroup viewGroup) {
        try {
            ...
            p1.a(viewGroup, this.adNativeWrapper.getAdLoader().getPosId(), this.sdkAdInfo.getMsLoadedTime());
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
    ...
    public void showAd(Activity activity, ViewGroup viewGroup) {
        try {
            ...
            if (tTNativeExpressAd2 != null && k0.f31920b) {
