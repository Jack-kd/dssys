...
public class CSJAdInteractionListenerAdapter implements TTNativeAd.AdInteractionListener {
    ...
    public void onAdClicked(View view, TTNativeAd tTNativeAd) {
        try {
            if (this.adData.getAdWrapper() != null && !TextUtils.isEmpty(this.adData.getAdWrapper().getSdkAdInfo().getClk())) {
                ...
                a0.a(this.adData.getAdWrapper().getContext().getApplicationContext(), f.a(this.adData.getAdWrapper().getSdkAdInfo().getClk(), this.adData), new i());
            }
    ...
    public void onAdShow(TTNativeAd tTNativeAd) {
        ...
        try {
            ...
            i0.a(this.adWrapper.getSdkAdInfo(), tTNativeAd.getAdView());
        } catch (Throwable th) {
            th.printStackTrace();
        }
        try {
