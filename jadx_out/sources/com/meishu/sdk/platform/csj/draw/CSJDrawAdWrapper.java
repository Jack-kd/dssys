...
public class CSJDrawAdWrapper extends BasePlatformLoader<DrawAdLoader, a> {
    ...
    private void loadExpressAd(int i2, int i3) {
        try {
            this.ttAdNative.loadExpressDrawFeedAd(new AdSlot.Builder().setCodeId(getSdkAdInfo().getPid()).setSupportDeepLink(true).setImageAcceptedSize(i2, i3).setExpressViewAcceptedSize(m.b(((DrawAdLoader) this.adLoader).getContext(), i2), m.b(((DrawAdLoader) this.adLoader).getContext(), i3)).build(), new CSJDrawListenerImpl(this));
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }

    private void loadMediationExpressAd(int i2, int i3) {
        this.ttAdNative.loadDrawFeedAd(new AdSlot.Builder().setCodeId(getSdkAdInfo().getPid()).setImageAcceptedSize(i2, i3).setAdCount(1).build(), new TTAdNative.DrawFeedAdListener() { // from class: com.meishu.sdk.platform.csj.draw.CSJDrawAdWrapper.1
            ...
            public void onError(int i4, String str) {
                try {
                    LogUtil.e(CSJDrawAdWrapper.TAG, "onError, code: " + i4 + ", msg: " + str);
                    new CSJPlatformError(str, Integer.valueOf(i4), CSJDrawAdWrapper.this.getSdkAdInfo()).post(CSJDrawAdWrapper.this.getLoaderListener());
                } catch (Throwable th) {
                    th.printStackTrace();
                }
            }
    ...
    private void loadNativeAd(int i2, int i3) {
        try {
            CSJAdConfig.getTtAdManager().createAdNative(getContext()).loadDrawFeedAd(new AdSlot.Builder().setCodeId(getSdkAdInfo().getPid()).setImageAcceptedSize(i2, i3).setAdCount(1).build(), new TTAdNative.DrawFeedAdListener() { // from class: com.meishu.sdk.platform.csj.draw.CSJDrawAdWrapper.2
                @Override // com.bytedance.sdk.openadsdk.TTAdNative.DrawFeedAdListener
                public void onDrawFeedAdLoad(List<TTDrawFeedAd> list) {
                    if (list != null) {
                        try {
                            ...
                            tTDrawFeedAd.setVideoAdListener(new TTFeedAd.VideoAdListener() { // from class: com.meishu.sdk.platform.csj.draw.CSJDrawAdWrapper.2.1
                                ...
                                public void onProgressUpdate(long j2, long j3) {
                                    try {
                                        if (cSJNativeDrawAd.getDrawVideoListener() != null) {
                                            cSJNativeDrawAd.getDrawVideoListener().onProgressUpdate(j2, j3);
                                        }
                                    } catch (Throwable th) {
                                        th.printStackTrace();
                                    }
                                ...
                                public void onVideoError(int i4, int i5) {
                                    try {
                                        if (cSJNativeDrawAd.getDrawVideoListener() != null) {
                                            cSJNativeDrawAd.getDrawVideoListener().onVideoError(i4, i5);
                                        }
                                    } catch (Throwable th) {
                                        th.printStackTrace();
                                    }
