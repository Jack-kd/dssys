                    ...
                    public void onAdCreativeClick(View view, TTNativeAd tTNativeAd) {
                        try {
                            ...
                            if (CSJNativeDrawAd.this.adWrapper != null && !TextUtils.isEmpty(CSJNativeDrawAd.this.adWrapper.getSdkAdInfo().getClk())) {
                                ...
                                a0.a(CSJNativeDrawAd.this.adWrapper.getContext(), f.a(CSJNativeDrawAd.this.adWrapper.getSdkAdInfo().getClk(), CSJNativeDrawAd.this), new i());
                            }
