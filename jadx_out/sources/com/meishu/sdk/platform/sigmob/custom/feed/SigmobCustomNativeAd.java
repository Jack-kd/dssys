...
public class SigmobCustomNativeAd extends MsCustomRecyclerFeedAd {
    ...
    public void bindAdToView(Context context, ViewGroup viewGroup, List<View> list) {
        ...
        if (windNativeAdData != null) {
            windNativeAdData.bindViewForInteraction(viewGroup, list, list, null, new NativeADEventListener() { // from class: com.meishu.sdk.platform.sigmob.custom.feed.SigmobCustomNativeAd.2
    ...
    public String[] getImgUrls() {
        try {
            ...
            if (windNativeAdData != null && windNativeAdData.getImageList() != null) {
                try {
                    List<SigImage> imageList = this.windNativeAdData.getImageList();
