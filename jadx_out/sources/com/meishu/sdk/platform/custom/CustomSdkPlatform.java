...
public class CustomSdkPlatform extends c {
    ...
    public com.meishu.sdk.core.loader.d drawLoader(DrawAdLoader drawAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public com.meishu.sdk.core.loader.d fullScreenVideoLoader(FullScreenVideoAdLoader fullScreenVideoAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public MsCustomBannerAdapter bannerLoader(BannerAdLoader bannerAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public MsCustomInterstitialAdapter interstitialLoader(InterstitialAdLoader interstitialAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public MsCustomRecyclerAdapter recyclerLoader(RecyclerMixAdLoader recyclerMixAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public MsCustomRewardAdapter rewardLoader(RewardVideoLoader rewardVideoLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
    ...
    @Override // com.meishu.sdk.core.c, com.meishu.sdk.core.e
    public MsCustomSplashAdapter splashLoader(SplashAdLoader splashAdLoader, SdkAdInfo sdkAdInfo, MeishuAdInfo meishuAdInfo) throws NoSuchMethodException, SecurityException {
        if (TextUtils.isEmpty(sdkAdInfo.getCls())) {
            return null;
        }
        try {
