...
public abstract class MsCustomRecyclerAdapter extends BasePlatformLoader<RecyclerMixAdLoader, a> {
    ...
    public void loadAd() {
        a0.a(((RecyclerMixAdLoader) this.adLoader).getContext(), i0.a(getSdkAdInfo().getReq()), new i());
    ...
    public void onExpressAdClicked(MsCustomRecyclerExpressAd msCustomRecyclerExpressAd) {
        if (!TextUtils.isEmpty(getSdkAdInfo().getClk())) {
            ...
            com.meishu.sdk.core.loader.a.a(getContext().getApplicationContext(), f.a(getSdkAdInfo().getClk(), msCustomRecyclerExpressAd));
        }
    ...
    public void onFeedAdClicked(MsCustomRecyclerFeedAd msCustomRecyclerFeedAd) {
        if (!TextUtils.isEmpty(getSdkAdInfo().getClk())) {
            LogUtil.d(TAG, "send onAdClicked");
            com.meishu.sdk.core.loader.a.a(getContext().getApplicationContext(), f.a(getSdkAdInfo().getClk(), msCustomRecyclerFeedAd));
        }
