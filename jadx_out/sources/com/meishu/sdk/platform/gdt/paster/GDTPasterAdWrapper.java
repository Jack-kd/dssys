...
public class GDTPasterAdWrapper extends BasePlatformLoader<PasterAdLoader, b> {
            ...
            public void onADClicked() {
                try {
                    if (GDTPasterAdWrapper.this.getSdkAdInfo() != null && !TextUtils.isEmpty(GDTPasterAdWrapper.this.getSdkAdInfo().getClk())) {
                        ...
                        a0.a(GDTPasterAdWrapper.this.getContext(), f.a(GDTPasterAdWrapper.this.getSdkAdInfo().getClk(), GDTPasterAdWrapper.this.gdtPasterAd), new com.meishu.sdk.core.utils.i());
                    }
    ...
    private void renderAdUi(NativeUnifiedADData nativeUnifiedADData) {
        ...
        if (adPatternType == 4) {
            ...
            View view = this.aQuery.b(R.id.ms_img_poster).f31521d;
            if (view != null) {
    ...
    public void loadAd() {
        try {
            a0.a(((PasterAdLoader) this.adLoader).getContext(), i0.a(getSdkAdInfo().getReq()), new com.meishu.sdk.core.utils.i());
