...
public class GDTRecyclerAdWrapper extends BasePlatformLoader<RecyclerMixAdLoader, a> {
    ...
    public void loadNativeExpressAD(int i2) {
        try {
            ...
            if (getAdLoader().getAccept_ad_height() != null && getAdLoader().getAccept_ad_height().intValue() > 0) {
                getAdLoader().getAccept_ad_height().getClass();
            ...
            this.nativeExpressAD.loadAD(i2);
        } catch (Throwable th) {
            th.printStackTrace();
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void loadNativeUnifiedAD(int i2) {
        this.gdtNativeAdapter = new GDTNativeUnifiedAdListenerAdapter(this);
        if (!TextUtils.isEmpty(this.sdkAdInfo.getS2sb())) {
            try {
                this.nativeUnifiedAD = new NativeUnifiedAD(getContext().getApplicationContext(), this.sdkAdInfo.getPid(), this.gdtNativeAdapter, ((S2sbResultBean) new Gson().fromJson(this.sdkAdInfo.getS2sb(), S2sbResultBean.class)).getToken());
            } catch (Exception e2) {
                e2.printStackTrace();
            }
        }
        if (this.nativeUnifiedAD == null) {
            this.nativeUnifiedAD = new NativeUnifiedAD(getContext().getApplicationContext(), this.sdkAdInfo.getPid(), this.gdtNativeAdapter);
        }
    ...
    public void loadAd() {
        ...
        h0.b.f31910a.a(new l() { // from class: com.meishu.sdk.platform.gdt.recycler.GDTRecyclerAdWrapper.1
            @Override // com.meishu.sdk.core.safe.l
            public void safeRun() {
                try {
                    a0.a(GDTRecyclerAdWrapper.this.getContext().getApplicationContext(), i0.a(GDTRecyclerAdWrapper.this.getSdkAdInfo().getReq()), new i());
        ...
        try {
            ...
            for (NativeUnifiedADData nativeUnifiedADData : this.gdtNativeAdapter.getAdList()) {
                if (z2) {
                    ...
                    map3.put("highestLossPrice", Integer.valueOf(u0.a(nativeUnifiedADData.getECPM(), i2, this.sdkAdInfo.getAt_rate(), this.sdkAdInfo.getPrice())));
                    nativeUnifiedADData.sendWinNotification(map3);
                } else {
                    HashMap map4 = new HashMap();
                    map4.put("winPrice", Integer.valueOf(i2));
