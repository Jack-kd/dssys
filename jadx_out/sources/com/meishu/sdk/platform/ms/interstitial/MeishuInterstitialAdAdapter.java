...
public class MeishuInterstitialAdAdapter extends InterstitialAd {
    ...
    public ResultBean getData() {
        ...
        resultBean.setAdInfo(C1242a.a((BaseAdSlot) this.interstitialAd.a()));
        return resultBean;
    }

    public String getDeepLink() {
        if (C1242a.a(this.interstitialAd.a().getAder_id())) {
    ...
    public boolean getIsOperationContent() {
        return C1242a.a(this.interstitialAd.a().getAder_id());
    }
    ...
    public void sendLossNotification(Map map) {
        a0.a(AdSdk.getContext(), this.interstitialAd.a().getLossUrl(), (Map<String, Object>) map);
    }

    @Override // com.meishu.sdk.core.ad.a, com.meishu.sdk.core.s2s.ISBidding
    public void sendWinNotification(Map map) {
        a0.b(AdSdk.getContext(), this.interstitialAd.a().getWinUrl(), map);
    }
    ...
    public void showAd() {
        ...
        if (cVar != null) {
            try {
                cVar.a((Activity) cVar.f32247a.getContext());
            } catch (Throwable th) {
                com.meishu.sdk.meishu_ad.interstitial.a aVar = cVar.f32248b;
                if (aVar != null) {
            ...
            if (this.interstitialAd.a() != null) {
                p1.b(this.interstitialAd.a().getEventUrl());
            }
        }
    }
    ...
    public void showAd(Activity activity) {
        ...
        if (cVar != null) {
            try {
                ...
                if (cVar.f32248b != null) {
                    ((a) cVar.f32248b).onAdRenderFail("插屏渲染失败,showAd", ErrorCodeUtil.RES_LOAD_ERROR.intValue());
                }
                th.printStackTrace();
            }
            if (this.interstitialAd.a() != null) {
