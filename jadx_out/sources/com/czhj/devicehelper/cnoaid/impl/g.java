...
class g implements com.czhj.devicehelper.cnoaid.d {
    ...
    private final Handler f29134b = new Handler(Looper.getMainLooper());
    ...
    public void b(com.czhj.devicehelper.cnoaid.c cVar) {
        ...
        try {
            if (this.f29135c) {
                a.C0449a c0449aA = com.czhj.devicehelper.honor.identifier.a.a(this.f29133a);
                if (c0449aA == null) {
                    return;
                } else {
                    str = c0449aA.f29184a;
                ...
                Object objInvoke = method.invoke(null, this.f29133a);
                if (objInvoke == null) {
    ...
    public void a(final com.czhj.devicehelper.cnoaid.c cVar) {
        if (this.f29133a == null || cVar == null) {
            return;
        }
    ...
    private void a(final com.czhj.devicehelper.cnoaid.c cVar, final com.czhj.devicehelper.cnoaid.f fVar) {
        this.f29134b.post(new Runnable() { // from class: com.czhj.devicehelper.cnoaid.impl.g.3
            @Override // java.lang.Runnable
            public void run() {
                cVar.a(fVar);
            }
    ...
    private void a(final com.czhj.devicehelper.cnoaid.c cVar, final String str) {
        this.f29134b.post(new Runnable() { // from class: com.czhj.devicehelper.cnoaid.impl.g.2
            @Override // java.lang.Runnable
            public void run() {
                cVar.a(str);
            }
    ...
    public boolean a() {
        ...
        try {
            Object objInvoke = Class.forName("com.hihonor.ads.identifier.AdvertisingIdClient").getMethod("isAdvertisingIdAvailable", Context.class).invoke(null, this.f29133a);
            ...
            try {
                boolean zB = com.czhj.devicehelper.honor.identifier.a.b(this.f29133a);
                this.f29135c = true;
                return zB;
