...
public class TrackingRequest extends Request<NetworkResponse> {
    ...
    public TrackingRequest(String str, int i2, int i3, RequestListener requestListener) {
        ...
        setRetryPolicy(new DefaultRetryPolicy(i3, i3, i2, 0.0f));
    ...
    public TrackingRequest(String str, int i2, RequestListener requestListener) {
        this(str, i2, Config.sharedInstance().getNetworkTimeout(), requestListener);
    }
}
