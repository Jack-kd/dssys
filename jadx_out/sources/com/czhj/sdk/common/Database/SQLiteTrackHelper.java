...
public class SQLiteTrackHelper extends SQLiteOpenHelper {
    ...
    private static String f29293a = "sigmob_track.db";

    /* renamed from: b, reason: collision with root package name */
    private static final int f29294b = 9;

    /* renamed from: c, reason: collision with root package name */
    private static String f29295c = "CREATE TABLE tracks ( id integer primary key AUTOINCREMENT ,retryNum integer   ,source text   ,event text   ,request_id text   ,url text   ,timestamp integer, extInfo text, messageType integer );\n";

    /* renamed from: d, reason: collision with root package name */
    private static final long f29296d = -6;

    /* renamed from: e, reason: collision with root package name */
    private static final long f29297e = -5;

    /* renamed from: f, reason: collision with root package name */
    private static final long f29298f = -4;

    /* renamed from: g, reason: collision with root package name */
    private static final long f29299g = 0;

    /* renamed from: h, reason: collision with root package name */
    private static volatile SQLiteTrackHelper f29300h;

    /* renamed from: i, reason: collision with root package name */
    private static SQLiteDatabase f29301i;
    ...
    public SQLiteTrackHelper(Context context) {
        super(context, f29293a, (SQLiteDatabase.CursorFactory) null, 9);
    }
    ...
    public static void initialize(Context context) {
        if (f29300h == null) {
            synchronized (SQLiteTrackHelper.class) {
                try {
                    if (f29300h == null) {
                        f29300h = new SQLiteTrackHelper(context);
                    }
                } catch (Throwable th) {
                    throw th;
                }
    ...
    */
    public static void insert(android.database.sqlite.SQLiteDatabase r4, com.czhj.sdk.common.Database.SQLiteBuider.Insert r5, com.czhj.sdk.common.Database.SQLiteTrackHelper.ExecCallBack r6) {
        /*
            r4.beginTransaction()
    ...
    public void onCreate(SQLiteDatabase sQLiteDatabase) throws SQLException {
        sQLiteDatabase.execSQL(f29295c);
    }
