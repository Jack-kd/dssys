...
public class PoolingByteArrayOutputStream extends ByteArrayOutputStream {
    ...
    private static final int f29698a = 256;

    /* renamed from: b, reason: collision with root package name */
    private final ByteArrayPool f29699b;
    ...
    private void a(int i2) {
        ...
        byte[] buf = this.f29699b.getBuf((i3 + i2) * 2);
        System.arraycopy(((ByteArrayOutputStream) this).buf, 0, buf, 0, ((ByteArrayOutputStream) this).count);
        this.f29699b.returnBuf(((ByteArrayOutputStream) this).buf);
