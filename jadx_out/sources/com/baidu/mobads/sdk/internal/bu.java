...
public class bu extends File {
    ...
    public static final String f11234a = "LocalApkFile";

    /* renamed from: b, reason: collision with root package name */
    private static final long f11235b = 6916965592955692235L;

    /* renamed from: h, reason: collision with root package name */
    private static ClassLoader f11236h;

    /* renamed from: c, reason: collision with root package name */
    private bz f11237c;

    /* renamed from: d, reason: collision with root package name */
    private Class<?> f11238d;

    /* renamed from: e, reason: collision with root package name */
    private Context f11239e;

    /* renamed from: f, reason: collision with root package name */
    private PublicKey f11240f;
    ...
    private void d() {
        File[] fileArrListFiles = this.f11239e.getFilesDir().listFiles(new a());
        for (int i2 = 0; fileArrListFiles != null && i2 < fileArrListFiles.length; i2++) {
            if (fileArrListFiles[i2].getAbsolutePath().contains("__xadsdk__remote__final__")) {
                this.f11241g.a(f11234a, "clearDexCacheFiles-->" + i2 + "--" + fileArrListFiles[i2].getAbsolutePath());
    ...
    public void a() throws Throwable {
        if (this.f11237c == null) {
            this.f11241g.a(f11234a, "built-in apk, no need to check");
            return;
        }
        String strA = a(new File(getAbsolutePath()));
        String strB = b(this.f11237c.d());
    ...
    public bu(String str, Context context, bz bzVar) {
        ...
        if (bzVar != null) {
            try {
                this.f11240f = c("MIGfMA0GCSqGSIb3DQEBAQUAA4GNADCBiQKBgQDBcp8gg3O7bjdnz+pSxg+JH/mbcKfm7dEjcRqVNAFwG7bTpLwDQh40bZJzrcBKQWbD6kArR6TPuQUCMQ09/y55Vk1P2Kq7vJGGisFpjlqv2qlg8drLdhXkLQUt/SeZVJgT+CNxVbuzxAF61EEf8M0MHi1I2dm6n6lOA6fomiCD9wIDAQAB");
            } catch (Exception unused) {
                this.f11240f = null;
            }
        }
    ...
    private String b(String str) throws NoSuchPaddingException, NoSuchAlgorithmException, InvalidKeyException {
        ...
        try {
            ...
            cipher.init(2, this.f11240f);
            return new String(cipher.doFinal(bArrDecode), "UTF-8").trim();
        } catch (Exception e2) {
            this.f11241g.c("ErrorWhileVerifySigNature", e2);
            return null;
        }
    }
    ...
    */
    private java.lang.String a(java.io.File r9) throws java.lang.Throwable {
        ...
        L5a:
            r9 = move-exception
            com.baidu.mobads.sdk.internal.bv r1 = r8.f11241g
        ...
        L6f:
            ...
            r4 = r2
        L71:
            com.baidu.mobads.sdk.internal.bv r3 = r8.f11241g     // Catch: java.lang.Throwable -> L92
        ...
        L82:
            ...
            goto L91
        L88:
            com.baidu.mobads.sdk.internal.bv r2 = r8.f11241g
            java.lang.String r9 = r9.getMessage()
            r2.a(r0, r9)
        L91:
            return r1
    ...
    private Class<?> b(File file) throws cb.a {
        Class<?> cls;
        this.f11241g.a(f11234a, "Android version:" + bn.a(this.f11239e).c());
        Class<?> cls2 = null;
        try {
            synchronized (cb.class) {
                String absolutePath = file.getAbsolutePath();
                ClassLoader classLoader = getClass().getClassLoader();
                String absolutePath2 = this.f11239e.getFilesDir().getAbsolutePath();
                String str = z.aQ;
                ClassLoader classLoaderA = ao.a(absolutePath, absolutePath2, (String) null, classLoader);
                f11236h = classLoaderA;
                cls = Class.forName(str, true, classLoaderA);
                this.f11241g.a(f11234a, "dexPath=" + absolutePath + ", cl=" + classLoader + ", dir=" + absolutePath2 + ", len=" + file.length() + ", list=" + file.list() + ", class=" + cls);
            }
            cls2 = cls;
        } catch (Exception e2) {
            this.f11241g.a(f11234a, e2.getMessage());
        }
        this.f11241g.a(f11234a, "jar.path=" + file.getAbsolutePath() + ", clz=" + cls2);
        return cls2;
    }

    public static ClassLoader a(Context context) {
        ClassLoader classLoader = f11236h;
