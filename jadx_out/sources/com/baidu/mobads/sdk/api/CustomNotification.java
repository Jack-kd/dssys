...
public class CustomNotification {
    ...
    public static void initNotification(@DrawableRes int i2, String str) {
        mSmallIcon = i2;
    ...
    @TargetApi(16)
    public Notification getNewNotification(Context context, String str, boolean z2, Bitmap bitmap, String str2, String str3, int i2, boolean z3, String str4, PendingIntent pendingIntent, String str5, PendingIntent pendingIntent2) {
        NotificationCompat.Builder builder;
        if (bn.a(context).a() < 26) {
            builder = new NotificationCompat.Builder(context);
        } else {
        ...
        if (i2 < 0 || i2 > 100) {
            ...
            remoteViews.setProgressBar(R.id.progress, 100, i2, z3);
        ...
        return builder.setStyle(this.mStyle).setSmallIcon(mSmallIcon).setOngoing(false).setTicker(str).setAutoCancel(z2).setWhen(System.currentTimeMillis()).setCustomContentView(remoteViews).build();
    }
}
