...
public class SplashAd {
        ...
        ctVar.a(new ct.a() { // from class: com.baidu.mobads.sdk.api.SplashAd.2
            ...
            public void onLayoutComplete(int i2, int i3) {
                if (this.mIsFirstOnLayout) {
                    ...
                    SplashAd.this.mAdProd.f11523u = false;
    ...
    public String getBiddingToken() {
        ...
        dk dkVar2 = new dk(this.mContext, this.mAdPlaceId, i3, i2, this.mTipStyle, this.mTimeout, this.mDisplayDownInfo, this.mPopDialogIfDL.booleanValue(), this.mDisplayClickRegion.booleanValue(), this.mLimitRegionClick.booleanValue());
        this.mAdProd = dkVar2;
        ...
        dk dkVar3 = this.mAdProd;
        dkVar3.f11181r = this.mBidFloor;
        dkVar3.f11523u = true;
        RequestParameters requestParameters2 = this.mParameter;
        if (requestParameters2 != null) {
            dkVar3.a(requestParameters2);
        }
    ...
    public boolean isReady() {
        ...
        dk dkVar = this.mAdProd;
        if (dkVar == null || (iAdInterListener = dkVar.f11176m) == null) {
            return false;
        }
    ...
    public void loadAndShow(ViewGroup viewGroup) {
        ...
        ctVar.a(new ct.a() { // from class: com.baidu.mobads.sdk.api.SplashAd.3
            ...
            public void onLayoutComplete(int i2, int i3) {
                ...
                SplashAd.this.mAdProd = new dk(SplashAd.this.mContext, SplashAd.this.mAdPlaceId, i4, i5, SplashAd.this.mTipStyle, SplashAd.this.mTimeout, SplashAd.this.mDisplayDownInfo, SplashAd.this.mPopDialogIfDL.booleanValue(), SplashAd.this.mDisplayClickRegion.booleanValue(), SplashAd.this.mLimitRegionClick.booleanValue());
                SplashAd.this.mAdProd.a(ctVar);
                ...
                SplashAd.this.mAdProd.f11181r = SplashAd.this.mBidFloor;
    ...
    public static void registerEnterTransition(Activity activity, int i2, int i3, SplashFocusAdListener splashFocusAdListener) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
    ...
    @Deprecated
    public static void registerEnterTransition(Activity activity, int i2, int i3, int i4, SplashFocusAdListener splashFocusAdListener) throws JSONException {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("right_margin", i2);
            jSONObject.put("bottom_margin", i3);
