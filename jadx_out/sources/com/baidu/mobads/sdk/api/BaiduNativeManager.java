...
public class BaiduNativeManager {
    ...
    public interface ExpressAdListener {
        ...
        void onNativeFail(int i2, String str, ExpressResponse expressResponse);

        void onNativeLoad(List<ExpressResponse> list);

        void onNoAd(int i2, String str, ExpressResponse expressResponse);
    ...
    public interface FeedAdListener {
        ...
        void onNativeFail(int i2, String str, NativeResponse nativeResponse);

        void onNativeLoad(List<NativeResponse> list);

        void onNoAd(int i2, String str, NativeResponse nativeResponse);
    ...
    private void loadBiddingAd(RequestParameters requestParameters, String str, String str2, FeedAdListener feedAdListener, ExpressAdListener expressAdListener) {
        ...
        dgVar.f11181r = getBidFloor(requestParameters);
    ...
    public void setAdReward(boolean z2) {
        this.mAdReward = z2;
    }
    ...
    public void setRewardOnDownloaded(boolean z2) {
        this.mRewardOnDownloaded = z2;
    }
