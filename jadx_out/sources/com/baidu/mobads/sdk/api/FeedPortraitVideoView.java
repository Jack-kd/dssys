...
public class FeedPortraitVideoView extends RelativeLayout {
    ...
    public void pause() {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, C1244a.f35682j, new Class[0], new Object[0]);
        }
    }
    ...
    public void seekTo(int i2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "seekTo", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
        }
    }
    ...
    public void setCanClickVideo(boolean z2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setCanClickVideo", new Class[]{Boolean.TYPE}, Boolean.valueOf(z2));
        }
    }
    ...
    public void setPlayBackSpeed(float f2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setPlayBackSpeed", new Class[]{Float.TYPE}, Float.valueOf(f2));
        }
    }
    ...
    public void setProgressBackgroundColor(int i2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setProgressBackgroundColor", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
        }
    }
    ...
    public void setProgressBarColor(int i2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setProgressBarColor", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
        }
    }
    ...
    public void setProgressHeightInDp(int i2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setProgressHeightDp", new Class[]{Integer.TYPE}, Integer.valueOf(i2));
        }
    }
    ...
    public void setShowProgress(boolean z2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setShowProgressBar", new Class[]{Boolean.TYPE}, Boolean.valueOf(z2));
        }
    }
    ...
    public void setUseDownloadFrame(boolean z2) {
        View view = this.mAdView;
        if (view != null) {
            av.a(this.mRemoteClassName, view, this.mLoader, "setUseDownloadFrame", new Class[]{Boolean.TYPE}, Boolean.valueOf(z2));
        }
    }
    ...
    public void setVideoMute(boolean z2) {
        try {
            View view = this.mAdView;
            if (view != null) {
                av.a(this.mRemoteClassName, view, this.mLoader, "userSetVideoMute", new Class[]{Boolean.TYPE}, Boolean.valueOf(z2));
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    public void systemSetVideoMute(boolean z2) {
        try {
            View view = this.mAdView;
            if (view != null) {
                av.a(this.mRemoteClassName, view, this.mLoader, "setVideoMute", new Class[]{Boolean.TYPE}, Boolean.valueOf(z2));
            }
        } catch (Exception e2) {
            e2.printStackTrace();
        }
    ...
    public FeedPortraitVideoView(Context context, AttributeSet attributeSet, int i2) {
        ...
        this.mRemoteClassName = z.f11741e;
