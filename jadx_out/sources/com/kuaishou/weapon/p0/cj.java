...
public class cj {
    ...
    public cj(Context context, int i2, int i3) {
    ...
    public JSONObject a() {
        try {
            ...
            jSONObject.put("36", ab.a(this.f30983a) ? 1 : 0);
            Object objA = ai.a(this.f30983a);
            if (objA != null) {
                jSONObject.put("4", objA);
            }
            z zVar = new z();
            JSONArray jSONArrayA = zVar.a(this.f30983a);
            ...
            boolean zA = acVar.a(this.f30983a);
            jSONObject.put(GlobalSetting.UNIFIED_INTERSTITIAL_HS_AD, zA ? 1 : 0);
            if (zA) {
                jSONObject.put("61", acVar.b(this.f30983a));
            }
            jSONObject.put("181", acVar.f(this.f30983a) ? 1 : 0);
            jSONObject.put("9", acVar.d(this.f30983a));
            jSONObject.put(PointType.SIGMOB_APP, acVar.e(this.f30983a));
            jSONObject.put("11", acVar.c(this.f30983a));
            ae aeVar = new ae();
            ...
            if (objA2 != null) {
                ...
                if (setB != null || setC != null) {
                    ...
                    jSONObject.put(PointType.SIGMOB_REPORT_TRACKING, anVar.a(this.f30983a, 13, hashSet));
                    jSONObject.put("14", anVar.a(this.f30983a, 14, hashSet));
                    jSONObject.put("15", anVar.a(this.f30983a, 15, hashSet));
                    jSONObject.put("16", anVar.a(this.f30983a, 16, hashSet));
                    jSONObject.put(PointType.LOAD_READY, anVar.a(this.f30983a, 17, hashSet));
                    jSONObject.put("18", anVar.a(this.f30983a, 18, hashSet));
                    jSONObject.put("19", anVar.a(this.f30983a, 19, hashSet));
                    jSONObject.put("20", anVar.a(this.f30983a, 20, hashSet));
                    jSONObject.put("21", anVar.a(this.f30983a, 21, hashSet));
            ...
            jSONObject2.put("03007", bt.a(this.f30983a));
            jSONObject2.put("03014", bf.g(this.f30983a));
            jSONObject2.put("03020", bt.b(this.f30983a));
            jSONObject2.put("03030", be.d(this.f30983a));
            ...
            jSONObject.put("145", ahVar.a(this.f30983a));
            jSONObject.put("132", di.a());
            jSONObject.put("133", new aj(this.f30983a).g());
            if (hVarA.b(dd.an, 1) == 1) {
                jSONObject.put("139", dj.c(this.f30983a));
                jSONObject.put("140", dj.d(this.f30983a));
            ...
            if (Engine.loadSuccess) {
                as asVar = new as(this.f30983a, 100);
                ...
                jSONObject.put(UBiXLossReason.Reason_Occupied, asVar.a(UBiXLossReason.Reason_Occupied));
                if (hVarA.b(dd.f31105Z, 1) == 1) {
                    aq aqVar = new aq(this.f30983a, 0);
                    jSONObject.put("108", aqVar.a("108"));
                    jSONObject.put("109", aqVar.a("109"));
                    jSONObject.put("111", aqVar.a("111"));
                }
                if (hVarA.b(dd.ab, 1) == 1) {
                    aq aqVar2 = new aq(this.f30983a, 1);
                    ...
                    aq aqVar3 = new aq(this.f30983a, 4);
                ...
                if (hVarA.b(dd.aj, 0) == 1) {
                    av avVar = new av(this.f30983a, 100);
                    ...
                    av avVar2 = new av(this.f30983a, 200);
                    jSONObject.put("173", avVar2.a("173"));
                    jSONObject.put("182", avVar2.a("182"));
                }
                if (hVarA.b(dd.f31104Y, 1) == 1) {
                    jSONObject.put("129", new bc(this.f30983a, 4).a("129"));
                    bc bcVar = new bc(this.f30983a, 1);
                    jSONObject.put("121", bcVar.a(bcVar.a(), "121"));
                    bc bcVar2 = new bc(this.f30983a, 2);
                    ...
                    bd bdVar = new bd(this.f30983a, 3);
                ...
                if (hVarA.b(dd.f31100U, 1) == 1) {
                    az azVar = new az(this.f30983a, 100);
                    ...
                    jSONObject.put("177", new az(this.f30983a, 500).d("177"));
                }
                if ((zE || zE2) && hVarA.b(dd.f31102W, 0) == 1) {
                    jSONObject.put("158", new az(this.f30983a, 300).b("158"));
                }
                if (hVarA.b(dd.am, 0) == 1) {
                    bb bbVar = new bb(this.f30983a);
                    jSONObject.put("162", bbVar.a("162"));
                    jSONObject.put("160", bbVar.a(bbVar.a(), "160"));
                    az azVar2 = new az(this.f30983a, MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL);
                ...
                if (hVarA.b(dd.ak, 1) == 1) {
                    ax axVar = new ax(this.f30983a, 600);
                    jSONObject.put("179", axVar.a("179"));
                    jSONObject.put("186", axVar.a("186"));
                    jSONObject.put("189", axVar.a("189"));
                }
            }
            jSONObject.put("60", ab.b(this.f30983a) ? 1 : 0);
            jSONObject.put("11000", Engine.loadSuccess ? 1 : 0);
            jSONObject.put("11002", Engine.soVersion);
            jSONObject.put("11008", hVarA.b(dd.f31112g, bo.f30891e));
            jSONObject.put("11009", bq.a(this.f30983a.getApplicationContext()));
            try {
            ...
            String strB = hVarA.b(dd.f31118m, "", true);
            ...
            jSONObject.put("20000", this.f30984b);
            jSONObject.put(com.anythink.core.common.inner.b.b.f4587d, this.f30985c);
            try {
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new ck(str, ci.f30966j).a(this.f30983a);
