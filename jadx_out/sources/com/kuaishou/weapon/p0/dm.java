...
public class dm {
    ...
    public static final class b {
        ...
        public static void b(ClassLoader classLoader, File file) throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
            ...
            Object obj3 = (Object[]) Cdo.a(obj, "makePathElements", List.class, File.class, List.class).invoke(obj, arrayList4, null, new ArrayList());
            Field fieldA2 = Cdo.a(obj, "nativeLibraryPathElements");
            fieldA2.set(obj, obj3);
            if (fieldA2.get(obj) != obj3) {
                Cdo.b(obj, "nativeLibraryPathElements").set(obj, obj3);
            }
        }
    }
