...
public class at {
    ...
    public at(Context context) {
        if (Engine.loadSuccess) {
            try {
                String strPqr = Engine.getInstance(context).pqr(Integer.valueOf(ci.f30964h).intValue(), 0, 100, "");
                if (TextUtils.isEmpty(strPqr)) {
                    return;
                }
                this.f30821a = new JSONObject(strPqr);
    ...
    public String a(String str) {
        JSONObject jSONObject = this.f30821a;
        if (jSONObject == null) {
            return null;
        }
        try {
        ...
        if (jSONObject != null) {
            try {
                ...
                if (!TextUtils.isEmpty(strOptString) && strOptString.length() > 3) {
                    ...
                    for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                        Integer numValueOf = Integer.valueOf((String) jSONArray.get(i2), 16);
                        numValueOf.intValue();
    ...
    public Set a(Context context, String str, int i2) throws JSONException {
        JSONObject jSONObject = this.f30821a;
        if (jSONObject == null) {
            return null;
        }
