...
public class dg {
    ...
    */
    public static int d() throws java.lang.Throwable {
        ...
        L1a:
            java.lang.String r1 = r3.readLine()     // Catch: java.lang.Throwable -> L2d java.lang.Exception -> L34
            if (r1 == 0) goto L30
            java.lang.String r2 = "scrcpy"
            boolean r1 = r1.contains(r2)     // Catch: java.lang.Throwable -> L2d java.lang.Exception -> L34
            if (r1 == 0) goto L1a
        ...
        try {
            ...
            try {
                ...
                while (true) {
                    ...
                    if (line.contains(ServiceReference.DELIMITER) || line.contains("@")) {
                        if (line.contains(ServiceReference.DELIMITER)) {
                            line = line.substring(line.indexOf(ServiceReference.DELIMITER));
