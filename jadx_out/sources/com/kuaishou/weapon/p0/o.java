...
public class o {
    public static s a(JSONObject jSONObject) throws JSONException {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(strF) && !TextUtils.isEmpty(strB) && strB.startsWith(com.anythink.core.common.d.i.f2495E)) {
        ...
        sVar.f31252t = iA2;
        sVar.f31253u = iB;
        sVar.f31251s = System.currentTimeMillis();
    ...
    private static p b(JSONObject jSONObject) throws JSONException {
        try {
            ...
            pVar.c(jSONObject.optString(bg.f30871q));
            ...
            for (int i2 = 0; i2 < jSONArray.length(); i2++) {
                ...
                aVar.a(jSONObject2.optInt(t.f31269k));
                aVar.b(jSONObject2.optInt(com.umeng.analytics.pro.bv.aI));
