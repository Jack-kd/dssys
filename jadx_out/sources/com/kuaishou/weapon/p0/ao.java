...
public class ao {
    public boolean a() throws IllegalAccessException, NoSuchFieldException, SecurityException, IllegalArgumentException {
        try {
            Field declaredField = ClassLoader.getSystemClassLoader().loadClass(an.f30815b).getDeclaredField("disableHooks");
    ...
    public boolean b() throws Exception {
        try {
            ...
            for (StackTraceElement stackTraceElement : e2.getStackTrace()) {
                if (stackTraceElement.getClassName().contains(an.f30815b)) {
                    return true;
                }
            }
            return false;
    ...
    public boolean d() throws IllegalAccessException, InstantiationException {
        ...
        if (systemClassLoader != null) {
            try {
                systemClassLoader.loadClass(an.f30814a).newInstance();
        ...
        if (systemClassLoader != null) {
            try {
                systemClassLoader.loadClass(an.f30815b).newInstance();
