...
public class cl {
    ...
    public cl(Context context, int i2) {
        ...
        try {
            ...
            if (hVarA.b(dd.aP, 0) == 1 && (zE || zE2)) {
                ...
                if (hVarA.b(dd.bc, 1) == 1) {
                    jSONObject.put(ErrorCode.unknownMediationIdError, beVar.f(this.f30998a));
                }
            }
            if (hVarA.b(dd.aQ, 1) == 1 && (zE || zE2)) {
                jSONObject.put("01011", bf.e(this.f30998a));
            }
            if (hVarA.b(dd.aR, 1) == 1 && (zE || zE2)) {
                String strP = bf.p(this.f30998a);
            ...
            if (hVarA.b(dd.aF, 1) == 1) {
                ...
                try {
                    if (Engine.loadSuccess) {
                        try {
                            jSONObject.put("02019", bj.b(this.f30998a));
                            jSONObject.put("02021", bj.d(this.f30998a));
                            jSONObject.put("02022", bj.c(this.f30998a));
                            jSONObject.put("02030", bj.f(this.f30998a));
                            cc ccVar = new cc(this.f30998a);
                        ...
                        clVar = this;
                        try {
                            jSONObject.put("02019", bj.b(clVar.f30998a));
                            jSONObject.put("02020", bj.u());
                            jSONObject.put("02021", bj.d(clVar.f30998a));
                            jSONObject.put("02022", bj.c(clVar.f30998a));
                            jSONObject.put("02030", bj.f(clVar.f30998a));
                    ...
                    str2 = "";
                    jSONObject.put("02067", clVar.f30998a.getApplicationContext().getPackageResourcePath().replace("/data/app/", str2).replace("/base.apk", str2));
                    jSONObject.put("02039", bf.i());
                    jSONObject.put("02040", bf.j());
                    jSONObject.put("02041", bf.t(clVar.f30998a));
                    ...
                    hVar = hVarA;
                    long jA = hVar.a(dd.f31109d, -1L);
                    if (jA != -1) {
                        jSONObject.put("03074", jA + System.currentTimeMillis());
                    }
                    try {
                        jSONObject.put("03064", Settings.System.getInt(clVar.f30998a.getContentResolver(), "screen_brightness_mode"));
                        jSONObject.put("03065", Settings.System.getInt(clVar.f30998a.getContentResolver(), "accelerometer_rotation"));
                    } catch (Throwable unused3) {
                    }
                    jSONObject.put("03081", bj.L());
                    jSONObject.put("03052", bj.i(clVar.f30998a));
                    jSONObject.put("03050", bj.h(clVar.f30998a));
                    jSONObject.put("03049", bj.g(clVar.f30998a));
            ...
            if (hVar.b(dd.aG, 1) == 1) {
                ...
                bw bwVar = new bw(clVar.f30998a);
                if (Engine.loadSuccess) {
                    jSONObject.put("03004", bwVar.a("03004") != null ? bwVar.a("03004") : str2);
                    jSONObject.put("03036", bwVar.b("03036") != null ? bwVar.b("03036") : str2);
                    jSONObject.put("03039", bwVar.a("03039") != null ? bwVar.a("03039") : str2);
                    jSONObject.put("03040", bwVar.a("03040") != null ? bwVar.a("03040") : str2);
                    jSONObject.put("03041", bwVar.a("03041") != null ? bwVar.a("03041") : str2);
                    jSONObject.put("03042", bwVar.a("03042") != null ? bwVar.a("03042") : str2);
                    jSONObject.put("03079", bwVar.a("03079") != null ? bwVar.a("03079") : null);
                    jSONObject.put("03080", bwVar.a("03080") != null ? bwVar.a("03080") : null);
                }
                jSONObject.put("03007", bt.a(clVar.f30998a));
                jSONObject.put("03008", bt.c(clVar.f30998a));
                jSONObject.put("03011", am.b(clVar.f30998a));
                jSONObject.put("03012", am.b());
                jSONObject.put("03014", bf.g(clVar.f30998a));
                jSONObject.put("03034", bf.h(clVar.f30998a));
                jSONObject.put("03020", bt.b(clVar.f30998a));
                jSONObject.put("03037", bj.I());
                jSONObject.put("03038", bj.J());
                jSONObject.put("03077", bj.K());
                try {
                    be beVar2 = new be();
                    jSONObject.put("03006", beVar2.a(clVar.f30998a));
                    jSONObject.put("03010", beVar2.b(clVar.f30998a));
                    jSONObject.put("03033", beVar2.c(clVar.f30998a));
                    jSONObject.put("03021", beVar2.e(clVar.f30998a));
                    jSONObject.put("03030", be.d(clVar.f30998a));
                    jSONObject.put("10031", beVar2.a());
                } catch (Exception unused5) {
                }
            }
            if (hVar.b(dd.aU, 0) == 1) {
                jSONObject.put("03019", bf.k(clVar.f30998a));
                String strM = bf.m(clVar.f30998a);
                if (!TextUtils.isEmpty(strM)) {
                    jSONObject.put("03047", strM);
                }
            }
            if (hVar.b(dd.aV, 1) == 1) {
                jSONObject.put("02059", bk.a(clVar.f30998a));
                jSONObject.put("02060", bk.a());
                jSONObject.put("02062", bk.c());
                if (Engine.loadSuccess) {
                    by byVar = new by(clVar.f30998a);
                    jSONObject.put("08001", byVar.a("08001") != null ? byVar.a("08001") : str2);
                }
            ...
            if (hVar.b(dd.aH, 1) == 1) {
                if (Engine.loadSuccess) {
                    bx bxVar = new bx(clVar.f30998a);
                    jSONObject.put("04001", bxVar.a("04001") != null ? bxVar.a("04001") : str2);
                    jSONObject.put("04002", bxVar.a("04002") != null ? bxVar.a("04002") : str2);
                    jSONObject.put("04003", bxVar.a("04003") != null ? bxVar.a("04003") : str2);
                    jSONObject.put("04004", bxVar.a("04004") != null ? bxVar.a("04004") : str2);
                } else {
                    try {
                        bh bhVarB = bi.b();
            ...
            if (hVar.b(dd.aK, 0) == 1 && (z2 || z3)) {
                Object objF = bf.f();
                if (objF != null) {
                    jSONObject.put("06014", objF);
                }
                if (Engine.loadSuccess) {
                    cd cdVar = new cd(clVar.f30998a);
                    jSONObject.put("06015", cdVar.b("06015") != null ? cdVar.b("06015") : str2);
                }
            }
            if (z2 || z3) {
                String strH = bf.h();
            ...
            if (hVar.b(dd.aI, 0) == 1 && (z2 || z3)) {
                if (Engine.loadSuccess) {
                    jSONObject.put("07007", new ca(clVar.f30998a).a("07007"));
                }
                JSONArray jSONArrayA = bp.a(clVar.f30998a);
            ...
            if (hVar.b(dd.aJ, 1) == 1 && Engine.loadSuccess) {
                String strA17 = new cb(clVar.f30998a).a("05001");
                try {
            ...
            if (Engine.loadSuccess) {
                bz bzVar = new bz(clVar.f30998a);
                jSONObject.put("13001", bzVar.a("13001") != null ? bzVar.a("13001") : str2);
            }
            jSONObject.put("11000", Engine.loadSuccess ? 1 : 0);
            jSONObject.put("11002", Engine.soVersion);
            jSONObject.put("11003", bg.f30876v);
            jSONObject.put("11004", Engine.loadSoCount);
            jSONObject.put("11006", z2 ? 1 : 0);
            jSONObject.put("11029", z3 ? 1 : 0);
            jSONObject.put("11008", hVar.b(dd.f31112g, bo.f30891e));
            jSONObject.put("11009", bq.a(clVar.f30998a.getApplicationContext()));
            try {
                String strW = bf.w(clVar.f30998a);
            ...
            try {
                jSONObject.put("02078", com.kuaishou.weapon.p0.jni.A.getE("W_S_V"));
                jSONObject.put("02079", com.kuaishou.weapon.p0.jni.A.getE("W_S_S_V"));
                jSONObject.put("02069", Build.VERSION.SECURITY_PATCH);
                String string = Settings.Global.getString(clVar.f30998a.getContentResolver(), "Phenotype_boot_count");
                if (!TextUtils.isEmpty(string)) {
                    jSONObject.put("03085", string);
                }
                String string2 = Settings.Global.getString(clVar.f30998a.getContentResolver(), "boot_count");
                if (!TextUtils.isEmpty(string2)) {
                    jSONObject.put("03086", string2);
                }
                String string3 = Settings.System.getString(clVar.f30998a.getContentResolver(), "power_on_times");
                if (!TextUtils.isEmpty(string3)) {
                    jSONObject.put("03091", string3);
                }
                String string4 = Settings.System.getString(clVar.f30998a.getContentResolver(), "first_boot_flag");
    ...
    public String a(String str) {
        ...
        try {
            JSONObject jSONObjectA2 = new ck(str, ci.f30966j).a(this.f30998a);
