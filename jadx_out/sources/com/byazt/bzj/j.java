...
@com.byazt.kj.hp(hp = {0, 1, 200, 38})
/* loaded from: classes2.dex */
public class j extends s {
    public j(com.byazt.rlh.l lVar, Function<SparseArray<Object>, Object> function) {
        super(lVar, function);
        if (function != null) {
    ...
    public <T> T applyFunction(int i2, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i2 == 8134) {
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeRenderFail code:" + iIntValue + " msg:" + strStringValue + " view" + view);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeRenderSuccess width:" + fFloatValue + " height:" + fFloatValue2);
            callNativeRenderSuccess(fFloatValue, fFloatValue2);
        } else if (i2 == 8130) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeAdClick");
            callNativeAdClick();
        } else if (i2 == 8113) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeAdShow");
            callNativeAdShow();
        } else if (i2 == 8145) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoStart");
            callNativeVideoStart();
        } else if (i2 == 8146) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoPause");
            callNativeVideoPause();
        } else if (i2 == 8150) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoResume");
            callNativeVideoResume();
        } else if (i2 == 8118) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoCompleted");
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoError code:" + iIntValue2 + " msg:" + strStringValue2);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeVideoError current:" + jLongValue + " duration:" + jLongValue2);
            callNativeVideoProgressUpdate(jLongValue, jLongValue2);
        } else if (i2 == 8152) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnIdle");
            callNativeOnIdle();
        } else if (i2 == 8187) {
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnDownloadActive totalBytes:" + jLongValue3 + " curlBytes:" + jLongValue4);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnDownloadPaused totalBytes:" + jLongValue5 + " curlBytes:" + jLongValue6 + " fileName:" + strStringValue3 + " appName:" + strStringValue4);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnDownloadFailed totalBytes:" + jLongValue7 + " curlBytes:" + jLongValue8 + " fileName:" + strStringValue5 + " appName:" + strStringValue6);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnDownloadFinished totalBytes:" + jLongValue9 + " fileName:" + strStringValue7 + " appName:" + strStringValue8);
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeOnDownloadFinished  fileName:" + strStringValue9 + " appName:" + strStringValue10);
            callNativeOnInstalled(strStringValue9, strStringValue10);
        } else if (i2 == 8185) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeDislikeShow");
            callNativeDislikeShow();
        } else if (i2 == 8184) {
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeDislikeCancel");
            callNativeDislikeCancel();
        } else if (i2 != 6085) {
            if (i2 == 8110) {
                boolean zIsClientBiddingAd = isClientBiddingAd();
                com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : isClientBiddingAd :".concat(String.valueOf(zIsClientBiddingAd)));
                return (T) Boolean.valueOf(zIsClientBiddingAd);
            }
            if (i2 == 8136) {
                boolean zIsServerBiddingAd = isServerBiddingAd();
                com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : isServerBiddingAd :".concat(String.valueOf(zIsServerBiddingAd)));
                return (T) Boolean.valueOf(zIsServerBiddingAd);
            }
            if (i2 == 8160) {
                boolean zIsUseCustomVideo = isUseCustomVideo();
                com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : isUseCustomVideo :".concat(String.valueOf(zIsUseCustomVideo)));
                return (T) Boolean.valueOf(zIsUseCustomVideo);
            }
            if (i2 == 8226) {
                int adNetworkSlotType = getAdNetworkSlotType();
                com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : getBiddingType :".concat(String.valueOf(adNetworkSlotType)));
            ...
            if (i2 == 8132) {
                ...
                com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw ad : callNativeDislikeSelected postion:" + iIntValue3 + " value:" + strStringValue11);
    ...
    public void callNativeAdClick() {
        checkClick(new hp() { // from class: com.byazt.bzj.j.2
            @Override // com.byazt.bzj.hp
            public void hp() {
                if (j.this.getGMDrawAdListener() != null) {
                    j.this.getGMDrawAdListener().hp(null);
                }
            }
        });
    }
    ...
    public void callNativeAdShow() {
        checkShow(new hp() { // from class: com.byazt.bzj.j.3
            @Override // com.byazt.bzj.hp
            public void hp() {
                if (j.this.getGMDrawAdListener() != null) {
                    j.this.getGMDrawAdListener().hp();
                }
            }
        });
    }
    ...
    public void callNativeRenderFail(View view, String str, int i2) {
        if (getGMDrawAdListener() instanceof com.byazt.gpb.j) {
            try {
                ((com.byazt.gpb.j) getGMDrawAdListener()).hp(view, str, i2);
    ...
    public void callNativeRenderSuccess(float f2, float f3) {
        if (getGMDrawAdListener() instanceof com.byazt.gpb.j) {
            try {
                ((com.byazt.gpb.j) getGMDrawAdListener()).hp(f2, f3);
            } catch (Exception unused) {
            }
        }
    }
    ...
    public com.byazt.qt.eb getDislikeDialog(Activity activity) {
        ...
        Object objApply = ((jx) this).f18695q.apply(com.byazt.wi.j.hp().hp(6072).hp(Object.class).hp(20033, activity).l());
        if (objApply == null) {
            return null;
        }
        final com.byazt.aqw.a aVar = new com.byazt.aqw.a(com.byazt.vd.jx.hp(objApply));
        return new com.byazt.qt.eb() { // from class: com.byazt.bzj.j.1
    ...
    public Integer isReadyStatus() {
        if (((jx) this).f18695q != null) {
            Integer numHp = com.byazt.ktf.hp.hp(((jx) this).f18695q.apply(com.byazt.wi.j.hp().hp(8121).hp(20068, 1).hp(Object.class).l()));
            if (numHp != null) {
                return numHp;
            }
        }
