...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_DEMUXER_VIDEO_STACK_SIZE, 30})
/* loaded from: classes3.dex */
public class jx extends l {
    public jx(String str, com.byazt.ewl.l lVar) {
        super(str, lVar);
    }
    ...
    public void callLoadSucceed(List<Function<SparseArray<Object>, Object>> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new com.byazt.bzj.j(this, it.next()));
        }
    ...
    public <T> T callManager(int i2, PluginValueSet pluginValueSet, Class<T> cls) {
        if (i2 == 8222) {
            ...
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw loader : isExpressRender: " + zIsExpressRender);
            return (T) Boolean.valueOf(zIsExpressRender);
        }
        if (i2 == 8223) {
            boolean zIsNativeAd = isNativeAd();
            com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw loader : isNativeAd: " + zIsNativeAd);
        ...
        if (i2 != 8123) {
            ...
            StringBuilder sb = new StringBuilder("Adn custom draw loader : callLoadSucceed  list size:");
        ...
        com.byazt.aw.l.l(MediationConstant.TAG, "Adn custom draw loader : callLoaderFail  code:" + iIntValue + " msg:" + strStringValue);
