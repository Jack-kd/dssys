...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_GET_FIRST_VIDEO_PTS, 38})
@com.byazt.cv.l
...
public class j implements com.byazt.zp.jx {
    ...
    @com.byazt.cv.hp(hp = "privacy_popup_listener")
    public w.hp f23214j;
    ...
    public boolean hp(Map<String, Object> map, Map<String, Object> map2, com.byazt.rsz.hp hpVar) {
        ...
        TTDelegateActivity.l(this.hp, this.jx, this.f23217w);
        hpVar.hp(map2);
        return true;
    }

    private w.hp hp() {
        return new w.hp() { // from class: com.byazt.mpn.j.1
            @Override // com.byazt.zn.w.hp
            public void hp() {
                if (j.this.f23214j == null) {
                    return;
                }
                j.this.f23214j.hp();
                j jVar = j.this;
                jVar.hp(jVar.f23213a);
            }
    ...
    public void hp(String str) {
        if (this.f23215l == null || TextUtils.isEmpty(str)) {
            return;
        }
        HashMap map = new HashMap();
        map.put("material_meta", this.f23215l);
        map.put(g.f49337X, this.hp);
        com.byazt.rj.jx.hp(str, this.f23215l.ij(), map);
    }
}
