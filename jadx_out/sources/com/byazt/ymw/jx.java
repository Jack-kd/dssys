...
public final class jx {
    ...
    public static String hp(Context context) {
        ...
        ArrayList<String> arrayListHp = hp(context, "SHA1");
        if (arrayListHp != null && arrayListHp.size() != 0) {
            for (int i2 = 0; i2 < arrayListHp.size(); i2++) {
                sb.append(arrayListHp.get(i2));
                if (i2 < arrayListHp.size() - 1) {
                    sb.append(",");
                }
            }
        }
