...
@com.byazt.kj.hp(hp = {0, 1, 1286, MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_START_OFFSET})
/* loaded from: classes2.dex */
public final class w implements HostnameVerifier {
    public static final w hp = new w();
    ...
    private boolean jx(String str, X509Certificate x509Certificate) throws CertificateParsingException {
        ...
        if (z2 || (strHp = new j(x509Certificate.getSubjectX500Principal()).hp("cn")) == null) {
            return false;
        }
    ...
    public boolean hp(String str, X509Certificate x509Certificate) {
        return com.byazt.ru.jx.jx(str) ? l(str, x509Certificate) : jx(str, x509Certificate);
    }
    ...
    public static List<String> hp(X509Certificate x509Certificate) throws CertificateParsingException {
        List<String> listHp = hp(x509Certificate, 7);
        List<String> listHp2 = hp(x509Certificate, 2);
        ArrayList arrayList = new ArrayList(listHp.size() + listHp2.size());
