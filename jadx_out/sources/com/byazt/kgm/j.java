...
@com.byazt.kj.hp(hp = {0, 1, 46, 38})
/* loaded from: classes.dex */
public class j extends hp {
    private View hp(Context context) {
        RelativeLayout relativeLayout = new RelativeLayout(context);
        relativeLayout.setId(2114387693);
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(-2, xh.jx(context, 32.0f));
        layoutParams.addRule(3, 2114387807);
        layoutParams.addRule(14);
        layoutParams.topMargin = xh.jx(context, 17.0f);
        ...
        relativeLayout.setMinimumWidth(xh.jx(context, 110.0f));
        View imageView = new ImageView(context);
        imageView.setId(2114387876);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(xh.jx(context, 12.0f), xh.jx(context, 14.0f));
        layoutParams2.addRule(15);
        layoutParams2.rightMargin = xh.jx(context, 6.0f);
        ...
        RelativeLayout.LayoutParams layoutParams4 = new RelativeLayout.LayoutParams(xh.jx(context, 12.0f), xh.jx(context, 14.0f));
    ...
    public View inflate(Context context) {
        ...
        relativeLayoutHp.addView(relativeLayout, layoutParams);
        relativeLayout.addView(l(context, 0));
        TextView textView = new TextView(context);
        textView.setId(2114387742);
        RelativeLayout.LayoutParams layoutParams2 = new RelativeLayout.LayoutParams(-2, -2);
        layoutParams2.addRule(3, 2114387911);
        layoutParams2.addRule(14);
        layoutParams2.setMargins(0, xh.jx(context, 13.0f), 0, 0);
