...
public final class e {
    ...
    */
    private static java.net.InetAddress jx(java.lang.String r12, int r13, int r14) {
        /*
            r0 = 16
            byte[] r1 = new byte[r0]
            r2 = 0
        ...
        L8e:
            ...
            throw r12
        */
        throw new UnsupportedOperationException("Method not decompiled: com.byazt.ndb.e.jx(java.lang.String, int, int):java.net.InetAddress");
    }
    ...
    public static String hp(String str) {
        InetAddress inetAddressJx;
        if (str.contains(":")) {
            if (str.startsWith("[") && str.endsWith("]")) {
                inetAddressJx = jx(str, 1, str.length() - 1);
            } else {
                inetAddressJx = jx(str, 0, str.length());
            }
            if (inetAddressJx == null) {
                return null;
            }
            byte[] address = inetAddressJx.getAddress();
    ...
    private static String hp(byte[] bArr) {
        ...
        while (i3 < bArr.length) {
            if (i3 == i2) {
                ...
                hpVar.l(((bArr[i3] & 255) << 8) | (bArr[i3 + 1] & 255));
                i3 += 2;
            }
        }
        return hpVar.jx();
