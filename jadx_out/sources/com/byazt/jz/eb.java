...
public class eb {
    public static String hp(int i2) {
        ...
        switch (i2) {
            case com.anythink.core.common.k.f5401t /* -14 */:
                return "开屏视频加载失败";
            case com.anythink.core.common.k.f5400s /* -13 */:
                return "广告请求使用了错误代码位";
            case com.anythink.core.common.k.f5399r /* -12 */:
                return "缓存中没有开屏广告";
            case com.anythink.core.common.k.f5398q /* -11 */:
            case com.anythink.core.common.k.f5397p /* -10 */:
                return "请重新发起广告请求";
            case com.anythink.core.common.k.f5396o /* -9 */:
                return "请求实体为空";
            case com.anythink.core.common.k.f5395n /* -8 */:
