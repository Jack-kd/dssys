...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_NO_AV_SYNC, MediaPlayer.MEDIA_PLAYER_OPTION_GET_DROP_COUNT})
/* loaded from: classes2.dex */
public class s implements TTDrawFeedAd {
    public final Function<SparseArray<Object>, Object> hp;

    /* renamed from: l, reason: collision with root package name */
    public ValueSet f20067l;

    public s(Function<SparseArray<Object>, Object> function) {
        this.f20067l = com.byazt.xi.jx.hp;
        ...
        if (objApply instanceof SparseArray) {
            this.f20067l = com.byazt.xi.jx.hp((SparseArray<Object>) objApply).l();
        }
    }
    ...
    public Bitmap getAdLogo() {
        return (Bitmap) this.f20067l.objectValue(140002, Bitmap.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public View getAdView() {
        return (View) this.f20067l.objectValue(140016, View.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public int getAdViewHeight() {
        return this.f20067l.intValue(160004);
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public int getAdViewWidth() {
        return this.f20067l.intValue(160003);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppCommentNum() {
        return this.f20067l.intValue(140006);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppScore() {
        return this.f20067l.intValue(140005);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppSize() {
        return this.f20067l.intValue(140007);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getButtonText() {
        return this.f20067l.stringValue(140018);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public ComplianceInfo getComplianceInfo() {
        return new jx(v.hp(this.f20067l.objectValue(140014, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public TTFeedAd.CustomizeVideo getCustomVideo() {
        return new com.byazt.wo.hp(v.hp(this.f20067l.objectValue(160002, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getDescription() {
        return this.f20067l.stringValue(140004);
    }
    ...
    public DislikeInfo getDislikeInfo() {
        return new j(v.hp(this.f20067l.objectValue(140013, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public DownloadStatusController getDownloadStatusController() {
        return new w(v.hp(this.f20067l.objectValue(140015, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getIcon() {
        return new gu(v.hp(this.f20067l.objectValue(140009, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public List<TTImage> getImageList() {
        List arrayList = (List) this.f20067l.objectValue(140010, List.class);
        if (arrayList == null) {
        ...
        while (it.hasNext()) {
            arrayList2.add(new gu(v.hp(it.next())));
        }
        return arrayList2;
    }
    ...
    public int getImageMode() {
        return this.f20067l.intValue(140012);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getInteractionType() {
        return this.f20067l.intValue(140011);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public Map<String, Object> getMediaExtraInfo() {
        return (Map) this.f20067l.objectValue(140017, Map.class);
    }
    ...
    public String getSource() {
        return this.f20067l.stringValue(140008);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getTitle() {
        return this.f20067l.stringValue(140003);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getVideoCoverImage() {
        return new gu(v.hp(this.f20067l.objectValue(140001, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTFeedAd
    public double getVideoDuration() {
        return this.f20067l.doubleValue(160001);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(2, new com.byazt.eu.hp(adInteractionListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void setDrawVideoListener(TTDrawFeedAd.DrawVideoListener drawVideoListener) {
        ...
        sparseArray.put(-99999985, Void.class);
        sparseArray.put(0, new com.byazt.qs.hp(drawVideoListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void setEasyPlayWidgetListener(TTNativeAd.EasyPlayWidgetListener easyPlayWidgetListener) {
        ...
        sparseArray.put(0, new com.byazt.eu.l(easyPlayWidgetListener));
        sparseArray.put(-99999985, Void.class);
        this.hp.apply(sparseArray);
    }
    ...
    public void setExpressRenderListener(TTNativeAd.ExpressRenderListener expressRenderListener) {
        ...
        if (expressRenderListener instanceof MediationExpressRenderListener) {
            sparseArray.put(0, new com.byazt.ja.a((MediationExpressRenderListener) expressRenderListener));
            sparseArray.put(1, 1);
        } else {
            sparseArray.put(0, new com.byazt.eu.jx(expressRenderListener));
            sparseArray.put(1, 0);
        }
        this.hp.apply(sparseArray);
    }
    ...
    public void setVideoAdListener(TTFeedAd.VideoAdListener videoAdListener) {
        ...
        sparseArray.put(-99999985, Void.class);
        sparseArray.put(0, new com.byazt.th.hp(videoAdListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void setVideoRewardListener(TTFeedAd.VideoRewardListener videoRewardListener) {
        ...
        sparseArray.put(-99999985, Void.class);
        sparseArray.put(0, new com.byazt.th.l(videoRewardListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(3, new com.byazt.eu.hp(adInteractionListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(4, new com.byazt.eu.hp(adInteractionListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(5, new com.byazt.eu.hp(adInteractionListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, List<View> list4, View view, TTNativeAd.AdInteractionListener adInteractionListener) {
        ...
        sparseArray.put(6, new com.byazt.eu.hp(adInteractionListener));
        this.hp.apply(sparseArray);
    }
    ...
    public void registerViewForInteraction(Activity activity, ViewGroup viewGroup, List<View> list, List<View> list2, List<View> list3, TTNativeAd.AdInteractionListener adInteractionListener, IMediationViewBinder iMediationViewBinder) {
        ...
        sparseArray.put(5, new com.byazt.eu.hp(adInteractionListener));
        sparseArray.put(6, new com.byazt.ja.w(iMediationViewBinder));
        this.hp.apply(sparseArray);
    }
}
