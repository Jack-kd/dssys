...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_NO_AV_SYNC, 19})
/* loaded from: classes2.dex */
public class jl implements TTNativeAd {
    public final Function<SparseArray<Object>, Object> hp;

    /* renamed from: l, reason: collision with root package name */
    public ValueSet f20062l;

    public jl(Function<SparseArray<Object>, Object> function) {
        this.f20062l = com.byazt.xi.jx.hp;
        ...
        if (objApply instanceof SparseArray) {
            this.f20062l = com.byazt.xi.jx.hp((SparseArray<Object>) objApply).l();
        }
    }
    ...
    public Bitmap getAdLogo() {
        return (Bitmap) this.f20062l.objectValue(140002, Bitmap.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public View getAdView() {
        return (View) this.f20062l.objectValue(140016, View.class);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppCommentNum() {
        return this.f20062l.intValue(140006);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppScore() {
        return this.f20062l.intValue(140005);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getAppSize() {
        return this.f20062l.intValue(140007);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getButtonText() {
        return this.f20062l.stringValue(140018);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public ComplianceInfo getComplianceInfo() {
        return new jx(v.hp(this.f20062l.objectValue(140014, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getDescription() {
        return this.f20062l.stringValue(140004);
    }
    ...
    public DislikeInfo getDislikeInfo() {
        return new j(v.hp(this.f20062l.objectValue(140013, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public DownloadStatusController getDownloadStatusController() {
        return new w(v.hp(this.f20062l.objectValue(140015, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getIcon() {
        return new gu(v.hp(this.f20062l.objectValue(140009, Object.class)));
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public List<TTImage> getImageList() {
        List arrayList = (List) this.f20062l.objectValue(140010, List.class);
        if (arrayList == null) {
    ...
    public int getImageMode() {
        return this.f20062l.intValue(140012);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public int getInteractionType() {
        return this.f20062l.intValue(140011);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public Map<String, Object> getMediaExtraInfo() {
        return (Map) this.f20062l.objectValue(140017, Map.class);
    }
    ...
    public String getSource() {
        return this.f20062l.stringValue(140008);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public String getTitle() {
        return this.f20062l.stringValue(140003);
    }

    @Override // com.bytedance.sdk.openadsdk.TTNativeAd
    public TTImage getVideoCoverImage() {
        return new gu((Function) this.f20062l.objectValue(140001, Function.class));
    }
