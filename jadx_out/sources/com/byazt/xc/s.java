...
@com.byazt.kj.hp(hp = {0, 1, 592, MediaPlayer.MEDIA_PLAYER_OPTION_GET_DROP_COUNT})
/* loaded from: classes3.dex */
public class s extends com.byazt.qa.j {
    public com.byazt.fi.jx hp;

    public s(com.byazt.fi.jx jxVar) {
        this.hp = jxVar;
    }

    @Override // com.byazt.qa.j
    public void destroy() {
    ...
    public List<com.byazt.qa.l> getAdLoadInfo() {
        ...
        for (int i2 = 0; i2 < this.hp.l().size(); i2++) {
            linkedList.add(new com.byazt.ju.s(this.hp.l().get(i2)));
        }
        return linkedList;
    }
