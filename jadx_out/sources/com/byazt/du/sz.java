...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_SET_LIVE_ABR_NON_KEY_FRAME_SWITCH_BUFFER_THRESHOLD, MediaPlayer.MEDIA_PLAYER_OPTION_DISABLE_RESET_SYSTEM_VOLUME})
/* loaded from: classes2.dex */
public class sz extends com.byazt.oa.w<JSONObject, JSONObject> {
    public WeakReference<com.byazt.jz.ud> hp;

    public sz(com.byazt.jz.ud udVar) {
        this.hp = new WeakReference<>(udVar);
    }

    public static void hp(com.byazt.oa.xs xsVar, com.byazt.jz.ud udVar) {
        xsVar.hp("getSendRewardStatus", (com.byazt.oa.w<?, ?>) new sz(udVar));
    }
    ...
    public JSONObject hp(JSONObject jSONObject, com.byazt.oa.a aVar) throws Exception {
        ...
        if (weakReference != null && weakReference.get() != null && (udVar = this.hp.get()) != null) {
            jSONObject2.put("isReward", udVar.eb());
        }
        return jSONObject2;
    }
}
