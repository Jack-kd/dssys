...
@com.byazt.kj.hp(hp = {0, 1, MediaPlayer.MEDIA_PLAYER_OPTION_ENABLE_SUB, MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_START_OFFSET})
/* loaded from: classes3.dex */
public class w extends com.byazt.oa.j<JSONObject, JSONObject> {
    ...
    public static void hp(xs xsVar, final ud udVar) {
        xsVar.hp("openPrivacy", new j.l() { // from class: com.byazt.vna.w.1
    ...
    public void hp(JSONObject jSONObject, com.byazt.oa.a aVar) throws Exception {
        ...
        if (weakReference == null || (udVar = weakReference.get()) == null || (mpVarS = udVar.s()) == null) {
            return;
        }
        com.byazt.zn.w.hp(aVar.getContext(), mpVarS);
        udVar.pu();
    }
}
