...
@com.byazt.kj.hp(hp = {0, 1, 235, AVMDLDataLoader.KeyIsPreconnectNum})
...
public class SlideUpLoadMoreArrow extends LinearLayout {
    ...
    public final AnimatorSet f21765l;

    @com.byazt.kj.hp(hp = {0, 1, 235, 2162})
    ...
    public SlideUpLoadMoreArrow(Context context, int i2, boolean z2) {
        super(context);
        this.f21765l = new AnimatorSet();
        if (z2) {
            jx();
        }
        this.hp = i2;
    ...
    private void j() {
        ...
        setClipChildren(false);
        LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(-1, -2);
        layoutParams.topMargin = xh.jx(context, 80.0f);
        layoutParams.gravity = 1;
        addView(hp(getContext()), layoutParams);
        TextView textView = new TextView(context);
        textView.setTextColor(-1);
        if (Build.VERSION.SDK_INT >= 28) {
            textView.setLineHeight(xh.jx(context, 17.0f));
        }
        textView.setTextSize(2, 12.0f);
        textView.setText("向上滑动浏览更多");
        LinearLayout.LayoutParams layoutParams2 = new LinearLayout.LayoutParams(-2, -2);
        layoutParams2.topMargin = xh.jx(context, 6.0f);
        layoutParams2.bottomMargin = xh.jx(context, this.hp);
    ...
    private void hp(View view, View view2) {
        ...
        ObjectAnimator objectAnimatorOfFloat2 = ObjectAnimator.ofFloat(view, "translationY", 0.0f, xh.jx(getContext(), -5.0f));
        ...
        ObjectAnimator objectAnimatorOfFloat4 = ObjectAnimator.ofFloat(view2, "translationY", xh.jx(getContext(), -6.0f));
        ...
        this.f21765l.playTogether(objectAnimatorOfFloat, objectAnimatorOfFloat3, objectAnimatorOfFloat2, objectAnimatorOfFloat4);
    }

    public void hp() {
        if (this.f21765l.isStarted()) {
            return;
        }
        this.f21765l.start();
    }
