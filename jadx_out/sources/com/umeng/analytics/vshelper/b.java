...
public class b implements cf {
    ...
    private static final String f49737a = "RealTimeDebugSwitch";

    /* renamed from: b, reason: collision with root package name */
    private static volatile int f49738b;
                    ...
                    if (scheme != null && scheme.startsWith("um.")) {
                        ...
                        if (jLongValue < 0) {
                            if (AnalyticsConfig.isRealTimeDebugMode()) {
                                ...
                                UMWorkDispatch.sendEvent(applicationContext, r.a.f49619G, CoreProtocol.getInstance(applicationContext), null);
                                return;
                            }
                        ...
                        if (jLongValue > 0) {
                            ...
                            UMWorkDispatch.sendEvent(applicationContext2, r.a.f49618F, CoreProtocol.getInstance(applicationContext2), jSONObject);
                            UMRTLog.i(UMRTLog.RTLOG_TAG, "--->>> turnOnRealTimeDebug[persistent] dk: " + queryParameter + "; period: " + jLongValue);
                            return;
                        }
                        AnalyticsConfig.turnOnRealTimeDebug(map);
                        Context applicationContext3 = activity.getApplicationContext();
                        UMWorkDispatch.sendEvent(applicationContext3, r.a.f49619G, CoreProtocol.getInstance(applicationContext3), null);
