...
public class UMProcessDBDatasSender implements UMLogDataProtocol {
    ...
    public class ReplaceCallback implements FileLockCallback {
        ...
        public boolean onFileLock(String str) throws Throwable {
            ...
            String str2 = a.f49716c;
            if (str.startsWith(str2)) {
                str = str.replaceFirst(str2, "");
            }
            UMProcessDBHelper.getInstance(UMProcessDBDatasSender.this.mContext).deleteEventDatas(str.replace(a.f49717d, ""), null, null);
            return true;
        }
    }
    ...
    private int defconProcesserHandler() throws Throwable {
        ...
        if (iA != 0) {
            ...
            UMProcessDBHelper.getInstance(this.mContext).deleteEventDatas(a.f49721h, null, null);
        }
        return iA;
    }
        ...
        try {
            ...
            if (strArrA != null && !TextUtils.isEmpty(strArrA[0]) && !TextUtils.isEmpty(strArrA[1])) {
                ...
                if (jSONObject.length() > 0) {
                    mainEvents.put(g.f49325L, jSONObject);
                }
            }
            if (ABTest.getService(this.mContext).isInTest()) {
                ...
                mainEvents.put(g.f49324K, jSONObject2);
            }
    ...
    private JSONObject generalHeader() {
        ...
        try {
            ...
            jSONObject.put(g.f49348i, AnalyticsConfig.getVerticalType(this.mContext));
            int verticalType = AnalyticsConfig.getVerticalType(this.mContext);
            String str2 = AnalyticsSdkVersion.SDK_VERSION;
            if (verticalType == 1) {
            ...
            SharedPreferences sharedPreferences = PreferenceWrapper.getDefault(this.mContext);
            jSONObject.put(g.f49351l, UMEnvelopeBuild.imprintProperty(this.mContext, "pr_ve", null));
            jSONObject.put(g.f49352m, UMEnvelopeBuild.imprintProperty(this.mContext, "ud_da", null));
            jSONObject.put(g.an, "1.0.0");
            if (TextUtils.isEmpty(strImprintProperty)) {
                jSONObject.put(g.f49351l, sharedPreferences.getString("vers_pre_version", "0"));
                jSONObject.put(g.f49352m, sharedPreferences.getString("vers_date", new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date(System.currentTimeMillis()))));
            }
            return jSONObject;
        } catch (Throwable th) {
            th.printStackTrace();
        ...
        try {
            ...
            if (jSONObject2.length() > 0) {
                if (jSONObject2.has("analytics")) {
                    ...
                    if (jSONObjectOptJSONObject.length() == 1 && (jSONObjectOptJSONObject.optJSONObject(g.f49325L) != null || !TextUtils.isEmpty(jSONObjectOptJSONObject.optString("userlevel")))) {
                        return null;
                    }
                    if (jSONObjectOptJSONObject.length() == 2 && jSONObjectOptJSONObject.optJSONObject(g.f49325L) != null && !TextUtils.isEmpty(jSONObjectOptJSONObject.optString("userlevel"))) {
                        return null;
                    }
                }
