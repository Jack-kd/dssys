...
public final class df {
    ...
    private static final Comparator f49174a = new a();
    ...
    public static class a implements Comparator {
        ...
        public int compare(Object obj, Object obj2) {
            ...
            return obj instanceof List ? df.a((List) obj, (List) obj2) : obj instanceof Set ? df.a((Set) obj, (Set) obj2) : obj instanceof Map ? df.a((Map) obj, (Map) obj2) : obj instanceof byte[] ? df.a((byte[]) obj, (byte[]) obj2) : df.a((Comparable) obj, (Comparable) obj2);
        }
    }
    ...
    public static int a(List list, List list2) {
        ...
        for (int i2 = 0; i2 < list.size(); i2++) {
            int iCompare = f49174a.compare(list.get(i2), list2.get(i2));
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Set set, Set set2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            int iCompare = f49174a.compare(it.next(), it2.next());
            if (iCompare != 0) {
                return iCompare;
            }
        }
    ...
    public static int a(Map map, Map map2) {
        ...
        while (it.hasNext() && it2.hasNext()) {
            ...
            Comparator comparator2 = f49174a;
