...
public class v {
    ...
    private static final String f49665a = "fs_lc_tl_uapp";

    /* renamed from: f, reason: collision with root package name */
    private static final String f49666f = "-1";

    /* renamed from: g, reason: collision with root package name */
    private static Context f49667g;
    ...
    private JSONObject f49672h;

    public static class a {

        /* renamed from: a, reason: collision with root package name */
        private static final v f49673a = new v();
    ...
    public static v a(Context context) {
        if (f49667g == null && context != null) {
            f49667g = context.getApplicationContext();
        }
        return a.f49673a;
    }
    ...
    private void b(Context context) {
        try {
            String string = PreferenceWrapper.getDefault(context).getString(f49665a, null);
            if (!TextUtils.isEmpty(string)) {
                this.f49672h = new JSONObject(string);
            }
            a();
    ...
    private void c(Context context) {
        try {
            if (this.f49672h != null) {
                PreferenceWrapper.getDefault(f49667g).edit().putString(f49665a, this.f49672h.toString()).commit();
            }
    ...
    public void a(String str, String str2, long j2, int i2, String str3) {
        ...
        try {
            if (a(str) && b(str2)) {
                ...
                if (j2 > 0) {
                    jSONObject.put(g.ac, j2);
                }
                jSONObject.put("__t", l.f49441a);
                if (!TextUtils.isEmpty(str2)) {
                    jSONObject.put(str, str2);
                }
                if (UMUtils.isMainProgress(f49667g)) {
                    strA = ab.a().d(UMGlobalContext.getAppContext(f49667g));
                } else {
                    strA = ab.a().a(UMGlobalContext.getAppContext(f49667g), jCurrentTimeMillis);
                }
                ...
                jSONObject.put("ds", 0);
                jSONObject.put("pn", UMGlobalContext.getInstance(f49667g).getProcessName(f49667g));
                a();
                JSONObject jSONObject3 = this.f49672h;
                if (jSONObject3 != null && jSONObject3.has(str) && !((Boolean) this.f49672h.get(str)).booleanValue()) {
                    jSONObject.put(g.ae, 1);
                    this.f49672h.put(str, true);
                    c(f49667g);
                }
                Context context = f49667g;
                UMWorkDispatch.sendEvent(context, 4097, CoreProtocol.getInstance(context), jSONObject);
                return;
            }
            UMLog.aq(m.f49498l, 0, "\\|");
    ...
    public void a(String str, Map<String, Object> map, long j2, String str2, boolean z2) {
        ...
        try {
            ...
            if (b(map)) {
                ...
                if (!UMUtils.isMainProgress(f49667g)) {
                    strA = ab.a().a(UMGlobalContext.getAppContext(f49667g), jSONObject.getLong("ts"));
                } else {
                    strA = ab.a().d(UMGlobalContext.getAppContext(f49667g));
                }
                if (TextUtils.isEmpty(strA)) {
                ...
                if (!z2) {
                    ...
                    Context context2 = f49667g;
                    UMWorkDispatch.sendEvent(context2, r.a.f49633n, CoreProtocol.getInstance(context2), jSONObject);
                }
            }
        } catch (Throwable unused2) {
        }
    ...
    public void a(String str, Map<String, Object> map, String str2) {
        try {
            if (a(str)) {
                ...
                String strD = ab.a().d(UMGlobalContext.getAppContext(f49667g));
    ...
    private void a() throws JSONException {
        try {
            String strImprintProperty = UMEnvelopeBuild.imprintProperty(f49667g, "track_list", "");
            ...
            if (this.f49672h != null) {
                for (String str : strArrSplit) {
                    ...
                    if (this.f49672h.has(strSubStr)) {
                        jSONObject.put(strSubStr, this.f49672h.get(strSubStr));
                    }
                }
            }
            this.f49672h = new JSONObject();
    ...
    private void a(String str, boolean z2) throws JSONException {
        try {
            if (g.ae.equals(str) || g.ac.equals(str) || "id".equals(str) || "ts".equals(str) || this.f49672h.has(str)) {
                return;
            }
            this.f49672h.put(str, z2);
        } catch (Exception unused) {
        }
    }
    ...
    public void a(List<String> list) {
        if (list != null) {
            try {
                if (list.size() > 0) {
                    a();
                    JSONObject jSONObject = this.f49672h;
                    if (jSONObject == null) {
                        this.f49672h = new JSONObject();
                        int size = list.size();
                        for (int i2 = 0; i2 < size; i2++) {
                            JSONObject jSONObject2 = this.f49672h;
                            if (jSONObject2 == null) {
                                this.f49672h = new JSONObject();
