...
public class FieldManager {
    ...
    private static final String f49871a = "cfgfd";

    /* renamed from: b, reason: collision with root package name */
    private static b f49872b = b.b();

    /* renamed from: c, reason: collision with root package name */
    private static boolean f49873c = false;

    /* renamed from: d, reason: collision with root package name */
    private static Object f49874d = new Object();

    public static class a {

        /* renamed from: a, reason: collision with root package name */
        private static final FieldManager f49875a = new FieldManager();
    ...
    public void a(Context context) {
        ...
        String[] strArr = {d.a.class.getName(), d.b.class.getName(), d.c.class.getName(), d.EnumC0860d.class.getName()};
            ...
            try {
                ...
                if (length > 0) {
                    ...
                    for (int i2 = 0; i2 < length; i2++) {
                        arrayList.add(gVar);
                        ((e) arrayList.get(i2)).a(strArrSplit[i2], f49872b, d.b(strArr[i2]));
                    }
                }
                f49873c = true;
            } catch (Throwable th) {
