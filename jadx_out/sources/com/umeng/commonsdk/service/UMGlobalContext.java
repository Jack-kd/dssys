...
public class UMGlobalContext {
    ...
    public static class a {
        ...
        private static final UMGlobalContext f50186a = new UMGlobalContext();
    ...
    public static Context getAppContext(Context context) {
        if (a.f50186a.mApplicationContext == null && context != null) {
            a.f50186a.mApplicationContext = context.getApplicationContext();
        }
        return a.f50186a.mApplicationContext;
    }

    public static UMGlobalContext getInstance(Context context) {
        if (a.f50186a.mApplicationContext == null && context != null) {
            a.f50186a.mApplicationContext = context;
        }
        return a.f50186a;
    }
    ...
    public String getProcessName(Context context) {
        if (TextUtils.isEmpty(this.mProcessName)) {
            if (context != null) {
                Context context2 = a.f50186a.mApplicationContext;
                if (context2 != null) {
                ...
                this.mProcessName = UMFrUtils.getCurrentProcessName(a.f50186a.mApplicationContext);
            }
        }
    ...
    public String toString() {
        if (a.f50186a.mApplicationContext == null) {
