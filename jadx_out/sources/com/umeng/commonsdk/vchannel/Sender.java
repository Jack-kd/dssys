...
public class Sender {
    ...
    public static void handleEvent(Context context, b bVar) {
        ...
        try {
            ...
            context2 = context;
            try {
                UMEnvelopeBuild.buildEnvelopeWithExtHeader(context2, jSONObject, jSONObject2, a.f50519c, "v", "1.0.0");
            } catch (Throwable th) {
                th = th;
    ...
    public static void onEvent(Context context, String str, Map<String, Object> map) {
        ...
        bVar.a(map);
        try {
            UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f50111o, com.umeng.commonsdk.internal.b.a(context).a(), bVar);
        } catch (Throwable unused) {
        }
