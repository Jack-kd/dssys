...
public class Response implements de<Response, e>, Serializable, Cloneable {
    ...
    private static final dy IMPRINT_FIELD_DESC = new dy(bv.f48897X, (byte) 12, 3);
    ...
    public static class a extends en<Response> {
        ...
        public void b(ed edVar, Response response) throws dk {
            edVar.j();
            while (true) {
                dy dyVarL = edVar.l();
        ...
        public void a(ed edVar, Response response) throws dk {
            response.validate();
    ...
    static {
        ...
        enumMap.put((EnumMap) e.RESP_CODE, (e) new dq("resp_code", (byte) 1, new dr((byte) 8)));
        enumMap.put((EnumMap) e.MSG, (e) new dq("msg", (byte) 2, new dr((byte) 11)));
        enumMap.put((EnumMap) e.IMPRINT, (e) new dq(bv.f48897X, (byte) 2, new dv((byte) 12, com.umeng.commonsdk.statistics.proto.d.class)));
    ...
    public void setResp_codeIsSet(boolean z2) {
        this.__isset_bitfield = db.a(this.__isset_bitfield, 0, z2);
    }
    ...
    public void validate() throws dk {
        com.umeng.commonsdk.statistics.proto.d dVar = this.imprint;
        if (dVar != null) {
            dVar.l();
        }
    ...
    public enum e implements dl {
        ...
        MSG(2, "msg"),
        IMPRINT(3, bv.f48897X);


        /* renamed from: d, reason: collision with root package name */
        private static final Map<String, e> f50338d = new HashMap();

        /* renamed from: e, reason: collision with root package name */
        private final short f50340e;

        /* renamed from: f, reason: collision with root package name */
        private final String f50341f;

        static {
            Iterator it = EnumSet.allOf(e.class).iterator();
            while (it.hasNext()) {
                e eVar = (e) it.next();
                f50338d.put(eVar.b(), eVar);
            }
        }
