...
public class Envelope {
    ...
    public static Envelope genEncryptEnvelope(Context context, String str, byte[] bArr) {
        try {
            ...
            String string = sharedPreferences.getString(com.umeng.ccg.a.f49739A, null);
            ...
            envelope.seal();
            sharedPreferences.edit().putInt("serial", i2 + 1).putString(com.umeng.ccg.a.f49739A, envelope.getSignature()).commit();
    ...
    public static String getSignature(Context context) {
        ...
        return sharedPreferences.getString(com.umeng.ccg.a.f49739A, null);
    }

    public void export(Context context) {
        String str = this.mAddress;
        String strImprintProperty = UMEnvelopeBuild.imprintProperty(context, bv.f48906g, null);
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject.put(bv.f48906g, strImprintProperty);
            }
            jSONObject.put(com.umeng.ccg.a.f49739A, hexString);
            jSONObject.put("checksum", hexString2);
            File file = new File(context.getFilesDir(), be.b().b(be.f48799b));
            if (!file.exists()) {
                file.mkdir();
            }
        ...
        try {
            ...
            if (strImprintProperty != null) {
                jSONObject2.put(bv.f48906g, HelperUtils.getUmengMD5(strImprintProperty));
            }
            HelperUtils.writeFile(new File(context.getFilesDir(), be.b().b(be.f48805h)), jSONObject2.toString());
        } catch (Throwable th2) {
            th2.printStackTrace();
        }
    }
