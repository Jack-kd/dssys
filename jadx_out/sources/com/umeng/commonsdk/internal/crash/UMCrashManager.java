            ...
            synchronized (mObject) {
                try {
                    ...
                    if (!TextUtils.isEmpty(str)) {
                        String str2 = context.getFilesDir() + File.separator + com.umeng.commonsdk.stateless.a.f50194f;
    ...
    public static void reportCrash(Context context, Throwable th) {
        synchronized (mObject) {
            try {
                if (!isReportCrash) {
                    isReportCrash = true;
                    UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f50117u, b.a(context).a(), a.a(th));
                }
            } catch (Throwable th2) {
                throw th2;
            }
