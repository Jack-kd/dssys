...
public class d {
    public static void a(Context context) throws JSONException {
        ...
        try {
            ...
            jSONObject.put(bv.aN, a.f50101e);
            context2 = context;
        } catch (Exception e2) {
            e = e2;
            context2 = context;
        ...
        try {
            JSONObject jSONObjectBuildEnvelopeWithExtHeader = UMEnvelopeBuild.buildEnvelopeWithExtHeader(context2, jSONObject, d(context), UMServerURL.PATH_ANALYTICS, "i", a.f50101e);
    ...
    public static JSONObject d(Context context) throws JSONException {
        ...
        if (context != null) {
            ...
            try {
                if (FieldManager.allow(com.umeng.commonsdk.utils.d.f50476L) && (jSONArrayI = i(applicationContext)) != null && jSONArrayI.length() > 0) {
    ...
    private static void h(Context context) {
        ...
        try {
            if (UMEnvelopeBuild.isReadyBuild(context, UMLogDataProtocol.UMBusinessType.U_INTERNAL)) {
                context2 = context;
                try {
                    UMWorkDispatch.sendEvent(context2, a.f50102f, b.a(context).a(), null, 5000L);
                } catch (Throwable th) {
                    th = th;
            ...
            try {
                UMWorkDispatch.sendEvent(context3, a.f50118v, b.a(context2).a(), null, 5000L);
            } catch (Throwable th2) {
                th = th2;
                context2 = context3;
                UMCrashManager.reportCrash(context2, th);
    ...
    private static JSONObject b() throws Throwable {
        try {
            ...
            JSONObject jSONObject = new JSONObject();
            try {
                jSONObject.put("pro", aVarA.f50159a);
                jSONObject.put("pla", aVarA.f50160b);
                jSONObject.put("cpus", aVarA.f50161c);
                jSONObject.put("fea", aVarA.f50162d);
                jSONObject.put(be.f48800c, aVarA.f50163e);
                jSONObject.put("arc", aVarA.f50164f);
                jSONObject.put("var", aVarA.f50165g);
                jSONObject.put("par", aVarA.f50166h);
                jSONObject.put("rev", aVarA.f50167i);
                jSONObject.put("har", aVarA.f50168j);
                jSONObject.put("rev", aVarA.f50169k);
                jSONObject.put("ser", aVarA.f50170l);
    ...
    private static void b(Context context, JSONObject jSONObject) throws JSONException {
        if (context != null) {
            ...
            try {
                ...
                if (jSONObject2.has(k.f50182d)) {
                    jSONObject.put(k.f50182d, jSONObject2.opt(k.f50182d));
                }
                if (jSONObject2.has(k.f50181c)) {
                    jSONObject.put(k.f50181c, jSONObject2.opt(k.f50181c));
                }
                if (jSONObject2.has(k.f50180b)) {
                    jSONObject.put(k.f50180b, jSONObject2.opt(k.f50180b));
                }
            } catch (Exception unused) {
            }
        }
