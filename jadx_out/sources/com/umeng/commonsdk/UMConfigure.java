...
public class UMConfigure {
    ...
    public static void enableApModeSwitch(boolean z2) {
        b.c(z2);
    }

    @Deprecated
    public static void enableAplCollection(boolean z2) {
        shouldCollectApl = z2;
    }
    ...
    public static void enableInstallReferrerCollection(boolean z2) {
        d.a(z2);
    }

    public static void enablePi(boolean z2) {
        o.a(z2);
    }

    public static void enablePo(boolean z2) {
        o.b(z2);
    }
    ...
    public static void setOnAttributionListener(OnAttributionListener onAttributionListener) {
        com.umeng.commonsdk.deeplink.a.a().a(UMGlobalContext.getAppContext(), onAttributionListener);
    }
    ...
    private static void setWraperType(String str, String str2) {
        if (!TextUtils.isEmpty(str)) {
            if (str.equals(WRAPER_TYPE_NATIVE)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_NATIVE;
                a.f50216a = WRAPER_TYPE_NATIVE;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_X)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_COCOS2DX_X;
                a.f50216a = WRAPER_TYPE_COCOS2DX_X;
            } else if (str.equals(WRAPER_TYPE_COCOS2DX_XLUA)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_COCOS2DX_XLUA;
                a.f50216a = WRAPER_TYPE_COCOS2DX_XLUA;
            } else if (str.equals(WRAPER_TYPE_UNITY)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_UNITY;
                a.f50216a = WRAPER_TYPE_UNITY;
            } else if (str.equals(WRAPER_TYPE_REACTNATIVE)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_REACTNATIVE;
                a.f50216a = WRAPER_TYPE_REACTNATIVE;
            } else if (str.equals(WRAPER_TYPE_PHONEGAP)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_PHONEGAP;
                a.f50216a = WRAPER_TYPE_PHONEGAP;
            } else if (str.equals(WRAPER_TYPE_WEEX)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_WEEX;
                a.f50216a = WRAPER_TYPE_WEEX;
            } else if (str.equals("hybrid")) {
                com.umeng.commonsdk.stateless.a.f50189a = "hybrid";
                a.f50216a = "hybrid";
            } else if (str.equals(WRAPER_TYPE_FLUTTER)) {
                com.umeng.commonsdk.stateless.a.f50189a = WRAPER_TYPE_FLUTTER;
                a.f50216a = WRAPER_TYPE_FLUTTER;
            }
        }
        if (TextUtils.isEmpty(str2)) {
            return;
        }
        com.umeng.commonsdk.stateless.a.f50190b = str2;
        a.f50217b = str2;
    }
    ...
    public static void submitPolicyGrantResult(Context context, boolean z2) {
        UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f50082B, com.umeng.commonsdk.internal.b.a(context).a(), null);
        synchronized (lock) {
            try {
        ...
        UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f50122z, com.umeng.commonsdk.internal.b.a(context).a(), Integer.valueOf(policyGrantResult));
    }
    ...
    public static void init(Context context, String str, String str2, int i2, String str3) throws IllegalAccessException, NoSuchMethodException, ClassNotFoundException, SecurityException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            try {
                if (debugLog) {
                    String str4 = SdkVersion.SDK_VERSION;
                }
            } catch (Exception e2) {
                if (debugLog) {
        ...
        if (c.a()) {
            ...
            UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f50084D, com.umeng.commonsdk.internal.b.a(applicationContext).a(), null);
            return;
        }
        try {
        ...
        try {
            Method declaredMethod6 = MobclickAgent.class.getDeclaredMethod("init", Context.class);
            ...
            Method declaredMethod7 = MobclickAgent.class.getDeclaredMethod("setGameScenarioType", Context.class);
            if (declaredMethod7 != null) {
                declaredMethod7.setAccessible(true);
                declaredMethod7.invoke(MobclickAgent.class, applicationContext);
            }
            if (com.umeng.commonsdk.statistics.b.f50219a.indexOf("e") >= 0 && (declaredMethod5 = MobclickAgent.class.getDeclaredMethod("disableExceptionCatch", null)) != null) {
                declaredMethod5.setAccessible(true);
                declaredMethod5.invoke(MobclickAgent.class, null);
            }
        } catch (Throwable unused4) {
        }
        try {
            Class<?> cls4 = Class.forName("com.umeng.message.PushAgent");
            Method declaredMethod8 = cls4.getDeclaredMethod("init", Context.class);
        ...
        try {
            ...
            if (declaredMethod9 != null && (objInvoke2 = declaredMethod9.invoke(cls5, applicationContext)) != null) {
            ...
            synchronized (lock) {
                try {
                    ...
                    try {
                        ...
                        jSONObject.put(com.umeng.commonsdk.internal.a.f50094N, preInitInvokedFlag);
                        jSONObject.put(com.umeng.commonsdk.internal.a.f50095O, policyGrantInvokedFlag);
                        jSONObject.put("policyGrantResult", policyGrantResult);
                        UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f50081A, com.umeng.commonsdk.internal.b.a(applicationContext).a(), jSONObject);
        ...
        if (needSendZcfgEnv(applicationContext)) {
            ...
            UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f50112p, com.umeng.commonsdk.internal.b.a(applicationContext).a(), null);
        } else if (UMUtils.isMainProgress(applicationContext)) {
            UMRTLog.e(UMRTLog.RTLOG_TAG, "--->>> 走正常逻辑.");
            if (FieldManager.b()) {
                UMWorkDispatch.sendEvent(applicationContext, com.umeng.commonsdk.internal.a.f50121y, com.umeng.commonsdk.internal.b.a(applicationContext).a(), null);
            }
        ...
        UMWorkDispatch.sendEvent(context, com.umeng.commonsdk.internal.a.f50086F, com.umeng.commonsdk.internal.b.a(context).a(), null);
        if (!isInit) {
            isInit = true;
        }
        ...
        if (SdkVersion.SDK_TYPE == 0) {
            try {
                com.umeng.commonsdk.deeplink.a.a().a(context);
