...
public abstract class PigeonApiFileChooserParams {
    ...
    @NotNull
    public abstract List<String> acceptTypes(@NotNull WebChromeClient.FileChooserParams pigeon_instance);

    @Nullable
    public abstract String filenameHint(@NotNull WebChromeClient.FileChooserParams pigeon_instance);
    ...
    public abstract boolean isCaptureEnabled(@NotNull WebChromeClient.FileChooserParams pigeon_instance);

    @NotNull
    public abstract FileChooserMode mode(@NotNull WebChromeClient.FileChooserParams pigeon_instance);

    public final void pigeon_newInstance(@NotNull WebChromeClient.FileChooserParams pigeon_instanceArg, @NotNull final Function1<? super Result<kotlin.j>, kotlin.j> callback) {
        ...
        new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.FileChooserParams.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(kotlin.collections.q.o(Long.valueOf(jAddHostCreatedInstance), Boolean.valueOf(zIsCaptureEnabled), acceptTypes(pigeon_instanceArg), mode(pigeon_instanceArg), filenameHint(pigeon_instanceArg)), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.m0
