...
public abstract class PigeonApiConsoleMessage {
    ...
    public PigeonApiConsoleMessage(@NotNull AndroidWebkitLibraryPigeonProxyApiRegistrar pigeonRegistrar) {
    ...
    @NotNull
    public abstract ConsoleMessageLevel level(@NotNull ConsoleMessage pigeon_instance);

    public abstract long lineNumber(@NotNull ConsoleMessage pigeon_instance);

    @NotNull
    public abstract String message(@NotNull ConsoleMessage pigeon_instance);

    public final void pigeon_newInstance(@NotNull ConsoleMessage pigeon_instanceArg, @NotNull final Function1<? super Result<kotlin.j>, kotlin.j> callback) {
    ...
    @NotNull
    public abstract String sourceId(@NotNull ConsoleMessage pigeon_instance);
}
