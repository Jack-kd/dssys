...
public class WebViewProxyApi extends PigeonApiWebView {
    ...
    public static class WebViewPlatformView extends WebView implements PlatformView {
        ...
        public /* synthetic */ void lambda$onScrollChanged$1(int i2, int i3, int i4, int i5) {
            this.api.onScrollChanged(this, i2, i3, i4, i5, new Function1() { // from class: io.flutter.plugins.webviewflutter.K3
                @Override // kotlin.jvm.functions.Function1
                public final Object invoke(Object obj) {
                    return WebViewProxyApi.WebViewPlatformView.a((Result) obj);
                }
            });
        }
        ...
        public void onScrollChanged(final int i2, final int i3, final int i4, final int i5) {
            ...
            this.api.getPigeonRegistrar().runOnMainThread(new Runnable() { // from class: io.flutter.plugins.webviewflutter.J3
                ...
                public final void run() {
                    this.f50983b.lambda$onScrollChanged$1(i2, i3, i4, i5);
                }
            });
        }
    ...
    @Override // io.flutter.plugins.webviewflutter.PigeonApiWebView
    public void clearCache(@NonNull WebView webView, boolean z2) {
    ...
    @Override // io.flutter.plugins.webviewflutter.PigeonApiWebView
    public void evaluateJavascript(@NonNull WebView webView, @NonNull String str, @NonNull final Function1<? super Result<String>, kotlin.j> function1) {
        webView.evaluateJavascript(str, new ValueCallback() { // from class: io.flutter.plugins.webviewflutter.I3
            @Override // android.webkit.ValueCallback
            public final void onReceiveValue(Object obj) {
                ResultCompat.success((String) obj, function1);
            }
        });
    }
    ...
    @Override // io.flutter.plugins.webviewflutter.PigeonApiWebView
    public void setBackgroundColor(@NonNull WebView webView, long j2) {
