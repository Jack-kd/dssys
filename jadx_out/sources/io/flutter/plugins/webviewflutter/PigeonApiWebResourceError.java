...
public abstract class PigeonApiWebResourceError {
    ...
    @NotNull
    public abstract String description(@NotNull WebResourceError pigeon_instance);

    public abstract long errorCode(@NotNull WebResourceError pigeon_instance);
    ...
    public final void pigeon_newInstance(@NotNull WebResourceError pigeon_instanceArg, @NotNull final Function1<? super Result<kotlin.j>, kotlin.j> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.WebResourceError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(kotlin.collections.q.o(Long.valueOf(jAddHostCreatedInstance), Long.valueOf(jErrorCode), description(pigeon_instanceArg)), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.t1
