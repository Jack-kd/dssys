...
public final class AndroidWebkitLibraryPigeonInstanceManager {
    ...
    public static final class Companion {
        ...
        public final AndroidWebkitLibraryPigeonInstanceManager create(@NotNull PigeonFinalizationListener finalizationListener) {
            kotlin.jvm.internal.j.e(finalizationListener, "finalizationListener");
    ...
    @Metadata(d1 = {"\u0000(\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\u0018\u0000*\b\b\u0000\u0010\u0001*\u00020\u00022\b\u0012\u0004\u0012\u0002H\u00010\u0003B\u0011\b\u0016\u0012\u0006\u0010\u0004\u001a\u00028\u0000¢\u0006\u0004\b\u0005\u0010\u0006B!\b\u0016\u0012\u0006\u0010\u0004\u001a\u00028\u0000\u0012\u000e\u0010\u0007\u001a\n\u0012\u0004\u0012\u00028\u0000\u0018\u00010\b¢\u0006\u0004\b\u0005\u0010\tJ\u0013\u0010\f\u001a\u00020\r2\b\u0010\u000e\u001a\u0004\u0018\u00010\u0002H\u0096\u0002J\b\u0010\u000f\u001a\u00020\u000bH\u0016R\u000e\u0010\n\u001a\u00020\u000bX\u0082\u0004¢\u0006\u0002\n\u0000¨\u0006\u0010"}, d2 = {"Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonInstanceManager$IdentityWeakReference;", ExifInterface.GPS_DIRECTION_TRUE, "", "Ljava/lang/ref/WeakReference;", "instance", "<init>", "(Ljava/lang/Object;)V", "queue", "Ljava/lang/ref/ReferenceQueue;", "(Ljava/lang/Object;Ljava/lang/ref/ReferenceQueue;)V", "savedHashCode", "", "equals", "", "other", "hashCode", "webview_flutter_android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class IdentityWeakReference<T> extends WeakReference<T> {
        private final int savedHashCode;

        /* JADX WARN: 'this' call moved to the top of the method (can break code semantics) */
        public IdentityWeakReference(@NotNull T instance) {
            this(instance, null);
        ...
        public boolean equals(@Nullable Object other) {
            T t2 = get();
            return t2 != null ? (other instanceof IdentityWeakReference) && ((IdentityWeakReference) other).get() == t2 : other == this;
        }
        ...
        public IdentityWeakReference(@NotNull T instance, @Nullable ReferenceQueue<T> referenceQueue) {
    ...
    @Metadata(d1 = {"\u0000\u0016\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\u0010\t\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\bf\u0018\u00002\u00020\u0001J\u0017\u0010\u0005\u001a\u00020\u00042\u0006\u0010\u0003\u001a\u00020\u0002H&¢\u0006\u0004\b\u0005\u0010\u0006¨\u0006\u0007À\u0006\u0003"}, d2 = {"Lio/flutter/plugins/webviewflutter/AndroidWebkitLibraryPigeonInstanceManager$PigeonFinalizationListener;", "", "", "identifier", "Lkotlin/j;", "onFinalize", "(J)V", "webview_flutter_android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    ...
    public AndroidWebkitLibraryPigeonInstanceManager(@NotNull PigeonFinalizationListener finalizationListener) {
        ...
        Runnable runnable = new Runnable() { // from class: io.flutter.plugins.webviewflutter.a
            ...
            public final void run() {
                this.f51068b.releaseAllFinalizedInstances();
            }
        };
    ...
    public final void releaseAllFinalizedInstances() {
        ...
        while (true) {
            ...
            Long l2 = (Long) kotlin.jvm.internal.p.b(this.weakReferencesToIdentifiers).remove(identityWeakReference);
            if (l2 != null) {
                this.weakInstances.remove(l2);
                this.strongInstances.remove(l2);
                this.finalizationListener.onFinalize(l2.longValue());
            }
        }
    }

    public final void addDartCreatedInstance(@NotNull Object instance, long identifier) {
        kotlin.jvm.internal.j.e(instance, "instance");
    ...
    public final boolean containsInstance(@Nullable Object instance) {
        logWarningIfFinalizationListenerHasStopped();
    ...
    @Nullable
    public final Long getIdentifierForStrongReference(@Nullable Object instance) {
        logWarningIfFinalizationListenerHasStopped();
        if (instance == null) {
            return null;
        }
        Long l2 = this.identifiers.get(new IdentityWeakReference(instance));
        if (l2 != null) {
            this.strongInstances.put(l2, instance);
        }
        return l2;
    }
    ...
    public final void setClearFinalizedWeakReferencesInterval(long j2) {
        ...
        this.clearFinalizedWeakReferencesInterval = j2;
