...
public class ConsoleMessageProxyApi extends PigeonApiConsoleMessage {
    ...
    public ConsoleMessageLevel level(@NonNull ConsoleMessage consoleMessage) {
        ...
        return i2 != 1 ? i2 != 2 ? i2 != 3 ? i2 != 4 ? i2 != 5 ? ConsoleMessageLevel.UNKNOWN : ConsoleMessageLevel.DEBUG : ConsoleMessageLevel.ERROR : ConsoleMessageLevel.WARNING : ConsoleMessageLevel.LOG : ConsoleMessageLevel.TIP;
    }
