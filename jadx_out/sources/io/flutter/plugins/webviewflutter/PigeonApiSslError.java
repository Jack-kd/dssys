...
public abstract class PigeonApiSslError {
    ...
    @Metadata(d1 = {"\u0000 \n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u001f\u0010\t\u001a\u00020\b2\u0006\u0010\u0005\u001a\u00020\u00042\b\u0010\u0007\u001a\u0004\u0018\u00010\u0006¢\u0006\u0004\b\t\u0010\n¨\u0006\u000b"}, d2 = {"Lio/flutter/plugins/webviewflutter/PigeonApiSslError$Companion;", "", "<init>", "()V", "Lio/flutter/plugin/common/BinaryMessenger;", "binaryMessenger", "Lio/flutter/plugins/webviewflutter/PigeonApiSslError;", "api", "Lkotlin/j;", "setUpMessageHandlers", "(Lio/flutter/plugin/common/BinaryMessenger;Lio/flutter/plugins/webviewflutter/PigeonApiSslError;)V", "webview_flutter_android_release"}, k = 1, mv = {2, 2, 0}, xi = 48)
    public static final class Companion {
        ...
        public static final void setUpMessageHandlers$lambda$0$0(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            try {
                listWrapError = kotlin.collections.p.e(pigeonApiSslError.getPrimaryError((SslError) obj2));
            } catch (Throwable th) {
        ...
        public static final void setUpMessageHandlers$lambda$1$0(PigeonApiSslError pigeonApiSslError, Object obj, BasicMessageChannel.Reply reply) {
            ...
            try {
                listWrapError = kotlin.collections.p.e(Boolean.valueOf(pigeonApiSslError.hasError(sslError, (SslErrorType) obj3)));
            } catch (Throwable th) {
                listWrapError = AndroidWebkitLibraryPigeonUtils.INSTANCE.wrapError(th);
            }
            reply.reply(listWrapError);
        ...
        public final void setUpMessageHandlers(@NotNull BinaryMessenger binaryMessenger, @Nullable final PigeonApiSslError api) {
            ...
            if (api != null) {
                basicMessageChannel.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.P0
                    ...
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        PigeonApiSslError.Companion.setUpMessageHandlers$lambda$0$0(api, obj, reply);
                    }
                });
            } else {
            ...
            if (api != null) {
                basicMessageChannel2.setMessageHandler(new BasicMessageChannel.MessageHandler() { // from class: io.flutter.plugins.webviewflutter.Q0
                    @Override // io.flutter.plugin.common.BasicMessageChannel.MessageHandler
                    public final void onMessage(Object obj, BasicMessageChannel.Reply reply) {
                        PigeonApiSslError.Companion.setUpMessageHandlers$lambda$1$0(api, obj, reply);
                    }
                });
            } else {
    ...
    public PigeonApiSslError(@NotNull AndroidWebkitLibraryPigeonProxyApiRegistrar pigeonRegistrar) {
    ...
    @NotNull
    public abstract SslCertificate certificate(@NotNull SslError pigeon_instance);
    ...
    @NotNull
    public abstract SslErrorType getPrimaryError(@NotNull SslError pigeon_instance);

    public abstract boolean hasError(@NotNull SslError pigeon_instance, @NotNull SslErrorType error);

    public final void pigeon_newInstance(@NotNull SslError pigeon_instanceArg, @NotNull final Function1<? super Result<kotlin.j>, kotlin.j> callback) {
        ...
        if (getPigeonRegistrar().getIgnoreCallsToDart()) {
            ...
            new BasicMessageChannel(getPigeonRegistrar().getBinaryMessenger(), "dev.flutter.pigeon.webview_flutter_android.SslError.pigeon_newInstance", getPigeonRegistrar().getCodec()).send(kotlin.collections.q.o(Long.valueOf(jAddHostCreatedInstance), certificate(pigeon_instanceArg), url(pigeon_instanceArg)), new BasicMessageChannel.Reply() { // from class: io.flutter.plugins.webviewflutter.O0
    ...
    @NotNull
    public abstract String url(@NotNull SslError pigeon_instance);
}
