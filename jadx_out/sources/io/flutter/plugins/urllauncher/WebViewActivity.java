...
public class WebViewActivity extends Activity {
    ...
    public static Intent createIntent(@NonNull Context context, @NonNull String str, boolean z2, boolean z3, @NonNull Bundle bundle) {
        return new Intent(context, (Class<?>) WebViewActivity.class).putExtra("url", str).putExtra(ENABLE_JS_EXTRA, z2).putExtra(ENABLE_DOM_EXTRA, z3).putExtra("com.android.browser.headers", bundle);
    }
