...
public class StandardMessageCodec implements MessageCodec<Object> {
    ...
    public static void readAlignment(@NonNull ByteBuffer byteBuffer, int i2) {
    ...
    public static void writeAlignment(@NonNull ByteArrayOutputStream byteArrayOutputStream, int i2) {
    ...
    public static void writeChar(@NonNull ByteArrayOutputStream byteArrayOutputStream, int i2) {
        if (LITTLE_ENDIAN) {
    ...
    public static void writeDouble(@NonNull ByteArrayOutputStream byteArrayOutputStream, double d2) {
        writeLong(byteArrayOutputStream, Double.doubleToLongBits(d2));
    }

    public static void writeFloat(@NonNull ByteArrayOutputStream byteArrayOutputStream, float f2) {
        writeInt(byteArrayOutputStream, Float.floatToIntBits(f2));
    }

    public static void writeInt(@NonNull ByteArrayOutputStream byteArrayOutputStream, int i2) {
        if (LITTLE_ENDIAN) {
            byteArrayOutputStream.write(i2);
            byteArrayOutputStream.write(i2 >>> 8);
    ...
    public static void writeLong(@NonNull ByteArrayOutputStream byteArrayOutputStream, long j2) {
        if (LITTLE_ENDIAN) {
    ...
    public static void writeSize(@NonNull ByteArrayOutputStream byteArrayOutputStream, int i2) {
        if (i2 < 254) {
            byteArrayOutputStream.write(i2);
        } else if (i2 <= 65535) {
