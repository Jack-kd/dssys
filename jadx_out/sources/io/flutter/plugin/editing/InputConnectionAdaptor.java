...
public class InputConnectionAdaptor extends BaseInputConnection implements ListenableEditingState.EditingStateWatcher {
    ...
    public InputConnectionAdaptor(View view, int i2, TextInputChannel textInputChannel, ScribeChannel scribeChannel, KeyboardDelegate keyboardDelegate, ListenableEditingState listenableEditingState, EditorInfo editorInfo, FlutterJNI flutterJNI) {
        super(view, true);
                    ...
                    if (contentUri != null) {
                        try {
                            ...
                            if (inputStreamOpenInputStream != null) {
                                ...
                                map.put(ContentProviderManager.PROVIDER_URI, contentUri.toString());
    ...
    public InputConnectionAdaptor(View view, int i2, TextInputChannel textInputChannel, ScribeChannel scribeChannel, KeyboardDelegate keyboardDelegate, ListenableEditingState listenableEditingState, EditorInfo editorInfo) {
        this(view, i2, textInputChannel, scribeChannel, keyboardDelegate, listenableEditingState, editorInfo, new FlutterJNI());
    }
}
