...
public class PlatformViewsController implements PlatformViewsAccessibilityDelegate {
    ...
    public class AnonymousClass1 implements PlatformViewsChannel.PlatformViewsHandler {
        ...
        public static /* synthetic */ void a(AnonymousClass1 anonymousClass1, VirtualDisplayController virtualDisplayController, float f2, PlatformViewsChannel.PlatformViewBufferResized platformViewBufferResized) {
            ...
            if (PlatformViewsController.this.usesVirtualDisplay(i2)) {
                ...
                virtualDisplayController.resize(physicalPixels, physicalPixels2, new Runnable() { // from class: io.flutter.plugin.platform.i
                    ...
                    public final void run() {
                        PlatformViewsController.AnonymousClass1.a(this.f50877b, virtualDisplayController, displayDensity, platformViewBufferResized);
                    }
                });
                return;
            }
    ...
    public static /* synthetic */ void a(PlatformViewsController platformViewsController, PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z2) {
        if (z2) {
    ...
    public static /* synthetic */ void c(PlatformViewsController platformViewsController, PlatformViewCreationRequest platformViewCreationRequest, View view, boolean z2) {
        if (z2) {
            platformViewsController.platformViewsChannel.invokeViewFocused(platformViewCreationRequest.viewId);
        } else {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public long configureForVirtualDisplay(@NonNull PlatformView platformView, @NonNull final PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        VirtualDisplayController virtualDisplayControllerCreate = VirtualDisplayController.create(this.context, this.accessibilityEventsDelegate, platformView, platformViewRenderTargetMakePlatformViewRenderTarget, toPhysicalPixels(platformViewCreationRequest.logicalWidth), toPhysicalPixels(platformViewCreationRequest.logicalHeight), platformViewCreationRequest.viewId, null, new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.g
            ...
            public final void onFocusChange(View view, boolean z2) {
                PlatformViewsController.c(this.f50874b, platformViewCreationRequest, view, z2);
            }
        });
    ...
    public static /* synthetic */ void d(PlatformViewsController platformViewsController, int i2, View view, boolean z2) {
        if (z2) {
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void finishFrame(boolean z2) {
    ...
    private static PlatformViewRenderTarget makePlatformViewRenderTarget(TextureRegistry textureRegistry) {
        int i2;
        if (enableSurfaceProducerRenderTarget && (i2 = Build.VERSION.SDK_INT) >= 29) {
            TextureRegistry.SurfaceProducer surfaceProducerCreateSurfaceProducer = textureRegistry.createSurfaceProducer(i2 <= 34 ? TextureRegistry.SurfaceLifecycle.resetInBackground : TextureRegistry.SurfaceLifecycle.manual);
    ...
    public long configureForTextureLayerComposition(@NonNull PlatformView platformView, @NonNull final PlatformViewCreationRequest platformViewCreationRequest) {
        ...
        platformViewWrapper.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.f
            ...
            public final void onFocusChange(View view2, boolean z2) {
                PlatformViewsController.a(this.f50872b, platformViewCreationRequest, view2, z2);
            }
        });
    ...
    @VisibleForTesting(otherwise = 3)
    public PlatformView createPlatformView(@NonNull PlatformViewCreationRequest platformViewCreationRequest, boolean z2) {
    ...
    public boolean initializePlatformViewIfNeeded(final int i2) {
        ...
        flutterMutatorView.setOnDescendantFocusChangeListener(new View.OnFocusChangeListener() { // from class: io.flutter.plugin.platform.e
            @Override // android.view.View.OnFocusChangeListener
            public final void onFocusChange(View view2, boolean z2) {
                PlatformViewsController.d(this.f50870b, i2, view2, z2);
            }
        });
    ...
    public void onEndFrame() {
        ...
        if (this.flutterViewConvertedToImageView && this.currentFrameUsedPlatformViewIds.isEmpty()) {
            this.flutterViewConvertedToImageView = false;
            this.flutterView.revertImageView(new Runnable() { // from class: io.flutter.plugin.platform.h
                @Override // java.lang.Runnable
                public final void run() {
                    this.f50876b.finishFrame(false);
                }
            });
        } else {
    ...
    @VisibleForTesting
    public MotionEvent toMotionEvent(float f2, PlatformViewTouch platformViewTouch, boolean z2) {
