...
public class PlatformPlugin {
    ...
    public class AnonymousClass2 implements View.OnSystemUiVisibilityChangeListener {
        ...
        public static /* synthetic */ void a(AnonymousClass2 anonymousClass2, int i2) {
            if ((i2 & 4) == 0) {
        ...
        public void onSystemUiVisibilityChange(final int i2) {
            this.val$decorView.post(new Runnable() { // from class: io.flutter.plugin.platform.d
                ...
                public final void run() {
                    PlatformPlugin.AnonymousClass2.a(this.f50868b, i2);
                }
            });
        }
    }
    ...
    public void setSystemChromeApplicationSwitcherDescription(PlatformChannel.AppSwitcherDescription appSwitcherDescription) {
        ...
        AbstractC1451c.a();
        this.activity.setTaskDescription(AbstractC1450b.a(appSwitcherDescription.label, 0, appSwitcherDescription.color));
    }
