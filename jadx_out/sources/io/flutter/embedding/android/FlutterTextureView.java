...
public class FlutterTextureView extends TextureView implements RenderSurface {
    ...
    public void onMeasure(int i2, int i3) {
        if (this.isContentSizingEnabled) {
            FlutterMeasureSpec.onMeasure(i2, i3, new FlutterMeasureSpec.MeasureCallback() { // from class: io.flutter.embedding.android.i
                @Override // io.flutter.embedding.android.FlutterMeasureSpec.MeasureCallback
                public final void onMeasure(int i4, int i5) {
                    this.f50822a.setMeasuredDimension(i4, i5);
                }
            });
        } else {
