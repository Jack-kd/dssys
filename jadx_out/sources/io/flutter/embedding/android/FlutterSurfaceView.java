...
public class FlutterSurfaceView extends SurfaceView implements RenderSurface {
    ...
    public void onMeasure(int i2, int i3) {
        if (this.isContentSizingEnabled) {
            FlutterMeasureSpec.onMeasure(i2, i3, new FlutterMeasureSpec.MeasureCallback() { // from class: io.flutter.embedding.android.h
                @Override // io.flutter.embedding.android.FlutterMeasureSpec.MeasureCallback
                public final void onMeasure(int i4, int i5) {
                    this.f50821a.setMeasuredDimension(i4, i5);
                }
            });
        } else {
