...
public class FlutterFragmentActivity extends FragmentActivity implements FlutterEngineProvider, FlutterEngineConfigurator {
    ...
    public static class NewEngineInGroupIntentBuilder {
        ...
        private String initialRoute = ServiceReference.DELIMITER;
        private String backgroundMode = FlutterActivityLaunchConfigs.DEFAULT_BACKGROUND_MODE;
    ...
    public FlutterFragment createFlutterFragment() {
        ...
        if (getCachedEngineId() != null) {
            ...
            return FlutterFragment.withCachedEngine(getCachedEngineId()).renderMode(renderMode).transparencyMode(transparencyMode).handleDeeplinking(Boolean.valueOf(shouldHandleDeeplinking())).shouldAttachEngineToActivity(shouldAttachEngineToActivity()).destroyEngineWithFragment(shouldDestroyEngineWithHost()).shouldDelayFirstAndroidViewDraw(z2).shouldAutomaticallyHandleOnBackPressed(true).build();
        }
