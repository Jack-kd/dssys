...
class DartMessenger implements BinaryMessenger, PlatformMessageHandler {
    ...
    public static class BufferedMessageInfo {
        ...
        public BufferedMessageInfo(@NonNull ByteBuffer byteBuffer, int i2, long j2) {
    ...
    public static /* synthetic */ void a(DartMessenger dartMessenger, String str, int i2, HandlerInfo handlerInfo, ByteBuffer byteBuffer, long j2) {
        ...
        try {
            ...
            try {
                dartMessenger.invokeHandler(handlerInfo, byteBuffer, i2);
            ...
            dartMessenger.flutterJNI.cleanupMessageData(j2);
        }
    }

    private void dispatchMessageToQueue(@NonNull final String str, @Nullable final HandlerInfo handlerInfo, @Nullable final ByteBuffer byteBuffer, final int i2, final long j2) {
        ...
        Runnable runnable = new Runnable() { // from class: io.flutter.embedding.engine.dart.a
            ...
            public final void run() {
                DartMessenger.a(this.f50835b, str, i2, handlerInfo, byteBuffer, j2);
            }
        };
