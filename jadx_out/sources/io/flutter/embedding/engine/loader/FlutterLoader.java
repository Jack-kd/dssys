...
public class FlutterLoader {
        ...
        public InitResult call() throws Throwable {
            ...
            try {
                ...
                try {
                    ...
                    sb2.append(fileFromPath.getAbsolutePath());
                    sb2.append(") ");
    ...
    public static /* synthetic */ void b(final FlutterLoader flutterLoader, final Context context, final String[] strArr, final Handler handler, final Runnable runnable) throws ExecutionException, InterruptedException {
        flutterLoader.getClass();
        try {
            ...
            HandlerCompat.createAsyncHandler(Looper.getMainLooper()).post(new Runnable() { // from class: io.flutter.embedding.engine.loader.b
                @Override // java.lang.Runnable
                public final void run() {
                    FlutterLoader.a(this.f50854b, context, strArr, handler, runnable);
                }
            });
        } catch (Exception e2) {
    ...
    private String getSafeAotSharedLibraryNameFlag(@NonNull Context context, @NonNull String str) throws IOException {
        ...
        if (this.initialized) {
            ...
            this.executorService.execute(new Runnable() { // from class: io.flutter.embedding.engine.loader.a
                ...
                public final void run() throws ExecutionException, InterruptedException {
                    FlutterLoader.b(this.f50849b, context, strArr, handler, runnable);
                }
            });
        }
    }
