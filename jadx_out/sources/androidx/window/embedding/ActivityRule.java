...
public final class ActivityRule extends EmbeddingRule {
    ...
    public /* synthetic */ ActivityRule(String str, Set set, boolean z2, int i2, kotlin.jvm.internal.f fVar) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return kotlin.jvm.internal.j.a(this.filters, activityRule.filters) && this.alwaysExpand == activityRule.alwaysExpand;
    }
    ...
    public final ActivityRule plus$window_release(@NotNull ActivityFilter filter) {
        ...
        return new ActivityRule(getTag(), K.j(this.filters, filter), this.alwaysExpand);
    }
    ...
    public ActivityRule(@Nullable String str, @NotNull Set<ActivityFilter> filters, boolean z2) {
        super(str);
        kotlin.jvm.internal.j.e(filters, "filters");
        this.filters = filters;
