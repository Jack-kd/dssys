...
public final class SplitPairRule extends SplitRule {
    ...
    public static final class Builder {
        ...
        @NotNull
        public final Builder setFinishPrimaryWithSecondary(@NotNull SplitRule.FinishBehavior finishPrimaryWithSecondary) {
            kotlin.jvm.internal.j.e(finishPrimaryWithSecondary, "finishPrimaryWithSecondary");
            this.finishPrimaryWithSecondary = finishPrimaryWithSecondary;
            return this;
        }

        @NotNull
        public final Builder setFinishSecondaryWithPrimary(@NotNull SplitRule.FinishBehavior finishSecondaryWithPrimary) {
            kotlin.jvm.internal.j.e(finishSecondaryWithPrimary, "finishSecondaryWithPrimary");
    ...
    public /* synthetic */ SplitPairRule(Set set, SplitAttributes splitAttributes, String str, SplitRule.FinishBehavior finishBehavior, SplitRule.FinishBehavior finishBehavior2, boolean z2, int i2, int i3, int i4, EmbeddingAspectRatio embeddingAspectRatio, EmbeddingAspectRatio embeddingAspectRatio2, int i5, kotlin.jvm.internal.f fVar) {
        this(set, splitAttributes, (i5 & 4) != 0 ? null : str, (i5 & 8) != 0 ? SplitRule.FinishBehavior.NEVER : finishBehavior, (i5 & 16) != 0 ? SplitRule.FinishBehavior.ALWAYS : finishBehavior2, (i5 & 32) != 0 ? false : z2, (i5 & 64) != 0 ? 600 : i2, (i5 & 128) != 0 ? 600 : i3, (i5 & 256) != 0 ? 600 : i4, (i5 & 512) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_PORTRAIT_DEFAULT : embeddingAspectRatio, (i5 & 1024) != 0 ? SplitRule.SPLIT_MAX_ASPECT_RATIO_LANDSCAPE_DEFAULT : embeddingAspectRatio2);
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return kotlin.jvm.internal.j.a(this.filters, splitPairRule.filters) && kotlin.jvm.internal.j.a(this.finishPrimaryWithSecondary, splitPairRule.finishPrimaryWithSecondary) && kotlin.jvm.internal.j.a(this.finishSecondaryWithPrimary, splitPairRule.finishSecondaryWithPrimary) && this.clearTop == splitPairRule.clearTop;
    }
    ...
    public SplitPairRule(@NotNull Set<SplitPairFilter> filters, @NotNull SplitAttributes defaultSplitAttributes, @Nullable String str, @NotNull SplitRule.FinishBehavior finishPrimaryWithSecondary, @NotNull SplitRule.FinishBehavior finishSecondaryWithPrimary, boolean z2, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3, @IntRange(from = 0) int i4, @NotNull EmbeddingAspectRatio maxAspectRatioInPortrait, @NotNull EmbeddingAspectRatio maxAspectRatioInLandscape) {
