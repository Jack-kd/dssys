...
public final class HardwareFoldingFeature implements FoldingFeature {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\b\u0080\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0017\u0010\t\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004H\u0000¢\u0006\u0004\b\u0007\u0010\b¨\u0006\n"}, d2 = {"Landroidx/window/layout/HardwareFoldingFeature$Companion;", "", "<init>", "()V", "Landroidx/window/core/Bounds;", "bounds", "Lkotlin/j;", "validateFeatureBounds$window_release", "(Landroidx/window/core/Bounds;)V", "validateFeatureBounds", "window_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public HardwareFoldingFeature(@NotNull Bounds featureBounds, @NotNull Type type, @NotNull FoldingFeature.State state) {
        j.e(featureBounds, "featureBounds");
        j.e(type, "type");
        j.e(state, "state");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (!j.a(HardwareFoldingFeature.class, other != null ? other.getClass() : null)) {
            return false;
        }
        j.c(other, "null cannot be cast to non-null type androidx.window.layout.HardwareFoldingFeature");
        HardwareFoldingFeature hardwareFoldingFeature = (HardwareFoldingFeature) other;
        return j.a(this.featureBounds, hardwareFoldingFeature.featureBounds) && j.a(this.type, hardwareFoldingFeature.type) && j.a(getState(), hardwareFoldingFeature.getState());
    }
    ...
    public boolean isSeparating() {
        ...
        if (j.a(type, companion.getHINGE())) {
            return true;
        }
        return j.a(this.type, companion.getFOLD()) && j.a(getState(), FoldingFeature.State.HALF_OPENED);
    }
