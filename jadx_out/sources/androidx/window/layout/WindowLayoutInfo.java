...
public final class WindowLayoutInfo {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other == null || !j.a(WindowLayoutInfo.class, other.getClass())) {
            return false;
        }
        return j.a(this.displayFeatures, ((WindowLayoutInfo) other).displayFeatures);
    }
    ...
    public String toString() {
        return y.Q(this.displayFeatures, ", ", "WindowLayoutInfo{ DisplayFeatures[", "] }", 0, null, null, 56, null);
    }
}
