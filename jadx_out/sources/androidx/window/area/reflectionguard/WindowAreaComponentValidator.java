...
public final class WindowAreaComponentValidator {
    ...
    public final boolean isExtensionWindowAreaPresentationValid$window_release(@NotNull Class<?> extensionWindowAreaPresentation, int apiLevel) {
        j.e(extensionWindowAreaPresentation, "extensionWindowAreaPresentation");
        if (apiLevel <= 2) {
            return false;
        }
    ...
    public final boolean isExtensionWindowAreaStatusValid$window_release(@NotNull Class<?> extensionWindowAreaStatus, int apiLevel) {
    ...
    public final boolean isWindowAreaComponentValid$window_release(@NotNull Class<?> windowAreaComponent, int apiLevel) {
