...
public final class WindowAreaInfo {
    ...
    private final WindowAreaSession createRearFacingSession(WindowAreaCapability.Operation operation) {
        if (j.a(operation, WindowAreaCapability.Operation.OPERATION_TRANSFER_ACTIVITY_TO_AREA)) {
            return new RearDisplaySessionImpl(this.windowAreaComponent);
        }
        if (!j.a(operation, WindowAreaCapability.Operation.OPERATION_PRESENT_ON_AREA)) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return j.a(this.metrics, windowAreaInfo.metrics) && j.a(this.type, windowAreaInfo.type) && j.a(this.capabilityMap.entrySet(), windowAreaInfo.capabilityMap.entrySet());
    }

    @Nullable
    public final WindowAreaSession getActiveSession(@NotNull WindowAreaCapability.Operation operation) {
        j.e(operation, "operation");
        if (!j.a(getCapability(operation).getStatus(), WindowAreaCapability.Status.WINDOW_AREA_STATUS_ACTIVE)) {
            throw new IllegalStateException("No session is currently active");
        }
        if (j.a(this.type, Type.TYPE_REAR_FACING)) {
