...
public final class DeviceMetrics {
    ...
    public DeviceMetrics(@NotNull String manufacturer, @NotNull String model, @NotNull DisplayMetrics rearDisplayMetrics) {
        ...
        j.e(model, "model");
        j.e(rearDisplayMetrics, "rearDisplayMetrics");
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return j.a(this.manufacturer, deviceMetrics.manufacturer) && j.a(this.model, deviceMetrics.model) && this.rearDisplayMetrics.equals(deviceMetrics.rearDisplayMetrics);
    }
