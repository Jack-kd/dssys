...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo39clone = transition.mo39clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo39clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo39clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo39clone);
    }
    ...
    public static void beginDelayedTransition(@NonNull ViewGroup viewGroup, @Nullable Transition transition) {
        ...
        Transition transitionMo39clone = transition.mo39clone();
        sceneChangeSetup(viewGroup, transitionMo39clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo39clone);
    }
