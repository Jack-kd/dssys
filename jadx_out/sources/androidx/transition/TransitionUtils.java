...
class TransitionUtils {
    ...
    public static View copyViewImage(ViewGroup viewGroup, View view, View view2) {
        ...
        imageView.measure(View.MeasureSpec.makeMeasureSpec(iRound3 - iRound, C.ENCODING_PCM_32BIT), View.MeasureSpec.makeMeasureSpec(iRound4 - iRound2, C.ENCODING_PCM_32BIT));
