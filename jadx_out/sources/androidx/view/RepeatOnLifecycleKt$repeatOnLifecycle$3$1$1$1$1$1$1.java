...
public final class RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1 extends SuspendLambda implements Function2<M, e, Object> {
    ...
    public RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1(Function2<? super M, ? super e, ? extends Object> function2, e eVar) {
        super(2, eVar);
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        if (i2 == 0) {
            ...
            this.label = 1;
            if (function2.invoke(m2, this) == objE) {
                return objE;
            }
        } else {
            if (i2 != 1) {
    ...
    public final Object invoke(@NotNull M m2, @Nullable e eVar) {
        return ((RepeatOnLifecycleKt$repeatOnLifecycle$3$1$1$1$1$1$1) create(m2, eVar)).invokeSuspend(j.f51397a);
    }
}
