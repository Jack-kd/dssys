...
public final class BrowserServiceFileProvider extends FileProvider {
    ...
    public static a loadBitmap(final ContentResolver contentResolver, final Uri uri) {
        ...
        AsyncTask.THREAD_POOL_EXECUTOR.execute(new Runnable() { // from class: androidx.browser.browseractions.BrowserServiceFileProvider.1
            ...
            public void run() throws IOException {
                try {
                    ParcelFileDescriptor parcelFileDescriptorOpenFileDescriptor = contentResolver.openFileDescriptor(uri, t.f31269k);
    ...
    @UiThread
    public static ResolvableFuture<Uri> saveBitmap(Context context, Bitmap bitmap, String str, int i2) {
