...
public class CustomTabsClient {
    ...
    public class AnonymousClass2 extends IAuthTabCallback.Stub {
        ...
        @Override // android.support.customtabs.IAuthTabCallback
        public void onNavigationEvent(final int i2, final Bundle bundle) throws RemoteException {
            if (this.val$callback == null) {
                return;
            }
            long jClearCallingIdentity = Binder.clearCallingIdentity();
            try {
                ...
                executor.execute(new Runnable() { // from class: androidx.browser.customtabs.d
                    @Override // java.lang.Runnable
                    public final void run() {
                        authTabCallback.onNavigationEvent(i2, bundle);
                    }
                });
            } finally {
                Binder.restoreCallingIdentity(jClearCallingIdentity);
    ...
    private ICustomTabsCallback.Stub createCallbackWrapper(final CustomTabsCallback customTabsCallback) {
        return new ICustomTabsCallback.Stub() { // from class: androidx.browser.customtabs.CustomTabsClient.3
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onActivityLayout(final int i2, final int i3, final int i4, final int i5, final int i6, final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onActivityResized(final int i2, final int i3, final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
            ...
            @Override // android.support.customtabs.ICustomTabsCallback
            public void onRelationshipValidationResult(final int i2, final Uri uri, final boolean z2, final Bundle bundle) throws RemoteException {
                if (customTabsCallback == null) {
                    return;
                }
    ...
    public static AuthTabSession.PendingSession createPendingAuthTabSession(Context context, int i2, Executor executor, AuthTabCallback authTabCallback) {
        return new AuthTabSession.PendingSession(createSessionId(context, i2), executor, authTabCallback);
    }
    ...
    public AuthTabSession newAuthTabSession(AuthTabCallback authTabCallback, Executor executor, int i2) {
        return newAuthTabSessionInternal(authTabCallback, executor, createSessionId(this.mApplicationContext, i2));
    }
    ...
    @ExperimentalPendingSession
    public static AuthTabSession.PendingSession createPendingAuthTabSession(Context context, int i2) {
        return new AuthTabSession.PendingSession(createSessionId(context, i2), null, null);
    }
}
