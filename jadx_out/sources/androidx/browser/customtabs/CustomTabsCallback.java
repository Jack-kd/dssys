...
public class CustomTabsCallback {
    ...
    public void onActivityLayout(@Dimension(unit = 1) int i2, @Dimension(unit = 1) int i3, @Dimension(unit = 1) int i4, @Dimension(unit = 1) int i5, int i6, Bundle bundle) {
    }

    public void onActivityResized(@Dimension(unit = 1) int i2, @Dimension(unit = 1) int i3, Bundle bundle) {
    }
