...
public final class PrefetchOptions {
    ...
    public static final class Builder {
        ...
        public Builder setRequiresAnonymousIpWhenCrossOrigin(boolean z2) {
            this.mRequiresAnonymousIpWhenCrossOrigin = z2;
            return this;
        }
    ...
    public PrefetchOptions(boolean z2, Uri uri) {
        this.requiresAnonymousIpWhenCrossOrigin = z2;
