...
public abstract class CustomTabsService extends Service {
    ...
    public class AnonymousClass1 extends ICustomTabsService.Stub {
        ...
        public void prefetch(ICustomTabsCallback iCustomTabsCallback, Uri uri, Bundle bundle) {
            CustomTabsService.this.prefetch(new CustomTabsSessionToken(iCustomTabsCallback, getSessionIdFromBundle(bundle)), h.a(new Object[]{uri}), PrefetchOptions.fromBundle(bundle));
        }
    ...
    public abstract boolean receiveFile(CustomTabsSessionToken customTabsSessionToken, Uri uri, int i2, Bundle bundle);
