...
public final class SQLiteCopyOpenHelper implements SupportSQLiteOpenHelper, DelegatingOpenHelper {
    ...
    private final void copyDatabaseFile(File destinationFile, boolean writable) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        if (this.copyFromAssetPath != null) {
            ...
            kotlin.jvm.internal.j.d(readableByteChannelNewChannel, "newChannel(context.assets.open(copyFromAssetPath))");
        } else if (this.copyFromFile != null) {
            readableByteChannelNewChannel = new FileInputStream(this.copyFromFile).getChannel();
            kotlin.jvm.internal.j.d(readableByteChannelNewChannel, "FileInputStream(copyFromFile).channel");
        } else {
            ...
            try {
                ...
                kotlin.jvm.internal.j.d(readableByteChannelNewChannel, "newChannel(inputStream)");
            } catch (Exception e2) {
    ...
    private final SupportSQLiteOpenHelper createFrameworkOpenHelper(File databaseFile) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException {
        try {
            ...
            final int iB = E1.f.b(version, 1);
            return frameworkSQLiteOpenHelperFactory.create(builderName.callback(new SupportSQLiteOpenHelper.Callback(iB) { // from class: androidx.room.SQLiteCopyOpenHelper$createFrameworkOpenHelper$configuration$1
    ...
    private final void dispatchOnOpenPrepackagedDatabase(File databaseFile, boolean writable) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        DatabaseConfiguration databaseConfiguration = this.databaseConfiguration;
        if (databaseConfiguration == null) {
            kotlin.jvm.internal.j.u("databaseConfiguration");
        ...
        try {
            ...
            kotlin.jvm.internal.j.b(prepackagedDatabaseCallback);
            prepackagedDatabaseCallback.onOpenPrepackagedDatabase(writableDatabase);
            kotlin.j jVar = kotlin.j.f51397a;
            kotlin.io.a.a(supportSQLiteOpenHelperCreateFrameworkOpenHelper, null);
        } finally {
        }
    }
    ...
    private final void verifyDatabaseFile(boolean writable) throws IOException {
        ...
        boolean z2 = databaseConfiguration.multiInstanceInvalidation;
        File filesDir = this.context.getFilesDir();
        kotlin.jvm.internal.j.d(filesDir, "context.filesDir");
        ProcessLock processLock = new ProcessLock(name, filesDir, z2);
        try {
