...
public final class ViewInfo {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final ViewInfo read(@NotNull SupportSQLiteDatabase database, @NotNull String viewName) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
            ViewInfo viewInfo;
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (j.a(this.name, viewInfo.name)) {
            String str = this.sql;
