...
public final class TableInfo {
    ...
    public TableInfo(@NotNull String name, @NotNull Map<String, Column> columns, @NotNull Set<ForeignKey> foreignKeys) {
        this(name, columns, foreignKeys, J.e());
        j.e(name, "name");
        j.e(columns, "columns");
        j.e(foreignKeys, "foreignKeys");
    }
    ...
    public static final class Column {
        ...
        public static final class Companion {
            ...
            private final boolean containsSurroundingParenthesis(String current) {
                ...
                while (i2 < current.length()) {
                    char cCharAt = current.charAt(i2);
                    int i5 = i4 + 1;
                    if (i4 == 0 && cCharAt != '(') {
                        return false;
                    }
            ...
            public final boolean defaultValueEquals(@NotNull String current, @Nullable String other) {
                ...
                return j.a(B.B0(strSubstring).toString(), other);
            }
        ...
        private final int findAffinity(String type) {
            ...
            if (B.M(upperCase, "INT", false, 2, null)) {
                return 3;
            }
            if (B.M(upperCase, "CHAR", false, 2, null) || B.M(upperCase, "CLOB", false, 2, null) || B.M(upperCase, "TEXT", false, 2, null)) {
                return 2;
            }
            if (B.M(upperCase, "BLOB", false, 2, null)) {
                return 5;
            }
            return (B.M(upperCase, "REAL", false, 2, null) || B.M(upperCase, "FLOA", false, 2, null) || B.M(upperCase, "DOUB", false, 2, null)) ? 4 : 1;
        }
        ...
        public boolean equals(@Nullable Object other) {
            ...
            return (i2 == 0 || i2 != column.createdFrom || ((str = this.defaultValue) == null ? column.defaultValue == null : INSTANCE.defaultValueEquals(str, column.defaultValue))) && this.affinity == column.affinity;
        }
        ...
        public Column(@NotNull String name, @NotNull String type, boolean z2, int i2) {
    ...
    public static final class Index {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            if (this.unique == index.unique && j.a(this.columns, index.columns) && j.a(this.orders, index.orders)) {
                return z.H(this.name, DEFAULT_PREFIX, false, 2, null) ? z.H(index.name, DEFAULT_PREFIX, false, 2, null) : j.a(this.name, index.name);
            }
            return false;
        }

        public int hashCode() {
            return ((((((z.H(this.name, DEFAULT_PREFIX, false, 2, null) ? -1184239155 : this.name.hashCode()) * 31) + (this.unique ? 1 : 0)) * 31) + this.columns.hashCode()) * 31) + this.orders.hashCode();
        }
        ...
        public Index(@NotNull String name, boolean z2, @NotNull List<String> columns) {
            j.e(name, "name");
            j.e(columns, "columns");
            int size = columns.size();
