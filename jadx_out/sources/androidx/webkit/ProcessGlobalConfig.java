...
public class ProcessGlobalConfig {
    ...
    public static void apply(ProcessGlobalConfig processGlobalConfig) {
        ...
        int i2 = processGlobalConfig.mUiThreadStartupMode;
        if (i2 != -1) {
            map.put(ProcessGlobalConfigConstants.UI_THREAD_STARTUP_MODE, Integer.valueOf(i2));
        }
        if (!AbstractC1061g.a(sProcessGlobalConfig, null, map)) {
    ...
    @WebViewCompat.ExperimentalAsyncStartUp
    @Deprecated
    public ProcessGlobalConfig setUiThreadStartupMode(Context context, int i2) {
        StartupApiFeature.NoFramework noFramework = WebViewFeatureInternal.STARTUP_FEATURE_SET_UI_THREAD_STARTUP_MODE;
        if (i2 == 4 || !noFramework.isSupported(context)) {
            throw WebViewFeatureInternal.getUnsupportedOperationException();
        }
        this.mUiThreadStartupMode = i2;
        return this;
    }

    @WebViewCompat.ExperimentalAsyncStartUp
    public ProcessGlobalConfig setUiThreadStartupModeV2(Context context, int i2) {
