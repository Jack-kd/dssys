...
public class WebViewCompat {
    ...
    public static /* synthetic */ void b(WebViewStartUpConfig webViewStartUpConfig, final WebViewStartUpCallback webViewStartUpCallback, Context context) {
    ...
    @UiThread
    public static void postVisualStateCallback(WebView webView, long j2, final VisualStateCallback visualStateCallback) {
        webView.postVisualStateCallback(j2, new WebView.VisualStateCallback() { // from class: androidx.webkit.WebViewCompat.1
    ...
    @UiThread
    public static void saveState(WebView webView, Bundle bundle, @IntRange(from = 1) int i2, boolean z2) {
    ...
    public static void startUpWebView(final Context context, final WebViewStartUpConfig webViewStartUpConfig, final WebViewStartUpCallback webViewStartUpCallback) {
        webViewStartUpConfig.getBackgroundExecutor().execute(new Runnable() { // from class: androidx.webkit.e
            @Override // java.lang.Runnable
            public final void run() {
                WebViewCompat.b(webViewStartUpConfig, webViewStartUpCallback, context);
            }
        });
    }
    ...
    public static void addNavigationListener(WebView webView, NavigationListener navigationListener) {
        addNavigationListener(webView, new androidx.browser.customtabs.f(new Handler(Looper.getMainLooper())), navigationListener);
    }
