...
public class SpeculativeLoadingConfig {
    ...
    public static final class Builder {
        ...
        public Builder setMaxPrefetches(@IntRange(from = 1) int i2) {
            if (i2 < 1) {
        ...
        public Builder setMaxPrerenders(@IntRange(from = 1) int i2) {
            if (i2 < 1) {
        ...
        public Builder setPrefetchTtlSeconds(@IntRange(from = 1) int i2) {
            if (i2 <= 0) {
