...
public final class UserAgentMetadata {
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    private UserAgentMetadata(List<BrandVersion> list, String str, String str2, String str3, String str4, String str5, boolean z2, int i2, boolean z3, List<String> list2) {
