...
public class ApiHelperForP {
    ...
    public static void start(TracingController tracingController, TracingConfig tracingConfig) {
        tracingController.start(AbstractC1089n.a().addCategories(tracingConfig.getPredefinedCategories()).addCategories((Collection<String>) tracingConfig.getCustomIncludedCategories()).setTracingMode(tracingConfig.getTracingMode()).build());
    }
