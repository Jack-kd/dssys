...
public final class URLUtilCompat {
    ...
    private static String encodePlusCharacters(String str, String str2) {
        ...
        for (byte b3 : charsetForName.encode("+").array()) {
    ...
    public static String getFilenameFromContentDisposition(String str) {
        ...
        while (matcher.find()) {
            ...
            if (strGroup != null && strRemoveSlashEscapes != null) {
                ...
                } else if (com.sigmob.sdk.downloader.core.breakpoint.f.f37327e.equalsIgnoreCase(strGroup)) {
    ...
    public static String guessFileName(String str, String str2, String str3) {
        ...
        if (strReplacePathSeparators.indexOf(46) >= 0 && !extensionDifferentFromMimeType(strReplacePathSeparators, str3)) {
            return strReplacePathSeparators;
        }
        return strReplacePathSeparators + suggestExtensionFromMimeType(str3);
    }
    ...
    private static String replacePathSeparators(String str) {
        return str.replaceAll(ServiceReference.DELIMITER, "_");
    }
    ...
    private static String suggestExtensionFromMimeType(String str) {
        ...
        return i.f2495E + extensionFromMimeType;
    }
}
