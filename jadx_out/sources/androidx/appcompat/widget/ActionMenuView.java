    ...
    private void onMeasureExactFormat(int i2, int i3) {
            ...
            while (i24 < childCount) {
                ...
                if ((j4 & j5) == 0) {
                    ...
                    if (!z9 || !layoutParams3.preventEdgeOffset) {
                        ...
                        z2 = true;
                        i5 = i24;
                        childAt2.setPadding(i25 + i18, 0, i25, 0);
                    } else {
                        i5 = i24;
                        z2 = true;
                    }
        ...
        if (i9 <= 0 || j3 == 0 || (i9 >= i13 - 1 && !z10 && iMax2 <= 1)) {
            ...
            if (z10) {
                ...
                if ((j3 & (1 << i26)) != 0 && !((LayoutParams) getChildAt(i26).getLayoutParams()).preventEdgeOffset) {
                    fBitCount -= 0.5f;
                }
            }
            int i27 = fBitCount > 0.0f ? (int) ((i9 * i18) / fBitCount) : i4;
            boolean z11 = z7;
        ...
        if (z7) {
            for (int i29 = i4; i29 < childCount; i29++) {
                ...
                if (layoutParams5.expanded) {
                    childAt4.measure(View.MeasureSpec.makeMeasureSpec((layoutParams5.cellsUsed * i18) + layoutParams5.extraPixels, C.ENCODING_PCM_32BIT), childMeasureSpec);
                }
            }
        }
        setMeasuredDimension(i7, mode != 1073741824 ? iMax : i17);
    }
