...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
    ...
    public class TabView extends LinearLayout {
        ...
        public void onMeasure(int i2, int i3) {
            ...
            if (ScrollingTabContainerView.this.mMaxTabWidth > 0) {
                ...
                if (measuredWidth > i4) {
                    super.onMeasure(View.MeasureSpec.makeMeasureSpec(i4, C.ENCODING_PCM_32BIT), i3);
                }
            }
        }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(this.mContentHeight, C.ENCODING_PCM_32BIT);
