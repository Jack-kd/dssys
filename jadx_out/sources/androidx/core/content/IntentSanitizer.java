...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAnyComponent() {
            ...
            this.mAllowedComponents = new Predicate() { // from class: androidx.core.content.k
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowClipDataUriWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            return allowClipDataUri(new Predicate() { // from class: androidx.core.content.l
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowComponentWithPackage(final String str) {
            Preconditions.checkNotNull(str);
            return allowComponent(new Predicate() { // from class: androidx.core.content.g
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowDataWithAuthority(final String str) {
            Preconditions.checkNotNull(str);
            allowData(new Predicate() { // from class: androidx.core.content.h
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return str.equals(((Uri) obj).getAuthority());
                }
        ...
        public Builder allowExtra(String str, Class<?> cls) {
            return allowExtra(str, cls, new Predicate() { // from class: androidx.core.content.w
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
        ...
        public Builder allowExtraOutput(final String str) {
            allowExtra("output", Uri.class, new Predicate() { // from class: androidx.core.content.e
                @Override // androidx.core.util.Predicate
                public final boolean test(Object obj) {
                    return str.equals(((Uri) obj).getAuthority());
                }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            if (predicate2 == null) {
                predicate2 = new Predicate() { // from class: androidx.core.content.m
                    @Override // androidx.core.util.Predicate
                    public final boolean test(Object obj) {
    ...
    */
    ...
    public Intent sanitizeByFiltering(Intent intent) {
        return sanitize(intent, new Consumer() { // from class: androidx.core.content.d
