...
public class ShortcutInfoCompat {
            ...
            if (this.mCapabilityBindingParams != null) {
                ...
                for (String str : this.mCapabilityBindingParams.keySet()) {
                    ...
                    for (String str2 : map.keySet()) {
                        ...
                        this.mInfo.mExtras.putStringArray(str + ServiceReference.DELIMITER + str2, list == null ? new String[0] : (String[]) list.toArray(new String[0]));
                    }
                }
            }
    ...
    public static List<ShortcutInfoCompat> fromShortcuts(Context context, List<ShortcutInfo> list) {
        ...
        while (it.hasNext()) {
            arrayList.add(new Builder(context, AbstractC0910f.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public ShortcutInfo toShortcutInfo() {
        AbstractC0914j.a();
        ShortcutInfo.Builder intents = AbstractC0913i.a(this.mContext, this.mId).setShortLabel(this.mLabel).setIntents(this.mIntents);
