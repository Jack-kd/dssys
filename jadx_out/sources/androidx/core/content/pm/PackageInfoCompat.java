...
public final class PackageInfoCompat {
    ...
    public static boolean hasSignatures(PackageManager packageManager, String str, @Size(min = 1) Map<byte[], Integer> map, boolean z2) throws PackageManager.NameNotFoundException {
        byte[][] bArr;
        if (map.isEmpty()) {
            return false;
        }
