...
public class ShortcutManagerCompat {
    ...
    public static Intent createShortcutResultIntent(Context context, ShortcutInfoCompat shortcutInfoCompat) {
        Intent intentCreateShortcutResultIntent = Build.VERSION.SDK_INT >= 26 ? Y.a(context.getSystemService(M.a())).createShortcutResultIntent(shortcutInfoCompat.toShortcutInfo()) : null;
    ...
    public static List<ShortcutInfoCompat> getDynamicShortcuts(Context context) {
        ...
        List dynamicShortcuts = Y.a(context.getSystemService(M.a())).getDynamicShortcuts();
        ArrayList arrayList = new ArrayList(dynamicShortcuts.size());
        Iterator it = dynamicShortcuts.iterator();
        while (it.hasNext()) {
            arrayList.add(new ShortcutInfoCompat.Builder(context, AbstractC0910f.a(it.next())).build());
        }
        return arrayList;
    }
    ...
    public static int getIconMaxHeight(Context context) {
        ...
        return Build.VERSION.SDK_INT >= 25 ? Y.a(context.getSystemService(M.a())).getIconMaxHeight() : getIconDimensionInternal(context, false);
    }

    public static int getIconMaxWidth(Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? Y.a(context.getSystemService(M.a())).getIconMaxWidth() : getIconDimensionInternal(context, true);
    }
    ...
    public static List<ShortcutInfoCompat> getShortcuts(Context context, int i2) {
        ...
        if (i3 >= 30) {
            return ShortcutInfoCompat.fromShortcuts(context, Y.a(context.getSystemService(M.a())).getShortcuts(i2));
        }
        if (i3 < 25) {
            if ((i2 & 2) != 0) {
                try {
        ...
        ShortcutManager shortcutManagerA = Y.a(context.getSystemService(M.a()));
        ArrayList arrayList = new ArrayList();
        if ((i2 & 1) != 0) {
    ...
    public static boolean isRateLimitingActive(Context context) {
        Preconditions.checkNotNull(context);
        return Build.VERSION.SDK_INT >= 25 ? Y.a(context.getSystemService(M.a())).isRateLimitingActive() : getShortcuts(context, 3).size() == getMaxShortcutCountPerActivity(context);
    }

    public static boolean isRequestPinShortcutSupported(Context context) {
        if (Build.VERSION.SDK_INT >= 26) {
            return Y.a(context.getSystemService(M.a())).isRequestPinShortcutSupported();
        }
