...
public class CamColor {
    ...
    public static void fromColorInViewingConditions(@ColorInt int i2, ViewingConditions viewingConditions, @Size(7) float[] fArr, @Size(MediaDescriptionCompat.BT_FOLDER_TYPE_ARTISTS) float[] fArr2) {
    ...
    public static void getM3HCTfromColor(@ColorInt int i2, @Size(MediaDescriptionCompat.BT_FOLDER_TYPE_ARTISTS) float[] fArr) {
    ...
    @ColorInt
    public static int toColor(@FloatRange(from = 0.0d, to = 360.0d) float f2, @FloatRange(from = 0.0d, to = Double.POSITIVE_INFINITY, toInclusive = false) float f3, @FloatRange(from = 0.0d, to = 100.0d) float f4, ViewingConditions viewingConditions) {
