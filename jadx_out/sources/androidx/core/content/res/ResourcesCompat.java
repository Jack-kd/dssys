...
public final class ResourcesCompat {
    ...
    public static abstract class FontCallback {
        ...
        public final void callbackFailAsync(final int i2, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.e
                ...
                public final void run() {
                    this.f854b.onFontRetrievalFailed(i2);
                }
            });
        }
        ...
        public final void callbackSuccessAsync(final Typeface typeface, Handler handler) {
            getHandler(handler).post(new Runnable() { // from class: androidx.core.content.res.d
                @Override // java.lang.Runnable
                public final void run() {
                    this.f852b.onFontRetrieved(typeface);
                }
            });
        }
    ...
    */
    ...
    public static Typeface getCachedFont(Context context, @FontRes int i2) throws Resources.NotFoundException {
    ...
    @ColorInt
    public static int getColor(Resources resources, @ColorRes int i2, Resources.Theme theme) throws Resources.NotFoundException {
        return resources.getColor(i2, theme);
    }

    public static ColorStateList getColorStateList(Resources resources, @ColorRes int i2, Resources.Theme theme) throws Resources.NotFoundException {
    ...
    public static Drawable getDrawable(Resources resources, @DrawableRes int i2, Resources.Theme theme) throws Resources.NotFoundException {
        return resources.getDrawable(i2, theme);
    }

    public static Drawable getDrawableForDensity(Resources resources, @DrawableRes int i2, int i3, Resources.Theme theme) throws Resources.NotFoundException {
        return resources.getDrawableForDensity(i2, i3, theme);
    }

    public static float getFloat(Resources resources, @DimenRes int i2) throws Resources.NotFoundException {
        if (Build.VERSION.SDK_INT >= 29) {
    ...
    public static Typeface getFont(Context context, @FontRes int i2) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
    ...
    private static boolean isColorInt(Resources resources, @ColorRes int i2) throws Resources.NotFoundException {
        TypedValue typedValue = getTypedValue();
        resources.getValue(i2, typedValue, true);
    ...
    private static Typeface loadFont(Context context, int i2, TypedValue typedValue, int i3, FontCallback fontCallback, Handler handler, boolean z2, boolean z3) throws Resources.NotFoundException {
    ...
    public static void getFont(Context context, @FontRes int i2, FontCallback fontCallback, Handler handler) throws Resources.NotFoundException {
    ...
    */
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP_PREFIX})
    public static Typeface getFont(Context context, @FontRes int i2, TypedValue typedValue, int i3, FontCallback fontCallback) throws Resources.NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
