...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    */
    ...
    public boolean executeKeyEvent(KeyEvent keyEvent) {
        ...
        int i2 = MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE;
        if (!zCanScroll) {
            if (isFocused() && keyEvent.getKeyCode() != 4) {
                ...
                if (viewFindNextFocus != null && viewFindNextFocus != this && viewFindNextFocus.requestFocus(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE)) {
                    return true;
                }
            }
            return false;
        ...
        if (keyEvent.getAction() == 0) {
            ...
            if (keyCode == 20) {
                return keyEvent.isAltPressed() ? fullScroll(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE) : arrowScroll(MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE);
            }
            if (keyCode == 62) {
    ...
    */
    ...
    public void onMeasure(int i2, int i3) {
        ...
        if (this.mFillViewport && View.MeasureSpec.getMode(i3) != 0 && getChildCount() > 0) {
            ...
            if (measuredHeight < measuredHeight2) {
                childAt.measure(ViewGroup.getChildMeasureSpec(i2, getPaddingLeft() + getPaddingRight() + layoutParams.leftMargin + layoutParams.rightMargin, layoutParams.width), View.MeasureSpec.makeMeasureSpec(measuredHeight2, C.ENCODING_PCM_32BIT));
            }
        }
    }
    ...
    public boolean onRequestFocusInDescendants(int i2, Rect rect) {
        if (i2 == 2) {
            i2 = MediaPlayer.MEDIA_PLAYER_OPTION_DEFAULT_VIDEO_BITRATE;
        } else if (i2 == 1) {
            i2 = 33;
        }
            ...
            if (actionMasked == 2) {
                ...
                if (iFindPointerIndex == -1) {
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        nestedScrollView.mLastMotionY = y2 - iScrollBy;
