...
public interface AconfigPackageCompat {
    ...
    public static final class Companion {
        ...
        @JvmStatic
        @NotNull
        public final AconfigPackageCompat load(@NotNull String packageName) throws AconfigStorageReadException {
    ...
    @JvmStatic
    @NotNull
    static AconfigPackageCompat load(@NotNull String str) throws AconfigStorageReadException {
        return INSTANCE.load(str);
    }

    boolean getBooleanFlagValue(@NotNull String flagName, boolean defaultValue);
}
