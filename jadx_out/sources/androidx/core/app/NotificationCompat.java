...
public class NotificationCompat {
    ...
    public static class Builder {
        ...
        public Builder(Context context, Notification notification) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && (parcelableArrayList = notification.extras.getParcelableArrayList(NotificationCompat.EXTRA_PEOPLE_LIST)) != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i2 < size) {
                    ...
                    i2++;
                    addPerson(Person.fromAndroidPerson(o.a(obj)));
                }
            }
            ...
            if (i3 < 36 || !bundle.containsKey(NotificationCompat.EXTRA_SHORT_CRITICAL_TEXT)) {
                return;
            }
        ...
        public Builder setRequestPromotedOngoing(boolean z2) {
            getExtras().putBoolean(NotificationCompat.EXTRA_REQUEST_PROMOTED_ONGOING, z2);
            return this;
        }
        ...
        public Builder setSound(Uri uri, int i2) {
            ...
            AudioAttributes.Builder legacyStreamType = new AudioAttributes.Builder().setContentType(4).setLegacyStreamType(i2);
    ...
    public static class CallStyle extends Style {
        ...
        public ArrayList<Action> getActionsListWithSystemActions() {
            ...
            if (arrayList2 != null) {
                ...
                while (i3 < size) {
                    ...
                    } else if (!isActionAddedByCallStyle(action2)) {
                        arrayList.add(action2);
                        i2--;
                    }
        ...
        public void restoreFromCompatExtras(Bundle bundle) {
            ...
            if (Build.VERSION.SDK_INT >= 28 && bundle.containsKey(NotificationCompat.EXTRA_CALL_PERSON)) {
                this.mPerson = Person.fromAndroidPerson(o.a(bundle.getParcelable(NotificationCompat.EXTRA_CALL_PERSON)));
    ...
    public static class ProgressStyle extends Style {
        ...
        public static final class Api36Impl {
            ...
            @RequiresApi(36)
            public static void setProgress(Notification.ProgressStyle progressStyle, int i2) {
                progressStyle.setProgress(i2);
            }
            ...
            @RequiresApi(36)
            public static void setProgressIndeterminate(Notification.ProgressStyle progressStyle, boolean z2) {
                progressStyle.setProgressIndeterminate(z2);
            }
            ...
            @RequiresApi(36)
            public static void setStyledByProgress(Notification.ProgressStyle progressStyle, boolean z2) {
                progressStyle.setStyledByProgress(z2);
            }
        }
        ...
        public static final class Point {
            ...
            public Point(@IntRange(from = 1) int i2) {
                this.mPosition = i2;
            }
            ...
            public Point setColor(@ColorInt int i2) {
                this.mColor = i2;
                return this;
            }

            public Point setId(int i2) {
                this.mId = i2;
                return this;
            }
        }
        ...
        public static final class Segment {
            ...
            public Segment(@IntRange(from = 1) int i2) {
                this.mLength = i2;
            }
            ...
            public Segment setColor(@ColorInt int i2) {
                this.mColor = i2;
                return this;
            }

            public Segment setId(int i2) {
                this.mId = i2;
                return this;
            }
        }
        ...
        private static List<Point> getProgressPointsFromBundleList(List<Bundle> list) {
            ...
            if (list != null && !list.isEmpty()) {
                for (int i2 = 0; i2 < list.size(); i2++) {
                    ...
                    int i3 = bundle.getInt(KEY_POINT_POSITION);
                    if (i3 >= 0) {
                        arrayList.add(new Point(i3).setId(bundle.getInt("id")).setColor(bundle.getInt(KEY_ELEMENT_COLOR, 0)));
                    }
                }
            }
            return arrayList;
        ...
        private static List<Segment> getProgressSegmentsFromBundleList(List<Bundle> list) {
            ...
            if (list != null && !list.isEmpty()) {
                for (int i2 = 0; i2 < list.size(); i2++) {
                    Bundle bundle = list.get(i2);
                    int i3 = bundle.getInt(KEY_SEGMENT_LENGTH);
                    if (i3 > 0) {
                        arrayList.add(new Segment(i3).setId(bundle.getInt("id")).setColor(bundle.getInt(KEY_ELEMENT_COLOR, 0)));
                    }
                }
            }
            return arrayList;
        ...
        public void apply(NotificationBuilderWithBuilderAccessor notificationBuilderWithBuilderAccessor) {
            ...
            Notification.ProgressStyle progressStyleA = q.a();
            ...
            Api36Impl.setProgressPoints(progressStyleA, this.mProgressPoints);
        ...
        public ProgressStyle setProgress(@IntRange(from = 0) int i2) {
            this.mProgress = i2;
            return this;
        }
        ...
        public ProgressStyle setProgressIndeterminate(boolean z2) {
        ...
        public ProgressStyle setStyledByProgress(boolean z2) {
            this.mIsStyledByProgress = z2;
            return this;
        }
    }
    ...
    public static abstract class Style {
        ...
        private static Style constructCompatStyleByPlatformName(String str) {
            ...
            if (Build.VERSION.SDK_INT >= 36 && str.equals(r.a().getName())) {
                return new ProgressStyle();
            }
    ...
    public static Action getActionCompatFromAction(Notification.Action action) {
        ...
        if (remoteInputs == null) {
            ...
            for (int i3 = 0; i3 < remoteInputs.length; i3++) {
                ...
                remoteInputArr2[i3] = new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, remoteInput.getExtras(), null);
            }
            remoteInputArr = remoteInputArr2;
        }
        int i4 = Build.VERSION.SDK_INT;
        boolean z2 = action.getExtras().getBoolean("android.support.allowGeneratedReplies") || Api24Impl.getAllowGeneratedReplies(action);
        boolean z3 = action.getExtras().getBoolean("android.support.action.showsUserInterface", true);
        int semanticAction = i4 >= 28 ? Api28Impl.getSemanticAction(action) : action.getExtras().getInt("android.support.action.semanticAction", 0);
        ...
        if (action.getIcon() != null || (i2 = action.icon) == 0) {
            return new Action(action.getIcon() != null ? IconCompat.createFromIconOrNullIfZeroResId(action.getIcon()) : null, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, zIsContextual, zIsAuthenticationRequired);
        }
        return new Action(i2, action.title, action.actionIntent, action.getExtras(), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, zIsContextual, zIsAuthenticationRequired);
    }
        ...
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            if (parcelableArrayList != null && !parcelableArrayList.isEmpty()) {
                ...
                while (i2 < size) {
                    Object obj = parcelableArrayList.get(i2);
                    i2++;
                    arrayList.add(Person.fromAndroidPerson(o.a(obj)));
                }
            }
        } else {
    ...
    public static boolean isSilent(Notification notification) {
        if (Build.VERSION.SDK_INT < 26) {
            ...
            return (i2 & 1) == 0 && (i2 & 2) == 0 && notification.vibrate == null && notification.sound == null;
        }
        if ("silent".equals(notification.getGroup())) {
            return true;
        }
    ...
    public static final class CarExtender implements Extender {
        ...
        private static UnreadConversation getUnreadConversationFromBundle(Bundle bundle) {
            ...
            return new UnreadConversation(strArr, remoteInput != null ? new RemoteInput(remoteInput.getResultKey(), remoteInput.getLabel(), remoteInput.getChoices(), remoteInput.getAllowFreeFormInput(), Build.VERSION.SDK_INT >= 29 ? Api29Impl.getEditChoicesBeforeSending(remoteInput) : 0, remoteInput.getExtras(), null) : null, pendingIntent2, pendingIntent, stringArray, bundle.getLong(KEY_TIMESTAMP));
        }
