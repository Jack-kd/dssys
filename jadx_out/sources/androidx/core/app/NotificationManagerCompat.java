...
public final class NotificationManagerCompat {
    ...
    public void deleteUnlistedNotificationChannels(Collection<String> collection) {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannel notificationChannelA = n.a(it.next());
                if (!collection.contains(Api26Impl.getId(notificationChannelA)) && (Build.VERSION.SDK_INT < 30 || !collection.contains(Api30Impl.getParentChannelId(notificationChannelA)))) {
                    Api26Impl.deleteNotificationChannel(this.mNotificationManager, Api26Impl.getId(notificationChannelA));
                }
            }
        }
    }
    ...
    public NotificationChannelGroup getNotificationChannelGroup(String str) {
        ...
        if (i2 >= 26) {
            ...
            while (it.hasNext()) {
                NotificationChannelGroup notificationChannelGroupA = s.a(it.next());
                if (Api26Impl.getId(notificationChannelGroupA).equals(str)) {
            ...
            if (!notificationChannelGroups.isEmpty()) {
                ...
                while (it.hasNext()) {
                    ...
                    if (Build.VERSION.SDK_INT >= 28) {
                        ...
                        arrayList.add(new NotificationChannelGroupCompat(notificationChannelGroupA, notificationChannels));
                    }
                }
                return arrayList;
            }
    ...
    public List<NotificationChannelCompat> getNotificationChannelsCompat() {
        if (Build.VERSION.SDK_INT >= 26) {
            ...
            if (!notificationChannels.isEmpty()) {
                ...
                while (it.hasNext()) {
                    arrayList.add(new NotificationChannelCompat(n.a(it.next())));
                }
                return arrayList;
            }
        }
