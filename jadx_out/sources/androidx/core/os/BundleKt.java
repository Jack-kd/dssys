        ...
        for (Pair<String, ? extends Object> pair : pairArr) {
            ...
            if (objComponent2 == null) {
                ...
                if (Parcelable.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.j.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<android.os.Parcelable>");
                    bundle.putParcelableArray(strComponent1, (Parcelable[]) objComponent2);
                } else if (String.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.j.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.String>");
                    bundle.putStringArray(strComponent1, (String[]) objComponent2);
                } else if (CharSequence.class.isAssignableFrom(componentType)) {
                    kotlin.jvm.internal.j.c(objComponent2, "null cannot be cast to non-null type kotlin.Array<kotlin.CharSequence>");
