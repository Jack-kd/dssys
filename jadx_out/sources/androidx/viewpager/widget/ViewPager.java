...
public class ViewPager extends ViewGroup {
    ...
    */
    ...
    public void onMeasure(int i2, int i3) throws Resources.NotFoundException {
        ...
        this.mChildWidthMeasureSpec = View.MeasureSpec.makeMeasureSpec(paddingLeft, C.ENCODING_PCM_32BIT);
        this.mChildHeightMeasureSpec = View.MeasureSpec.makeMeasureSpec(measuredHeight, C.ENCODING_PCM_32BIT);
        this.mInLayout = true;
        populate();
        ...
        for (int i13 = 0; i13 < childCount2; i13++) {
            ...
            if (childAt2.getVisibility() != 8 && ((layoutParams = (LayoutParams) childAt2.getLayoutParams()) == null || !layoutParams.isDecor)) {
                childAt2.measure(View.MeasureSpec.makeMeasureSpec((int) (paddingLeft * layoutParams.widthFactor), C.ENCODING_PCM_32BIT), this.mChildHeightMeasureSpec);
            }
        }
    }
