...
public final class FragmentTransactionKt {
    public static final /* synthetic */ <F extends Fragment> FragmentTransaction add(FragmentTransaction fragmentTransaction, @IdRes int i2, String str, Bundle bundle) {
        kotlin.jvm.internal.j.e(fragmentTransaction, "<this>");
        kotlin.jvm.internal.j.k(4, "F");
        FragmentTransaction fragmentTransactionAdd = fragmentTransaction.add(i2, Fragment.class, bundle, str);
        kotlin.jvm.internal.j.d(fragmentTransactionAdd, "add(containerViewId, F::class.java, args, tag)");
    ...
    public static final /* synthetic */ <F extends Fragment> FragmentTransaction replace(FragmentTransaction fragmentTransaction, @IdRes int i2, String str, Bundle bundle) {
        ...
        kotlin.jvm.internal.j.d(fragmentTransactionReplace, "replace(containerViewId, F::class.java, args, tag)");
    ...
    public static final /* synthetic */ <F extends Fragment> FragmentTransaction add(FragmentTransaction fragmentTransaction, String tag, Bundle bundle) {
        ...
        kotlin.jvm.internal.j.d(fragmentTransactionAdd, "add(F::class.java, args, tag)");
        return fragmentTransactionAdd;
    }
