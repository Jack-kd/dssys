...
public class SlidingPaneLayout extends ViewGroup implements Openable {
    ...
    private static int measureChildHeight(@NonNull View view, int i2, int i3) {
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        return (((ViewGroup.MarginLayoutParams) layoutParams).width != 0 || layoutParams.weight <= 0.0f) ? View.MeasureSpec.makeMeasureSpec(view.getMeasuredHeight(), C.ENCODING_PCM_32BIT) : ViewGroup.getChildMeasureSpec(i2, i3, ((ViewGroup.MarginLayoutParams) layoutParams).height);
    }
    ...
    public void onMeasure(int i2, int i3) {
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                i5 = i6;
                childAt.measure(i9 == -2 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode == 0 ? mode : Integer.MIN_VALUE) : i9 == -1 ? View.MeasureSpec.makeMeasureSpec(iMax3, mode) : View.MeasureSpec.makeMeasureSpec(i9, C.ENCODING_PCM_32BIT), ViewGroup.getChildMeasureSpec(i3, getPaddingTop() + getPaddingBottom(), ((ViewGroup.MarginLayoutParams) layoutParams).height));
            ...
            while (i11 < childCount) {
                ...
                if (childAt2.getVisibility() != i4) {
                    ...
                    if (z2) {
                        ...
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, C.ENCODING_PCM_32BIT);
                    } else if (layoutParams2.weight > 0.0f) {
                        iMax = ((int) ((layoutParams2.weight * Math.max(0, i7)) / f2)) + measuredWidth2;
                        iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(iMax, C.ENCODING_PCM_32BIT);
                    } else {
                        iMax = measuredWidth2;
                        iMakeMeasureSpec = 0;
                    }
                    int iMeasureChildHeight = measureChildHeight(childAt2, i3, getPaddingTop() + getPaddingBottom());
        ...
        if (arrayListSplitViewPositions != null && !z2) {
            for (int i12 = 0; i12 < childCount; i12++) {
                ...
                if (childAt3.getVisibility() != 8) {
                    ...
                    int iMakeMeasureSpec2 = View.MeasureSpec.makeMeasureSpec(childAt3.getMeasuredHeight(), C.ENCODING_PCM_32BIT);
                    ...
                    if ((childAt3.getMeasuredWidthAndState() & 16777216) == 1 || (getMinimumWidth(childAt3) != 0 && rect.width() < getMinimumWidth(childAt3))) {
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(i10 - i13, C.ENCODING_PCM_32BIT), iMakeMeasureSpec2);
                        if (i12 != 0) {
                        ...
                        childAt3.measure(View.MeasureSpec.makeMeasureSpec(rect.width(), C.ENCODING_PCM_32BIT), iMakeMeasureSpec2);
                    }
                }
            }
        }
