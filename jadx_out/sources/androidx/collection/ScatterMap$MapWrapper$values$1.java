...
public final class ScatterMap$MapWrapper$values$1<V> implements Collection<V>, B1.a {
    ...
    public Iterator<V> iterator() {
        return kotlin.sequences.j.a(new ScatterMap$MapWrapper$values$1$iterator$1(this.this$0, null));
    }
