...
public abstract class FloatList {
    ...
    public final <R> R fold(R initial, @NotNull Function2<? super R, ? super Float, ? extends R> operation) {
        ...
        int i2 = this._size;
        for (int i3 = 0; i3 < i2; i3++) {
            initial = operation.invoke(initial, Float.valueOf(fArr[i3]));
        }
        return initial;
    }
    ...
    public final <R> R foldIndexed(R initial, @NotNull Function3<? super Integer, ? super R, ? super Float, ? extends R> operation) {
        ...
        for (int i3 = 0; i3 < i2; i3++) {
            R r2 = initial;
            initial = operation.invoke(Integer.valueOf(i3), r2, Float.valueOf(fArr[i3]));
        }
        return initial;
    }
    ...
    public final <R> R foldRight(R initial, @NotNull Function2<? super Float, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            initial = operation.invoke(Float.valueOf(fArr[i2]), initial);
        }
    }
    ...
    public final <R> R foldRightIndexed(R initial, @NotNull Function3<? super Integer, ? super Float, ? super R, ? extends R> operation) {
        ...
        while (true) {
            ...
            initial = operation.invoke(Integer.valueOf(i2), Float.valueOf(fArr[i2]), initial);
        }
    }
    ...
    public final void forEachIndexed(@NotNull Function2<? super Integer, ? super Float, kotlin.j> block) {
        j.e(block, "block");
        float[] fArr = this.content;
        int i2 = this._size;
        for (int i3 = 0; i3 < i2; i3++) {
    ...
    public final void forEachReversed(@NotNull Function1<? super Float, kotlin.j> block) {
        j.e(block, "block");
        float[] fArr = this.content;
        int i2 = this._size;
        while (true) {
    ...
    public final void forEachReversedIndexed(@NotNull Function2<? super Integer, ? super Float, kotlin.j> block) {
        j.e(block, "block");
        float[] fArr = this.content;
        int i2 = this._size;
        while (true) {
    ...
    public final int indexOfLast(@NotNull Function1<? super Float, Boolean> predicate) {
        ...
        } while (!predicate.invoke(Float.valueOf(fArr[i2])).booleanValue());
        return i2;
    }
