...
public final class MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1 extends RestrictedSuspendLambda implements Function2<i, e, Object> {
    int I$0;
    int I$1;
    int I$2;
    int I$3;
    ...
    public MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1(MutableScatterMap<K, V> mutableScatterMap, e eVar) {
        super(2, eVar);
    ...
    */
    ...
    public final Object invoke(@NotNull i iVar, @Nullable e eVar) {
        return ((MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1) create(iVar, eVar)).invokeSuspend(j.f51397a);
    }
}
