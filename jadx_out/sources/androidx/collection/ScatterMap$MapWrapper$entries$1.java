...
public final class ScatterMap$MapWrapper$entries$1<K, V> implements Set<Map.Entry<? extends K, ? extends V>>, B1.a {
    ...
    public boolean containsAll(@NotNull Collection<? extends Object> elements) {
        ...
        while (it.hasNext()) {
            ...
            if (!j.a(scatterMap.get(entry.getKey()), entry.getValue())) {
                return false;
            }
        }
        return true;
    ...
    public Iterator<Map.Entry<K, V>> iterator() {
        return kotlin.sequences.j.a(new ScatterMap$MapWrapper$entries$1$iterator$1(this.this$0, null));
    }
