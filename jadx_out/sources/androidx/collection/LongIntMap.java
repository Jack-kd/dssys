...
public abstract class LongIntMap {
    ...
    public /* synthetic */ LongIntMap(kotlin.jvm.internal.f fVar) {
        this();
    }
    ...
    */
    ...
    public final void forEach(@NotNull Function2<? super Long, ? super Integer, kotlin.j> block) {
        j.e(block, "block");
        long[] jArr = this.keys;
        int[] iArr = this.values;
        long[] jArr2 = this.metadata;
    ...
    */
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i2, @NotNull Function2<? super Long, ? super Integer, ? extends CharSequence> transform) {
        int i3;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Long.valueOf(j3), Integer.valueOf(i10)));
                            i5++;
                        } else {
                            i3 = i6;
                        }
