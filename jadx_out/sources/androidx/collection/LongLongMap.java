...
public abstract class LongLongMap {
    ...
    public /* synthetic */ LongLongMap(kotlin.jvm.internal.f fVar) {
        this();
    }
    ...
    */
    ...
    public final void forEach(@NotNull Function2<? super Long, ? super Long, kotlin.j> block) {
        j.e(block, "block");
        long[] jArr = this.keys;
        long[] jArr2 = this.values;
        long[] jArr3 = this.metadata;
    ...
    */
    ...
    @JvmOverloads
    @NotNull
    public final String joinToString(@NotNull CharSequence charSequence, @NotNull CharSequence prefix, @NotNull CharSequence postfix, int i2, @NotNull Function2<? super Long, ? super Long, ? extends CharSequence> transform) {
        int i3;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i8 < i7) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(Long.valueOf(j3), Long.valueOf(j4)));
                            i5++;
                        } else {
                            i3 = i6;
                        }
