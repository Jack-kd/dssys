...
public abstract class ObjectLongMap<K> {
    ...
    public /* synthetic */ ObjectLongMap(kotlin.jvm.internal.f fVar) {
        this();
    }
    ...
    */
    ...
    public final void forEach(@NotNull Function2<? super K, ? super Long, kotlin.j> block) {
        j.e(block, "block");
        Object[] objArr = this.keys;
        long[] jArr = this.values;
        long[] jArr2 = this.metadata;
                ...
                if ((((~j2) << 7) & j2 & (-9187201950435737472L)) != -9187201950435737472L) {
                    ...
                    while (i6 < i5) {
                        if ((j2 & 255) < 128) {
                            ...
                            sb.append(transform.invoke(obj, Long.valueOf(j3)));
                            i3++;
                        } else {
                            objArr2 = objArr3;
                        }
