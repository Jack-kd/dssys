...
public abstract class AbstractResolvableFuture<V> implements M0.a {
    ...
    public static final class SetFuture<V> implements Runnable {
        ...
        public SetFuture(AbstractResolvableFuture<V> abstractResolvableFuture, M0.a aVar) {
    ...
    public static Object getFutureValue(M0.a aVar) {
    ...
    public final boolean cancel(boolean z2) {
        ...
        while (true) {
            if (ATOMIC_HELPER.casValue(abstractResolvableFuture, obj, cancellation)) {
                ...
                M0.a aVar = ((SetFuture) obj).future;
                if (!(aVar instanceof AbstractResolvableFuture)) {
                    aVar.cancel(z2);
                    break;
                }
    ...
    public boolean setFuture(M0.a aVar) {
        Failure failure;
        checkNotNull(aVar);
        Object obj = this.value;
        if (obj == null) {
