...
public final class Constraints {
    ...
    public static final class Builder {
        ...
        public final Constraints build() {
            Set setE0 = y.e0(this.contentUriTriggers);
            long j2 = this.triggerContentUpdateDelay;
            long j3 = this.triggerContentMaxDelay;
            return new Constraints(this.requiredNetworkType, this.requiresCharging, this.requiresDeviceIdle, this.requiresBatteryNotLow, this.requiresStorageNotLow, j2, j3, setE0);
        }
        ...
        public Builder(@NotNull Constraints constraints) {
            ...
            this.contentUriTriggers = y.d0(constraints.getContentUriTriggers());
        }
    }

    @Metadata(d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0007\n\u0002\u0010\b\n\u0000\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u0013\u0010\n\u001a\u00020\u00052\b\u0010\u000b\u001a\u0004\u0018\u00010\u0001H\u0096\u0002J\b\u0010\f\u001a\u00020\rH\u0016R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0004\u0010\u0007R\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\b\u0010\t¨\u0006\u000e"}, d2 = {"Landroidx/work/Constraints$ContentUriTrigger;", "", ContentProviderManager.PROVIDER_URI, "Landroid/net/Uri;", "isTriggeredForDescendants", "", "(Landroid/net/Uri;Z)V", "()Z", "getUri", "()Landroid/net/Uri;", "equals", "other", "hashCode", "", "work-runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class ContentUriTrigger {
        ...
        public boolean equals(@Nullable Object other) {
            ...
            if (!j.a(ContentUriTrigger.class, other != null ? other.getClass() : null)) {
                return false;
            }
            j.c(other, "null cannot be cast to non-null type androidx.work.Constraints.ContentUriTrigger");
    ...
    public /* synthetic */ Constraints(NetworkType networkType, boolean z2, boolean z3, boolean z4, int i2, f fVar) {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        if (other == null || !j.a(Constraints.class, other.getClass())) {
            return false;
        }
    ...
    public Constraints(@NotNull NetworkType requiredNetworkType, boolean z2, boolean z3, boolean z4) {
        ...
        j.e(requiredNetworkType, "requiredNetworkType");
    }
    ...
    /*  JADX ERROR: NullPointerException in pass: InitCodeVariables
        ...
        */
    public /* synthetic */ Constraints(androidx.work.NetworkType r2, boolean r3, boolean r4, boolean r5, boolean r6, int r7, kotlin.jvm.internal.f r8) {
        /*
            r1 = this;
            r8 = r7 & 1
            if (r8 == 0) goto L6
        ...
        L27:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.work.Constraints.<init>(androidx.work.NetworkType, boolean, boolean, boolean, boolean, int, kotlin.jvm.internal.f):void");
    }
    ...
    public Constraints(@NotNull NetworkType requiredNetworkType, boolean z2, boolean z3, boolean z4, boolean z5) {
        this(requiredNetworkType, z2, z3, z4, z5, -1L, 0L, null, MediaPlayer.MEDIA_PLAYER_OPTION_SET_KSY_FRAME_WAIT, null);
        j.e(requiredNetworkType, "requiredNetworkType");
    }

    public /* synthetic */ Constraints(NetworkType networkType, boolean z2, boolean z3, boolean z4, boolean z5, long j2, long j3, Set set, int i2, f fVar) {
        this((i2 & 1) != 0 ? NetworkType.NOT_REQUIRED : networkType, (i2 & 2) != 0 ? false : z2, (i2 & 4) != 0 ? false : z3, (i2 & 8) != 0 ? false : z4, (i2 & 16) != 0 ? false : z5, (i2 & 32) != 0 ? -1L : j2, (i2 & 64) != 0 ? -1L : j3, (i2 & 128) != 0 ? J.e() : set);
    }
    ...
    public Constraints(@NotNull NetworkType requiredNetworkType, boolean z2, boolean z3, boolean z4, boolean z5, long j2, long j3, @NotNull Set<ContentUriTrigger> contentUriTriggers) {
        j.e(requiredNetworkType, "requiredNetworkType");
        j.e(contentUriTriggers, "contentUriTriggers");
