...
public abstract class WorkManager {
    ...
    @NonNull
    public abstract M0.a getLastCancelAllTimeMillis();

    @NonNull
    public abstract LiveData<Long> getLastCancelAllTimeMillisLiveData();

    @NonNull
    public abstract M0.a getWorkInfoById(@NonNull UUID uuid);

    @NonNull
    public abstract InterfaceC1639c getWorkInfoByIdFlow(@NonNull UUID uuid);

    @NonNull
    public abstract LiveData<WorkInfo> getWorkInfoByIdLiveData(@NonNull UUID uuid);

    @NonNull
    public abstract M0.a getWorkInfos(@NonNull WorkQuery workQuery);

    @NonNull
    public abstract M0.a getWorkInfosByTag(@NonNull String str);

    @NonNull
    public abstract InterfaceC1639c getWorkInfosByTagFlow(@NonNull String str);

    @NonNull
    public abstract LiveData<List<WorkInfo>> getWorkInfosByTagLiveData(@NonNull String str);

    @NonNull
    public abstract InterfaceC1639c getWorkInfosFlow(@NonNull WorkQuery workQuery);

    @NonNull
    public abstract M0.a getWorkInfosForUniqueWork(@NonNull String str);

    @NonNull
    public abstract InterfaceC1639c getWorkInfosForUniqueWorkFlow(@NonNull String str);
    ...
    @NonNull
    public abstract M0.a updateWork(@NonNull WorkRequest workRequest);
