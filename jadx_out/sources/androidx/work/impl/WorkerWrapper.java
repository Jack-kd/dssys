...
public class WorkerWrapper implements Runnable {
    ...
    public static /* synthetic */ void a(WorkerWrapper workerWrapper, M0.a aVar) {
    ...
    private void runWorker() {
        ...
        try {
            ...
            final M0.a future = workForegroundRunnable.getFuture();
            this.mWorkerResultFuture.addListener(new Runnable() { // from class: androidx.work.impl.j
                @Override // java.lang.Runnable
                public final void run() {
                    WorkerWrapper.a(this.f1159b, future);
                }
                    ...
                    try {
                        try {
                            ...
                            if (result == null) {
                                ...
                                Logger.get().debug(WorkerWrapper.TAG, WorkerWrapper.this.mWorkSpec.workerClassName + " returned a " + result + com.anythink.core.common.d.i.f2495E);
