...
public class SystemForegroundDispatcher implements OnConstraintsStateChangedListener, ExecutionListener {
    ...
    final Map<WorkGenerationalId, InterfaceC1705u0> mTrackedWorkSpecs;
    ...
    public void onDestroy() {
        ...
        synchronized (this.mLock) {
            try {
                Iterator<InterfaceC1705u0> it = this.mTrackedWorkSpecs.values().iterator();
                while (it.hasNext()) {
                    it.next().a(null);
                }
            } catch (Throwable th) {
    ...
    public void onExecuted(@NonNull WorkGenerationalId workGenerationalId, boolean z2) {
        ...
        synchronized (this.mLock) {
            try {
                InterfaceC1705u0 interfaceC1705u0Remove = this.mWorkSpecById.remove(workGenerationalId) != null ? this.mTrackedWorkSpecs.remove(workGenerationalId) : null;
                if (interfaceC1705u0Remove != null) {
                    interfaceC1705u0Remove.a(null);
                }
            } catch (Throwable th) {
                throw th;
            }
