...
public final class IdGenerator {
    ...
    public final int nextAlarmManagerId() {
        Object objRunInTransaction = this.workDatabase.runInTransaction((Callable<Object>) new Callable() { // from class: androidx.work.impl.utils.e
            ...
            public final Object call() {
                return IdGenerator.nextAlarmManagerId$lambda$1(this.f1161a);
            }
        });
        j.d(objRunInTransaction, "workDatabase.runInTransa…ANAGER_ID_KEY)\n        })");
    ...
    public final int nextJobSchedulerIdWithRange(final int minInclusive, final int maxInclusive) {
        Object objRunInTransaction = this.workDatabase.runInTransaction((Callable<Object>) new Callable() { // from class: androidx.work.impl.utils.f
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return IdGenerator.nextJobSchedulerIdWithRange$lambda$0(this.f1162a, minInclusive, maxInclusive);
            }
        });
        j.d(objRunInTransaction, "workDatabase.runInTransa…            id\n        })");
        return ((Number) objRunInTransaction).intValue();
    }
}
