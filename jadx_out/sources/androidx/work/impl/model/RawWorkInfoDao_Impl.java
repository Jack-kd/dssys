...
public final class RawWorkInfoDao_Impl implements RawWorkInfoDao {
    ...
    public List<WorkSpec.WorkInfoPojo> getWorkInfoPojos(SupportSQLiteQuery supportSQLiteQuery) {
        ...
        try {
            ...
            while (cursorQuery.moveToNext()) {
                ...
                long j6 = columnIndex10 == -1 ? 0L : cursorQuery.getLong(columnIndex10);
                int i8 = i5;
                ...
                i6 = i10;
                int i12 = i3;
                long j7 = i12 == -1 ? 0L : cursorQuery.getLong(i12);
                i3 = i12;
                ...
                boolean z6 = z5;
                long j8 = i20 == -1 ? 0L : cursorQuery.getLong(i20);
                columnIndex20 = i20;
                int i21 = columnIndex21;
                long j9 = i21 != -1 ? cursorQuery.getLong(i21) : 0L;
                columnIndex21 = i21;
                ...
                Constraints constraints = new Constraints(networkTypeIntToNetworkType, z2, z3, z4, z6, j8, j10, setByteArrayToSetOfTriggers);
                ...
                arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, j2, j3, j4, constraints, i7, backoffPolicyIntToBackoffPolicy, j5, j6, i9, i11, j7, i14, arrayList2, arrayList3));
                columnIndex22 = i22;
            }
            cursorQuery.close();
            return arrayList;
    ...
    @Override // androidx.work.impl.model.RawWorkInfoDao
    public InterfaceC1639c getWorkInfoPojosFlow(final SupportSQLiteQuery supportSQLiteQuery) {
