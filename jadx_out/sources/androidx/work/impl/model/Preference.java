...
public final /* data */ class Preference {
    ...
    public Preference(@NotNull String key, @Nullable Long l2) {
        j.e(key, "key");
        this.key = key;
        this.value = l2;
    }
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return j.a(this.key, preference.key) && j.a(this.value, preference.value);
    }
    ...
    public Preference(@NotNull String key, boolean z2) {
