...
public final class WorkSpecDao_Impl implements WorkSpecDao {
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    boolean z2 = cursorQuery.getInt(i8) != 0;
                    ...
                    long j9 = cursorQuery.getLong(i14);
                    ...
                    boolean z6 = cursorQuery.getInt(i23) != 0;
                    ...
                    arrayList.add(new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j2, j3, j4, new Constraints(networkTypeIntToNetworkType, z3, z4, z5, z6, j10, j11, WorkTypeConverters.byteArrayToSetOfTriggers(cursorQuery.isNull(i26) ? null : cursorQuery.getBlob(i26))), i4, backoffPolicyIntToBackoffPolicy, j5, j6, j7, j8, z2, outOfQuotaPolicyIntToOutOfQuotaPolicy, i11, i13, j9, i16, i18));
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    boolean z2 = cursorQuery.getInt(i7) != 0;
                    ...
                    boolean z6 = cursorQuery.getInt(i22) != 0;
                    columnIndexOrThrow27 = i22;
                    int i23 = columnIndexOrThrow28;
                    long j10 = cursorQuery.getLong(i23);
                    columnIndexOrThrow28 = i23;
                    int i24 = columnIndexOrThrow29;
                    long j11 = cursorQuery.getLong(i24);
                    columnIndexOrThrow29 = i24;
                    int i25 = columnIndexOrThrow30;
                    columnIndexOrThrow30 = i25;
                    arrayList.add(new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j2, j3, j4, new Constraints(networkTypeIntToNetworkType, z3, z4, z5, z6, j10, j11, WorkTypeConverters.byteArrayToSetOfTriggers(cursorQuery.isNull(i25) ? null : cursorQuery.getBlob(i25))), i3, backoffPolicyIntToBackoffPolicy, j5, j6, j7, j8, z2, outOfQuotaPolicyIntToOutOfQuotaPolicy, i10, i12, j9, i15, i17));
    ...
    @Override // androidx.work.impl.model.WorkSpecDao
    public List<WorkSpec> getRecentlyCompletedWork(long j2) throws Throwable {
        RoomSQLiteQuery roomSQLiteQuery;
        ...
        try {
            ...
            try {
                ...
                while (cursorQuery.moveToNext()) {
                    ...
                    long j4 = cursorQuery.getLong(columnIndexOrThrow8);
                    long j5 = cursorQuery.getLong(columnIndexOrThrow9);
                    int i3 = cursorQuery.getInt(columnIndexOrThrow10);
                    BackoffPolicy backoffPolicyIntToBackoffPolicy = WorkTypeConverters.intToBackoffPolicy(cursorQuery.getInt(columnIndexOrThrow11));
                    long j6 = cursorQuery.getLong(columnIndexOrThrow12);
                    long j7 = cursorQuery.getLong(columnIndexOrThrow13);
                    int i4 = i2;
                    long j8 = cursorQuery.getLong(i4);
                    int i5 = columnIndexOrThrow;
                    int i6 = columnIndexOrThrow15;
                    ...
                    columnIndexOrThrow19 = i11;
                    int i13 = columnIndexOrThrow20;
                    long j10 = cursorQuery.getLong(i13);
                    columnIndexOrThrow20 = i13;
                    int i14 = columnIndexOrThrow21;
                    int i15 = cursorQuery.getInt(i14);
                    columnIndexOrThrow21 = i14;
                    ...
                    columnIndexOrThrow28 = i23;
                    int i24 = columnIndexOrThrow29;
                    long j12 = cursorQuery.getLong(i24);
                    columnIndexOrThrow29 = i24;
                    int i25 = columnIndexOrThrow30;
                    columnIndexOrThrow30 = i25;
                    arrayList.add(new WorkSpec(string, stateIntToState, string2, string3, dataFromByteArray, dataFromByteArray2, j3, j4, j5, new Constraints(networkTypeIntToNetworkType, z3, z4, z5, z6, j11, j12, WorkTypeConverters.byteArrayToSetOfTriggers(cursorQuery.isNull(i25) ? null : cursorQuery.getBlob(i25))), i3, backoffPolicyIntToBackoffPolicy, j6, j7, j8, j9, z2, outOfQuotaPolicyIntToOutOfQuotaPolicy, i10, i12, j10, i15, i17));
                    columnIndexOrThrow = i5;
                    i2 = i4;
                }
                cursorQuery.close();
    ...
    @Override // androidx.work.impl.model.WorkSpecDao
    public InterfaceC1639c getWorkStatusPojoFlowDataForIds(List<String> list) {
        StringBuilder sbNewStringBuilder = StringUtil.newStringBuilder();
                ...
                try {
                    ...
                    try {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            long j2 = cursorQuery.getLong(13);
                            long j3 = cursorQuery.getLong(14);
                            long j4 = cursorQuery.getLong(15);
                            BackoffPolicy backoffPolicyIntToBackoffPolicy = WorkTypeConverters.intToBackoffPolicy(cursorQuery.getInt(16));
                            long j5 = cursorQuery.getLong(17);
                            long j6 = cursorQuery.getLong(18);
                            ...
                            arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, j2, j3, j4, constraints, i3, backoffPolicyIntToBackoffPolicy, j5, j6, i5, i4, j7, i6, arrayList2, arrayList3));
                        }
                        WorkSpecDao_Impl.this.__db.setTransactionSuccessful();
                        cursorQuery.close();
                        return arrayList;
    ...
    @Override // androidx.work.impl.model.WorkSpecDao
    public InterfaceC1639c getWorkStatusPojoFlowForName(String str) {
                ...
                try {
                    ...
                    try {
                        ...
                        while (cursorQuery.moveToNext()) {
                            ...
                            arrayList.add(new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, j2, j3, j4, constraints, i2, backoffPolicyIntToBackoffPolicy, j5, j6, i4, i3, j7, i5, arrayList2, arrayList3));
                        }
                        WorkSpecDao_Impl.this.__db.setTransactionSuccessful();
                        cursorQuery.close();
                        return arrayList;
    ...
    @Override // androidx.work.impl.model.WorkSpecDao
    public InterfaceC1639c getWorkStatusPojoFlowForTag(String str) {
        ...
        try {
            ...
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    ...
                    boolean z2 = cursorQuery.getInt(6) != 0;
                    boolean z3 = cursorQuery.getInt(7) != 0;
                    boolean z4 = cursorQuery.getInt(8) != 0;
                    boolean z5 = cursorQuery.getInt(9) != 0;
                    long j8 = cursorQuery.getLong(10);
                    long j9 = cursorQuery.getLong(11);
                    ...
                    workInfoPojo = new WorkSpec.WorkInfoPojo(string3, stateIntToState, dataFromByteArray, j2, j3, j4, constraints, i2, backoffPolicyIntToBackoffPolicy, j5, j6, i4, i3, j7, i5, arrayList, arrayList2);
                }
                this.__db.setTransactionSuccessful();
                cursorQuery.close();
                roomSQLiteQueryAcquire.release();
