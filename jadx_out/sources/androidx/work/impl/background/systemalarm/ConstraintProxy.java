...
abstract class ConstraintProxy extends BroadcastReceiver {
    ...
    public static void updateAll(Context context, List<WorkSpec> list) {
        ...
        while (it.hasNext()) {
            ...
            if (requiresBatteryNotLow && requiresCharging && requiresStorageNotLow && z2) {
                break;
            }
        }
        context.sendBroadcast(ConstraintProxyUpdateReceiver.newConstraintProxyUpdateIntent(context, requiresBatteryNotLow, requiresCharging, requiresStorageNotLow, z2));
    }
