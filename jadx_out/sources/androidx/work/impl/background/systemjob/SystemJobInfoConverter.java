...
class SystemJobInfoConverter {
    ...
    public JobInfo convert(WorkSpec workSpec, int i2) {
        ...
        JobInfo.Builder extras = new JobInfo.Builder(i2, this.mWorkServiceComponent).setRequiresCharging(constraints.getRequiresCharging()).setRequiresDeviceIdle(constraints.getRequiresDeviceIdle()).setExtras(persistableBundle);
        ...
        boolean z3 = jMax > 0;
        if (i3 >= 31 && workSpec.expedited && !z2 && !z3) {
