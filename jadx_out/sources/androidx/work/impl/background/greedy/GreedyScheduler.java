...
public class GreedyScheduler implements Scheduler, OnConstraintsStateChangedListener, ExecutionListener {
    ...
    private final Map<WorkGenerationalId, InterfaceC1705u0> mConstrainedWorkSpecs = new HashMap();
    ...
    private void removeConstraintTrackingFor(@NonNull WorkGenerationalId workGenerationalId) {
        InterfaceC1705u0 interfaceC1705u0Remove;
        synchronized (this.mLock) {
            interfaceC1705u0Remove = this.mConstrainedWorkSpecs.remove(workGenerationalId);
        }
