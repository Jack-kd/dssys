...
public final class Data {
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder putByte(@NonNull String str, byte b3) {
            this.mValues.put(str, Byte.valueOf(b3));
            return this;
        }
    ...
    */
    ...
    public byte getByte(@NonNull String str, byte b3) {
        Object obj = this.mValues.get(str);
        return obj instanceof Byte ? ((Byte) obj).byteValue() : b3;
    }
