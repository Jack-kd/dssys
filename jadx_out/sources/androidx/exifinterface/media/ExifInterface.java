...
public class ExifInterface {
    ...
    private static final byte[] HEIF_BRAND_MIF1 = {109, 105, 102, e.f35443I};
    ...
    private static final byte[] ORF_MAKER_NOTE_HEADER_1 = {79, e.f35450P, 89, 77, 80, 0};
    private static final byte[] ORF_MAKER_NOTE_HEADER_2 = {79, e.f35450P, 89, 77, 80, 85, e.f35451Q, 0, 73, 73};
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, ek.f49293k, 10, 26, 10};

    @VisibleForTesting
    static final byte[] PNG_ITXT_XMP_KEYWORD = "XML:com.adobe.xmp\u0000\u0000\u0000\u0000\u0000".getBytes(StandardCharsets.UTF_8);
    private static final byte[] WEBP_SIGNATURE_1 = {82, 73, 70, 70};
    private static final byte[] WEBP_SIGNATURE_2 = {87, 69, 66, 80};
    private static final byte[] WEBP_CHUNK_TYPE_EXIF = {69, e.f35453S, 73, 70};
    ...
    private static final byte[] EXIF_ASCII_PREFIX = {65, e.f35451Q, 67, 73, 73, 0, 0, 0};
    ...
    public static class ExifAttribute {
        ...
        /* JADX WARN: Type inference failed for: r13v22, types: [androidx.exifinterface.media.ExifInterface$Rational[]] */
        /* JADX WARN: Type inference failed for: r13v24, types: [int[]] */
        /* JADX WARN: Type inference failed for: r13v26, types: [int[]] */
        /* JADX WARN: Type inference failed for: r13v28, types: [androidx.exifinterface.media.ExifInterface$Rational[]] */
        /* JADX WARN: Type inference failed for: r13v30, types: [double[]] */
                    ...
                    switch (this.format) {
                        ...
                        case 6:
                            ...
                            if (bArr.length == 1 && (b3 = bArr[0]) >= 0 && b3 <= 1) {
                                str = new String(new char[]{(char) (b3 + e.f35442H)});
                                break;
                            } else {
                        ...
                        case 7:
                            ...
                            StringBuilder sb = new StringBuilder();
                            while (length < this.numberOfComponents && (b4 = this.bytes[length]) != 0) {
                                if (b4 >= 32) {
                                    sb.append((char) b4);
                                } else {
                                    sb.append('?');
    ...
    public static class Rational {
        ...
        public static Rational createFromDouble(double d2) {
            ...
            if (d2 >= 9.223372036854776E18d || d2 <= -9.223372036854776E18d) {
                return new Rational(d2 > 0.0d ? LocationRequestCompat.PASSIVE_INTERVAL : Long.MIN_VALUE, 1L);
            }
        ...
        try {
            try {
                ExifInterfaceUtils.Api23Impl.setDataSource(mediaMetadataRetriever, new MediaDataSource() { // from class: androidx.exifinterface.media.ExifInterface.1
                    ...
                    @Override // android.media.MediaDataSource
                    public int readAt(long j2, byte[] bArr, int i4, int i5) throws IOException {
                        if (i5 == 0) {
                            return 0;
                        }
                        if (j2 < 0) {
                ...
                if (strExtractMetadata2 != null) {
                    ...
                    this.mAttributes[0].put(TAG_ORIENTATION, ExifAttribute.createUShort(i4 != 90 ? i4 != 180 ? i4 != 270 ? 1 : 8 : 3 : 6, this.mExifByteOrder));
                }
                ...
                if (strExtractMetadata8 != null && strExtractMetadata9 != null) {
                    ...
                    this.mXmpFromSeparateMarker = new ExifAttribute(1, i10, j2, bArr3);
    ...
    */
    ...
    private boolean isSupportedDataType(HashMap<String, ExifAttribute> map) throws Throwable {
        ExifAttribute exifAttribute;
        ...
        if (this.mMimeType != 3 || (exifAttribute = map.get(TAG_PHOTOMETRIC_INTERPRETATION)) == null) {
            return false;
        }
        int intValue = exifAttribute.getIntValue(this.mExifByteOrder);
        ...
        if (str != null && NON_ZERO_TIME_PATTERN.matcher(str).matches()) {
            ...
            try {
                ...
                if (str3 != null) {
                    ...
                    if (("+".equals(strSubstring) || "-".equals(strSubstring)) && ":".equals(str3.substring(3, 4)) && i3 <= 14) {
                        int i5 = ((i3 * 60) + i4) * BaseConstants.Time.MINUTE;
    ...
    private void saveJpegAttributes(InputStream inputStream, OutputStream outputStream) throws IOException {
        ...
        while (byteOrderedDataInputStream.readByte() == -1) {
            ...
            if (b3 != -31) {
                ...
                while (length > 0) {
                    int i4 = byteOrderedDataInputStream.read(bArr3, 0, Math.min(length, 4096));
                    if (i4 >= 0) {
    ...
    public Bitmap getThumbnailBitmap() throws Throwable {
        ...
        if (i2 == 1) {
            ...
            for (int i3 = 0; i3 < length; i3++) {
                ...
                int i4 = i3 * 3;
                iArr[i3] = (bArr[i4] << ek.f49296n) + (bArr[i4 + 1] << 8) + bArr[i4 + 2];
            }
    ...
    */
    public byte[] getThumbnailBytes() throws java.lang.Throwable {
        ...
        L6:
            ...
            return r0
        Lb:
            android.content.res.AssetManager$AssetInputStream r0 = r7.mAssetInputStream     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
            if (r0 == 0) goto L28
        ...
        L24:
            ...
            return r1
        L28:
            java.lang.String r0 = r7.mFilename     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
            if (r0 == 0) goto L3b
            java.io.FileInputStream r0 = new java.io.FileInputStream     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
            java.lang.String r2 = r7.mFilename     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
        ...
        L38:
            ...
            goto L84
        L3b:
            java.io.FileDescriptor r0 = r7.mSeekableFileDescriptor     // Catch: java.lang.Throwable -> L34 java.lang.Exception -> L38
            ...
            r0 = r6
        L50:
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r3 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            r3.<init>(r0)     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            int r4 = r7.mThumbnailOffset     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            int r5 = r7.mOffsetToExifData     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            int r4 = r4 + r5
            r3.skipFully(r4)     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            int r4 = r7.mThumbnailLength     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            ...
            r7.mThumbnailBytes = r4     // Catch: java.lang.Throwable -> L6f java.lang.Exception -> L84
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r0)
            if (r2 == 0) goto L6e
    ...
    */
    ...
    public void setAttribute(String str, String str2) throws NumberFormatException {
        ...
        if (strReplaceAll != null) {
            if (RATIONAL_TAGS_HANDLED_AS_DECIMALS_FOR_COMPATIBILITY.contains(str3) && !strReplaceAll.contains(ServiceReference.DELIMITER)) {
                try {
                    ...
                    switch (i2) {
                        ...
                        case 5:
                            ...
                            for (int i10 = 0; i10 < strArrSplit3.length; i10++) {
                                String[] strArrSplit4 = strArrSplit3[i10].split(ServiceReference.DELIMITER, -1);
                                rationalArr[i10] = new Rational((long) Double.parseDouble(strArrSplit4[0]), (long) Double.parseDouble(strArrSplit4[i3]));
                            }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY})
    public void setDateTime(Long l2) throws NumberFormatException {
        if (l2 == null) {
    ...
    /*
        ...
        To view partially-correct add '--show-bad-code' argument
    */
    public ExifInterface(java.io.InputStream r3, int r4) throws java.lang.Throwable {
        /*
            r2 = this;
            r2.<init>()
