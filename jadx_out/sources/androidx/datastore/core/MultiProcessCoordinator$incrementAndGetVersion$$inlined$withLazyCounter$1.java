...
public final class MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1 extends SuspendLambda implements Function2<M, e, Object> {
    int label;
    ...
    public final Object invokeSuspend(@NotNull Object obj) throws Throwable {
        ...
        kotlin.e.b(obj);
        return AbstractC1791a.c(this.this$0.getSharedCounter().incrementAndGetValue());
    }

    @Override // kotlin.jvm.functions.Function2
    @Nullable
    public final Object invoke(@NotNull M m2, @Nullable e eVar) {
        return ((MultiProcessCoordinator$incrementAndGetVersion$$inlined$withLazyCounter$1) create(m2, eVar)).invokeSuspend(j.f51397a);
    }
}
