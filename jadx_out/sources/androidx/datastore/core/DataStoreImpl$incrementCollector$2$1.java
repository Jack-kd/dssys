...
@DebugMetadata(c = "androidx.datastore.core.DataStoreImpl$incrementCollector$2$1", f = "DataStoreImpl.kt", i = {}, l = {MediaPlayer.MEDIA_PLAYER_OPTION_SET_MAX_FPS, MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_START_OFFSET}, m = "invokeSuspend", n = {}, s = {})
/* loaded from: classes.dex */
public final class DataStoreImpl$incrementCollector$2$1 extends SuspendLambda implements Function2<M, e, Object> {
    int label;
    ...
    */
    public final java.lang.Object invokeSuspend(@org.jetbrains.annotations.NotNull java.lang.Object r5) throws java.lang.Throwable {
        ...
        L30:
            ...
            kotlinx.coroutines.flow.c r5 = r5.getUpdateNotifications()
            kotlinx.coroutines.flow.c r5 = kotlinx.coroutines.flow.AbstractC1641e.i(r5)
    ...
    public final Object invoke(@NotNull M m2, @Nullable e eVar) {
        return ((DataStoreImpl$incrementCollector$2$1) create(m2, eVar)).invokeSuspend(j.f51397a);
    }
}
