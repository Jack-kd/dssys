...
public final class FileStorage<T> implements Storage<T> {
    ...
    public StorageConnection<T> createConnection() throws IOException {
        ...
        j.d(file, "file");
        return new FileStorageConnection(file, this.serializer, this.coordinatorProducer.invoke(file), new Function0<kotlin.j>() { // from class: androidx.datastore.core.FileStorage.createConnection.2
    ...
    public /* synthetic */ FileStorage(Serializer serializer, Function1 function1, Function0 function0, int i2, f fVar) {
