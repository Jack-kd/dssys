...
final class Utf8 {
    ...
    public static class DecodeUtil {
        ...
        public static void handleFourBytes(byte b3, byte b4, byte b5, byte b6, char[] cArr, int i2) throws InvalidProtocolBufferException {
            if (isNotTrailingByte(b4) || (((b3 << 28) + (b4 + 112)) >> 30) != 0 || isNotTrailingByte(b5) || isNotTrailingByte(b6)) {
        ...
        public static void handleThreeBytes(byte b3, byte b4, byte b5, char[] cArr, int i2) throws InvalidProtocolBufferException {
            ...
            cArr[i2] = (char) (((b3 & ek.f49295m) << 12) | (trailingByteValue(b4) << 6) | trailingByteValue(b5));
        }
        ...
        public static void handleTwoBytes(byte b3, byte b4, char[] cArr, int i2) throws InvalidProtocolBufferException {
            ...
            cArr[i2] = (char) (((b3 & 31) << 6) | trailingByteValue(b4));
        }
    ...
    public static abstract class Processor {
        ...
        public final String decodeUtf8Default(ByteBuffer byteBuffer, int i2, int i3) throws InvalidProtocolBufferException {
            ...
            while (i2 < i4) {
                ...
                if (DecodeUtil.isOneByte(b4)) {
                    ...
                    int i10 = i2 + 2;
                    i2 += 3;
                    DecodeUtil.handleThreeBytes(b4, byteBuffer.get(i7), byteBuffer.get(i10), cArr, i6);
                    i6++;
                } else {
                    if (i7 >= i4 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    i2 += 4;
                    DecodeUtil.handleFourBytes(b4, b6, b7, byteBuffer.get(i11), cArr, i6);
                    i6 += 2;
                }
            }
        ...
        public abstract int encodeUtf8(String str, byte[] bArr, int i2, int i3);
    ...
    public static int encode(String str, byte[] bArr, int i2, int i3) {
        return processor.encodeUtf8(str, bArr, i2, i3);
    }
    ...
    public static final class UnsafeProcessor extends Processor {
        ...
        private static int unsafeEstimateConsecutiveAscii(byte[] bArr, long j2, int i2) {
            ...
            while (true) {
                int i5 = i3 + 8;
                if (i5 > i2 || (UnsafeUtil.getLong((Object) bArr, UnsafeUtil.BYTE_ARRAY_BASE_OFFSET + j2) & (-9187201950435737472L)) != 0) {
                    break;
                }
                j2 += 8;
                i3 = i5;
        ...
        public String decodeUtf8(byte[] bArr, int i2, int i3) throws InvalidProtocolBufferException {
            ...
            if (str.indexOf(okio.Utf8.REPLACEMENT_CODE_POINT) >= 0 && !Arrays.equals(str.getBytes(charset), Arrays.copyOfRange(bArr, i2, i3 + i2))) {
                throw InvalidProtocolBufferException.invalidUtf8();
            }
            return str;
        }
        ...
        public String decodeUtf8Direct(ByteBuffer byteBuffer, int i2, int i3) throws InvalidProtocolBufferException {
            ...
            while (jAddressOffset < j2) {
                ...
                if (DecodeUtil.isOneByte(b4)) {
                    ...
                    jAddressOffset += 3;
                    DecodeUtil.handleThreeBytes(b4, UnsafeUtil.getByte(j3), UnsafeUtil.getByte(j5), cArr, i5);
                    i5++;
                } else {
                    if (j3 >= j2 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    byte b7 = UnsafeUtil.getByte(2 + jAddressOffset);
                    jAddressOffset += 4;
        ...
        @Override // androidx.datastore.preferences.protobuf.Utf8.Processor
        public int encodeUtf8(String str, byte[] bArr, int i2, int i3) {
            long j2;
            long j3;
            long j4;
            int i4;
                ...
                if (cCharAt2 < 128 && j5 < j6) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || j5 > j6 - 3) {
                        ...
                        if (i6 != length) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                UnsafeUtil.putByte(bArr, j5, (byte) ((codePoint >>> 18) | MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA));
                                UnsafeUtil.putByte(bArr, j5 + j3, (byte) (((codePoint >>> 12) & 63) | 128));
                                long j7 = j5 + 3;
                    ...
                    long j8 = j5 + 2;
                    j4 = j6;
                    UnsafeUtil.putByte(bArr, j5 + j3, (byte) (((cCharAt2 >>> 6) & 63) | 128));
                    j5 += 3;
                    ...
                    j5 += 2;
                    UnsafeUtil.putByte(bArr, j9, (byte) ((cCharAt2 & '?') | 128));
                    j4 = j6;
                }
                i5++;
                j2 = j3;
                    ...
                    if (cCharAt2 < 2048 && jPosition <= jLimit - 2) {
                        ...
                        if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || jPosition > jLimit - 3) {
                            ...
                            if (i4 != length) {
                                ...
                                if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                    int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                    UnsafeUtil.putByte(jPosition, (byte) ((codePoint >>> 18) | MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA));
                                    c3 = 128;
        ...
        public String decodeUtf8(byte[] bArr, int i2, int i3) throws InvalidProtocolBufferException {
            ...
            while (i2 < i4) {
                ...
                if (DecodeUtil.isOneByte(b4)) {
                    ...
                    int i10 = i2 + 2;
                    i2 += 3;
                    DecodeUtil.handleThreeBytes(b4, bArr[i7], bArr[i10], cArr, i6);
                    i6++;
                } else {
                    if (i7 >= i4 - 2) {
                        throw InvalidProtocolBufferException.invalidUtf8();
                    ...
                    byte b7 = bArr[i2 + 2];
                    i2 += 4;
                    DecodeUtil.handleFourBytes(b4, b6, b7, bArr[i11], cArr, i6);
                    i6 += 2;
                }
            }
            return new String(cArr, 0, i6);
                ...
                if (cCharAt2 < 128 && i8 < i6) {
                    ...
                    if ((cCharAt2 >= 55296 && 57343 >= cCharAt2) || i8 > i6 - 3) {
                        ...
                        if (i10 != str.length()) {
                            ...
                            if (Character.isSurrogatePair(cCharAt2, cCharAt3)) {
                                int codePoint = Character.toCodePoint(cCharAt2, cCharAt3);
                                bArr[i8] = (byte) ((codePoint >>> 18) | MediaPlayer.MEDIA_PLAYER_OPTION_GET_PLAY_WASTE_DATA);
