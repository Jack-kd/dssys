...
final class CodedOutputStreamWriter implements Writer {
    ...
    private void writeBoolListInternal(int i2, BooleanArrayList booleanArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < booleanArrayList.size()) {
                this.output.writeBool(i2, booleanArrayList.getBoolean(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < booleanArrayList.size(); i4++) {
            iComputeBoolSizeNoTag += CodedOutputStream.computeBoolSizeNoTag(booleanArrayList.getBoolean(i4));
        }
        this.output.writeUInt32NoTag(iComputeBoolSizeNoTag);
        while (i3 < booleanArrayList.size()) {
            this.output.writeBoolNoTag(booleanArrayList.getBoolean(i3));
            i3++;
        }
    }
    ...
    private void writeDoubleListInternal(int i2, DoubleArrayList doubleArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < doubleArrayList.size()) {
                this.output.writeDouble(i2, doubleArrayList.getDouble(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < doubleArrayList.size(); i4++) {
            iComputeDoubleSizeNoTag += CodedOutputStream.computeDoubleSizeNoTag(doubleArrayList.getDouble(i4));
        }
        this.output.writeUInt32NoTag(iComputeDoubleSizeNoTag);
        while (i3 < doubleArrayList.size()) {
            this.output.writeDoubleNoTag(doubleArrayList.getDouble(i3));
            i3++;
        }
    }
    ...
    private void writeEnumListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeEnum(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeEnumSizeNoTag += CodedOutputStream.computeEnumSizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeEnumSizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeEnumNoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeFixed32ListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeFixed32(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeFixed32SizeNoTag += CodedOutputStream.computeFixed32SizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeFixed32SizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeFixed32NoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeFixed64ListInternal(int i2, LongArrayList longArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < longArrayList.size()) {
                this.output.writeFixed64(i2, longArrayList.getLong(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < longArrayList.size(); i4++) {
            iComputeFixed64SizeNoTag += CodedOutputStream.computeFixed64SizeNoTag(longArrayList.getLong(i4));
        }
        this.output.writeUInt32NoTag(iComputeFixed64SizeNoTag);
        while (i3 < longArrayList.size()) {
            this.output.writeFixed64NoTag(longArrayList.getLong(i3));
            i3++;
        }
    }
    ...
    private void writeFloatListInternal(int i2, FloatArrayList floatArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < floatArrayList.size()) {
                this.output.writeFloat(i2, floatArrayList.getFloat(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < floatArrayList.size(); i4++) {
            iComputeFloatSizeNoTag += CodedOutputStream.computeFloatSizeNoTag(floatArrayList.getFloat(i4));
        }
        this.output.writeUInt32NoTag(iComputeFloatSizeNoTag);
        while (i3 < floatArrayList.size()) {
            this.output.writeFloatNoTag(floatArrayList.getFloat(i3));
            i3++;
        }
    }
    ...
    private void writeInt32ListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeInt32(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeInt32SizeNoTag += CodedOutputStream.computeInt32SizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeInt32SizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeInt32NoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeInt64ListInternal(int i2, LongArrayList longArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < longArrayList.size()) {
                this.output.writeInt64(i2, longArrayList.getLong(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < longArrayList.size(); i4++) {
            iComputeInt64SizeNoTag += CodedOutputStream.computeInt64SizeNoTag(longArrayList.getLong(i4));
        }
        this.output.writeUInt32NoTag(iComputeInt64SizeNoTag);
        while (i3 < longArrayList.size()) {
            this.output.writeInt64NoTag(longArrayList.getLong(i3));
            i3++;
        }
    }
    ...
    private void writeSFixed32ListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeSFixed32(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeSFixed32SizeNoTag += CodedOutputStream.computeSFixed32SizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeSFixed32SizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeSFixed32NoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeSFixed64ListInternal(int i2, LongArrayList longArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < longArrayList.size()) {
                this.output.writeSFixed64(i2, longArrayList.getLong(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < longArrayList.size(); i4++) {
            iComputeSFixed64SizeNoTag += CodedOutputStream.computeSFixed64SizeNoTag(longArrayList.getLong(i4));
        }
        this.output.writeUInt32NoTag(iComputeSFixed64SizeNoTag);
        while (i3 < longArrayList.size()) {
            this.output.writeSFixed64NoTag(longArrayList.getLong(i3));
            i3++;
        }
    }
    ...
    private void writeSInt32ListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeSInt32(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeSInt32SizeNoTag += CodedOutputStream.computeSInt32SizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeSInt32SizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeSInt32NoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeSInt64ListInternal(int i2, LongArrayList longArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < longArrayList.size()) {
                this.output.writeSInt64(i2, longArrayList.getLong(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < longArrayList.size(); i4++) {
            iComputeSInt64SizeNoTag += CodedOutputStream.computeSInt64SizeNoTag(longArrayList.getLong(i4));
        }
        this.output.writeUInt32NoTag(iComputeSInt64SizeNoTag);
        while (i3 < longArrayList.size()) {
            this.output.writeSInt64NoTag(longArrayList.getLong(i3));
            i3++;
        }
    }
    ...
    private void writeUInt32ListInternal(int i2, IntArrayList intArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < intArrayList.size()) {
                this.output.writeUInt32(i2, intArrayList.getInt(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < intArrayList.size(); i4++) {
            iComputeUInt32SizeNoTag += CodedOutputStream.computeUInt32SizeNoTag(intArrayList.getInt(i4));
        }
        this.output.writeUInt32NoTag(iComputeUInt32SizeNoTag);
        while (i3 < intArrayList.size()) {
            this.output.writeUInt32NoTag(intArrayList.getInt(i3));
            i3++;
        }
    }
    ...
    private void writeUInt64ListInternal(int i2, LongArrayList longArrayList, boolean z2) throws IOException {
        ...
        if (!z2) {
            while (i3 < longArrayList.size()) {
                this.output.writeUInt64(i2, longArrayList.getLong(i3));
                i3++;
            }
            return;
        }
        ...
        for (int i4 = 0; i4 < longArrayList.size(); i4++) {
            iComputeUInt64SizeNoTag += CodedOutputStream.computeUInt64SizeNoTag(longArrayList.getLong(i4));
        }
        this.output.writeUInt32NoTag(iComputeUInt64SizeNoTag);
        while (i3 < longArrayList.size()) {
            this.output.writeUInt64NoTag(longArrayList.getLong(i3));
            i3++;
        }
    }
