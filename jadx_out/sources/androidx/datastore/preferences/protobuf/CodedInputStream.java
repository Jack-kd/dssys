...
public abstract class CodedInputStream {
    ...
    public static final class IterableDirectByteBufferDecoder extends CodedInputStream {
        ...
        public long readRawLittleEndian64() throws IOException {
            ...
            return rawByte | ((rawByte2 & 255) << c2);
        }
        ...
        public int readRawVarint32() throws IOException {
            ...
            if (this.currentByteBufferLimit != j2) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j4 = 2 + j2;
                    int i3 = (UnsafeUtil.getByte(j3) << 7) ^ b3;
                    if (i3 < 0) {
                        i2 = i3 ^ (-128);
                    } else {
                        long j5 = 3 + j2;
                        int i4 = (UnsafeUtil.getByte(j4) << ek.f49294l) ^ i3;
                        if (i4 >= 0) {
                            i2 = i4 ^ 16256;
                        } else {
                            long j6 = 4 + j2;
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.currentByteBufferLimit != j5) {
                ...
                if (this.currentByteBufferLimit - this.currentByteBufferPos >= 10) {
                    long j7 = 2 + j5;
                    int i2 = (UnsafeUtil.getByte(j6) << 7) ^ b3;
                    if (i2 < 0) {
                        j2 = i2 ^ (-128);
                    } else {
                        long j8 = 3 + j5;
                        int i3 = (UnsafeUtil.getByte(j7) << ek.f49294l) ^ i2;
                        if (i3 >= 0) {
                            j2 = i3 ^ 16256;
                            j7 = j8;
                        } else {
                            long j9 = 4 + j5;
                            int i4 = i3 ^ (UnsafeUtil.getByte(j8) << 21);
                            if (i4 < 0) {
                                j2 = (-2080896) ^ i4;
                                j7 = j9;
                            } else {
                                long j10 = 5 + j5;
                                long j11 = (UnsafeUtil.getByte(j9) << 28) ^ i4;
                                if (j11 >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j12 = 6 + j5;
                                    long j13 = j11 ^ (UnsafeUtil.getByte(j10) << 35);
                                    if (j13 < 0) {
                                        j3 = -34093383808L;
                                    } else {
                                        j10 = 7 + j5;
                                        j11 = j13 ^ (UnsafeUtil.getByte(j12) << 42);
                                        if (j11 >= 0) {
                                            j4 = 4363953127296L;
                                        } else {
                                            j12 = 8 + j5;
                                            j13 = j11 ^ (UnsafeUtil.getByte(j10) << 49);
                                            if (j13 < 0) {
                                                j3 = -558586000294016L;
                                            } else {
                                                j10 = 9 + j5;
                                                long j14 = (j13 ^ (UnsafeUtil.getByte(j12) << 56)) ^ 71499008037633920L;
                                                if (j14 < 0) {
                                                    long j15 = j5 + 10;
        ...
        */
        ...
        public long readRawVarint64() throws IOException {
            ...
            if (this.limit != j5) {
                ...
                if (this.limit - j6 >= 9) {
                    long j7 = 2 + j5;
                    int i3 = (UnsafeUtil.getByte(j6) << 7) ^ b3;
                    if (i3 >= 0) {
                        long j8 = 3 + j5;
                        int i4 = i3 ^ (UnsafeUtil.getByte(j7) << ek.f49294l);
                        if (i4 >= 0) {
                            j2 = i4 ^ 16256;
                            j7 = j8;
                        } else {
                            ...
                            if (i5 < 0) {
                                ...
                                long j9 = 5 + j5;
                                long j10 = i5 ^ (UnsafeUtil.getByte(j7) << 28);
                                if (j10 >= 0) {
                                    j4 = 266354560;
                                } else {
                                    long j11 = 6 + j5;
