...
final class ArrayDecoders {
    ...
    public static int decodeExtension(int i2, byte[] bArr, int i3, int i4, GeneratedMessageLite.ExtendableMessage<?, ?> extendableMessage, GeneratedMessageLite.GeneratedExtension<?, ?> generatedExtension, UnknownFieldSchema<UnknownFieldSetLite, UnknownFieldSetLite> unknownFieldSchema, Registers registers) throws IOException {
        ...
        if (generatedExtension.descriptor.isRepeated() && generatedExtension.descriptor.isPacked()) {
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 14:
                    ...
                    SchemaUtil.filterUnknownEnumList((Object) extendableMessage, i7, (List<Integer>) intArrayList4, generatedExtension.descriptor.getEnumType(), (Object) null, (UnknownFieldSchema<UT, Object>) unknownFieldSchema);
        ...
        if (generatedExtension.getLiteType() == WireFormat.FieldType.ENUM) {
            ...
            if (generatedExtension.descriptor.getEnumType().findValueByNumber(registers.int1) == null) {
                SchemaUtil.storeUnknownEnum(extendableMessage, i7, registers.int1, null, unknownFieldSchema);
                return i3;
            }
            ...
            switch (AnonymousClass1.$SwitchMap$com$google$protobuf$WireFormat$FieldType[generatedExtension.getLiteType().ordinal()]) {
                ...
                case 17:
                    ...
                    if (generatedExtension.isRepeated()) {
                        int iDecodeGroupField = decodeGroupField(schemaSchemaFor, bArr, i3, i4, i8, registers);
                    ...
                    return mergeGroupField(field, schemaSchemaFor, bArr, i3, i4, i8, registers);
                case 18:
                    Schema schemaSchemaFor2 = Protobuf.getInstance().schemaFor((Class) generatedExtension.getMessageDefaultInstance().getClass());
                    if (generatedExtension.isRepeated()) {
                        int iDecodeMessageField = decodeMessageField(schemaSchemaFor2, bArr, i3, i4, registers);
                        fieldSet.addRepeatedField(generatedExtension.descriptor, registers.object1);
                    ...
                    return mergeMessageField(field2, schemaSchemaFor2, bArr, i3, i4, registers);
            }
        }
        if (generatedExtension.isRepeated()) {
    ...
    public static int decodeGroupField(Schema schema, byte[] bArr, int i2, int i3, int i4, Registers registers) throws IOException {
        ...
        int iMergeGroupField = mergeGroupField(objNewInstance, schema, bArr, i2, i3, i4, registers);
    ...
    public static int decodeMessageField(Schema schema, byte[] bArr, int i2, int i3, Registers registers) throws IOException {
        Object objNewInstance = schema.newInstance();
        int iMergeMessageField = mergeMessageField(objNewInstance, schema, bArr, i2, i3, registers);
        schema.makeImmutable(objNewInstance);
        registers.object1 = objNewInstance;
    ...
    public static int decodeUnknownField(int i2, byte[] bArr, int i3, int i4, UnknownFieldSetLite unknownFieldSetLite, Registers registers) throws InvalidProtocolBufferException {
        ...
        int i6 = (i2 & (-8)) | 4;
        int i7 = registers.recursionDepth + 1;
        registers.recursionDepth = i7;
    ...
    public static int mergeGroupField(Object obj, Schema schema, byte[] bArr, int i2, int i3, int i4, Registers registers) throws IOException {
        int i5 = registers.recursionDepth + 1;
        registers.recursionDepth = i5;
        checkRecursionLimit(i5);
        int message = ((MessageSchema) schema).parseMessage(obj, bArr, i2, i3, i4, registers);
        registers.recursionDepth--;
        registers.object1 = obj;
        return message;
    }

    public static int mergeMessageField(Object obj, Schema schema, byte[] bArr, int i2, int i3, Registers registers) throws IOException {
    ...
    public static int decodeVarint32(int i2, byte[] bArr, int i3, Registers registers) {
        ...
        byte b4 = bArr[i5];
        if (b4 >= 0) {
            registers.int1 = i6 | (b4 << ek.f49294l);
            return i7;
        }
        int i8 = i6 | ((b4 & 127) << 14);
        int i9 = i3 + 3;
