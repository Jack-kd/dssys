...
final class MessageLiteToString {
    ...
    public static void printField(StringBuilder sb, int i2, String str, Object obj) throws SecurityException {
        ...
        int i3 = i2 + 2;
        printField(sb, i3, f.a.f3242b, entry.getKey());
        printField(sb, i3, f.a.f3244d, entry.getValue());
        sb.append("\n");
        indent(i2, sb);
        sb.append("}");
    }
