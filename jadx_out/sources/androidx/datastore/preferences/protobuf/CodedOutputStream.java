...
public abstract class CodedOutputStream extends ByteOutput {
    ...
    public static abstract class AbstractBufferedEncoder extends CodedOutputStream {
        ...
        public final void bufferUInt32NoTag(int i2) {
            ...
            while ((i2 & (-128)) != 0) {
                ...
                this.position = i5 + 1;
                UnsafeUtil.putByte(bArr3, i5, (byte) ((i2 | 128) & 255));
                i2 >>>= 7;
            }
        ...
        public final void bufferUInt64NoTag(long j2) {
            ...
            while ((j2 & (-128)) != 0) {
                ...
                int i4 = this.position;
                this.position = i4 + 1;
                UnsafeUtil.putByte(bArr3, i4, (byte) ((((int) j2) | 128) & 255));
                j2 >>>= 7;
            }
            byte[] bArr4 = this.buffer;
            int i5 = this.position;
        ...
        public final void writeUInt64NoTag(long j2) throws IOException {
            if (CodedOutputStream.HAS_UNSAFE_ARRAY_OPERATIONS && spaceLeft() >= 10) {
                while ((j2 & (-128)) != 0) {
                    ...
                    int i2 = this.position;
                    this.position = i2 + 1;
                    UnsafeUtil.putByte(bArr, i2, (byte) ((((int) j2) | 128) & 255));
                    j2 >>>= 7;
                }
                byte[] bArr2 = this.buffer;
                int i3 = this.position;
    ...
    public static final class SafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt64NoTag(long j2) throws IOException {
            while (((-128) & j2) != 0) {
                try {
                    this.buffer.put((byte) ((((int) j2) | 128) & 255));
                    j2 >>>= 7;
                } catch (BufferOverflowException e2) {
                    throw new OutOfSpaceException(e2);
                }
    ...
    public static final class UnsafeDirectNioEncoder extends CodedOutputStream {
        ...
        public void writeUInt32NoTag(int i2) throws IOException {
            if (this.position <= this.oneVarintLimit) {
                while ((i2 & (-128)) != 0) {
                    long j2 = this.position;
                    this.position = j2 + 1;
                    UnsafeUtil.putByte(j2, (byte) ((i2 | 128) & 255));
                    i2 >>>= 7;
                }
                long j3 = this.position;
                this.position = 1 + j3;
            ...
            while (true) {
                ...
                if ((i2 & (-128)) == 0) {
                    ...
                    this.position = j4 + 1;
                    UnsafeUtil.putByte(j4, (byte) ((i2 | 128) & 255));
                    i2 >>>= 7;
                }
            }
        }
        ...
        public void write(byte[] bArr, int i2, int i3) throws IOException {
            ...
            if (bArr == null) {
                throw new NullPointerException(f.a.f3244d);
            }
