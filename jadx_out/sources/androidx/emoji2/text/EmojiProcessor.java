...
final class EmojiProcessor {
    ...
    public int getEmojiEnd(@NonNull CharSequence charSequence, @IntRange(from = 0) int i2) {
    ...
    public int getEmojiStart(@NonNull CharSequence charSequence, @IntRange(from = 0) int i2) {
        if (i2 < 0 || i2 >= charSequence.length()) {
            return -1;
        }
        if (charSequence instanceof Spanned) {
    ...
    */
    ...
    private <T> T process(@NonNull CharSequence charSequence, @IntRange(from = 0) int i2, @IntRange(from = 0) int i3, @IntRange(from = 0) int i4, boolean z2, EmojiProcessCallback<T> emojiProcessCallback) {
        int iCharCount;
        ProcessorSm processorSm = new ProcessorSm(this.mMetadataRepo.getRootNode(), this.mUseEmojiAsDefaultStyle, this.mEmojiAsDefaultStyleExceptions);
        int i5 = 0;
