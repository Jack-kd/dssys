    ...
    public static String decodeUtf8Array(byte[] bArr, int i2, int i3) throws IllegalArgumentException {
        ...
        while (i2 < i4) {
            ...
            if (Utf8.DecodeUtil.isOneByte(b4)) {
                ...
                int i10 = i2 + 2;
                i2 += 3;
                Utf8.DecodeUtil.handleThreeBytes(b4, bArr[i7], bArr[i10], cArr, i6);
                i6++;
            } else {
                if (i7 >= i4 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                byte b7 = bArr[i2 + 2];
                i2 += 4;
                Utf8.DecodeUtil.handleFourBytes(b4, b6, b7, bArr[i11], cArr, i6);
                i6 += 2;
            }
        }
    ...
    public static String decodeUtf8Buffer(ByteBuffer byteBuffer, int i2, int i3) throws IllegalArgumentException {
        ...
        while (i2 < i4) {
            ...
            if (Utf8.DecodeUtil.isOneByte(b4)) {
                ...
                int i10 = i2 + 2;
                i2 += 3;
                Utf8.DecodeUtil.handleThreeBytes(b4, byteBuffer.get(i7), byteBuffer.get(i10), cArr, i6);
                i6++;
            } else {
                if (i7 >= i4 - 2) {
                    throw new IllegalArgumentException("Invalid UTF-8");
                ...
                i2 += 4;
                Utf8.DecodeUtil.handleFourBytes(b4, b6, b7, byteBuffer.get(i11), cArr, i6);
                i6 += 2;
            }
        }
        return new String(cArr, 0, i6);
