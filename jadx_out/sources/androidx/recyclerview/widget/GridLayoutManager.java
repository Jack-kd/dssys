    ...
    public void layoutChunk(RecyclerView.Recycler recycler, RecyclerView.State state, LinearLayoutManager.LayoutState layoutState, LinearLayoutManager.LayoutChunkResult layoutChunkResult) {
        ...
        if (z2) {
            ...
            for (int i10 = 0; i10 < i6; i10++) {
                ...
                measureChild(view2, C.ENCODING_PCM_32BIT, true);
        ...
        for (int i11 = 0; i11 < i6; i11++) {
            ...
            if (this.mOrientationHelper.getDecoratedMeasurement(view3) != i8) {
                ...
                int spaceForSpanRange = getSpaceForSpanRange(layoutParams.mSpanIndex, layoutParams.mSpanSize);
                if (this.mOrientation == 1) {
                    childMeasureSpec2 = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, C.ENCODING_PCM_32BIT, i13, ((ViewGroup.MarginLayoutParams) layoutParams).width, false);
                    childMeasureSpec = View.MeasureSpec.makeMeasureSpec(i8 - i12, C.ENCODING_PCM_32BIT);
                } else {
                    int iMakeMeasureSpec = View.MeasureSpec.makeMeasureSpec(i8 - i13, C.ENCODING_PCM_32BIT);
                    childMeasureSpec = RecyclerView.LayoutManager.getChildMeasureSpec(spaceForSpanRange, C.ENCODING_PCM_32BIT, i12, ((ViewGroup.MarginLayoutParams) layoutParams).height, false);
