...
public abstract class LogController extends AbstractController<JPanel> {
    ...
    public void adjustTableUI() {
        ...
        this.logTable.getColumnModel().getColumn(3).setMaxWidth(MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL);
    ...
    public List<LogMessage> getSelectedMessages() {
        ...
        for (int i2 : this.logTable.getSelectedRows()) {
            arrayList.add((LogMessage) this.logTableModel.getValueAt(i2, 0));
        }
        return arrayList;
    }
