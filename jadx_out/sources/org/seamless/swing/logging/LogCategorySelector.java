...
public class LogCategorySelector extends JDialog {
    ...
    public LogCategorySelector(List<LogCategory> list) {
        ...
        add(jScrollPane);
        setMaximumSize(new Dimension(750, MediaPlayer.MEDIA_PLAYER_OPTION_FORCE_CLOSE_CODEC));
        setResizable(false);
        pack();
    }
    ...
    public void addLoggerGroups(final LogCategory logCategory, final JPanel jPanel) {
        ...
        for (final LogCategory.Group group : logCategory.getGroups()) {
            ...
            jCheckBox.addItemListener(new ItemListener() { // from class: org.seamless.swing.logging.LogCategorySelector.1
                public void itemStateChanged(ItemEvent itemEvent) throws SecurityException {
    ...
    public void disableLoggerGroup(LogCategory.Group group) throws SecurityException {
    ...
    public void enableLoggerGroup(LogCategory.Group group) throws SecurityException {
