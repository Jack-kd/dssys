...
public class XmlPullParserUtils {
    ...
    static {
        try {
            ...
            log.severe("cannot create XmlPullParserFactory instance: " + e2);
        }
    }
    ...
    public static String fixXMLEntities(String str) {
        ...
        for (int i2 = 0; i2 < str.length(); i2++) {
            ...
            if (cCharAt == '&') {
                String strSubstring = str.substring(i2, Math.min(i2 + 10, str.length()));
    ...
    public static void setSerializerIndentation(XmlSerializer xmlSerializer, int i2) throws IllegalStateException, IllegalArgumentException {
        if (i2 > 0) {
            try {
                xmlSerializer.setFeature("http://xmlpull.org/v1/doc/features.html#indent-output", true);
            } catch (Exception e2) {
                log.warning("error setting feature of XmlSerializer: " + e2);
            }
        }
    }
