...
public class SAXParser {
    ...
    public static class Handler<I> extends DefaultHandler {
        ...
        public void characters(char[] cArr, int i2, int i3) throws SAXException {
            this.characters.append(cArr, i2, i3);
        }
        ...
        public Handler(I i2, SAXParser sAXParser) {
            this(i2, sAXParser, null);
        }

        public Handler(I i2, Handler handler) {
            this(i2, handler.getParser(), handler);
        }

        public Handler(I i2, SAXParser sAXParser, Handler handler) {
            this.characters = new StringBuilder();
            this.instance = i2;
    ...
    public void parse(InputSource inputSource) throws SAXException, IOException, ParserException {
        try {
    ...
    public SAXParser(DefaultHandler defaultHandler) throws ParserConfigurationException, SAXException {
