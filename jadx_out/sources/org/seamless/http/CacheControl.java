...
public class CacheControl {
    ...
    public void setMustRevalidate(boolean z2) {
    ...
    public void setNoStore(boolean z2) {
        this.noStore = z2;
    }

    public void setNoTransform(boolean z2) {
        this.noTransform = z2;
    }
    ...
    public void setPrivateFlag(boolean z2) {
        this.privateFlag = z2;
    }

    public void setProxyRevalidate(boolean z2) {
        this.proxyRevalidate = z2;
    }

    public void setSharedMaxAge(int i2) {
        this.sharedMaxAge = i2;
    }
