...
public class RequestInfo {
    ...
    public static void dumpRequestHeaders(long j2, HttpServletRequest httpServletRequest) {
        dumpRequestHeaders(j2, "REQUEST HEADERS", httpServletRequest);
    }

    public static void dumpRequestString(long j2, HttpServletRequest httpServletRequest) {
        log.info(getRequestInfoString(j2, httpServletRequest));
    }
    ...
    public static String getRequestInfoString(long j2, HttpServletRequest httpServletRequest) {
        return String.format("%s %s %s %s %s %d", httpServletRequest.getMethod(), httpServletRequest.getRequestURI(), httpServletRequest.getProtocol(), httpServletRequest.getParameterMap(), httpServletRequest.getRemoteAddr(), Long.valueOf(j2));
    }
    ...
    public static void dumpRequestHeaders(long j2, String str, HttpServletRequest httpServletRequest) {
        log.info(str);
        dumpRequestString(j2, httpServletRequest);
        Enumeration headerNames = httpServletRequest.getHeaderNames();
        if (headerNames != null) {
            while (headerNames.hasMoreElements()) {
