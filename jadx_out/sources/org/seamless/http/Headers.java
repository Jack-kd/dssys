...
public class Headers implements Map<String, List<String>> {
    ...
    public int findNonWhitespace(String str, int i2) {
    ...
    public String[] splitHeader(String str) {
        ...
        while (i2 < str.length() && (cCharAt = str.charAt(i2)) != ':' && !Character.isWhitespace(cCharAt)) {
            i2++;
        }
        int i3 = i2;
        while (true) {
        ...
        int iFindNonWhitespace2 = findNonWhitespace(str, i3);
        int iFindEndOfString = findEndOfString(str);
        return new String[]{str.substring(iFindNonWhitespace, i2), (str.length() < iFindNonWhitespace2 || str.length() < iFindEndOfString || iFindNonWhitespace2 >= iFindEndOfString) ? null : str.substring(iFindNonWhitespace2, iFindEndOfString)};
    }
    ...
    public Headers(boolean z2) {
        this.map = new HashMap(32);
        this.normalizeHeaders = z2;
    }
}
