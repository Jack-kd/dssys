...
public class Reflections {
    ...
    public static Object get(Field field, Object obj) throws Exception {
        ...
        try {
            try {
                ...
                throw new IllegalArgumentException("Could not get field value by reflection: " + toString(field) + " on: " + obj.getClass().getName(), e2);
            }
        } finally {
    ...
    public static Object getAndWrap(Field field, Object obj) throws SecurityException {
        boolean zIsAccessible = field.isAccessible();
        try {
            try {
                field.setAccessible(true);
    ...
    public static Method getGetterMethod(Class cls, String str) throws SecurityException {
        while (cls != null && cls != Object.class) {
    ...
    public static List<Method> getMethods(Class cls, Class cls2) throws SecurityException {
        ArrayList arrayList = new ArrayList();
        while (cls != null && cls != Object.class) {
            for (Method method : cls.getDeclaredMethods()) {
    ...
    public static Method getSetterMethod(Class cls, String str) throws SecurityException {
    ...
    private static boolean instanceOf(Class cls, String str) {
        ...
        for (int i2 = 0; i2 < interfaces.length && !zInstanceOf; i2++) {
            zInstanceOf = instanceOf(interfaces[i2], str);
        }
        return zInstanceOf;
    }
    ...
    public static void setAndWrap(Field field, Object obj, Object obj2) throws SecurityException {
        boolean zIsAccessible = field.isAccessible();
        try {
            try {
                field.setAccessible(true);
