...
public class UDA10DeviceDescriptorBinderSAXImpl extends UDA10DeviceDescriptorBinderImpl {
    ...
    public static class DeviceDescriptorHandler<I> extends SAXParser.Handler<I> {
        public DeviceDescriptorHandler(I i2) {
            super(i2);
        }
        ...
        public DeviceDescriptorHandler(I i2, SAXParser sAXParser) {
            super(i2, sAXParser);
        }
        ...
        public DeviceDescriptorHandler(I i2, DeviceDescriptorHandler deviceDescriptorHandler) {
            super(i2, deviceDescriptorHandler);
        }

        public DeviceDescriptorHandler(I i2, SAXParser sAXParser, DeviceDescriptorHandler deviceDescriptorHandler) {
            super(i2, sAXParser, deviceDescriptorHandler);
        }
    }
            ...
            switch (AnonymousClass1.$SwitchMap$org$fourthline$cling$binding$xml$Descriptor$Device$ELEMENT[element.ordinal()]) {
                ...
                case 20:
                    try {
                        ...
                        UDA10DeviceDescriptorBinderSAXImpl.log.warning("Invalid icon depth '" + getCharacters() + "', using 16 as default: " + e2);
    ...
    public static class ServiceHandler extends DeviceDescriptorHandler<MutableService> {
        ...
        public void endElement(Descriptor.Device.ELEMENT element) throws SAXException {
            try {
                ...
                UDA10DeviceDescriptorBinderSAXImpl.log.warning("UPnP specification violation, skipping invalid service declaration. " + e2.getMessage());
            }
        }
    ...
    public static class SpecVersionHandler extends DeviceDescriptorHandler<MutableUDAVersion> {
        ...
        @Override // org.fourthline.cling.binding.xml.UDA10DeviceDescriptorBinderSAXImpl.DeviceDescriptorHandler
        public void endElement(Descriptor.Device.ELEMENT element) throws SAXException {
            int i2 = AnonymousClass1.$SwitchMap$org$fourthline$cling$binding$xml$Descriptor$Device$ELEMENT[element.ordinal()];
            if (i2 == 2) {
    ...
    public <D extends Device> D describe(D d2, String str) throws ValidationException, DescriptorBindingException {
        ...
        try {
            ...
            return (D) mutableDevice.build(d2);
