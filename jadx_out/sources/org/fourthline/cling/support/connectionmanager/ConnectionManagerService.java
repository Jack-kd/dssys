...
public class ConnectionManagerService {
    ...
    public synchronized ConnectionInfo getCurrentConnectionInfo(@UpnpInputArgument(name = "ConnectionID") int i2) throws ActionException {
        ConnectionInfo connectionInfo;
        log.fine("Getting connection information of connection ID: " + i2);
        connectionInfo = this.activeConnections.get(Integer.valueOf(i2));
