...
public class DIDLParser extends SAXParser {
    ...
    public abstract class DIDLObjectHandler<I extends DIDLObject> extends SAXParser.Handler<I> {
        public DIDLObjectHandler(I i2, SAXParser.Handler handler) {
            super(i2, handler);
        }
            ...
            if (DIDLObject.Property.UPNP.NAMESPACE.URI.equals(str)) {
                ...
                if ("albumArtURI".equals(str2)) {
                    ...
                    for (int i2 = 0; i2 < attributes.getLength(); i2++) {
                        if ("profileID".equals(attributes.getLocalName(i2))) {
                            album_art_uri.addAttribute(new DIDLObject.Property.DLNA.PROFILE_ID(new DIDLAttribute(DIDLObject.Property.DLNA.NAMESPACE.URI, Descriptor.Device.DLNA_PREFIX, attributes.getValue(i2))));
                        }
                    }
    ...
    public class DescMetaHandler extends SAXParser.Handler<DescMeta> {
        ...
        @Override // org.seamless.xml.SAXParser.Handler, org.xml.sax.helpers.DefaultHandler, org.xml.sax.ContentHandler
        public void endElement(String str, String str2, String str3) throws SAXException, DOMException {
            super.endElement(str, str2, str3);
        ...
        @Override // org.seamless.xml.SAXParser.Handler, org.xml.sax.helpers.DefaultHandler, org.xml.sax.ContentHandler
        public void startElement(String str, String str2, String str3, Attributes attributes) throws SAXException, DOMException {
            super.startElement(str, str2, str3, attributes);
            Element elementCreateElementNS = ((Document) getInstance().getMetadata()).createElementNS(str, str3);
            for (int i2 = 0; i2 < attributes.getLength(); i2++) {
                elementCreateElementNS.setAttributeNS(attributes.getURI(i2), attributes.getQName(i2), attributes.getValue(i2));
            }
    ...
    public void appendClass(Document document, Element element, DIDLObject.Class r5, String str, boolean z2) throws DOMException {
    ...
    public String booleanToInt(boolean z2) {
        return z2 ? "1" : "0";
    }

    public Document buildDOM(DIDLContent dIDLContent, boolean z2) throws Exception {
        ...
        generateRoot(dIDLContent, documentNewDocument, z2);
    ...
    public Res createResource(Attributes attributes) {
        ...
        try {
            ...
            if (attributes.getValue(MediaFormat.KEY_BIT_RATE) != null) {
                res.setBitrate(toLongOrNull(attributes.getValue(MediaFormat.KEY_BIT_RATE)));
            }
            ...
            if (attributes.getValue(bv.f48925z) != null) {
                res.setResolution(attributes.getValue(bv.f48925z));
            }
            return res;
        } catch (InvalidValueException e2) {
            log.warning("In DIDL content, invalid resource protocol info: " + Exceptions.unwrap(e2));
            return null;
        }
    }
    ...
    public String documentToString(Document document, boolean z2) throws Exception {
    ...
    public void generateContainer(Container container, Document document, Element element, boolean z2) throws DOMException {
    ...
    public void generateResource(Res res, Document document, Element element) throws DOMException {
        ...
        if (res.getBitrate() != null) {
            elementAppendNewElement.setAttribute(MediaFormat.KEY_BIT_RATE, res.getBitrate().toString());
        }
        ...
        if (res.getResolution() != null) {
            elementAppendNewElement.setAttribute(bv.f48925z, res.getResolution());
        }
    }

    public void generateRoot(DIDLContent dIDLContent, Document document, boolean z2) throws DOMException {
        ...
        for (Container container : dIDLContent.getContainers()) {
            if (container != null) {
                generateContainer(container, document, elementCreateElementNS, z2);
            }
        }
    ...
    public void populateDescMetadata(Element element, DescMeta descMeta) throws DOMException {
    ...
    public String generate(DIDLContent dIDLContent, boolean z2) throws Exception {
        return documentToString(buildDOM(dIDLContent, z2), true);
    }
}
