...
public abstract class Browse extends ActionCallback {
    ...
    public Browse(Service service, String str, BrowseFlag browseFlag, String str2, long j2, Long l2, SortCriterion... sortCriterionArr) throws InvalidValueException {
        ...
        getActionInvocation().setInput("StartingIndex", new UnsignedIntegerFourBytes(j2));
