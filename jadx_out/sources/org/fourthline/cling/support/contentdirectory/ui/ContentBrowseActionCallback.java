...
public abstract class ContentBrowseActionCallback extends Browse {
    ...
    public void received(ActionInvocation actionInvocation, DIDLContent dIDLContent) {
        ...
        try {
            ...
            log.fine("Creating DIDL tree nodes failed: " + e2);
            actionInvocation.setFailure(new ActionException(ErrorCode.ACTION_FAILED, "Can't create tree child nodes: " + e2, e2));
    ...
    public ContentBrowseActionCallback(Service service, DefaultTreeModel defaultTreeModel, DefaultMutableTreeNode defaultMutableTreeNode, String str, long j2, long j3, SortCriterion... sortCriterionArr) {
        super(service, ((Container) defaultMutableTreeNode.getUserObject()).getId(), BrowseFlag.DIRECT_CHILDREN, str, j2, Long.valueOf(j3), sortCriterionArr);
        this.treeModel = defaultTreeModel;
        this.treeNode = defaultMutableTreeNode;
    }
}
