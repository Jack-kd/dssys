...
public class AVTransportService<T extends AVTransport> extends AbstractAVTransportService {
    ...
    public UnsignedIntegerFourBytes[] getCurrentInstanceIds() {
        ...
        synchronized (this.stateMachines) {
            try {
                ...
                int i2 = 0;
                while (it.hasNext()) {
                    unsignedIntegerFourBytesArr[i2] = new UnsignedIntegerFourBytes(it.next().longValue());
                    i2++;
                }
            } catch (Throwable th) {
                throw th;
    ...
    public AVTransportStateMachine findStateMachine(UnsignedIntegerFourBytes unsignedIntegerFourBytes, boolean z2) throws AVTransportException {
        ...
        synchronized (this.stateMachines) {
            try {
                ...
                if (aVTransportStateMachineCreateStateMachine == null && jLongValue == 0 && z2) {
