...
public abstract class DIDLObject {
    ...
    public static class Class {
        ...
        public void setIncludeDerived(boolean z2) {
            this.includeDerived = z2;
        }
        ...
        public Class(String str, String str2, boolean z2) {
            this.value = str;
            this.friendlyName = str2;
            this.includeDerived = z2;
        }
    ...
    public DIDLObject setRestricted(boolean z2) {
        this.restricted = z2;
        return this;
    }
    ...
    public DIDLObject(String str, String str2, String str3, String str4, boolean z2, WriteStatus writeStatus, Class r8, List<Res> list, List<Property> list2, List<DescMeta> list3) {
        this.restricted = true;
        this.resources = new ArrayList();
        this.properties = new ArrayList();
        new ArrayList();
