...
public class PortMapping {
    ...
    public PortMapping(int i2, String str, Protocol protocol) {
        long j2 = i2;
        this(true, new UnsignedIntegerFourBytes(0L), null, new UnsignedIntegerTwoBytes(j2), new UnsignedIntegerTwoBytes(j2), str, protocol, null);
    }

    /* JADX WARN: Illegal instructions before constructor call */
    public PortMapping(int i2, String str, Protocol protocol, String str2) {
        long j2 = i2;
        this(true, new UnsignedIntegerFourBytes(0L), null, new UnsignedIntegerTwoBytes(j2), new UnsignedIntegerTwoBytes(j2), str, protocol, str2);
    }
    ...
    public PortMapping(boolean z2, UnsignedIntegerFourBytes unsignedIntegerFourBytes, String str, UnsignedIntegerTwoBytes unsignedIntegerTwoBytes, UnsignedIntegerTwoBytes unsignedIntegerTwoBytes2, String str2, Protocol protocol, String str3) {
        this.enabled = z2;
        this.leaseDurationSeconds = unsignedIntegerFourBytes;
        this.remoteHost = str;
        this.externalPort = unsignedIntegerTwoBytes;
