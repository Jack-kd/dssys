...
public class Item extends DIDLObject {
    ...
    public Item(String str, String str2, String str3, String str4, boolean z2, WriteStatus writeStatus, DIDLObject.Class r7, List<Res> list, List<DIDLObject.Property> list2, List<DescMeta> list3) {
        super(str, str2, str3, str4, z2, writeStatus, r7, list, list2, list3);
    }

    public Item(String str, String str2, String str3, String str4, boolean z2, WriteStatus writeStatus, DIDLObject.Class r7, List<Res> list, List<DIDLObject.Property> list2, List<DescMeta> list3, String str5) {
        super(str, str2, str3, str4, z2, writeStatus, r7, list, list2, list3);
        this.refID = str5;
    }
