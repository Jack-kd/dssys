...
public class Container extends DIDLObject {
    ...
    public Container(String str, String str2, String str3, String str4, boolean z2, WriteStatus writeStatus, DIDLObject.Class r7, List<Res> list, List<DIDLObject.Property> list2, List<DescMeta> list3) {
        super(str, str2, str3, str4, z2, writeStatus, r7, list, list2, list3);
        this.childCount = null;
        this.createClasses = new ArrayList();
        this.searchClasses = new ArrayList();
        this.containers = new ArrayList();
    ...
    public Container(String str, String str2, String str3, String str4, boolean z2, WriteStatus writeStatus, DIDLObject.Class r7, List<Res> list, List<DIDLObject.Property> list2, List<DescMeta> list3, Integer num, boolean z3, List<DIDLObject.Class> list4, List<DIDLObject.Class> list5, List<Item> list6) {
        super(str, str2, str3, str4, z2, writeStatus, r7, list, list2, list3);
        this.childCount = null;
        this.createClasses = new ArrayList();
        this.searchClasses = new ArrayList();
    ...
    public Container(String str, Container container, String str2, String str3, DIDLObject.Class r21, Integer num, boolean z2, List<DIDLObject.Class> list, List<DIDLObject.Class> list2, List<Item> list3) {
        this(str, container.getId(), str2, str3, true, null, r21, new ArrayList(), new ArrayList(), new ArrayList(), num, z2, list, list2, list3);
    }

    public Container(String str, String str2, String str3, String str4, DIDLObject.Class r21, Integer num, boolean z2, List<DIDLObject.Class> list, List<DIDLObject.Class> list2, List<Item> list3) {
        this(str, str2, str3, str4, true, null, r21, new ArrayList(), new ArrayList(), new ArrayList(), num, z2, list, list2, list3);
    }
}
