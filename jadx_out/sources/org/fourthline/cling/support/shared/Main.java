...
public abstract class Main implements ShutdownHandler, Thread.UncaughtExceptionHandler {
    ...
    public void init() throws SecurityException {
        ...
        this.errorWindow.setPreferredSize(new Dimension(900, MediaPlayer.MEDIA_PLAYER_OPTION_USE_CODEC_POOL));
    ...
    public void removeLoggingHandler() throws SecurityException {
