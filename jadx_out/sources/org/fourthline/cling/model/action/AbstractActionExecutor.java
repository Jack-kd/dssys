...
public abstract class AbstractActionExecutor implements ActionExecutor {
    ...
    public void execute(final ActionInvocation<LocalService> actionInvocation) throws IllegalArgumentException {
        ...
        try {
            ...
            if (logger.isLoggable(level)) {
                ...
                log.log(level, "Exception root cause: ", Exceptions.unwrap(e2));
            }
            ...
            if (logger2.isLoggable(level2)) {
                log.fine("ActionException thrown by service, wrapping in invocation and returning: " + e3);
                log.log(level2, "Exception root cause: ", Exceptions.unwrap(e3));
            }
            actionInvocation.setFailure(e3);
        } catch (Throwable th) {
    ...
    public Object readOutputArgumentValues(Action<LocalService> action, Object obj) throws Exception {
        ...
        int i3 = 0;
        while (i2 < length2) {
            Object obj2 = outputArguments[i2];
            ...
            objArr[i3] = stateVariableAccessor.read(obj);
            i2++;
            i3++;
        }
        if (length == 1) {
