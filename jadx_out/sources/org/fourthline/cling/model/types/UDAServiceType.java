...
public class UDAServiceType extends ServiceType {
    ...
    public static UDAServiceType valueOf(String str) throws InvalidValueException {
        ...
        try {
            ...
            throw new InvalidValueException(String.format("Can't parse UDA service type string (namespace/type/version) '%s': %s", str, e2.toString()));
        }
    }

    public UDAServiceType(String str, int i2) {
