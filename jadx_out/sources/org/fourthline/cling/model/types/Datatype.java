...
public interface Datatype<V> {
    ...
    public enum Builtin {
        ...
        INT(IAdInterListener.AdProdType.PRODUCT_INTERSTITIAL, new IntegerDatatype(4)),
        ...
        URI(ContentProviderManager.PROVIDER_URI, new URIDatatype()),
    ...
    public static final class Default {
        ...
        static {
            ...
            Default r12 = new Default("BOOLEAN", 0, Boolean.class, builtin);
            BOOLEAN = r12;
            ...
            Default r122 = new Default("DOUBLE", 11, Double.class, builtin5);
            DOUBLE = r122;
            ...
            CHAR_PRIMITIVE = r15;
            Default r02 = new Default("STRING", 15, String.class, Builtin.STRING);
            STRING = r02;
            Default r16 = new Default("CALENDAR", 16, Calendar.class, Builtin.DATETIME);
            CALENDAR = r16;
            Default r03 = new Default("BYTES", 17, byte[].class, Builtin.BIN_BASE64);
            BYTES = r03;
            Default r17 = new Default("URI", 18, URI.class, Builtin.URI);
            URI = r17;
            $VALUES = new Default[]{r12, r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r122, r13, r14, r15, r02, r16, r03, r17};
        }

        private Default(String str, int i2, Class cls, Builtin builtin) {
            this.javaType = cls;
