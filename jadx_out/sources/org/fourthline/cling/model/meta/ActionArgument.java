...
public class ActionArgument<S extends Service> implements Validatable {
    ...
    public ActionArgument(String str, String str2, Direction direction, boolean z2) {
        this(str, new String[0], str2, direction, z2);
    }

    public ActionArgument(String str, String[] strArr, String str2, Direction direction, boolean z2) {
        this.name = str;
        this.aliases = strArr;
