...
public class ProtocolFactoryImpl implements ProtocolFactory {
    ...
    public ReceivingAsync createReceivingAsync(IncomingDatagramMessage incomingDatagramMessage) throws ProtocolCreationException {
        ...
        if (incomingDatagramMessage.getOperation() instanceof UpnpRequest) {
            int i2 = AnonymousClass1.$SwitchMap$org$fourthline$cling$model$message$UpnpRequest$Method[((UpnpRequest) incomingDatagramMessage.getOperation()).getMethod().ordinal()];
            if (i2 == 1) {
    ...
    public SendingSearch createSendingSearch(UpnpHeader upnpHeader, int i2) {
        return new SendingSearch(getUpnpService(), upnpHeader, i2);
    }
