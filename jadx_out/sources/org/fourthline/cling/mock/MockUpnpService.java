...
public class MockUpnpService implements UpnpService {
    ...
    public static class MockProtocolFactory extends ProtocolFactoryImpl {
        ...
        public MockProtocolFactory(UpnpService upnpService, boolean z2) {
            super(upnpService);
            this.sendsAlive = z2;
        }
        ...
        public SendingSearch createSendingSearch(UpnpHeader upnpHeader, int i2) {
            return new SendingSearch(getUpnpService(), upnpHeader, i2) { // from class: org.fourthline.cling.mock.MockUpnpService.MockProtocolFactory.2
    ...
    public ProtocolFactory createProtocolFactory(UpnpService upnpService, boolean z2) {
        return new MockProtocolFactory(upnpService, z2);
    }
    ...
    public MockUpnpService(boolean z2, boolean z3) {
        this(z2, new MockUpnpServiceConfiguration(z3, false));
    }

    public MockUpnpService(boolean z2, boolean z3, boolean z4) {
        this(z2, new MockUpnpServiceConfiguration(z3, z4));
    }

    public MockUpnpService(boolean z2, final MockUpnpServiceConfiguration mockUpnpServiceConfiguration) {
        this.configuration = mockUpnpServiceConfiguration;
        ProtocolFactory protocolFactoryCreateProtocolFactory = createProtocolFactory(this, z2);
