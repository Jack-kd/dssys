...
public class GENAEventProcessorImpl implements GENAEventProcessor, ErrorHandler {
    ...
    public void readBody(IncomingEventRequestMessage incomingEventRequestMessage) throws ParserConfigurationException, FactoryConfigurationError, UnsupportedDataException {
            ...
            if (nodeItem.getNodeType() == 1 && getUnprefixedNodeName(nodeItem).equals("property")) {
                ...
                for (int i3 = 0; i3 < childNodes2.getLength(); i3++) {
                    ...
                    if (nodeItem2.getNodeType() == 1) {
                        ...
                        while (true) {
                            if (i4 < length) {
                                StateVariable<RemoteService> stateVariable = stateVariables[i4];
