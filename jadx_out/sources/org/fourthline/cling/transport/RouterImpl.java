...
public class RouterImpl implements Router {
    ...
    public void lock(Lock lock, int i2) throws RouterException {
        try {
            log.finest("Trying to obtain lock with timeout milliseconds '" + i2 + "': " + lock.getClass().getSimpleName());
    ...
    public void received(IncomingDatagramMessage incomingDatagramMessage) {
        ...
        try {
            ...
            log.warning("Handling received datagram failed - " + Exceptions.unwrap(e2).toString());
        }
    }
    ...
    public void startAddressBasedTransports(Iterator<InetAddress> it) throws IllegalArgumentException, InitializationException {
        while (it.hasNext()) {
