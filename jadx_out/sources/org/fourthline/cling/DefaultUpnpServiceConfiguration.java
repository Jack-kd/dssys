...
public class DefaultUpnpServiceConfiguration implements UpnpServiceConfiguration {
    ...
    public static class ClingExecutor extends ThreadPoolExecutor implements AutoCloseable {
        ...
        public void afterExecute(Runnable runnable, Throwable th) throws IllegalArgumentException {
    ...
    public DefaultUpnpServiceConfiguration(boolean z2) {
        this(0, z2);
    }

    public DefaultUpnpServiceConfiguration(int i2, boolean z2) {
        if (z2 && ModelUtil.ANDROID_RUNTIME) {
