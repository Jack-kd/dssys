...
public interface Registry {
    ...
    void addResource(Resource resource, int i2);

    void advertiseLocalDevices();

    UpnpServiceConfiguration getConfiguration();

    Device getDevice(UDN udn, boolean z2);
    ...
    LocalDevice getLocalDevice(UDN udn, boolean z2);
    ...
    RemoteDevice getRemoteDevice(UDN udn, boolean z2);
