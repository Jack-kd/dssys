...
class RemoteItems extends RegistryItems<RemoteDevice, RemoteGENASubscription> {
    ...
    @Override // org.fourthline.cling.registry.RegistryItems
    public void removeAll() throws RegistrationException {
        removeAll(false);
    }
    ...
    public void resume() {
        ...
        while (i2 < size) {
            ...
            i2++;
            update((RemoteDeviceIdentity) obj);
        }
    }
    ...
    public void shutdown() throws RegistrationException, IllegalArgumentException {
        ...
        while (i2 < size) {
            Object obj = arrayList.get(i2);
            i2++;
            this.registry.getProtocolFactory().createSendingUnsubscribe((RemoteGENASubscription) obj).run();
        }
    ...
    @Override // org.fourthline.cling.registry.RegistryItems
    public void add(final RemoteDevice remoteDevice) throws RegistrationException {
    ...
    public void removeAll(boolean z2) throws RegistrationException {
        for (RemoteDevice remoteDevice : (RemoteDevice[]) get().toArray(new RemoteDevice[get().size()])) {
            remove(remoteDevice, z2);
        }
    }

    public boolean remove(RemoteDevice remoteDevice, boolean z2) throws RegistrationException {
