...
class LocalItems extends RegistryItems<LocalDevice, LocalGENASubscription> {
        ...
        this.registry.executeAsyncProtocol(new Runnable() { // from class: org.fourthline.cling.registry.LocalItems.4
            ...
            public void run() throws InterruptedException, IllegalArgumentException {
                try {
                    ...
                    LocalItems.log.severe("Background execution interrupted: " + e2.getMessage());
                }
    ...
    public void advertiseByebye(LocalDevice localDevice, boolean z2) throws IllegalArgumentException {
    ...
    @Override // org.fourthline.cling.registry.RegistryItems
    public void removeAll() throws RegistrationException, IllegalArgumentException {
        removeAll(false);
    }
    ...
    @Override // org.fourthline.cling.registry.RegistryItems
    public void shutdown() throws RegistrationException, IllegalArgumentException {
    ...
    @Override // org.fourthline.cling.registry.RegistryItems
    public void add(LocalDevice localDevice) throws RegistrationException, IllegalArgumentException {
    ...
    public void removeAll(boolean z2) throws RegistrationException, IllegalArgumentException {
        for (LocalDevice localDevice : (LocalDevice[]) get().toArray(new LocalDevice[get().size()])) {
            remove(localDevice, z2);
        }
    }

    public void add(final LocalDevice localDevice, DiscoveryOptions discoveryOptions) throws RegistrationException, IllegalArgumentException {
    ...
    public boolean remove(final LocalDevice localDevice, boolean z2) throws RegistrationException, IllegalArgumentException {
        ...
        if (isAdvertised(localDevice.getIdentity().getUdn())) {
            advertiseByebye(localDevice, !z2);
        }
        if (!z2) {
            for (final RegistryListener registryListener : this.registry.getListeners()) {
