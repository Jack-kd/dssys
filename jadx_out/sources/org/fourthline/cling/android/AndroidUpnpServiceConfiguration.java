...
public class AndroidUpnpServiceConfiguration extends DefaultUpnpServiceConfiguration {
    ...
    public NetworkAddressFactory createNetworkAddressFactory(int i2) {
        return new AndroidNetworkAddressFactory(i2);
    }
    ...
    public StreamClient createStreamClient() {
        return new StreamClientImpl(new StreamClientConfigurationImpl(getSyncProtocolExecutorService()) { // from class: org.fourthline.cling.android.AndroidUpnpServiceConfiguration.1
            ...
            public String getUserAgentValue(int i2, int i3) {
                ServerClientTokens serverClientTokens = new ServerClientTokens(i2, i3);
                serverClientTokens.setOsName(AnalyticsConstants.SDK_TYPE);
    ...
    public AndroidUpnpServiceConfiguration(int i2) {
        super(i2, false);
