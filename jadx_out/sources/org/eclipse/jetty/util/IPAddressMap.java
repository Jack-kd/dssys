...
public class IPAddressMap<TYPE> extends HashMap<String, TYPE> {
    private final HashMap<String, a> _patterns;

    public static class a {

        /* renamed from: a, reason: collision with root package name */
        public final OctetPattern[] f52604a = new OctetPattern[4];
        ...
        public a(String str) {
            ...
            try {
                StringTokenizer stringTokenizer = new StringTokenizer(str, com.anythink.core.common.d.i.f2495E);
                for (int i2 = 0; i2 < 4; i2++) {
                    ...
                    OctetPattern[] octetPatternArr = this.f52604a;
                    if (length != 0) {
                        str2 = strTrim;
                    }
        ...
        public boolean a(String str) {
            ...
            try {
                ...
                for (int i2 = 0; i2 < 4; i2++) {
                    ...
                    zMatch &= this.f52604a[i2].match(stringTokenizer.nextToken());
                    if (!zMatch) {
                        return zMatch;
                    }
                }
    ...
    public Object getLazyMatches(String str) {
        ...
        for (Map.Entry entry : super.entrySet()) {
            if (this._patterns.get(entry.getKey()).a(str)) {
    ...
    public TYPE put(String str, TYPE type) throws IllegalArgumentException {
        ...
        if (this._patterns.get(strTrim) == null) {
            this._patterns.put(strTrim, new a(strTrim));
        }
