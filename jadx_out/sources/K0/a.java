...
public class a implements b.a {
    ...
    public static class C0004a {
        ...
        public ZipFile f173a;

        /* renamed from: b, reason: collision with root package name */
        public ZipEntry f174b;

        public C0004a(ZipFile zipFile, ZipEntry zipEntry) {
            this.f173a = zipFile;
            this.f174b = zipEntry;
        }
    }
    ...
    */
    public void a(android.content.Context r9, java.lang.String[] r10, java.lang.String r11, java.io.File r12, K0.c r13) throws java.lang.Throwable {
        /*
            r8 = this;
            r0 = 0
            K0.a$a r1 = r8.d(r9, r10, r11, r13)     // Catch: java.lang.Throwable -> Lac
            if (r1 == 0) goto L98
            r9 = 0
            r10 = r9
        L9:
        ...
        L25:
            ...
            goto Lad
        L29:
            java.util.zip.ZipFile r10 = r1.f173a     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L75 java.io.FileNotFoundException -> L78
            java.util.zip.ZipEntry r3 = r1.f174b     // Catch: java.lang.Throwable -> L72 java.io.IOException -> L75 java.io.FileNotFoundException -> L78
        ...
        L50:
            ...
            java.util.zip.ZipFile r9 = r1.f173a     // Catch: java.io.IOException -> L97
            if (r9 == 0) goto L97
        L64:
        ...
        Lad:
            if (r0 == 0) goto Lb6
            java.util.zip.ZipFile r10 = r0.f173a     // Catch: java.io.IOException -> Lb6
            if (r10 == 0) goto Lb6
            r10.close()     // Catch: java.io.IOException -> Lb6
        Lb6:
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: K0.a.a(android.content.Context, java.lang.String[], java.lang.String, java.io.File, K0.c):void");
    }
    ...
    public final C0004a d(Context context, String[] strArr, String str, c cVar) throws IOException {
                ...
                while (true) {
                    ...
                    if (i5 < 5) {
                        for (String str3 : strArr) {
                            ...
                            cVar.j("Looking for %s in APK %s...", string, str2);
                            ZipEntry entry = zipFile.getEntry(string);
                            if (entry != null) {
                                return new C0004a(zipFile, entry);
                            }
                        }
                        i5 = i6;
                    } else {
