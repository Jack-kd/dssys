...
public final class C1744SegmentedByteString extends ByteString {
    ...
    public C1744SegmentedByteString(@NotNull byte[][] segments, @NotNull int[] directory) {
    ...
    private final Object writeReplace() {
        ...
        kotlin.jvm.internal.j.c(byteString, "null cannot be cast to non-null type java.lang.Object");
        return byteString;
    }
    ...
    public void copyInto(int offset, @NotNull byte[] target, int targetOffset, int byteCount) {
        ...
        while (offset < i2) {
            ...
            int i6 = i5 + (offset - i3);
            kotlin.collections.l.d(getSegments()[iSegment], target, targetOffset, i6, i6 + iMin);
            targetOffset += iMin;
            offset += iMin;
            iSegment++;
        }
    ...
    public ByteString substring(int beginIndex, int endIndex) {
        ...
        byte[][] bArr = (byte[][]) kotlin.collections.l.o(getSegments(), iSegment, iSegment2 + 1);
    ...
    public byte[] toByteArray() {
        ...
        while (i2 < length) {
            ...
            int i6 = getDirectory()[i2];
            int i7 = i6 - i3;
            kotlin.collections.l.d(getSegments()[i2], bArr, i4, i5, i5 + i7);
            i4 += i7;
            i2++;
            i3 = i6;
        }
    ...
    public boolean rangeEquals(int offset, @NotNull byte[] other, int otherOffset, int byteCount) {
        ...
        while (offset < i2) {
            ...
            int i5 = getDirectory()[getSegments().length + iSegment];
            int iMin = Math.min(i2, i4 + i3) - offset;
            if (!SegmentedByteString.arrayRangeEquals(getSegments()[iSegment], i5 + (offset - i3), other, otherOffset, iMin)) {
                return false;
            }
            otherOffset += iMin;
            offset += iMin;
