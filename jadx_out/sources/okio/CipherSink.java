    ...
    private final int update(Buffer source, long remaining) throws IOException, ShortBufferException {
        ...
        while (outputSize > 8192) {
            ...
            if (i2 <= i3) {
                ...
                kotlin.jvm.internal.j.d(bArrUpdate, "update(...)");
        ...
        source.setSize$okio(source.size() - i2);
        int i4 = segment.pos + i2;
        segment.pos = i4;
        if (i4 == segment.limit) {
