...
public final class Path {
    ...
    static {
        ...
        DOT = companion.encodeUtf8(i.f2495E);
    ...
    public static final boolean commonEquals(@NotNull okio.Path path, @Nullable Object obj) {
        j.e(path, "<this>");
        return (obj instanceof okio.Path) && j.a(((okio.Path) obj).getBytes(), path.getBytes());
    }
    ...
    public static final okio.Path commonParent(@NotNull okio.Path path) {
        j.e(path, "<this>");
        if (j.a(path.getBytes(), DOT) || j.a(path.getBytes(), SLASH) || j.a(path.getBytes(), BACKSLASH) || lastSegmentIsDotDot(path)) {
            return null;
        }
        int indexOfLastSlash = getIndexOfLastSlash(path);
    ...
    public static final okio.Path commonRelativeTo(@NotNull okio.Path path, @NotNull okio.Path other) {
        j.e(path, "<this>");
        j.e(other, "other");
        if (!j.a(path.getRoot(), other.getRoot())) {
        ...
        int i2 = 0;
        while (i2 < iMin && j.a(segmentsBytes.get(i2), segmentsBytes2.get(i2))) {
            i2++;
        }
        if (i2 == iMin && path.getBytes().size() == other.getBytes().size()) {
            return Path.Companion.get$default(okio.Path.INSTANCE, i.f2495E, false, 1, (Object) null);
        }
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull String child, boolean z2) {
        j.e(path, "<this>");
        j.e(child, "child");
    ...
    public static final List<String> commonSegments(@NotNull okio.Path path) {
        ...
        while (iRootLength < size) {
            if (path.getBytes().getByte(iRootLength) == 47 || path.getBytes().getByte(iRootLength) == 92) {
                arrayList.add(path.getBytes().substring(i3, iRootLength));
                i3 = iRootLength + 1;
            }
            iRootLength++;
        }
        if (i3 < path.getBytes().size()) {
            arrayList.add(path.getBytes().substring(i3, path.getBytes().size()));
        }
    ...
    private static final boolean startsWithVolumeLetterAndColon(Buffer buffer, ByteString byteString) {
        if (!j.a(byteString, BACKSLASH) || buffer.size() < 2 || buffer.getByte(1L) != 58) {
            return false;
        }
    ...
    @NotNull
    public static final okio.Path toPath(@NotNull Buffer buffer, boolean z2) throws EOFException {
        ...
        boolean z3 = i2 >= 2 && j.a(slash, byteString);
        if (z3) {
            j.b(slash);
            buffer2.write(slash);
            buffer2.write(slash);
        ...
        while (!buffer.exhausted()) {
            ...
            if (j.a(byteString2, byteString3)) {
                if (!z4 || !arrayList.isEmpty()) {
                    if (!z2 || (!z4 && (arrayList.isEmpty() || j.a(y.R(arrayList), byteString3)))) {
                        arrayList.add(byteString2);
                    } else if (!z3 || arrayList.size() != 1) {
                        v.D(arrayList);
                    }
                }
            } else if (!j.a(byteString2, DOT) && !j.a(byteString2, ByteString.EMPTY)) {
                arrayList.add(byteString2);
            }
        }
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull ByteString child, boolean z2) {
        j.e(path, "<this>");
        j.e(child, "child");
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull Buffer child, boolean z2) {
        j.e(path, "<this>");
        j.e(child, "child");
    ...
    @NotNull
    public static final okio.Path commonResolve(@NotNull okio.Path path, @NotNull okio.Path child, boolean z2) {
        j.e(path, "<this>");
        j.e(child, "child");
