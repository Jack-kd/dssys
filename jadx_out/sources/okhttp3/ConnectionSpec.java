...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, AbstractC1787a.b());
        } else {
    ...
    public final List<CipherSuite> m114deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m116deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(@NotNull SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), AbstractC1787a.b())) {
            return false;
        }
