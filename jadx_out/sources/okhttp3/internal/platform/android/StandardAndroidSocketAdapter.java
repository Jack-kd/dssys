    ...
    public static final class Companion {
        ...
        public final SocketAdapter buildIfSupported(@NotNull String packageName) throws ClassNotFoundException {
            ...
            try {
                ...
                j.c(cls, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocket>");
                Class<?> cls2 = Class.forName(packageName + ".OpenSSLSocketFactoryImpl");
                j.c(cls2, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocketFactory>");
                Class<?> paramsClass = Class.forName(packageName + ".SSLParametersImpl");
                j.d(paramsClass, "paramsClass");
