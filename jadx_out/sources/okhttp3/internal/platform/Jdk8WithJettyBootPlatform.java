...
public final class Jdk8WithJettyBootPlatform extends Platform {
    ...
    public static final class AlpnProvider implements InvocationHandler {
        ...
        public Object invoke(@NotNull Object proxy, @NotNull Method method, @Nullable Object[] args) throws Throwable {
            ...
            if (j.a(name, "protocols") && args.length == 0) {
                return this.protocols;
            }
            if ((j.a(name, "selectProtocol") || j.a(name, "select")) && j.a(String.class, returnType) && args.length == 1) {
                Object obj = args[0];
    ...
    public static final class Companion {
        ...
        public final Platform buildIfSupported() {
            ...
            try {
                ...
                j.d(putMethod, "putMethod");
                j.d(getMethod, "getMethod");
                j.d(removeMethod, "removeMethod");
                j.d(clientProviderClass, "clientProviderClass");
                j.d(serverProviderClass, "serverProviderClass");
    ...
    public Jdk8WithJettyBootPlatform(@NotNull Method putMethod, @NotNull Method getMethod, @NotNull Method removeMethod, @NotNull Class<?> clientProviderClass, @NotNull Class<?> serverProviderClass) {
        j.e(putMethod, "putMethod");
        j.e(getMethod, "getMethod");
        j.e(removeMethod, "removeMethod");
        j.e(clientProviderClass, "clientProviderClass");
        j.e(serverProviderClass, "serverProviderClass");
    ...
    public String getSelectedProtocol(@NotNull SSLSocket sslSocket) throws IllegalArgumentException {
        ...
        try {
            ...
            j.c(invocationHandler, "null cannot be cast to non-null type okhttp3.internal.platform.Jdk8WithJettyBootPlatform.AlpnProvider");
