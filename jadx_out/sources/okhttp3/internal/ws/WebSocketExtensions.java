    ...
    public static final class Companion {
        ...
        public final WebSocketExtensions parse(@NotNull Headers responseHeaders) throws IOException {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                if (z.v(responseHeaders.name(i2), WebSocketExtensions.HEADER_WEB_SOCKET_EXTENSION, true)) {
                    ...
                    while (i3 < strValue.length()) {
                        ...
                        if (z.v(strTrimSubstring, "permessage-deflate", true)) {
                            if (!z2) {
                                z5 = true;
                                while (i5 < iDelimiterOffset$default) {
                                    ...
                                    String strN0 = iDelimiterOffset3 < iDelimiterOffset2 ? B.n0(Util.trimSubstring(strValue, iDelimiterOffset3 + 1, iDelimiterOffset2), "\"") : null;
                                    int i6 = iDelimiterOffset2 + 1;
                                    if (z.v(strTrimSubstring2, "client_max_window_bits", true)) {
                                        if (numM != null) {
                                            z5 = true;
                                        }
                                        numM = strN0 != null ? y.m(strN0) : null;
                                        i5 = numM == null ? i6 : i6;
                                    } else if (z.v(strTrimSubstring2, "client_no_context_takeover", true)) {
                                        if (z3) {
                                            z5 = true;
                                        }
                                        if (strN0 != null) {
                                        ...
                                        i5 = i6;
                                        z3 = true;
                                    } else if (z.v(strTrimSubstring2, "server_max_window_bits", true)) {
                                        if (numM2 != null) {
                                            z5 = true;
                                        }
                                        numM2 = strN0 != null ? y.m(strN0) : null;
                                        if (numM2 == null) {
                                        }
                                    } else if (z.v(strTrimSubstring2, "server_no_context_takeover", true)) {
                                        if (z4) {
                                            z5 = true;
                                        }
                                        if (strN0 != null) {
            ...
            return new WebSocketExtensions(z2, numM, z3, numM2, z4, z5);
        }
