...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    public final class Editor {
        ...
        public final Sink newSink(int index) {
            ...
            synchronized (diskLruCache) {
                ...
                try {
                    return new FaultHidingSink(diskLruCache.getFileSystem().sink(this.entry.getDirtyFiles$okhttp().get(index)), new Function1<IOException, kotlin.j>() { // from class: okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1
                        ...
                        public /* bridge */ /* synthetic */ kotlin.j invoke(IOException iOException) {
                            invoke2(iOException);
    ...
    private final BufferedSink newJournalWriter() throws FileNotFoundException {
        return Okio.buffer(new FaultHidingSink(this.fileSystem.appendingSink(this.journalFile), new Function1<IOException, kotlin.j>() { // from class: okhttp3.internal.cache.DiskLruCache$newJournalWriter$faultHidingSink$1
            {
                super(1);
            }
    ...
    private final void readJournal() throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        try {
            ...
            if (!j.a(MAGIC, utf8LineStrict) || !j.a(VERSION_1, utf8LineStrict2) || !j.a(String.valueOf(this.appVersion), utf8LineStrict3) || !j.a(String.valueOf(this.valueCount), utf8LineStrict4) || utf8LineStrict5.length() > 0) {
            ...
            while (true) {
                try {
                    ...
                    kotlin.j jVar = kotlin.j.f51397a;
                    kotlin.io.a.a(bufferedSourceBuffer, null);
                    return;
                }
            }
        } finally {
    ...
    private final void readJournalLine(String line) throws IOException {
        ...
        int i2 = iU + 1;
        int iU2 = B.U(line, ' ', i2, false, 4, null);
        if (iU2 == -1) {
            strSubstring = line.substring(i2);
            j.d(strSubstring, "this as java.lang.String).substring(startIndex)");
            String str = REMOVE;
            if (iU == str.length() && z.H(line, str, false, 2, null)) {
                this.lruEntries.remove(strSubstring);
                return;
            }
        } else {
            strSubstring = line.substring(i2, iU2);
        ...
        if (iU2 != -1) {
            String str2 = CLEAN;
            if (iU == str2.length() && z.H(line, str2, false, 2, null)) {
                String strSubstring2 = line.substring(iU2 + 1);
                j.d(strSubstring2, "this as java.lang.String).substring(startIndex)");
                List<String> listS0 = B.s0(strSubstring2, new char[]{' '}, false, 0, 6, null);
                entry.setReadable$okhttp(true);
                entry.setCurrentEditor$okhttp(null);
                entry.setLengths$okhttp(listS0);
                return;
            }
        }
        if (iU2 == -1) {
            String str3 = DIRTY;
            if (iU == str3.length() && z.H(line, str3, false, 2, null)) {
        ...
        if (iU2 == -1) {
            String str4 = READ;
            if (iU == str4.length() && z.H(line, str4, false, 2, null)) {
                return;
            }
        }
        throw new IOException("unexpected journal line: " + line);
