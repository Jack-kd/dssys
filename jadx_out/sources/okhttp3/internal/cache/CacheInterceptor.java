...
public final class CacheInterceptor implements Interceptor {
    ...
    public static final class Companion {
        ...
        public final Headers combine(Headers cachedHeaders, Headers networkHeaders) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if ((!z.v("Warning", strName, true) || !z.H(strValue, "1", false, 2, null)) && (isContentSpecificHeader(strName) || !isEndToEnd(strName) || networkHeaders.get(strName) == null)) {
        ...
        private final boolean isContentSpecificHeader(String fieldName) {
            return z.v(c.f37366e, fieldName, true) || z.v("Content-Encoding", fieldName, true) || z.v(AbstractC1114b.f5589g, fieldName, true);
        }

        private final boolean isEndToEnd(String fieldName) {
            return (z.v("Connection", fieldName, true) || z.v("Keep-Alive", fieldName, true) || z.v("Proxy-Authenticate", fieldName, true) || z.v("Proxy-Authorization", fieldName, true) || z.v("TE", fieldName, true) || z.v("Trailers", fieldName, true) || z.v(c.f37369h, fieldName, true) || z.v("Upgrade", fieldName, true)) ? false : true;
        }
    ...
    private final Response cacheWritingResponse(final CacheRequest cacheRequest, Response response) throws IOException {
        ...
        return response.newBuilder().body(new RealResponseBody(Response.header$default(response, AbstractC1114b.f5589g, null, 2, null), response.body().getContentLength(), Okio.buffer(source2))).build();
    }
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IllegalAccessException, IOException, IllegalArgumentException, InvocationTargetException {
        ...
        if (networkRequest == null && cacheResponse == null) {
            Response responseBuild = new Response.Builder().request(chain.request()).protocol(Protocol.HTTP_1_1).code(e.f35439E).message("Unsatisfiable Request (only-if-cached)").body(Util.EMPTY_RESPONSE).sentRequestAtMillis(-1L).receivedResponseAtMillis(System.currentTimeMillis()).build();
