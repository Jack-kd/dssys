...
public final class TaskRunner {
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0010\u0010\u0003\u001a\u00020\u00048\u0006X\u0087\u0004¢\u0006\u0002\n\u0000R\u0011\u0010\u0005\u001a\u00020\u0006¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lokhttp3/internal/concurrent/TaskRunner$Companion;", "", "()V", "INSTANCE", "Lokhttp3/internal/concurrent/TaskRunner;", bv.f11243a, "Ljava/util/logging/Logger;", "getLogger", "()Ljava/util/logging/Logger;", "okhttp"}, k = 1, mv = {1, 8, 0}, xi = 48)
    ...
    public static final class RealBackend implements Backend {
        ...
        public void coordinatorWait(@NotNull TaskRunner taskRunner, long nanos) throws InterruptedException {
            j.e(taskRunner, "taskRunner");
            long j2 = nanos / C.MICROS_PER_SECOND;
            long j3 = nanos - (C.MICROS_PER_SECOND * j2);
            if (j2 > 0 || nanos > 0) {
    ...
    static {
        ...
        j.d(logger2, "getLogger(TaskRunner::class.java.name)");
        logger = logger2;
    }
    ...
    public final List<TaskQueue> activeQueues() {
        ...
        synchronized (this) {
            listT = y.T(this.busyQueues, this.readyQueues);
        }
        return listT;
    }
