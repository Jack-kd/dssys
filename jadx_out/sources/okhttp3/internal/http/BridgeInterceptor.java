...
public final class BridgeInterceptor implements Interceptor {
    ...
    public Response intercept(@NotNull Interceptor.Chain chain) throws IOException {
        ...
        if (requestBodyBody != null) {
            ...
            if (mediaType != null) {
                builderNewBuilder.header(AbstractC1114b.f5589g, mediaType.getMediaType());
            }
            long jContentLength = requestBodyBody.contentLength();
            if (jContentLength != -1) {
                builderNewBuilder.header(c.f37366e, String.valueOf(jContentLength));
                builderNewBuilder.removeHeader(c.f37369h);
            } else {
                builderNewBuilder.header(c.f37369h, "chunked");
                builderNewBuilder.removeHeader(c.f37366e);
            }
        }
        boolean z2 = false;
        ...
        if (request.header("Accept-Encoding") == null && request.header(c.f37363b) == null) {
        ...
        if (!listLoadForRequest.isEmpty()) {
            builderNewBuilder.header(e.f36239a, cookieHeader(listLoadForRequest));
        }
        ...
        if (z2 && z.v("gzip", Response.header$default(responseProceed, "Content-Encoding", null, 2, null), true) && HttpHeaders.promisesBody(responseProceed) && (responseBodyBody = responseProceed.body()) != null) {
            GzipSource gzipSource = new GzipSource(responseBodyBody.getBodySource());
            builderRequest.headers(responseProceed.headers().newBuilder().removeAll("Content-Encoding").removeAll(c.f37366e).build());
            builderRequest.body(new RealResponseBody(Response.header$default(responseProceed, AbstractC1114b.f5589g, null, 2, null), -1L, Okio.buffer(gzipSource)));
        }
