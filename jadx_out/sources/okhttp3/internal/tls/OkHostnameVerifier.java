...
public final class OkHostnameVerifier implements HostnameVerifier {
    ...
    public final List<String> allSubjectAltNames(@NotNull X509Certificate certificate) throws CertificateParsingException {
        ...
        return y.T(getSubjectAltNames(certificate, 7), getSubjectAltNames(certificate, 2));
    }
    ...
    private final boolean verifyHostname(String hostname, String pattern) {
        if (hostname != null && hostname.length() != 0 && !z.H(hostname, i.f2495E, false, 2, null) && !z.u(hostname, "..", false, 2, null) && pattern != null && pattern.length() != 0 && !z.H(pattern, i.f2495E, false, 2, null) && !z.u(pattern, "..", false, 2, null)) {
            if (!z.u(hostname, i.f2495E, false, 2, null)) {
                hostname = hostname + '.';
            }
            String str = hostname;
            if (!z.u(pattern, i.f2495E, false, 2, null)) {
                pattern = pattern + '.';
            }
            String strAsciiToLowercase = asciiToLowercase(pattern);
            if (!B.M(strAsciiToLowercase, "*", false, 2, null)) {
                return j.a(str, strAsciiToLowercase);
            }
            if (!z.H(strAsciiToLowercase, "*.", false, 2, null) || B.U(strAsciiToLowercase, '*', 1, false, 4, null) != -1 || str.length() < strAsciiToLowercase.length() || j.a("*.", strAsciiToLowercase)) {
                return false;
            }
            String strSubstring = strAsciiToLowercase.substring(1);
            j.d(strSubstring, "this as java.lang.String).substring(startIndex)");
            if (!z.u(str, strSubstring, false, 2, null)) {
                return false;
            }
            int length = str.length() - strSubstring.length();
            return length <= 0 || B.a0(str, '.', length + (-1), false, 4, null) == -1;
        }
        return false;
    }
}
