...
public enum Protocol {
    ...
    public static final class Companion {
        ...
        public final Protocol get(@NotNull String protocol) throws IOException {
            ...
            if (j.a(protocol, protocol3.protocol)) {
                return protocol3;
            }
            Protocol protocol4 = Protocol.H2_PRIOR_KNOWLEDGE;
            if (j.a(protocol, protocol4.protocol)) {
                return protocol4;
            }
            Protocol protocol5 = Protocol.HTTP_2;
            if (j.a(protocol, protocol5.protocol)) {
                return protocol5;
            }
            Protocol protocol6 = Protocol.SPDY_3;
            if (j.a(protocol, protocol6.protocol)) {
                return protocol6;
            }
            Protocol protocol7 = Protocol.QUIC;
            if (j.a(protocol, protocol7.protocol)) {
                return protocol7;
            }
