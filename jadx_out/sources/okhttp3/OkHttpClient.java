...
public class OkHttpClient implements Cloneable, Call.Factory, WebSocket.Factory {
    ...
    public static final class Builder {
        ...
        public final Builder m197addInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
            j.e(block, "block");
        ...
        public final Builder m198addNetworkInterceptor(@NotNull final Function1<? super Interceptor.Chain, Response> block) {
            j.e(block, "block");
        ...
        public final Builder protocols(@NotNull List<? extends Protocol> protocols) {
            ...
            List listC0 = y.c0(protocols);
            Protocol protocol = Protocol.H2_PRIOR_KNOWLEDGE;
            if (!listC0.contains(protocol) && !listC0.contains(Protocol.HTTP_1_1)) {
                throw new IllegalArgumentException(("protocols must contain h2_prior_knowledge or http/1.1: " + listC0).toString());
            }
            if (listC0.contains(protocol) && listC0.size() > 1) {
                throw new IllegalArgumentException(("protocols containing h2_prior_knowledge cannot use other protocols: " + listC0).toString());
            }
            if (listC0.contains(Protocol.HTTP_1_0)) {
                throw new IllegalArgumentException(("protocols must not contain http/1.0: " + listC0).toString());
            }
            j.c(listC0, "null cannot be cast to non-null type kotlin.collections.List<okhttp3.Protocol?>");
            if (listC0.contains(null)) {
                throw new IllegalArgumentException("protocols must not contain null");
            }
            listC0.remove(Protocol.SPDY_3);
            if (!j.a(listC0, this.protocols)) {
                this.routeDatabase = null;
            }
            List<? extends Protocol> listUnmodifiableList = Collections.unmodifiableList(listC0);
            j.d(listUnmodifiableList, "unmodifiableList(protocolsCopy)");
        ...
        public Builder(@NotNull OkHttpClient okHttpClient) {
            ...
            v.z(this.interceptors, okHttpClient.interceptors());
            v.z(this.networkInterceptors, okHttpClient.networkInterceptors());
    ...
    public final List<ConnectionSpec> m177deprecated_connectionSpecs() {
        return this.connectionSpecs;
    }
    ...
    public final List<Interceptor> m185deprecated_interceptors() {
        return this.interceptors;
    }
    ...
    public final List<Interceptor> m186deprecated_networkInterceptors() {
        return this.networkInterceptors;
    }
    ...
    public final List<Protocol> m188deprecated_protocols() {
        return this.protocols;
    }
