...
public final class CipherSuite {
    ...
    public static final class Companion {
        ...
        private final String secondaryName(String javaName) {
            if (z.H(javaName, "TLS_", false, 2, null)) {
            ...
            if (!z.H(javaName, "SSL_", false, 2, null)) {
                return javaName;
            }
    ...
    static {
        ...
        TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA = companion.init("TLS_DHE_DSS_WITH_CAMELLIA_256_CBC_SHA", MediaPlayer.MEDIA_PLAYER_OPTION_SET_PIPE_START_OFFSET);
        ...
        TLS_PSK_WITH_RC4_128_SHA = companion.init("TLS_PSK_WITH_RC4_128_SHA", MediaPlayer.MEDIA_PLAYER_OPTION_LOOP_END_TIME);
    ...
    public /* synthetic */ CipherSuite(String str, kotlin.jvm.internal.f fVar) {
        this(str);
    }
