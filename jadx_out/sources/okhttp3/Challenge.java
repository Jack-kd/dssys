...
public final class Challenge {
    ...
    public final Map<String, String> m109deprecated_authParams() {
    ...
    public final Charset m110deprecated_charset() {
        return charset();
    }
    ...
    public final String m111deprecated_realm() {
        return realm();
    }
    ...
    public final Charset charset() {
        ...
        if (str != null) {
            try {
                ...
                j.d(charsetForName, "forName(charset)");
    ...
    public final Challenge withCharset(@NotNull Charset charset) {
        j.e(charset, "charset");
        Map mapR = G.r(this.authParams);
        String strName = charset.name();
        j.d(strName, "charset.name()");
        mapR.put("charset", strName);
        return new Challenge(this.scheme, (Map<String, String>) mapR);
    }
