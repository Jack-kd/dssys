...
public final class Handshake {
    ...
    @NotNull
    private final c peerCertificates;
    ...
    public static final class Companion {
        ...
        private final List<Certificate> toImmutableList(Certificate[] certificateArr) {
            return certificateArr != null ? Util.immutableListOf(Arrays.copyOf(certificateArr, certificateArr.length)) : q.l();
        }
        ...
        public final Handshake m134deprecated_get(@NotNull SSLSession sslSession) throws IOException {
        ...
        public final Handshake get(@NotNull SSLSession sSLSession) throws IOException {
            ...
            if (j.a(Constraint.NONE, protocol)) {
                throw new IOException("tlsVersion == NONE");
            }
            TlsVersion tlsVersionForJavaName = TlsVersion.INSTANCE.forJavaName(protocol);
            try {
                listL = toImmutableList(sSLSession.getPeerCertificates());
    ...
    public Handshake(@NotNull TlsVersion tlsVersion, @NotNull CipherSuite cipherSuite, @NotNull List<? extends Certificate> localCertificates, @NotNull final Function0<? extends List<? extends Certificate>> peerCertificatesFn) {
        ...
        this.peerCertificates = d.b(new Function0<List<? extends Certificate>>() { // from class: okhttp3.Handshake.peerCertificates.2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            /* JADX WARN: Multi-variable type inference failed */
            {
                super(0);
    ...
    public final List<Certificate> m129deprecated_localCertificates() {
    ...
    public final Principal m130deprecated_localPrincipal() {
    ...
    public final List<Certificate> m131deprecated_peerCertificates() {
    ...
    public final Principal m132deprecated_peerPrincipal() {
    ...
    public final Principal localPrincipal() {
        Object objL = y.L(this.localCertificates);
        X509Certificate x509Certificate = objL instanceof X509Certificate ? (X509Certificate) objL : null;
    ...
    public final Principal peerPrincipal() {
        Object objL = y.L(peerCertificates());
        X509Certificate x509Certificate = objL instanceof X509Certificate ? (X509Certificate) objL : null;
        if (x509Certificate != null) {
            return x509Certificate.getSubjectX500Principal();
        }
