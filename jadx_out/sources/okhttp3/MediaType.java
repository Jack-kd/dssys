...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m163deprecated_get(@NotNull String mediaType) {
        ...
        public final MediaType m164deprecated_parse(@NotNull String mediaType) {
            j.e(mediaType, "mediaType");
        ...
        public final MediaType get(@NotNull String str) {
            ...
            while (iEnd < str.length()) {
                ...
                if (strGroup3 == null) {
                    ...
                    } else if (z.H(strGroup4, "'", false, 2, null) && z.u(strGroup4, "'", false, 2, null) && strGroup4.length() > 2) {
                        strGroup4 = strGroup4.substring(1, strGroup4.length() - 1);
                        j.d(strGroup4, "this as java.lang.String…ing(startIndex, endIndex)");
                    }
    ...
    public final String parameter(@NotNull String name) {
        j.e(name, "name");
        int i2 = 0;
        int iB = c.b(0, this.parameterNamesAndValues.length - 1, 2);
        if (iB < 0) {
            return null;
        }
        while (!z.v(this.parameterNamesAndValues[i2], name, true)) {
            if (i2 == iB) {
                return null;
            }
            i2 += 2;
