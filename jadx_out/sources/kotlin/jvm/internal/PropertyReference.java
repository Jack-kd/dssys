...
public abstract class PropertyReference extends CallableReference implements kotlin.reflect.k {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof PropertyReference) {
            ...
            return getOwner().equals(propertyReference.getOwner()) && getName().equals(propertyReference.getName()) && getSignature().equals(propertyReference.getSignature()) && j.a(getBoundReceiver(), propertyReference.getBoundReceiver());
        }
