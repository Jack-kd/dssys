...
public class AdaptedFunctionReference implements h, Serializable {
    ...
    public boolean equals(Object obj) {
        ...
        return this.isTopLevel == adaptedFunctionReference.isTopLevel && this.arity == adaptedFunctionReference.arity && this.flags == adaptedFunctionReference.flags && j.a(this.receiver, adaptedFunctionReference.receiver) && j.a(this.owner, adaptedFunctionReference.owner) && this.name.equals(adaptedFunctionReference.name) && this.signature.equals(adaptedFunctionReference.signature);
    }
